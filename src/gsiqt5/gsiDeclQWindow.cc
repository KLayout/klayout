...
static void _call_f_isAncestorOf_c4407 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QWindow *arg1 = args.read<const QWindow * > (heap);
  const qt_gsi::Converter<QWindow::AncestorMode>::target_type & arg2 = args ? args.read<const qt_gsi::Converter<QWindow::AncestorMode>::target_type & > (heap) : (const qt_gsi::Converter<QWindow::AncestorMode>::target_type &)(qt_gsi::CppToQtReadAdaptor<QWindow::AncestorMode>(heap, QWindow::IncludeTransients));
...
static void _call_f_setSurfaceType_2477 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QSurface::SurfaceType>::target_type & arg1 = args.read<const qt_gsi::Converter<QSurface::SurfaceType>::target_type & > (heap);
  __SUPPRESS_UNUSED_WARNING(ret);
...
qt_gsi::QtNativeClass<QWindow> decl_QWindow (qtdecl_QObject (), "QWindow_Native",
  methods_QWindow (),
  "@hide\n@alias QWindow");

GSIQT_PUBLIC gsi::Class<QWindow> &qtdecl_QWindow () { return decl_QWindow; }
...
gsi::Class<QWindow_Adaptor> decl_QWindow_Adaptor (qtdecl_QWindow (), "QWindow",
...
static gsi::Enum<QWindow::AncestorMode> decl_QWindow_AncestorMode_Enum ("QWindow_AncestorMode",
...
static gsi::QFlagsClass<QWindow::AncestorMode > decl_QWindow_AncestorMode_Enums ("QWindow_QFlags_AncestorMode",
...
static gsi::Enum<QWindow::Visibility> decl_QWindow_Visibility_Enum ("QWindow_Visibility",
...
static gsi::QFlagsClass<QWindow::Visibility > decl_QWindow_Visibility_Enums ("QWindow_QFlags_Visibility",
