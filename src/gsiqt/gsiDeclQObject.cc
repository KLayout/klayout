...
static gsi::Methods methods_QObject () {
  ...
  methods += new qt_gsi::GenericMethod ("connect", "@brief Method bool QObject::connect(const QObject *sender, const char *signal, const char *member, Qt::ConnectionType type)\n", true, &_init_f_connect_c7342, &_call_f_connect_c7342);
  ...
  methods += new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QObject::tr(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_tr_3354, &_call_f_tr_3354);
  ...
  methods += new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QObject::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
...
gsi::Class<QObject> decl_QObject ("QObject_Native",
