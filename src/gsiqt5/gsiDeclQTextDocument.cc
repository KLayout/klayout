...
static void _call_f_clearUndoRedoStacks_2502 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QTextDocument::Stacks>::target_type & arg1 = args ? args.read<const qt_gsi::Converter<QTextDocument::Stacks>::target_type & > (heap) : (const qt_gsi::Converter<QTextDocument::Stacks>::target_type &)(qt_gsi::CppToQtReadAdaptor<QTextDocument::Stacks>(heap, QTextDocument::UndoAndRedoStacks));
  __SUPPRESS_UNUSED_WARNING(ret);
...
gsi::Class<QTextDocument> decl_QTextDocument (qtdecl_QObject (), "QTextDocument_Native",
...
static gsi::Enum<QTextDocument::Stacks> decl_QTextDocument_Stacks_Enum ("QTextDocument_Stacks",
...
static gsi::QFlagsClass<QTextDocument::Stacks > decl_QTextDocument_Stacks_Enums ("QTextDocument_QFlags_Stacks",
