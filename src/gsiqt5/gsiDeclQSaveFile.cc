...
qt_gsi::QtNativeClass<QSaveFile> decl_QSaveFile (qtdecl_QFileDevice (), "QSaveFile_Native",
  methods_QSaveFile (),
  "@hide\n@alias QSaveFile");

GSIQT_PUBLIC gsi::Class<QSaveFile> &qtdecl_QSaveFile () { return decl_QSaveFile; }
...
gsi::Class<QSaveFile_Adaptor> decl_QSaveFile_Adaptor (qtdecl_QSaveFile (), "QSaveFile",
