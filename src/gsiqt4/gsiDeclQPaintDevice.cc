...
GSIQT_PUBLIC gsi::Class<QPaintDevice> &qtdecl_QPaintDevice () { return decl_QPaintDevice; }
...
gsi::Class<QPaintDevice_Adaptor> decl_QPaintDevice_Adaptor (qtdecl_QPaintDevice (), "QPaintDevice",
...
static gsi::Enum<QPaintDevice::PaintDeviceMetric> decl_QPaintDevice_PaintDeviceMetric_Enum ("QPaintDevice_PaintDeviceMetric",
...
static gsi::QFlagsClass<QPaintDevice::PaintDeviceMetric > decl_QPaintDevice_PaintDeviceMetric_Enums ("QPaintDevice_QFlags_PaintDeviceMetric",
