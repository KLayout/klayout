...
static gsi::Methods methods_QColormap () {
  ...
  methods += new qt_gsi::GenericMethod ("colormap", "@brief Method const QList<QColor> QColormap::colormap()\n", true, &_init_f_colormap_c0, &_call_f_colormap_c0);
