...
static void _call_f_attach_2848 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  const qt_gsi::Converter<QSharedMemory::AccessMode>::target_type & arg1 = args ? args.read<const qt_gsi::Converter<QSharedMemory::AccessMode>::target_type & > (heap) : (const qt_gsi::Converter<QSharedMemory::AccessMode>::target_type &)(qt_gsi::CppToQtReadAdaptor<QSharedMemory::AccessMode>(heap, QSharedMemory::ReadWrite));
...
static void _call_f_create_3507 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  const qt_gsi::Converter<QSharedMemory::AccessMode>::target_type & arg2 = args ? args.read<const qt_gsi::Converter<QSharedMemory::AccessMode>::target_type & > (heap) : (const qt_gsi::Converter<QSharedMemory::AccessMode>::target_type &)(qt_gsi::CppToQtReadAdaptor<QSharedMemory::AccessMode>(heap, QSharedMemory::ReadWrite));
...
qt_gsi::QtNativeClass<QSharedMemory> decl_QSharedMemory (qtdecl_QObject (), "QSharedMemory_Native",
  methods_QSharedMemory (),
  "@hide\n@alias QSharedMemory");

GSIQT_PUBLIC gsi::Class<QSharedMemory> &qtdecl_QSharedMemory () { return decl_QSharedMemory; }
...
gsi::Class<QSharedMemory_Adaptor> decl_QSharedMemory_Adaptor (qtdecl_QSharedMemory (), "QSharedMemory",
...
static gsi::Enum<QSharedMemory::AccessMode> decl_QSharedMemory_AccessMode_Enum ("QSharedMemory_AccessMode",
...
static gsi::QFlagsClass<QSharedMemory::AccessMode > decl_QSharedMemory_AccessMode_Enums ("QSharedMemory_QFlags_AccessMode",
...
static gsi::Enum<QSharedMemory::SharedMemoryError> decl_QSharedMemory_SharedMemoryError_Enum ("QSharedMemory_SharedMemoryError",
...
static gsi::QFlagsClass<QSharedMemory::SharedMemoryError > decl_QSharedMemory_SharedMemoryError_Enums ("QSharedMemory_QFlags_SharedMemoryError",
