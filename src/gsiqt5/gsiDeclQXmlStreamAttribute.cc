...
gsi::Class<QXmlStreamAttribute> decl_QXmlStreamAttribute ("QXmlStreamAttribute",
  methods_QXmlStreamAttribute (),
  "@qt\n@brief Binding of QXmlStreamAttribute");


GSIQT_PUBLIC gsi::Class<QXmlStreamAttribute> &qtdecl_QXmlStreamAttribute () { return decl_QXmlStreamAttribute; }
