...
GSIQT_PUBLIC gsi::Class<QDesktopServices> &qtdecl_QDesktopServices () { return decl_QDesktopServices; }
...
static gsi::Enum<QDesktopServices::StandardLocation> decl_QDesktopServices_StandardLocation_Enum ("QDesktopServices_StandardLocation",
...
static gsi::QFlagsClass<QDesktopServices::StandardLocation > decl_QDesktopServices_StandardLocation_Enums ("QDesktopServices_QFlags_StandardLocation",
