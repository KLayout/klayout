...
static void _init_f_operator_eq__3539 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("arg1");
  decl->add_arg<const QStyleOptionRubberBand & > (argspec_0);
  decl->set_return<QStyleOptionRubberBand & > ();
}

static void _call_f_operator_eq__3539 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QStyleOptionRubberBand &arg1 = gsi::arg_reader<const QStyleOptionRubberBand & >() (args, heap);
  ret.write<QStyleOptionRubberBand & > ((QStyleOptionRubberBand &)((QStyleOptionRubberBand *)cls)->operator= (arg1));
}
...
static gsi::Methods methods_QStyleOptionRubberBand () {
  ...
  methods += new qt_gsi::GenericMethod ("assign", "@brief Method QStyleOptionRubberBand &QStyleOptionRubberBand::operator=(const QStyleOptionRubberBand &)\n", false, &_init_f_operator_eq__3539, &_call_f_operator_eq__3539);
  return methods;
}
