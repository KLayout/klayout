...
gsi::Class<QDnsServiceRecord> decl_QDnsServiceRecord ("QDnsServiceRecord",
  methods_QDnsServiceRecord (),
  "@qt\n@brief Binding of QDnsServiceRecord");


GSIQT_PUBLIC gsi::Class<QDnsServiceRecord> &qtdecl_QDnsServiceRecord () { return decl_QDnsServiceRecord; }
