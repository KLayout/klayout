...
static gsi::Methods methods_QRegExpValidator () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QRegExpValidator::tr(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_tr_3354, &_call_f_tr_3354);
  ...
  methods += new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QRegExpValidator::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
...
qt_gsi::QtNativeClass<QRegExpValidator> decl_QRegExpValidator (qtdecl_QValidator (), "QRegExpValidator_Native",
...
static gsi::Methods methods_QRegExpValidator_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*disconnectNotify", "@brief Virtual method void QRegExpValidator::disconnectNotify(const char *signal)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_disconnectNotify_1731_0, &_call_cbs_disconnectNotify_1731_0, &_set_callback_cbs_disconnectNotify_1731_0);
