...
gsi::Class<QStylePainter> decl_QStylePainter (qtdecl_QPainter (), "QtGui", "QStylePainter",
  methods_QStylePainter (),
  "@qt\n@brief Binding of QStylePainter");


GSI_QTGUI_PUBLIC gsi::Class<QStylePainter> &qtdecl_QStylePainter () { return decl_QStylePainter; }
