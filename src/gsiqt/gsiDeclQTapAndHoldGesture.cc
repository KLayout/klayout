...
qt_gsi::QtNativeClass<QTapAndHoldGesture> decl_QTapAndHoldGesture (qtdecl_QGesture (), "QTapAndHoldGesture_Native",
  methods_QTapAndHoldGesture (),
  "@hide\n@alias QTapAndHoldGesture");

GSIQT_PUBLIC gsi::Class<QTapAndHoldGesture> &qtdecl_QTapAndHoldGesture () { return decl_QTapAndHoldGesture; }
...
gsi::Class<QTapAndHoldGesture_Adaptor> decl_QTapAndHoldGesture_Adaptor (qtdecl_QTapAndHoldGesture (), "QTapAndHoldGesture",
