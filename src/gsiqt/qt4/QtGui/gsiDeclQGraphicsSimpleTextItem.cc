...
gsi::Class<QGraphicsSimpleTextItem> decl_QGraphicsSimpleTextItem (qtdecl_QAbstractGraphicsShapeItem (), "QtGui", "QGraphicsSimpleTextItem_Native",
  methods_QGraphicsSimpleTextItem (),
  "@hide\n@alias QGraphicsSimpleTextItem");

GSI_QTGUI_PUBLIC gsi::Class<QGraphicsSimpleTextItem> &qtdecl_QGraphicsSimpleTextItem () { return decl_QGraphicsSimpleTextItem; }
...
gsi::Class<QGraphicsSimpleTextItem_Adaptor> decl_QGraphicsSimpleTextItem_Adaptor (qtdecl_QGraphicsSimpleTextItem (), "QtGui", "QGraphicsSimpleTextItem",
