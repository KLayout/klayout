...
gsi::Class<QGraphicsLineItem> decl_QGraphicsLineItem (qtdecl_QGraphicsItem (), "QtGui", "QGraphicsLineItem_Native",
  methods_QGraphicsLineItem (),
  "@hide\n@alias QGraphicsLineItem");

GSI_QTGUI_PUBLIC gsi::Class<QGraphicsLineItem> &qtdecl_QGraphicsLineItem () { return decl_QGraphicsLineItem; }
...
static gsi::Methods methods_QGraphicsLineItem_Adaptor () {
  gsi::Methods methods;
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QGraphicsLineItem::QGraphicsLineItem(QGraphicsItem *parent, QGraphicsScene *scene)\nThis method creates an object of class QGraphicsLineItem.", &_init_ctor_QGraphicsLineItem_Adaptor_3825, &_call_ctor_QGraphicsLineItem_Adaptor_3825);
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QGraphicsLineItem::QGraphicsLineItem(const QLineF &line, QGraphicsItem *parent, QGraphicsScene *scene)\nThis method creates an object of class QGraphicsLineItem.", &_init_ctor_QGraphicsLineItem_Adaptor_5573, &_call_ctor_QGraphicsLineItem_Adaptor_5573);
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QGraphicsLineItem::QGraphicsLineItem(double x1, double y1, double x2, double y2, QGraphicsItem *parent, QGraphicsScene *scene)\nThis method creates an object of class QGraphicsLineItem.", &_init_ctor_QGraphicsLineItem_Adaptor_7677, &_call_ctor_QGraphicsLineItem_Adaptor_7677);
...
gsi::Class<QGraphicsLineItem_Adaptor> decl_QGraphicsLineItem_Adaptor (qtdecl_QGraphicsLineItem (), "QtGui", "QGraphicsLineItem",
