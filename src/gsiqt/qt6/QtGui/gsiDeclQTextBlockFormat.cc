...
// int QTextBlockFormat::headingLevel()


static void _init_f_headingLevel_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<int > ();
}

static void _call_f_headingLevel_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<int > ((int)((QTextBlockFormat *)cls)->headingLevel ());
}
...
// QTextBlockFormat::MarkerType QTextBlockFormat::marker()


static void _init_f_marker_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<qt_gsi::Converter<QTextBlockFormat::MarkerType>::target_type > ();
}

static void _call_f_marker_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<qt_gsi::Converter<QTextBlockFormat::MarkerType>::target_type > ((qt_gsi::Converter<QTextBlockFormat::MarkerType>::target_type)qt_gsi::CppToQtAdaptor<QTextBlockFormat::MarkerType>(((QTextBlockFormat *)cls)->marker ()));
}
...
static void _init_f_setHeadingLevel_767 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("alevel");
  decl->add_arg<int > (argspec_0);
  decl->set_return<void > ();
}

static void _call_f_setHeadingLevel_767 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  int arg1 = gsi::arg_reader<int >() (args, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTextBlockFormat *)cls)->setHeadingLevel (arg1);
}
...
static void _init_f_setMarker_3190 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("marker");
  decl->add_arg<const qt_gsi::Converter<QTextBlockFormat::MarkerType>::target_type & > (argspec_0);
  decl->set_return<void > ();
}

static void _call_f_setMarker_3190 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QTextBlockFormat::MarkerType>::target_type & arg1 = gsi::arg_reader<const qt_gsi::Converter<QTextBlockFormat::MarkerType>::target_type & >() (args, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTextBlockFormat *)cls)->setMarker (qt_gsi::QtToCppAdaptor<QTextBlockFormat::MarkerType>(arg1).cref());
}
...
static gsi::Methods methods_QTextBlockFormat () {
  ...
  methods += new qt_gsi::GenericMethod (":marker", "@brief Method QTextBlockFormat::MarkerType QTextBlockFormat::marker()\n", true, &_init_f_marker_c0, &_call_f_marker_c0);
  ...
  methods += new qt_gsi::GenericMethod ("setMarker|marker=", "@brief Method void QTextBlockFormat::setMarker(QTextBlockFormat::MarkerType marker)\n", false, &_init_f_setMarker_3190, &_call_f_setMarker_3190);
...
//  Implementation of the enum wrapper class for QTextBlockFormat::MarkerType
namespace qt_gsi
{

static gsi::Enum<QTextBlockFormat::MarkerType> decl_QTextBlockFormat_MarkerType_Enum ("QtGui", "QTextBlockFormat_MarkerType",
    gsi::enum_const ("NoMarker", QTextBlockFormat::MarkerType::NoMarker, "@brief Enum constant QTextBlockFormat::MarkerType::NoMarker") +
    gsi::enum_const ("Unchecked", QTextBlockFormat::MarkerType::Unchecked, "@brief Enum constant QTextBlockFormat::MarkerType::Unchecked") +
    gsi::enum_const ("Checked", QTextBlockFormat::MarkerType::Checked, "@brief Enum constant QTextBlockFormat::MarkerType::Checked"),
  "@qt\n@brief This class represents the QTextBlockFormat::MarkerType enum");

static gsi::QFlagsClass<QTextBlockFormat::MarkerType > decl_QTextBlockFormat_MarkerType_Enums ("QtGui", "QTextBlockFormat_QFlags_MarkerType",
  "@qt\n@brief This class represents the QFlags<QTextBlockFormat::MarkerType> flag set");

static gsi::ClassExt<QTextBlockFormat> decl_QTextBlockFormat_MarkerType_Enum_as_child (decl_QTextBlockFormat_MarkerType_Enum, "MarkerType");
static gsi::ClassExt<QTextBlockFormat> decl_QTextBlockFormat_MarkerType_Enums_as_child (decl_QTextBlockFormat_MarkerType_Enums, "QFlags_MarkerType");
