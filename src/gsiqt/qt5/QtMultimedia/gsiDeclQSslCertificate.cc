...
gsi::Class<QSslCertificate> decl_QSslCertificate ("QtMultimedia", "QSslCertificate",
  methods_QSslCertificate (),
  "@qt\n@brief Binding of QSslCertificate");


GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QSslCertificate> &qtdecl_QSslCertificate () { return decl_QSslCertificate; }
...
static gsi::Enum<QSslCertificate::SubjectInfo> decl_QSslCertificate_SubjectInfo_Enum ("QtMultimedia", "QSslCertificate_SubjectInfo",
...
static gsi::QFlagsClass<QSslCertificate::SubjectInfo > decl_QSslCertificate_SubjectInfo_Enums ("QtMultimedia", "QSslCertificate_QFlags_SubjectInfo",
