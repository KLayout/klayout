...
static void _init_f_swap_1694 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("other");
  decl->add_arg<QBasicTimer & > (argspec_0);
  decl->set_return<void > ();
}

static void _call_f_swap_1694 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QBasicTimer &arg1 = gsi::arg_reader<QBasicTimer & >() (args, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QBasicTimer *)cls)->swap (arg1);
}
...
static gsi::Methods methods_QBasicTimer () {
  ...
  methods += new qt_gsi::GenericMethod ("swap", "@brief Method void QBasicTimer::swap(QBasicTimer &other)\n", false, &_init_f_swap_1694, &_call_f_swap_1694);
