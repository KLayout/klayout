...
GSIQT_PUBLIC gsi::Class<QUrlInfo> &qtdecl_QUrlInfo () { return decl_QUrlInfo; }
...
static gsi::Methods methods_QUrlInfo_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("setDir", "@hide", false, &_init_cbs_setDir_864_0, &_call_cbs_setDir_864_0);
  ...
  methods += new qt_gsi::GenericMethod ("setFile", "@hide", false, &_init_cbs_setFile_864_0, &_call_cbs_setFile_864_0);
  ...
  methods += new qt_gsi::GenericMethod ("setGroup", "@hide", false, &_init_cbs_setGroup_2025_0, &_call_cbs_setGroup_2025_0);
  ...
  methods += new qt_gsi::GenericMethod ("setLastModified", "@hide", false, &_init_cbs_setLastModified_2175_0, &_call_cbs_setLastModified_2175_0);
  ...
  methods += new qt_gsi::GenericMethod ("setName", "@hide", false, &_init_cbs_setName_2025_0, &_call_cbs_setName_2025_0);
  ...
  methods += new qt_gsi::GenericMethod ("setOwner", "@hide", false, &_init_cbs_setOwner_2025_0, &_call_cbs_setOwner_2025_0);
  ...
  methods += new qt_gsi::GenericMethod ("setPermissions", "@hide", false, &_init_cbs_setPermissions_767_0, &_call_cbs_setPermissions_767_0);
  ...
  methods += new qt_gsi::GenericMethod ("setReadable", "@hide", false, &_init_cbs_setReadable_864_0, &_call_cbs_setReadable_864_0);
  ...
  methods += new qt_gsi::GenericMethod ("setSize", "@hide", false, &_init_cbs_setSize_986_0, &_call_cbs_setSize_986_0);
  ...
  methods += new qt_gsi::GenericMethod ("setSymLink", "@hide", false, &_init_cbs_setSymLink_864_0, &_call_cbs_setSymLink_864_0);
  ...
  methods += new qt_gsi::GenericMethod ("setWritable", "@hide", false, &_init_cbs_setWritable_864_0, &_call_cbs_setWritable_864_0);
...
gsi::Class<QUrlInfo_Adaptor> decl_QUrlInfo_Adaptor (qtdecl_QUrlInfo (), "QUrlInfo",
