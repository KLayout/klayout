...
static void _call_f_createMaskFromColor_c3331 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  const QColor &arg1 = gsi::arg_reader<const QColor & >() (args, heap);
  const qt_gsi::Converter<Qt::MaskMode>::target_type & arg2 = gsi::arg_reader<const qt_gsi::Converter<Qt::MaskMode>::target_type & >() (args, heap);
...
static gsi::Methods methods_QPixmap () {
  gsi::Methods methods;
  methods += new qt_gsi::GenericMethod (":alphaChannel", "@brief Method QPixmap QPixmap::alphaChannel()\n", true, &_init_f_alphaChannel_c0, &_call_f_alphaChannel_c0);
  ...
  methods += new qt_gsi::GenericMethod ("serialNumber", "@brief Method int QPixmap::serialNumber()\n", true, &_init_f_serialNumber_c0, &_call_f_serialNumber_c0);
  methods += new qt_gsi::GenericMethod ("setAlphaChannel|alphaChannel=", "@brief Method void QPixmap::setAlphaChannel(const QPixmap &)\n", false, &_init_f_setAlphaChannel_2017, &_call_f_setAlphaChannel_2017);
  ...
  methods += new qt_gsi::GenericStaticMethod ("grabWidget", "@brief Static method QPixmap QPixmap::grabWidget(QWidget *widget, int x, int y, int w, int h)\nThis method is static and can be called without an instance.", &_init_f_grabWidget_3951, &_call_f_grabWidget_3951);
