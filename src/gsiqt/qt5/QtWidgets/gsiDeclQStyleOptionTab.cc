...
gsi::Class<QStyleOptionTab> decl_QStyleOptionTab (qtdecl_QStyleOption (), "QtWidgets", "QStyleOptionTab",
  methods_QStyleOptionTab (),
  "@qt\n@brief Binding of QStyleOptionTab");


GSI_QTWIDGETS_PUBLIC gsi::Class<QStyleOptionTab> &qtdecl_QStyleOptionTab () { return decl_QStyleOptionTab; }
