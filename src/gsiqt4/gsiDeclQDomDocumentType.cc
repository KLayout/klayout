...
gsi::Class<QDomDocumentType> decl_QDomDocumentType (qtdecl_QDomNode (), "QDomDocumentType",
  methods_QDomDocumentType (),
  "@qt\n@brief Binding of QDomDocumentType");


GSIQT_PUBLIC gsi::Class<QDomDocumentType> &qtdecl_QDomDocumentType () { return decl_QDomDocumentType; }
