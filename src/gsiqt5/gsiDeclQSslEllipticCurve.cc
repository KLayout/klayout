...
gsi::Class<QSslEllipticCurve> decl_QSslEllipticCurve ("QSslEllipticCurve",
  methods_QSslEllipticCurve (),
  "@qt\n@brief Binding of QSslEllipticCurve");


GSIQT_PUBLIC gsi::Class<QSslEllipticCurve> &qtdecl_QSslEllipticCurve () { return decl_QSslEllipticCurve; }
