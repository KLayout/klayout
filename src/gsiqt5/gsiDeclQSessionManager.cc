...
qt_gsi::QtNativeClass<QSessionManager> decl_QSessionManager (qtdecl_QObject (), "QSessionManager",
  methods_QSessionManager (),
  "@qt\n@brief Binding of QSessionManager");


GSIQT_PUBLIC gsi::Class<QSessionManager> &qtdecl_QSessionManager () { return decl_QSessionManager; }
...
static gsi::Enum<QSessionManager::RestartHint> decl_QSessionManager_RestartHint_Enum ("QSessionManager_RestartHint",
...
static gsi::QFlagsClass<QSessionManager::RestartHint > decl_QSessionManager_RestartHint_Enums ("QSessionManager_QFlags_RestartHint",
