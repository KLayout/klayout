...
qt_gsi::QtNativeClass<QGraphicsWidget> decl_QGraphicsWidget (qtdecl_QGraphicsObject (), "QGraphicsWidget_Native",
  methods_QGraphicsWidget (),
  "@hide\n@alias QGraphicsWidget");

GSIQT_PUBLIC gsi::Class<QGraphicsWidget> &qtdecl_QGraphicsWidget () { return decl_QGraphicsWidget; }
...
gsi::Class<QGraphicsWidget_Adaptor> decl_QGraphicsWidget_Adaptor (qtdecl_QGraphicsWidget (), "QGraphicsWidget",
