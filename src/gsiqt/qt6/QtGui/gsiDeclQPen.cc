...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QList<qreal> > ((QList<qreal>)((QPen *)cls)->dashPattern ());
}
...
static gsi::Methods methods_QPen () {
  ...
  methods += new qt_gsi::GenericMethod (":dashPattern", "@brief Method QList<qreal> QPen::dashPattern()\n", true, &_init_f_dashPattern_c0, &_call_f_dashPattern_c0);
  ...
  methods += new qt_gsi::GenericMethod ("setDashPattern|dashPattern=", "@brief Method void QPen::setDashPattern(const QList<qreal> &pattern)\n", false, &_init_f_setDashPattern_2461, &_call_f_setDashPattern_2461);
