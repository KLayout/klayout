...
public:
  ...
  //  [adaptor impl] bool QCalendarWidget::nativeEvent(const QByteArray &eventType, void *message, long int *result)
  ...
  virtual bool nativeEvent(const QByteArray &eventType, void *message, long int *result)
  {
    if (cb_nativeEvent_4678_0.can_issue()) {
      return cb_nativeEvent_4678_0.issue<QCalendarWidget_Adaptor, bool, const QByteArray &, void *, long int *>(&QCalendarWidget_Adaptor::cbs_nativeEvent_4678_0, eventType, message, result);
    } else {
      return QCalendarWidget::nativeEvent(eventType, message, result);
    }
  }
...
// bool QCalendarWidget::nativeEvent(const QByteArray &eventType, void *message, long int *result)
...
static void _call_cbs_nativeEvent_4678_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<bool > ((bool)((QCalendarWidget_Adaptor *)cls)->cbs_nativeEvent_4678_0 (arg1, arg2, arg3));
}

static void _set_callback_cbs_nativeEvent_4678_0 (void *cls, const gsi::Callback &cb)
{
  ((QCalendarWidget_Adaptor *)cls)->cb_nativeEvent_4678_0 = cb;
}
