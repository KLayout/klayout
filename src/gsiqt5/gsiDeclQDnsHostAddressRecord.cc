...
gsi::Class<QDnsHostAddressRecord> decl_QDnsHostAddressRecord ("QDnsHostAddressRecord",
  methods_QDnsHostAddressRecord (),
  "@qt\n@brief Binding of QDnsHostAddressRecord");


GSIQT_PUBLIC gsi::Class<QDnsHostAddressRecord> &qtdecl_QDnsHostAddressRecord () { return decl_QDnsHostAddressRecord; }
