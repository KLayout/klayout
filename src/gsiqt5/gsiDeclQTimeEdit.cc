...
qt_gsi::QtNativeClass<QTimeEdit> decl_QTimeEdit (qtdecl_QDateTimeEdit (), "QTimeEdit_Native",
  methods_QTimeEdit (),
  "@hide\n@alias QTimeEdit");

GSIQT_PUBLIC gsi::Class<QTimeEdit> &qtdecl_QTimeEdit () { return decl_QTimeEdit; }
...
gsi::Class<QTimeEdit_Adaptor> decl_QTimeEdit_Adaptor (qtdecl_QTimeEdit (), "QTimeEdit",
