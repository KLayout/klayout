...
gsi::Class<QStyleOptionToolButton> decl_QStyleOptionToolButton (qtdecl_QStyleOptionComplex (), "QtGui", "QStyleOptionToolButton",
  methods_QStyleOptionToolButton (),
  "@qt\n@brief Binding of QStyleOptionToolButton");


GSI_QTGUI_PUBLIC gsi::Class<QStyleOptionToolButton> &qtdecl_QStyleOptionToolButton () { return decl_QStyleOptionToolButton; }
