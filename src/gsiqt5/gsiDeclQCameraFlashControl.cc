...
qt_gsi::QtNativeClass<QCameraFlashControl> decl_QCameraFlashControl (qtdecl_QMediaControl (), "QCameraFlashControl_Native",
  methods_QCameraFlashControl (),
  "@hide\n@alias QCameraFlashControl");

GSIQT_PUBLIC gsi::Class<QCameraFlashControl> &qtdecl_QCameraFlashControl () { return decl_QCameraFlashControl; }
...
gsi::Class<QCameraFlashControl_Adaptor> decl_QCameraFlashControl_Adaptor (qtdecl_QCameraFlashControl (), "QCameraFlashControl",
