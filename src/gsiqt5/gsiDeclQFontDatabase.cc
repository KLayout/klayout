...
static void _call_f_systemFont_2881 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QFontDatabase::SystemFont>::target_type & arg1 = args.read<const qt_gsi::Converter<QFontDatabase::SystemFont>::target_type & > (heap);
...
static gsi::Enum<QFontDatabase::SystemFont> decl_QFontDatabase_SystemFont_Enum ("QFontDatabase_SystemFont",
...
static gsi::QFlagsClass<QFontDatabase::SystemFont > decl_QFontDatabase_SystemFont_Enums ("QFontDatabase_QFlags_SystemFont",
