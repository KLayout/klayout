...
gsi::Class<QXmlStreamWriter> decl_QXmlStreamWriter ("QXmlStreamWriter",
  methods_QXmlStreamWriter (),
  "@qt\n@brief Binding of QXmlStreamWriter");


GSIQT_PUBLIC gsi::Class<QXmlStreamWriter> &qtdecl_QXmlStreamWriter () { return decl_QXmlStreamWriter; }
