...
gsi::Class<QLinearGradient> decl_QLinearGradient (qtdecl_QGradient (), "QLinearGradient",
  methods_QLinearGradient (),
  "@qt\n@brief Binding of QLinearGradient");


GSIQT_PUBLIC gsi::Class<QLinearGradient> &qtdecl_QLinearGradient () { return decl_QLinearGradient; }
