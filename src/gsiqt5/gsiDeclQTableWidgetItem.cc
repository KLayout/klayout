...
GSIQT_PUBLIC gsi::Class<QTableWidgetItem> &qtdecl_QTableWidgetItem () { return decl_QTableWidgetItem; }
...
gsi::Class<QTableWidgetItem_Adaptor> decl_QTableWidgetItem_Adaptor (qtdecl_QTableWidgetItem (), "QTableWidgetItem",
