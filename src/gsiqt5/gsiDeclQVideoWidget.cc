...
qt_gsi::QtNativeClass<QVideoWidget> decl_QVideoWidget (qtdecl_QWidget (), "QVideoWidget_Native",
  methods_QVideoWidget (),
  "@hide\n@alias QVideoWidget");

GSIQT_PUBLIC gsi::Class<QVideoWidget> &qtdecl_QVideoWidget () { return decl_QVideoWidget; }
...
gsi::Class<QVideoWidget_Adaptor> decl_QVideoWidget_Adaptor (qtdecl_QVideoWidget (), "QVideoWidget",
