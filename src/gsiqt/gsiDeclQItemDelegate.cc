...
qt_gsi::QtNativeClass<QItemDelegate> decl_QItemDelegate (qtdecl_QAbstractItemDelegate (), "QItemDelegate_Native",
  methods_QItemDelegate (),
  "@hide\n@alias QItemDelegate");

GSIQT_PUBLIC gsi::Class<QItemDelegate> &qtdecl_QItemDelegate () { return decl_QItemDelegate; }
...
gsi::Class<QItemDelegate_Adaptor> decl_QItemDelegate_Adaptor (qtdecl_QItemDelegate (), "QItemDelegate",
