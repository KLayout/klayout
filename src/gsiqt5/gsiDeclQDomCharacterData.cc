...
gsi::Class<QDomCharacterData> decl_QDomCharacterData (qtdecl_QDomNode (), "QDomCharacterData",
  methods_QDomCharacterData (),
  "@qt\n@brief Binding of QDomCharacterData");


GSIQT_PUBLIC gsi::Class<QDomCharacterData> &qtdecl_QDomCharacterData () { return decl_QDomCharacterData; }
