...
qt_gsi::QtNativeClass<QGraphicsRotation> decl_QGraphicsRotation (qtdecl_QGraphicsTransform (), "QGraphicsRotation_Native",
  methods_QGraphicsRotation (),
  "@hide\n@alias QGraphicsRotation");

GSIQT_PUBLIC gsi::Class<QGraphicsRotation> &qtdecl_QGraphicsRotation () { return decl_QGraphicsRotation; }
...
gsi::Class<QGraphicsRotation_Adaptor> decl_QGraphicsRotation_Adaptor (qtdecl_QGraphicsRotation (), "QGraphicsRotation",
