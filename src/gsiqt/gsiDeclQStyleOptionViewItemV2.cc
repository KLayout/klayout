...
gsi::Class<QStyleOptionViewItemV2> decl_QStyleOptionViewItemV2 (qtdecl_QStyleOptionViewItem (), "QStyleOptionViewItemV2",
  methods_QStyleOptionViewItemV2 (),
  "@qt\n@brief Binding of QStyleOptionViewItemV2");


GSIQT_PUBLIC gsi::Class<QStyleOptionViewItemV2> &qtdecl_QStyleOptionViewItemV2 () { return decl_QStyleOptionViewItemV2; }
