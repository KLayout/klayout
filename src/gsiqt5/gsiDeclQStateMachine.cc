...
qt_gsi::QtNativeClass<QStateMachine> decl_QStateMachine (qtdecl_QState (), "QStateMachine_Native",
  methods_QStateMachine (),
  "@hide\n@alias QStateMachine");

GSIQT_PUBLIC gsi::Class<QStateMachine> &qtdecl_QStateMachine () { return decl_QStateMachine; }
...
gsi::Class<QStateMachine_Adaptor> decl_QStateMachine_Adaptor (qtdecl_QStateMachine (), "QStateMachine",
...
static gsi::Enum<QStateMachine::Error> decl_QStateMachine_Error_Enum ("QStateMachine_Error",
...
static gsi::QFlagsClass<QStateMachine::Error > decl_QStateMachine_Error_Enums ("QStateMachine_QFlags_Error",
...
static gsi::Enum<QStateMachine::EventPriority> decl_QStateMachine_EventPriority_Enum ("QStateMachine_EventPriority",
...
static gsi::QFlagsClass<QStateMachine::EventPriority > decl_QStateMachine_EventPriority_Enums ("QStateMachine_QFlags_EventPriority",
