...
static gsi::Methods methods_QDataWidgetMapper () {
  ...
  methods += gsi::qt_signal<const QString & > ("objectNameChanged(const QString &)", "objectNameChanged", gsi::arg("objectName"), "@brief Signal declaration for QDataWidgetMapper::objectNameChanged(const QString &objectName)\nYou can bind a procedure to this signal.");
...
public:
  ...
  //  [emitter impl] void QDataWidgetMapper::objectNameChanged(const QString &objectName)
  void emitter_QDataWidgetMapper_objectNameChanged_4567(const QString &objectName)
  {
    __SUPPRESS_UNUSED_WARNING (objectName);
    throw tl::Exception ("Can't emit private signal 'void QDataWidgetMapper::objectNameChanged(const QString &objectName)'");
  }
...
// emitter void QDataWidgetMapper::objectNameChanged(const QString &objectName)
...
static void _call_emitter_objectNameChanged_4567 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs & /*ret*/) 
{
  ...
  ((QDataWidgetMapper_Adaptor *)cls)->emitter_QDataWidgetMapper_objectNameChanged_4567 (arg1);
}
