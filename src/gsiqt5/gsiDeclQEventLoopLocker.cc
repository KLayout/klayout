...
gsi::Class<QEventLoopLocker> decl_QEventLoopLocker ("QEventLoopLocker",
  methods_QEventLoopLocker (),
  "@qt\n@brief Binding of QEventLoopLocker");


GSIQT_PUBLIC gsi::Class<QEventLoopLocker> &qtdecl_QEventLoopLocker () { return decl_QEventLoopLocker; }
