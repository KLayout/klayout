...
qt_gsi::QtNativeClass<QRegularExpressionValidator> decl_QRegularExpressionValidator (qtdecl_QValidator (), "QRegularExpressionValidator_Native",
  methods_QRegularExpressionValidator (),
  "@hide\n@alias QRegularExpressionValidator");

GSIQT_PUBLIC gsi::Class<QRegularExpressionValidator> &qtdecl_QRegularExpressionValidator () { return decl_QRegularExpressionValidator; }
...
gsi::Class<QRegularExpressionValidator_Adaptor> decl_QRegularExpressionValidator_Adaptor (qtdecl_QRegularExpressionValidator (), "QRegularExpressionValidator",
