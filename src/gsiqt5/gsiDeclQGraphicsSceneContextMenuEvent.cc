...
gsi::Class<QGraphicsSceneContextMenuEvent> decl_QGraphicsSceneContextMenuEvent (qtdecl_QGraphicsSceneEvent (), "QGraphicsSceneContextMenuEvent_Native",
  methods_QGraphicsSceneContextMenuEvent (),
  "@hide\n@alias QGraphicsSceneContextMenuEvent");

GSIQT_PUBLIC gsi::Class<QGraphicsSceneContextMenuEvent> &qtdecl_QGraphicsSceneContextMenuEvent () { return decl_QGraphicsSceneContextMenuEvent; }
...
gsi::Class<QGraphicsSceneContextMenuEvent_Adaptor> decl_QGraphicsSceneContextMenuEvent_Adaptor (qtdecl_QGraphicsSceneContextMenuEvent (), "QGraphicsSceneContextMenuEvent",
...
static gsi::Enum<QGraphicsSceneContextMenuEvent::Reason> decl_QGraphicsSceneContextMenuEvent_Reason_Enum ("QGraphicsSceneContextMenuEvent_Reason",
...
static gsi::QFlagsClass<QGraphicsSceneContextMenuEvent::Reason > decl_QGraphicsSceneContextMenuEvent_Reason_Enums ("QGraphicsSceneContextMenuEvent_QFlags_Reason",
