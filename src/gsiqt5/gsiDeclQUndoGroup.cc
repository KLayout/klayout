...
qt_gsi::QtNativeClass<QUndoGroup> decl_QUndoGroup (qtdecl_QObject (), "QUndoGroup_Native",
  methods_QUndoGroup (),
  "@hide\n@alias QUndoGroup");

GSIQT_PUBLIC gsi::Class<QUndoGroup> &qtdecl_QUndoGroup () { return decl_QUndoGroup; }
...
gsi::Class<QUndoGroup_Adaptor> decl_QUndoGroup_Adaptor (qtdecl_QUndoGroup (), "QUndoGroup",
