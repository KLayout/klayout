...
gsi::Class<QGraphicsLineItem> decl_QGraphicsLineItem (qtdecl_QGraphicsItem (), "QGraphicsLineItem_Native",
  methods_QGraphicsLineItem (),
  "@hide\n@alias QGraphicsLineItem");

GSIQT_PUBLIC gsi::Class<QGraphicsLineItem> &qtdecl_QGraphicsLineItem () { return decl_QGraphicsLineItem; }
...
gsi::Class<QGraphicsLineItem_Adaptor> decl_QGraphicsLineItem_Adaptor (qtdecl_QGraphicsLineItem (), "QGraphicsLineItem",
