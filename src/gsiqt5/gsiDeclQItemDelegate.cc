...
public:
  ...
  //  [adaptor impl] QVector<int> QItemDelegate::paintingRoles()
  ...
  virtual QVector<int> paintingRoles() const
  {
    if (cb_paintingRoles_c0_0.can_issue()) {
      return cb_paintingRoles_c0_0.issue<QItemDelegate_Adaptor, QVector<int> >(&QItemDelegate_Adaptor::cbs_paintingRoles_c0_0);
    } else {
      return QItemDelegate::paintingRoles();
    }
  }
...
// QVector<int> QItemDelegate::paintingRoles()
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QVector<int> > ((QVector<int>)((QItemDelegate_Adaptor *)cls)->cbs_paintingRoles_c0_0 ());
}
