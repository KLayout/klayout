...
qt_gsi::QtNativeClass<QHeaderView> decl_QHeaderView (qtdecl_QAbstractItemView (), "QtGui", "QHeaderView_Native",
  methods_QHeaderView (),
  "@hide\n@alias QHeaderView");

GSI_QTGUI_PUBLIC gsi::Class<QHeaderView> &qtdecl_QHeaderView () { return decl_QHeaderView; }
...
gsi::Class<QHeaderView_Adaptor> decl_QHeaderView_Adaptor (qtdecl_QHeaderView (), "QtGui", "QHeaderView",
...
static gsi::Enum<QHeaderView::ResizeMode> decl_QHeaderView_ResizeMode_Enum ("QtGui", "QHeaderView_ResizeMode",
...
static gsi::QFlagsClass<QHeaderView::ResizeMode > decl_QHeaderView_ResizeMode_Enums ("QtGui", "QHeaderView_QFlags_ResizeMode",
