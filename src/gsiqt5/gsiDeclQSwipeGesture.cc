...
qt_gsi::QtNativeClass<QSwipeGesture> decl_QSwipeGesture (qtdecl_QGesture (), "QSwipeGesture_Native",
  methods_QSwipeGesture (),
  "@hide\n@alias QSwipeGesture");

GSIQT_PUBLIC gsi::Class<QSwipeGesture> &qtdecl_QSwipeGesture () { return decl_QSwipeGesture; }
...
gsi::Class<QSwipeGesture_Adaptor> decl_QSwipeGesture_Adaptor (qtdecl_QSwipeGesture (), "QSwipeGesture",
...
static gsi::Enum<QSwipeGesture::SwipeDirection> decl_QSwipeGesture_SwipeDirection_Enum ("QSwipeGesture_SwipeDirection",
...
static gsi::QFlagsClass<QSwipeGesture::SwipeDirection > decl_QSwipeGesture_SwipeDirection_Enums ("QSwipeGesture_QFlags_SwipeDirection",
