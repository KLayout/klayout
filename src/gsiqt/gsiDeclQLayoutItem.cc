...
GSIQT_PUBLIC gsi::Class<QLayoutItem> &qtdecl_QLayoutItem () { return decl_QLayoutItem; }
...
gsi::Class<QLayoutItem_Adaptor> decl_QLayoutItem_Adaptor (qtdecl_QLayoutItem (), "QLayoutItem",
