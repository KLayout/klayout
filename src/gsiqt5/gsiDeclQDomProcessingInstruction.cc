...
gsi::Class<QDomProcessingInstruction> decl_QDomProcessingInstruction (qtdecl_QDomNode (), "QDomProcessingInstruction",
  methods_QDomProcessingInstruction (),
  "@qt\n@brief Binding of QDomProcessingInstruction");


GSIQT_PUBLIC gsi::Class<QDomProcessingInstruction> &qtdecl_QDomProcessingInstruction () { return decl_QDomProcessingInstruction; }
