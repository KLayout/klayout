...
qt_gsi::QtNativeClass<QVBoxLayout> decl_QVBoxLayout (qtdecl_QBoxLayout (), "QtGui", "QVBoxLayout_Native",
  methods_QVBoxLayout (),
  "@hide\n@alias QVBoxLayout");

GSI_QTGUI_PUBLIC gsi::Class<QVBoxLayout> &qtdecl_QVBoxLayout () { return decl_QVBoxLayout; }
...
gsi::Class<QVBoxLayout_Adaptor> decl_QVBoxLayout_Adaptor (qtdecl_QVBoxLayout (), "QtGui", "QVBoxLayout",
