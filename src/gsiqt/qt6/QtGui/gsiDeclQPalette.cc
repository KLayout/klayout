...
// QPalette QPalette::resolve(const QPalette &other)
...
static void _init_f_setResolveMask_2484 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("mask");
  decl->add_arg<QPalette::ResolveMask > (argspec_0);
  decl->set_return<void > ();
}

static void _call_f_setResolveMask_2484 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QPalette::ResolveMask arg1 = gsi::arg_reader<QPalette::ResolveMask >() (args, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QPalette *)cls)->setResolveMask (arg1);
}
