...
gsi::Class<QXmlDTDHandler> decl_QXmlDTDHandler ("QtCore5Compat", "QXmlDTDHandler_Native",
  methods_QXmlDTDHandler (),
  "@hide\n@alias QXmlDTDHandler");

GSI_QTCORE5COMPAT_PUBLIC gsi::Class<QXmlDTDHandler> &qtdecl_QXmlDTDHandler () { return decl_QXmlDTDHandler; }
...
gsi::Class<QXmlDTDHandler_Adaptor> decl_QXmlDTDHandler_Adaptor (qtdecl_QXmlDTDHandler (), "QtCore5Compat", "QXmlDTDHandler",
