...
GSIQT_PUBLIC gsi::Class<QXmlContentHandler> &qtdecl_QXmlContentHandler () { return decl_QXmlContentHandler; }
...
gsi::Class<QXmlContentHandler_Adaptor> decl_QXmlContentHandler_Adaptor (qtdecl_QXmlContentHandler (), "QXmlContentHandler",
