...
GSIQT_PUBLIC gsi::Class<QColormap> &qtdecl_QColormap () { return decl_QColormap; }
...
static gsi::Enum<QColormap::Mode> decl_QColormap_Mode_Enum ("QColormap_Mode",
...
static gsi::QFlagsClass<QColormap::Mode > decl_QColormap_Mode_Enums ("QColormap_QFlags_Mode",
