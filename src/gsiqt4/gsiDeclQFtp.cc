...
static void _call_f_connectToHost_3017 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  const QString &arg1 = args.read<const QString & > (heap);
  quint16 arg2 = args ? args.read<quint16 > (heap) : (quint16)(21);
...
static void _call_f_get_5442 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  const qt_gsi::Converter<QFtp::TransferType>::target_type & arg3 = args ? args.read<const qt_gsi::Converter<QFtp::TransferType>::target_type & > (heap) : (const qt_gsi::Converter<QFtp::TransferType>::target_type &)(qt_gsi::CppToQtReadAdaptor<QFtp::TransferType>(heap, QFtp::Binary));
...
static void _call_f_setTransferMode_2157 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QFtp::TransferMode>::target_type & arg1 = args.read<const qt_gsi::Converter<QFtp::TransferMode>::target_type & > (heap);
...
qt_gsi::QtNativeClass<QFtp> decl_QFtp (qtdecl_QObject (), "QFtp_Native",
  methods_QFtp (),
  "@hide\n@alias QFtp");

GSIQT_PUBLIC gsi::Class<QFtp> &qtdecl_QFtp () { return decl_QFtp; }
...
gsi::Class<QFtp_Adaptor> decl_QFtp_Adaptor (qtdecl_QFtp (), "QFtp",
...
static gsi::Enum<QFtp::Command> decl_QFtp_Command_Enum ("QFtp_Command",
...
static gsi::QFlagsClass<QFtp::Command > decl_QFtp_Command_Enums ("QFtp_QFlags_Command",
...
static gsi::Enum<QFtp::Error> decl_QFtp_Error_Enum ("QFtp_Error",
...
static gsi::QFlagsClass<QFtp::Error > decl_QFtp_Error_Enums ("QFtp_QFlags_Error",
...
static gsi::Enum<QFtp::State> decl_QFtp_State_Enum ("QFtp_State",
...
static gsi::QFlagsClass<QFtp::State > decl_QFtp_State_Enums ("QFtp_QFlags_State",
...
static gsi::Enum<QFtp::TransferMode> decl_QFtp_TransferMode_Enum ("QFtp_TransferMode",
...
static gsi::QFlagsClass<QFtp::TransferMode > decl_QFtp_TransferMode_Enums ("QFtp_QFlags_TransferMode",
...
static gsi::Enum<QFtp::TransferType> decl_QFtp_TransferType_Enum ("QFtp_TransferType",
...
static gsi::QFlagsClass<QFtp::TransferType > decl_QFtp_TransferType_Enums ("QFtp_QFlags_TransferType",
