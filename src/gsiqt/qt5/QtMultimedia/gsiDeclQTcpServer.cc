...
qt_gsi::QtNativeClass<QTcpServer> decl_QTcpServer (qtdecl_QObject (), "QtMultimedia", "QTcpServer_Native",
  methods_QTcpServer (),
  "@hide\n@alias QTcpServer");

GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QTcpServer> &qtdecl_QTcpServer () { return decl_QTcpServer; }
...
gsi::Class<QTcpServer_Adaptor> decl_QTcpServer_Adaptor (qtdecl_QTcpServer (), "QtMultimedia", "QTcpServer",
