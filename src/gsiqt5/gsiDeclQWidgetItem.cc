...
gsi::Class<QWidgetItem> decl_QWidgetItem (qtdecl_QLayoutItem (), "QWidgetItem_Native",
  methods_QWidgetItem (),
  "@hide\n@alias QWidgetItem");

GSIQT_PUBLIC gsi::Class<QWidgetItem> &qtdecl_QWidgetItem () { return decl_QWidgetItem; }
...
gsi::Class<QWidgetItem_Adaptor> decl_QWidgetItem_Adaptor (qtdecl_QWidgetItem (), "QWidgetItem",
