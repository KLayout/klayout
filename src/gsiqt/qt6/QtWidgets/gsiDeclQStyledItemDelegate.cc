...
public:
  ...
  //  [adaptor impl] QList<int> QStyledItemDelegate::paintingRoles()
  ...
  virtual QList<int> paintingRoles() const
  {
    if (cb_paintingRoles_c0_0.can_issue()) {
      return cb_paintingRoles_c0_0.issue<QStyledItemDelegate_Adaptor, QList<int> >(&QStyledItemDelegate_Adaptor::cbs_paintingRoles_c0_0);
    } else {
      return QStyledItemDelegate::paintingRoles();
    }
  }
...
// QList<int> QStyledItemDelegate::paintingRoles()
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QList<int> > ((QList<int>)((QStyledItemDelegate_Adaptor *)cls)->cbs_paintingRoles_c0_0 ());
}
