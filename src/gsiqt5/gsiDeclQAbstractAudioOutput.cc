...
qt_gsi::QtNativeClass<QAbstractAudioOutput> decl_QAbstractAudioOutput (qtdecl_QObject (), "QAbstractAudioOutput_Native",
  methods_QAbstractAudioOutput (),
  "@hide\n@alias QAbstractAudioOutput");

GSIQT_PUBLIC gsi::Class<QAbstractAudioOutput> &qtdecl_QAbstractAudioOutput () { return decl_QAbstractAudioOutput; }
...
gsi::Class<QAbstractAudioOutput_Adaptor> decl_QAbstractAudioOutput_Adaptor (qtdecl_QAbstractAudioOutput (), "QAbstractAudioOutput",
