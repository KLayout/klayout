...
static void _init_f_wait_2946 (qt_gsi::GenericMethod *decl)
{
  ...
  static gsi::ArgSpecBase argspec_1 ("deadline", true, "QDeadlineTimer(QDeadlineTimer::Forever)");
...
static void _call_f_wait_2946 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  QDeadlineTimer arg2 = args ? gsi::arg_reader<QDeadlineTimer >() (args, heap) : gsi::arg_maker<QDeadlineTimer >() (QDeadlineTimer(QDeadlineTimer::Forever), heap);
