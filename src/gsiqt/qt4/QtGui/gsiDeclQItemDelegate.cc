...
static gsi::Methods methods_QItemDelegate () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QItemDelegate::tr(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_tr_3354, &_call_f_tr_3354);
  ...
  methods += new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QItemDelegate::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
...
qt_gsi::QtNativeClass<QItemDelegate> decl_QItemDelegate (qtdecl_QAbstractItemDelegate (), "QtGui", "QItemDelegate_Native",
  methods_QItemDelegate (),
  "@hide\n@alias QItemDelegate");

GSI_QTGUI_PUBLIC gsi::Class<QItemDelegate> &qtdecl_QItemDelegate () { return decl_QItemDelegate; }
...
public:
  ...
  //  [expose] QRect QItemDelegate::check(const QStyleOptionViewItem &option, const QRect &bounding, const QVariant &variant)
  ...
  //  [expose] QPixmap *QItemDelegate::selected(const QPixmap &pixmap, const QPalette &palette, bool enabled)
...
// exposed QRect QItemDelegate::check(const QStyleOptionViewItem &option, const QRect &bounding, const QVariant &variant)
...
static void _call_fp_doLayout_c7101 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  const QStyleOptionViewItem &arg1 = args.read<const QStyleOptionViewItem & > (heap);
  QRect *arg2 = args.read<QRect * > (heap);
  QRect *arg3 = args.read<QRect * > (heap);
  QRect *arg4 = args.read<QRect * > (heap);
...
// exposed QPixmap *QItemDelegate::selected(const QPixmap &pixmap, const QPalette &palette, bool enabled)
...
static void _call_fp_selected_c4778 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  const QPalette &arg2 = args.read<const QPalette & > (heap);
...
static gsi::Methods methods_QItemDelegate_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*check", "@brief Method QRect QItemDelegate::check(const QStyleOptionViewItem &option, const QRect &bounding, const QVariant &variant)\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_check_c7061, &_call_fp_check_c7061);
  methods += new qt_gsi::GenericMethod ("*childEvent", "@hide", false, &_init_cbs_childEvent_1701_0, &_call_cbs_childEvent_1701_0);
  methods += new qt_gsi::GenericMethod ("*childEvent", "@brief Virtual method void QItemDelegate::childEvent(QChildEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_childEvent_1701_0, &_call_cbs_childEvent_1701_0, &_set_callback_cbs_childEvent_1701_0);
  ...
  methods += new qt_gsi::GenericMethod ("*customEvent", "@brief Virtual method void QItemDelegate::customEvent(QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_customEvent_1217_0, &_call_cbs_customEvent_1217_0, &_set_callback_cbs_customEvent_1217_0);
  ...
  methods += new qt_gsi::GenericMethod ("*disconnectNotify", "@brief Virtual method void QItemDelegate::disconnectNotify(const char *signal)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_disconnectNotify_1731_0, &_call_cbs_disconnectNotify_1731_0, &_set_callback_cbs_disconnectNotify_1731_0);
  ...
  methods += new qt_gsi::GenericMethod ("*drawCheck", "@hide", true, &_init_cbs_drawCheck_c8000_0, &_call_cbs_drawCheck_c8000_0);
  ...
  methods += new qt_gsi::GenericMethod ("*drawDecoration", "@hide", true, &_init_cbs_drawDecoration_c8277_0, &_call_cbs_drawDecoration_c8277_0);
  ...
  methods += new qt_gsi::GenericMethod ("*drawDisplay", "@hide", true, &_init_cbs_drawDisplay_c8285_0, &_call_cbs_drawDisplay_c8285_0);
  ...
  methods += new qt_gsi::GenericMethod ("*drawFocus", "@hide", true, &_init_cbs_drawFocus_c6368_0, &_call_cbs_drawFocus_c6368_0);
  ...
  methods += new qt_gsi::GenericMethod ("event", "@brief Virtual method bool QItemDelegate::event(QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_event_1217_0, &_call_cbs_event_1217_0, &_set_callback_cbs_event_1217_0);
  ...
  methods += new qt_gsi::GenericMethod ("*selected", "@brief Method QPixmap *QItemDelegate::selected(const QPixmap &pixmap, const QPalette &palette, bool enabled)\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_selected_c4778, &_call_fp_selected_c4778);
  ...
  methods += new qt_gsi::GenericMethod ("*timerEvent", "@brief Virtual method void QItemDelegate::timerEvent(QTimerEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_timerEvent_1730_0, &_call_cbs_timerEvent_1730_0, &_set_callback_cbs_timerEvent_1730_0);
...
gsi::Class<QItemDelegate_Adaptor> decl_QItemDelegate_Adaptor (qtdecl_QItemDelegate (), "QtGui", "QItemDelegate",
