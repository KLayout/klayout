...
qt_gsi::QtNativeClass<QMainWindow> decl_QMainWindow (qtdecl_QWidget (), "QtGui", "QMainWindow_Native",
  methods_QMainWindow (),
  "@hide\n@alias QMainWindow");

GSI_QTGUI_PUBLIC gsi::Class<QMainWindow> &qtdecl_QMainWindow () { return decl_QMainWindow; }
...
gsi::Class<QMainWindow_Adaptor> decl_QMainWindow_Adaptor (qtdecl_QMainWindow (), "QtGui", "QMainWindow",
...
static gsi::Enum<QMainWindow::DockOption> decl_QMainWindow_DockOption_Enum ("QtGui", "QMainWindow_DockOption",
...
static gsi::QFlagsClass<QMainWindow::DockOption > decl_QMainWindow_DockOption_Enums ("QtGui", "QMainWindow_QFlags_DockOption",
