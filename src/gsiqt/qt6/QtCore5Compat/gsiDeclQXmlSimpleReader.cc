...
gsi::Class<QXmlSimpleReader> decl_QXmlSimpleReader (qtdecl_QXmlReader (), "QtCore5Compat", "QXmlSimpleReader_Native",
  methods_QXmlSimpleReader (),
  "@hide\n@alias QXmlSimpleReader");

GSI_QTCORE5COMPAT_PUBLIC gsi::Class<QXmlSimpleReader> &qtdecl_QXmlSimpleReader () { return decl_QXmlSimpleReader; }
...
gsi::Class<QXmlSimpleReader_Adaptor> decl_QXmlSimpleReader_Adaptor (qtdecl_QXmlSimpleReader (), "QtCore5Compat", "QXmlSimpleReader",
