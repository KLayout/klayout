...
public:
  ...
  //  [adaptor impl] bool QGraphicsLayout::isEmpty()
  ...
  virtual bool isEmpty() const
  {
    if (cb_isEmpty_c0_0.can_issue()) {
      return cb_isEmpty_c0_0.issue<QGraphicsLayout_Adaptor, bool>(&QGraphicsLayout_Adaptor::cbs_isEmpty_c0_0);
    } else {
      return QGraphicsLayout::isEmpty();
    }
  }
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<bool > ((bool)((QGraphicsLayout_Adaptor *)cls)->cbs_isEmpty_c0_0 ());
}

static void _set_callback_cbs_isEmpty_c0_0 (void *cls, const gsi::Callback &cb)
{
  ((QGraphicsLayout_Adaptor *)cls)->cb_isEmpty_c0_0 = cb;
}
