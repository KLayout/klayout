...
qt_gsi::QtNativeClass<QStackedLayout> decl_QStackedLayout (qtdecl_QLayout (), "QStackedLayout_Native",
  methods_QStackedLayout (),
  "@hide\n@alias QStackedLayout");

GSIQT_PUBLIC gsi::Class<QStackedLayout> &qtdecl_QStackedLayout () { return decl_QStackedLayout; }
...
gsi::Class<QStackedLayout_Adaptor> decl_QStackedLayout_Adaptor (qtdecl_QStackedLayout (), "QStackedLayout",
...
static gsi::Enum<QStackedLayout::StackingMode> decl_QStackedLayout_StackingMode_Enum ("QStackedLayout_StackingMode",
...
static gsi::QFlagsClass<QStackedLayout::StackingMode > decl_QStackedLayout_StackingMode_Enums ("QStackedLayout_QFlags_StackingMode",
