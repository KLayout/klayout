...
gsi::Class<QJsonArray::iterator> decl_QJsonArray_Iterator ("QJsonArray_Iterator",
...
GSIQT_PUBLIC gsi::Class<QJsonArray::iterator> &qtdecl_QJsonArray_Iterator () { return decl_QJsonArray_Iterator; }
