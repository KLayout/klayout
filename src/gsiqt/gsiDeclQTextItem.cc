...
GSIQT_PUBLIC gsi::Class<QTextItem> &qtdecl_QTextItem () { return decl_QTextItem; }
...
static gsi::Enum<QTextItem::RenderFlag> decl_QTextItem_RenderFlag_Enum ("QTextItem_RenderFlag",
...
static gsi::QFlagsClass<QTextItem::RenderFlag > decl_QTextItem_RenderFlag_Enums ("QTextItem_QFlags_RenderFlag",
