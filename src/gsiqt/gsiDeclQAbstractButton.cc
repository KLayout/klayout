...
GSIQT_PUBLIC gsi::Class<QAbstractButton> &qtdecl_QAbstractButton () { return decl_QAbstractButton; }
...
gsi::Class<QAbstractButton_Adaptor> decl_QAbstractButton_Adaptor (qtdecl_QAbstractButton (), "QAbstractButton",
