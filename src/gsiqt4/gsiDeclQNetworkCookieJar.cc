...
qt_gsi::QtNativeClass<QNetworkCookieJar> decl_QNetworkCookieJar (qtdecl_QObject (), "QNetworkCookieJar_Native",
  methods_QNetworkCookieJar (),
  "@hide\n@alias QNetworkCookieJar");

GSIQT_PUBLIC gsi::Class<QNetworkCookieJar> &qtdecl_QNetworkCookieJar () { return decl_QNetworkCookieJar; }
...
gsi::Class<QNetworkCookieJar_Adaptor> decl_QNetworkCookieJar_Adaptor (qtdecl_QNetworkCookieJar (), "QNetworkCookieJar",
