...
// const void *QPersistentModelIndex::constInternalPointer()
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<const void * > ((const void *)((QPersistentModelIndex *)cls)->constInternalPointer ());
}
...
// void QPersistentModelIndex::multiData(QModelRoleDataSpan roleDataSpan)
...
static void _call_f_multiData_c2196 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ((QPersistentModelIndex *)cls)->multiData (arg1);
}
...
static gsi::Methods methods_QPersistentModelIndex () {
  ...
  methods += new qt_gsi::GenericMethod ("constInternalPointer", "@brief Method const void *QPersistentModelIndex::constInternalPointer()\n", true, &_init_f_constInternalPointer_c0, &_call_f_constInternalPointer_c0);
