...
qt_gsi::QtNativeClass<QEventTransition> decl_QEventTransition (qtdecl_QAbstractTransition (), "QEventTransition_Native",
  methods_QEventTransition (),
  "@hide\n@alias QEventTransition");

GSIQT_PUBLIC gsi::Class<QEventTransition> &qtdecl_QEventTransition () { return decl_QEventTransition; }
...
gsi::Class<QEventTransition_Adaptor> decl_QEventTransition_Adaptor (qtdecl_QEventTransition (), "QEventTransition",
