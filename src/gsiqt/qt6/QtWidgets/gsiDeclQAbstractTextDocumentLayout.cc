...
qt_gsi::QtNativeClass<QAbstractTextDocumentLayout> decl_QAbstractTextDocumentLayout (qtdecl_QObject (), "Qt", "QAbstractTextDocumentLayout_Native",
  methods_QAbstractTextDocumentLayout (),
  "@hide\n@alias QAbstractTextDocumentLayout");

GSI_QT_PUBLIC gsi::Class<QAbstractTextDocumentLayout> &qtdecl_QAbstractTextDocumentLayout () { return decl_QAbstractTextDocumentLayout; }
...
gsi::Class<QAbstractTextDocumentLayout_Adaptor> decl_QAbstractTextDocumentLayout_Adaptor (qtdecl_QAbstractTextDocumentLayout (), "Qt", "QAbstractTextDocumentLayout",
