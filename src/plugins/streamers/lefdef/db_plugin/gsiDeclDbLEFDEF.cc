...
static gsi::ClassExt<db::LoadLayoutOptions> decl_ext_lefdef_reader_options (
...
static gsi::Class<db::LEFDEFReaderOptions> decl_lefdef_config ("db", "LEFDEFReaderConfiguration",
