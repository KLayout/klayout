...
gsi::Class<QJsonValueRefPtr> decl_QJsonValueRefPtr ("QJsonValueRefPtr",
  methods_QJsonValueRefPtr (),
  "@qt\n@brief Binding of QJsonValueRefPtr");


GSIQT_PUBLIC gsi::Class<QJsonValueRefPtr> &qtdecl_QJsonValueRefPtr () { return decl_QJsonValueRefPtr; }
