...
gsi::Class<QByteArrayDataPtr> decl_QByteArrayDataPtr ("QtCore", "QByteArrayDataPtr",
  methods_QByteArrayDataPtr (),
  "@qt\n@brief Binding of QByteArrayDataPtr");


GSI_QTCORE_PUBLIC gsi::Class<QByteArrayDataPtr> &qtdecl_QByteArrayDataPtr () { return decl_QByteArrayDataPtr; }
