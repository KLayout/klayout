...
qt_gsi::QtNativeClass<QSortFilterProxyModel> decl_QSortFilterProxyModel (qtdecl_QAbstractProxyModel (), "QtGui", "QSortFilterProxyModel_Native",
  methods_QSortFilterProxyModel (),
  "@hide\n@alias QSortFilterProxyModel");

GSI_QTGUI_PUBLIC gsi::Class<QSortFilterProxyModel> &qtdecl_QSortFilterProxyModel () { return decl_QSortFilterProxyModel; }
...
gsi::Class<QSortFilterProxyModel_Adaptor> decl_QSortFilterProxyModel_Adaptor (qtdecl_QSortFilterProxyModel (), "QtGui", "QSortFilterProxyModel",
