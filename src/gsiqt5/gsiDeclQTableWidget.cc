...
qt_gsi::QtNativeClass<QTableWidget> decl_QTableWidget (qtdecl_QTableView (), "QTableWidget_Native",
  methods_QTableWidget (),
  "@hide\n@alias QTableWidget");

GSIQT_PUBLIC gsi::Class<QTableWidget> &qtdecl_QTableWidget () { return decl_QTableWidget; }
...
public:
  ...
  //  [expose] void QTableWidget::initStyleOption(QStyleOptionFrame *option)
  void fp_QTableWidget_initStyleOption_c2356 (QStyleOptionFrame *option) const {
  ...
  //  [adaptor impl] void QTableWidget::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
  ...
  virtual void dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
  {
    if (cb_dataChanged_7048_1.can_issue()) {
      cb_dataChanged_7048_1.issue<QTableWidget_Adaptor, const QModelIndex &, const QModelIndex &, const QVector<int> &>(&QTableWidget_Adaptor::cbs_dataChanged_7048_1, topLeft, bottomRight, roles);
    } else {
      QTableWidget::dataChanged(topLeft, bottomRight, roles);
    }
  }
  ...
  //  [adaptor impl] bool QTableWidget::nativeEvent(const QByteArray &eventType, void *message, long int *result)
  ...
  virtual bool nativeEvent(const QByteArray &eventType, void *message, long int *result)
  {
    if (cb_nativeEvent_4678_0.can_issue()) {
      return cb_nativeEvent_4678_0.issue<QTableWidget_Adaptor, bool, const QByteArray &, void *, long int *>(&QTableWidget_Adaptor::cbs_nativeEvent_4678_0, eventType, message, result);
    } else {
      return QTableWidget::nativeEvent(eventType, message, result);
    }
  }
...
// void QTableWidget::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
...
static void _call_cbs_dataChanged_7048_1 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTableWidget_Adaptor *)cls)->cbs_dataChanged_7048_1 (arg1, arg2, arg3);
}

static void _set_callback_cbs_dataChanged_7048_1 (void *cls, const gsi::Callback &cb)
{
  ((QTableWidget_Adaptor *)cls)->cb_dataChanged_7048_1 = cb;
}
...
// exposed void QTableWidget::initStyleOption(QStyleOptionFrame *option)
...
static void _call_fp_initStyleOption_c2356 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTableWidget_Adaptor *)cls)->fp_QTableWidget_initStyleOption_c2356 (arg1);
}
...
// bool QTableWidget::nativeEvent(const QByteArray &eventType, void *message, long int *result)
...
static void _call_cbs_nativeEvent_4678_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<bool > ((bool)((QTableWidget_Adaptor *)cls)->cbs_nativeEvent_4678_0 (arg1, arg2, arg3));
}

static void _set_callback_cbs_nativeEvent_4678_0 (void *cls, const gsi::Callback &cb)
{
  ((QTableWidget_Adaptor *)cls)->cb_nativeEvent_4678_0 = cb;
}
...
static gsi::Methods methods_QTableWidget_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*dataChanged", "@brief Virtual method void QTableWidget::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_dataChanged_7048_1, &_call_cbs_dataChanged_7048_1, &_set_callback_cbs_dataChanged_7048_1);
  ...
  methods += new qt_gsi::GenericMethod ("*dropMimeData", "@hide", false, &_init_cbs_dropMimeData_5138_0, &_call_cbs_dropMimeData_5138_0);
  ...
  methods += new qt_gsi::GenericMethod ("*mimeData", "@hide", true, &_init_cbs_mimeData_c3368_0, &_call_cbs_mimeData_c3368_0);
  methods += new qt_gsi::GenericMethod ("*mimeData", "@brief Virtual method QMimeData *QTableWidget::mimeData(const QList<QTableWidgetItem*> items)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_mimeData_c3368_0, &_call_cbs_mimeData_c3368_0, &_set_callback_cbs_mimeData_c3368_0);
...
gsi::Class<QTableWidget_Adaptor> decl_QTableWidget_Adaptor (qtdecl_QTableWidget (), "QTableWidget",
