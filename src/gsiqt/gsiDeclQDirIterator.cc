...
gsi::Class<QDirIterator> decl_QDirIterator ("QDirIterator_Native",
  methods_QDirIterator (),
  "@hide\n@alias QDirIterator");

GSIQT_PUBLIC gsi::Class<QDirIterator> &qtdecl_QDirIterator () { return decl_QDirIterator; }
...
gsi::Class<QDirIterator_Adaptor> decl_QDirIterator_Adaptor (qtdecl_QDirIterator (), "QDirIterator",
...
static gsi::Enum<QDirIterator::IteratorFlag> decl_QDirIterator_IteratorFlag_Enum ("QDirIterator_IteratorFlag",
...
static gsi::QFlagsClass<QDirIterator::IteratorFlag > decl_QDirIterator_IteratorFlag_Enums ("QDirIterator_QFlags_IteratorFlag",
