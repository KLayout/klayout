...
//  Constructor QSslCipher::QSslCipher(const QString &name)


static void _init_ctor_QSslCipher_2025 (qt_gsi::GenericStaticMethod *decl)
{
...
static void _call_ctor_QSslCipher_2025 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
...
static void _init_f_swap_1608 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("other");
  decl->add_arg<QSslCipher & > (argspec_0);
  decl->set_return<void > ();
}

static void _call_f_swap_1608 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QSslCipher &arg1 = gsi::arg_reader<QSslCipher & >() (args, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QSslCipher *)cls)->swap (arg1);
}
...
static gsi::Methods methods_QSslCipher () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QSslCipher::QSslCipher(const QString &name)\nThis method creates an object of class QSslCipher.", &_init_ctor_QSslCipher_2025, &_call_ctor_QSslCipher_2025);
  ...
  methods += new qt_gsi::GenericMethod ("swap", "@brief Method void QSslCipher::swap(QSslCipher &other)\n", false, &_init_f_swap_1608, &_call_f_swap_1608);
