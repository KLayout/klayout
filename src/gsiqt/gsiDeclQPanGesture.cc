...
qt_gsi::QtNativeClass<QPanGesture> decl_QPanGesture (qtdecl_QGesture (), "QPanGesture_Native",
  methods_QPanGesture (),
  "@hide\n@alias QPanGesture");

GSIQT_PUBLIC gsi::Class<QPanGesture> &qtdecl_QPanGesture () { return decl_QPanGesture; }
...
gsi::Class<QPanGesture_Adaptor> decl_QPanGesture_Adaptor (qtdecl_QPanGesture (), "QPanGesture",
