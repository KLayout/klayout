...
// QPixmap QIcon::pixmap(const QSize &size, double devicePixelRatio, QIcon::Mode mode, QIcon::State state)


static void _init_f_pixmap_c5506 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("size");
  decl->add_arg<const QSize & > (argspec_0);
  static gsi::ArgSpecBase argspec_1 ("devicePixelRatio");
...
static void _call_f_pixmap_c5506 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QSize &arg1 = gsi::arg_reader<const QSize & >() (args, heap);
...
static gsi::Methods methods_QIcon () {
  ...
  methods += new qt_gsi::GenericMethod ("pixmap", "@brief Method QPixmap QIcon::pixmap(const QSize &size, double devicePixelRatio, QIcon::Mode mode, QIcon::State state)\n", true, &_init_f_pixmap_c5506, &_call_f_pixmap_c5506);
  ...
  methods += new qt_gsi::GenericStaticMethod ("setFallbackSearchPaths", "@brief Static method void QIcon::setFallbackSearchPaths(const QStringList &paths)\nThis method is static and can be called without an instance.", &_init_f_setFallbackSearchPaths_2437, &_call_f_setFallbackSearchPaths_2437);
  methods += new qt_gsi::GenericStaticMethod ("setFallbackThemeName", "@brief Static method void QIcon::setFallbackThemeName(const QString &name)\nThis method is static and can be called without an instance.", &_init_f_setFallbackThemeName_2025, &_call_f_setFallbackThemeName_2025);
