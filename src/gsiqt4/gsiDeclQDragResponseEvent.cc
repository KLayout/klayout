...
gsi::Class<QDragResponseEvent> decl_QDragResponseEvent (qtdecl_QEvent (), "QDragResponseEvent_Native",
  methods_QDragResponseEvent (),
  "@hide\n@alias QDragResponseEvent");

GSIQT_PUBLIC gsi::Class<QDragResponseEvent> &qtdecl_QDragResponseEvent () { return decl_QDragResponseEvent; }
...
gsi::Class<QDragResponseEvent_Adaptor> decl_QDragResponseEvent_Adaptor (qtdecl_QDragResponseEvent (), "QDragResponseEvent",
