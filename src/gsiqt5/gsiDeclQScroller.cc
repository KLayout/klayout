...
qt_gsi::QtNativeClass<QScroller> decl_QScroller (qtdecl_QObject (), "QScroller",
  methods_QScroller (),
  "@qt\n@brief Binding of QScroller");


GSIQT_PUBLIC gsi::Class<QScroller> &qtdecl_QScroller () { return decl_QScroller; }
...
static gsi::Enum<QScroller::Input> decl_QScroller_Input_Enum ("QScroller_Input",
...
static gsi::QFlagsClass<QScroller::Input > decl_QScroller_Input_Enums ("QScroller_QFlags_Input",
...
static gsi::Enum<QScroller::ScrollerGestureType> decl_QScroller_ScrollerGestureType_Enum ("QScroller_ScrollerGestureType",
...
static gsi::QFlagsClass<QScroller::ScrollerGestureType > decl_QScroller_ScrollerGestureType_Enums ("QScroller_QFlags_ScrollerGestureType",
...
static gsi::Enum<QScroller::State> decl_QScroller_State_Enum ("QScroller_State",
...
static gsi::QFlagsClass<QScroller::State > decl_QScroller_State_Enums ("QScroller_QFlags_State",
