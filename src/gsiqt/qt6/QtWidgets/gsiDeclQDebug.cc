...
static void _call_f_verbosity_767 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  int arg1 = gsi::arg_reader<int >() (args, heap);
  ret.write<QDebug & > ((QDebug &)((QDebug *)cls)->verbosity (arg1));
}
...
gsi::Class<QDebug> decl_QDebug (qtdecl_QIODeviceBase (), "Qt", "QDebug",
  methods_QDebug (),
  "@qt\n@brief Binding of QDebug");


GSI_QT_PUBLIC gsi::Class<QDebug> &qtdecl_QDebug () { return decl_QDebug; }
