...
qt_gsi::QtNativeClass<QSslSocket> decl_QSslSocket (qtdecl_QTcpSocket (), "QSslSocket",
  methods_QSslSocket (),
  "@qt\n@brief Binding of QSslSocket");


GSIQT_PUBLIC gsi::Class<QSslSocket> &qtdecl_QSslSocket () { return decl_QSslSocket; }
...
static gsi::Enum<QSslSocket::PeerVerifyMode> decl_QSslSocket_PeerVerifyMode_Enum ("QSslSocket_PeerVerifyMode",
...
static gsi::QFlagsClass<QSslSocket::PeerVerifyMode > decl_QSslSocket_PeerVerifyMode_Enums ("QSslSocket_QFlags_PeerVerifyMode",
...
static gsi::Enum<QSslSocket::SslMode> decl_QSslSocket_SslMode_Enum ("QSslSocket_SslMode",
...
static gsi::QFlagsClass<QSslSocket::SslMode > decl_QSslSocket_SslMode_Enums ("QSslSocket_QFlags_SslMode",
