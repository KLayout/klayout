...
gsi::Class<QInputMethodEvent> decl_QInputMethodEvent (qtdecl_QEvent (), "QInputMethodEvent",
  methods_QInputMethodEvent (),
  "@qt\n@brief Binding of QInputMethodEvent");


GSIQT_PUBLIC gsi::Class<QInputMethodEvent> &qtdecl_QInputMethodEvent () { return decl_QInputMethodEvent; }
...
static gsi::Enum<QInputMethodEvent::AttributeType> decl_QInputMethodEvent_AttributeType_Enum ("QInputMethodEvent_AttributeType",
...
static gsi::QFlagsClass<QInputMethodEvent::AttributeType > decl_QInputMethodEvent_AttributeType_Enums ("QInputMethodEvent_QFlags_AttributeType",
