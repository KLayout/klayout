...
gsi::Class<QInputMethodQueryEvent> decl_QInputMethodQueryEvent (qtdecl_QEvent (), "QInputMethodQueryEvent_Native",
  methods_QInputMethodQueryEvent (),
  "@hide\n@alias QInputMethodQueryEvent");

GSIQT_PUBLIC gsi::Class<QInputMethodQueryEvent> &qtdecl_QInputMethodQueryEvent () { return decl_QInputMethodQueryEvent; }
...
gsi::Class<QInputMethodQueryEvent_Adaptor> decl_QInputMethodQueryEvent_Adaptor (qtdecl_QInputMethodQueryEvent (), "QInputMethodQueryEvent",
