...
qt_gsi::QtNativeClass<QMediaObject> decl_QMediaObject (qtdecl_QObject (), "QMediaObject_Native",
  methods_QMediaObject (),
  "@hide\n@alias QMediaObject");

GSIQT_PUBLIC gsi::Class<QMediaObject> &qtdecl_QMediaObject () { return decl_QMediaObject; }
...
gsi::Class<QMediaObject_Adaptor> decl_QMediaObject_Adaptor (qtdecl_QMediaObject (), "QMediaObject",
