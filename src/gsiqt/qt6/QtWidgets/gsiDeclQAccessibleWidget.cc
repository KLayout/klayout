...
// QList<QPair<QAccessibleInterface *, QAccessible::Relation> > QAccessibleWidget::relations(QFlags<QAccessible::RelationFlag> match)
...
static void _call_f_relations_c3543 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<QList<QPair<QAccessibleInterface *, QAccessible::Relation> > > ((QList<QPair<QAccessibleInterface *, QAccessible::Relation> >)((QAccessibleWidget *)cls)->relations (arg1));
}
...
static gsi::Methods methods_QAccessibleWidget () {
  ...
  methods += new qt_gsi::GenericMethod ("relations", "@brief Method QList<QPair<QAccessibleInterface *, QAccessible::Relation> > QAccessibleWidget::relations(QFlags<QAccessible::RelationFlag> match)\nThis is a reimplementation of QAccessibleInterface::relations", true, &_init_f_relations_c3543, &_call_f_relations_c3543);
