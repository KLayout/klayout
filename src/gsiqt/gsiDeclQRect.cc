...
static gsi::Methods methods_QRect () {
  ...
  methods += new qt_gsi::GenericMethod ("intersect", "@brief Method QRect QRect::intersect(const QRect &r)\n", true, &_init_f_intersect_c1792, &_call_f_intersect_c1792);
  ...
  methods += new qt_gsi::GenericMethod ("unite", "@brief Method QRect QRect::unite(const QRect &r)\n", true, &_init_f_unite_c1792, &_call_f_unite_c1792);
