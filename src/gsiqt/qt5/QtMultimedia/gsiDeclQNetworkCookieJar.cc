...
qt_gsi::QtNativeClass<QNetworkCookieJar> decl_QNetworkCookieJar (qtdecl_QObject (), "QtMultimedia", "QNetworkCookieJar_Native",
  methods_QNetworkCookieJar (),
  "@hide\n@alias QNetworkCookieJar");

GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QNetworkCookieJar> &qtdecl_QNetworkCookieJar () { return decl_QNetworkCookieJar; }
...
gsi::Class<QNetworkCookieJar_Adaptor> decl_QNetworkCookieJar_Adaptor (qtdecl_QNetworkCookieJar (), "QtMultimedia", "QNetworkCookieJar",
