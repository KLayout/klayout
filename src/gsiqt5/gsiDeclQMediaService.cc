...
qt_gsi::QtNativeClass<QMediaService> decl_QMediaService (qtdecl_QObject (), "QMediaService_Native",
  methods_QMediaService (),
  "@hide\n@alias QMediaService");

GSIQT_PUBLIC gsi::Class<QMediaService> &qtdecl_QMediaService () { return decl_QMediaService; }
...
gsi::Class<QMediaService_Adaptor> decl_QMediaService_Adaptor (qtdecl_QMediaService (), "QMediaService",
