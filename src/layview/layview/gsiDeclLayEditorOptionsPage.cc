...
void EditorOptionsPageImpl::call_edited ()
{
...
void EditorOptionsPageImpl::apply_impl (lay::Dispatcher *root)
{
  lay::EditorOptionsPage::apply (root);
}

void EditorOptionsPageImpl::apply (lay::Dispatcher *root)
{
...
void EditorOptionsPageImpl::setup_impl (lay::Dispatcher *root)
{
  lay::EditorOptionsPage::setup (root);
}

void EditorOptionsPageImpl::setup (lay::Dispatcher *root)
{
...
void EditorOptionsPageImpl::cancel_impl ()
{
  lay::EditorOptionsPageWidget::cancel ();
}

void EditorOptionsPageImpl::cancel ()
{
...
void EditorOptionsPageImpl::commit_impl (lay::Dispatcher *root)
{
  lay::EditorOptionsPageWidget::commit (root);
}

void EditorOptionsPageImpl::commit (lay::Dispatcher *root)
{
