...
static gsi::Methods methods_QSqlTableModel () {
  ...
  methods += new qt_gsi::GenericMethod ("record", "@brief Method () const\n", true, &_init_f_record_c0, &_call_f_record_c0);
  methods += new qt_gsi::GenericMethod ("record", "@brief Method (int) const\n", true, &_init_f_record_c767, &_call_f_record_c767);
  ...
  methods += gsi::qt_signal<const QModelIndex &, const QModelIndex &, const QVector<int> & > ("dataChanged(const QModelIndex &, const QModelIndex &, const QVector<int> &)", "dataChanged", gsi::arg("topLeft"), gsi::arg("bottomRight"), gsi::arg("roles"), "@brief Signal declaration for QSqlTableModel::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)\nYou can bind a procedure to this signal.");
...
qt_gsi::QtNativeClass<QSqlTableModel> decl_QSqlTableModel (qtdecl_QSqlQueryModel (), "QSqlTableModel_Native",
  methods_QSqlTableModel (),
  "@hide\n@alias QSqlTableModel");

GSIQT_PUBLIC gsi::Class<QSqlTableModel> &qtdecl_QSqlTableModel () { return decl_QSqlTableModel; }
...
public:
  ...
  //  [expose] void QSqlTableModel::resetInternalData()
  void fp_QSqlTableModel_resetInternalData_0 () {
  ...
  //  [emitter impl] void QSqlTableModel::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
  void emitter_QSqlTableModel_dataChanged_7048(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
  {
...
// emitter void QSqlTableModel::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
...
static void _call_emitter_dataChanged_7048 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs & /*ret*/) 
{
  ...
  ((QSqlTableModel_Adaptor *)cls)->emitter_QSqlTableModel_dataChanged_7048 (arg1, arg2, arg3);
}
...
// exposed void QSqlTableModel::resetInternalData()
...
static void _call_fp_resetInternalData_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QSqlTableModel_Adaptor *)cls)->fp_QSqlTableModel_resetInternalData_0 ();
}
...
static gsi::Methods methods_QSqlTableModel_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("emit_dataChanged", "@brief Emitter for signal void QSqlTableModel::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)\nCall this method to emit this signal.", false, &_init_emitter_dataChanged_7048, &_call_emitter_dataChanged_7048);
...
gsi::Class<QSqlTableModel_Adaptor> decl_QSqlTableModel_Adaptor (qtdecl_QSqlTableModel (), "QSqlTableModel",
...
static gsi::Enum<QSqlTableModel::EditStrategy> decl_QSqlTableModel_EditStrategy_Enum ("QSqlTableModel_EditStrategy",
...
static gsi::QFlagsClass<QSqlTableModel::EditStrategy > decl_QSqlTableModel_EditStrategy_Enums ("QSqlTableModel_QFlags_EditStrategy",
