...
GSIQT_PUBLIC gsi::Class<QColor> &qtdecl_QColor () { return decl_QColor; }
...
static gsi::Enum<QColor::Spec> decl_QColor_Spec_Enum ("QColor_Spec",
...
static gsi::QFlagsClass<QColor::Spec > decl_QColor_Spec_Enums ("QColor_QFlags_Spec",
