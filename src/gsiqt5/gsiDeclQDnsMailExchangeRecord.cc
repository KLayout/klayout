...
gsi::Class<QDnsMailExchangeRecord> decl_QDnsMailExchangeRecord ("QDnsMailExchangeRecord",
  methods_QDnsMailExchangeRecord (),
  "@qt\n@brief Binding of QDnsMailExchangeRecord");


GSIQT_PUBLIC gsi::Class<QDnsMailExchangeRecord> &qtdecl_QDnsMailExchangeRecord () { return decl_QDnsMailExchangeRecord; }
