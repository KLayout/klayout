...
gsi::Class<QSslCertificateExtension> decl_QSslCertificateExtension ("QtMultimedia", "QSslCertificateExtension",
  methods_QSslCertificateExtension (),
  "@qt\n@brief Binding of QSslCertificateExtension");


GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QSslCertificateExtension> &qtdecl_QSslCertificateExtension () { return decl_QSslCertificateExtension; }
