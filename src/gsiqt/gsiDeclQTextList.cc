...
qt_gsi::QtNativeClass<QTextList> decl_QTextList (qtdecl_QTextBlockGroup (), "QTextList_Native",
  methods_QTextList (),
  "@hide\n@alias QTextList");

GSIQT_PUBLIC gsi::Class<QTextList> &qtdecl_QTextList () { return decl_QTextList; }
...
gsi::Class<QTextList_Adaptor> decl_QTextList_Adaptor (qtdecl_QTextList (), "QTextList",
