...
gsi::Class<QDomEntityReference> decl_QDomEntityReference (qtdecl_QDomNode (), "QDomEntityReference",
  methods_QDomEntityReference (),
  "@qt\n@brief Binding of QDomEntityReference");


GSIQT_PUBLIC gsi::Class<QDomEntityReference> &qtdecl_QDomEntityReference () { return decl_QDomEntityReference; }
