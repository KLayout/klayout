...
qt_gsi::QtNativeClass<QRadioDataControl> decl_QRadioDataControl (qtdecl_QMediaControl (), "QRadioDataControl_Native",
  methods_QRadioDataControl (),
  "@hide\n@alias QRadioDataControl");

GSIQT_PUBLIC gsi::Class<QRadioDataControl> &qtdecl_QRadioDataControl () { return decl_QRadioDataControl; }
...
gsi::Class<QRadioDataControl_Adaptor> decl_QRadioDataControl_Adaptor (qtdecl_QRadioDataControl (), "QRadioDataControl",
