...
// void QTreeView::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QList<int> &roles)


static void _init_f_dataChanged_6833 (qt_gsi::GenericMethod *decl)
{
...
static void _call_f_dataChanged_6833 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QModelIndex &arg1 = gsi::arg_reader<const QModelIndex & >() (args, heap);
...
static void _init_f_expandRecursively_3054 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("index");
  decl->add_arg<const QModelIndex & > (argspec_0);
  static gsi::ArgSpecBase argspec_1 ("depth", true, "-1");
  decl->add_arg<int > (argspec_1);
  decl->set_return<void > ();
}

static void _call_f_expandRecursively_3054 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QModelIndex &arg1 = gsi::arg_reader<const QModelIndex & >() (args, heap);
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTreeView *)cls)->expandRecursively (arg1, arg2);
}
...
static gsi::Methods methods_QTreeView () {
  ...
  methods += new qt_gsi::GenericMethod ("dataChanged", "@brief Method void QTreeView::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QList<int> &roles)\nThis is a reimplementation of QAbstractItemView::dataChanged", false, &_init_f_dataChanged_6833, &_call_f_dataChanged_6833);
  ...
  methods += new qt_gsi::GenericMethod ("expandRecursively", "@brief Method void QTreeView::expandRecursively(const QModelIndex &index, int depth)\n", false, &_init_f_expandRecursively_3054, &_call_f_expandRecursively_3054);
...
public:
  ...
  //  [expose] void QTreeView::updateMicroFocus(Qt::InputMethodQuery query)
  void fp_QTreeView_updateMicroFocus_2420 (const qt_gsi::Converter<Qt::InputMethodQuery>::target_type & query) {
    QTreeView::updateMicroFocus(qt_gsi::QtToCppAdaptor<Qt::InputMethodQuery>(query).cref());
  }
  ...
  //  [adaptor impl] void QTreeView::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QList<int> &roles)
  ...
  virtual void dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QList<int> &roles)
  {
    if (cb_dataChanged_6833_1.can_issue()) {
      cb_dataChanged_6833_1.issue<QTreeView_Adaptor, const QModelIndex &, const QModelIndex &, const QList<int> &>(&QTreeView_Adaptor::cbs_dataChanged_6833_1, topLeft, bottomRight, roles);
    } else {
      QTreeView::dataChanged(topLeft, bottomRight, roles);
    }
  }
  ...
  //  [adaptor impl] QAbstractItemDelegate *QTreeView::itemDelegateForIndex(const QModelIndex &index)
  ...
  virtual QAbstractItemDelegate * itemDelegateForIndex(const QModelIndex &index) const
  {
    if (cb_itemDelegateForIndex_c2395_0.can_issue()) {
      return cb_itemDelegateForIndex_c2395_0.issue<QTreeView_Adaptor, QAbstractItemDelegate *, const QModelIndex &>(&QTreeView_Adaptor::cbs_itemDelegateForIndex_c2395_0, index);
    } else {
      return QTreeView::itemDelegateForIndex(index);
    }
  }
  ...
  //  [adaptor impl] void QTreeView::changeEvent(QEvent *event)
  ...
  virtual void changeEvent(QEvent *event)
  {
    if (cb_changeEvent_1217_0.can_issue()) {
      cb_changeEvent_1217_0.issue<QTreeView_Adaptor, QEvent *>(&QTreeView_Adaptor::cbs_changeEvent_1217_0, event);
    } else {
      QTreeView::changeEvent(event);
    }
  }
  ...
  //  [adaptor impl] void QTreeView::enterEvent(QEnterEvent *event)
  ...
  virtual void enterEvent(QEnterEvent *event)
  {
    if (cb_enterEvent_1727_0.can_issue()) {
      cb_enterEvent_1727_0.issue<QTreeView_Adaptor, QEnterEvent *>(&QTreeView_Adaptor::cbs_enterEvent_1727_0, event);
    } else {
      QTreeView::enterEvent(event);
    }
  }
  ...
  //  [adaptor impl] void QTreeView::initStyleOption(QStyleOptionFrame *option)
  ...
  virtual void initStyleOption(QStyleOptionFrame *option) const
  {
    if (cb_initStyleOption_c2356_0.can_issue()) {
      cb_initStyleOption_c2356_0.issue<QTreeView_Adaptor, QStyleOptionFrame *>(&QTreeView_Adaptor::cbs_initStyleOption_c2356_0, option);
    } else {
      QTreeView::initStyleOption(option);
    }
  }

  //  [adaptor impl] void QTreeView::initViewItemOption(QStyleOptionViewItem *option)
  ...
  virtual void initViewItemOption(QStyleOptionViewItem *option) const
  {
    if (cb_initViewItemOption_c2675_0.can_issue()) {
      cb_initViewItemOption_c2675_0.issue<QTreeView_Adaptor, QStyleOptionViewItem *>(&QTreeView_Adaptor::cbs_initViewItemOption_c2675_0, option);
    } else {
      QTreeView::initViewItemOption(option);
    }
  }
  ...
  //  [adaptor impl] bool QTreeView::nativeEvent(const QByteArray &eventType, void *message, QIntegerForSizeof<void *>::Signed *result)
  ...
  virtual bool nativeEvent(const QByteArray &eventType, void *message, QIntegerForSizeof<void *>::Signed *result)
  {
    if (cb_nativeEvent_6949_0.can_issue()) {
      return cb_nativeEvent_6949_0.issue<QTreeView_Adaptor, bool, const QByteArray &, void *, QIntegerForSizeof<void *>::Signed *>(&QTreeView_Adaptor::cbs_nativeEvent_6949_0, eventType, message, result);
    } else {
      return QTreeView::nativeEvent(eventType, message, result);
    }
  }
...
static void _call_cbs_dataChanged_6833_1 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  const QList<int> &arg3 = args ? gsi::arg_reader<const QList<int> & >() (args, heap) : gsi::arg_maker<const QList<int> & >() (QList<int>(), heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTreeView_Adaptor *)cls)->cbs_dataChanged_6833_1 (arg1, arg2, arg3);
}

static void _set_callback_cbs_dataChanged_6833_1 (void *cls, const gsi::Callback &cb)
{
  ((QTreeView_Adaptor *)cls)->cb_dataChanged_6833_1 = cb;
}
...
// void QTreeView::enterEvent(QEnterEvent *event)
...
static void _call_cbs_enterEvent_1727_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTreeView_Adaptor *)cls)->cbs_enterEvent_1727_0 (arg1);
}

static void _set_callback_cbs_enterEvent_1727_0 (void *cls, const gsi::Callback &cb)
{
  ((QTreeView_Adaptor *)cls)->cb_enterEvent_1727_0 = cb;
}
...
// void QTreeView::initStyleOption(QStyleOptionFrame *option)
...
static void _call_cbs_initStyleOption_c2356_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTreeView_Adaptor *)cls)->cbs_initStyleOption_c2356_0 (arg1);
}

static void _set_callback_cbs_initStyleOption_c2356_0 (void *cls, const gsi::Callback &cb)
{
  ((QTreeView_Adaptor *)cls)->cb_initStyleOption_c2356_0 = cb;
}


// void QTreeView::initViewItemOption(QStyleOptionViewItem *option)
...
static void _call_cbs_initViewItemOption_c2675_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTreeView_Adaptor *)cls)->cbs_initViewItemOption_c2675_0 (arg1);
}

static void _set_callback_cbs_initViewItemOption_c2675_0 (void *cls, const gsi::Callback &cb)
{
  ((QTreeView_Adaptor *)cls)->cb_initViewItemOption_c2675_0 = cb;
}
...
// QAbstractItemDelegate *QTreeView::itemDelegateForIndex(const QModelIndex &index)
...
static void _call_cbs_itemDelegateForIndex_c2395_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  const QModelIndex &arg1 = gsi::arg_reader<const QModelIndex & >() (args, heap);
  ret.write<QAbstractItemDelegate * > ((QAbstractItemDelegate *)((QTreeView_Adaptor *)cls)->cbs_itemDelegateForIndex_c2395_0 (arg1));
}

static void _set_callback_cbs_itemDelegateForIndex_c2395_0 (void *cls, const gsi::Callback &cb)
{
  ((QTreeView_Adaptor *)cls)->cb_itemDelegateForIndex_c2395_0 = cb;
}
...
// bool QTreeView::nativeEvent(const QByteArray &eventType, void *message, QIntegerForSizeof<void *>::Signed *result)
...
static void _call_cbs_nativeEvent_6949_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<bool > ((bool)((QTreeView_Adaptor *)cls)->cbs_nativeEvent_6949_0 (arg1, arg2, arg3));
}

static void _set_callback_cbs_nativeEvent_6949_0 (void *cls, const gsi::Callback &cb)
{
  ((QTreeView_Adaptor *)cls)->cb_nativeEvent_6949_0 = cb;
}
...
// exposed void QTreeView::updateMicroFocus(Qt::InputMethodQuery query)
...
static void _call_fp_updateMicroFocus_2420 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTreeView_Adaptor *)cls)->fp_QTreeView_updateMicroFocus_2420 (arg1);
}
...
static gsi::Methods methods_QTreeView_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("dataChanged", "@brief Virtual method void QTreeView::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QList<int> &roles)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_dataChanged_6833_1, &_call_cbs_dataChanged_6833_1);
  ...
  methods += new qt_gsi::GenericMethod ("*initStyleOption", "@brief Virtual method void QTreeView::initStyleOption(QStyleOptionFrame *option)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_initStyleOption_c2356_0, &_call_cbs_initStyleOption_c2356_0);
  ...
  methods += new qt_gsi::GenericMethod ("*initViewItemOption", "@brief Virtual method void QTreeView::initViewItemOption(QStyleOptionViewItem *option)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_initViewItemOption_c2675_0, &_call_cbs_initViewItemOption_c2675_0);
  ...
  methods += new qt_gsi::GenericMethod ("itemDelegateForIndex", "@brief Virtual method QAbstractItemDelegate *QTreeView::itemDelegateForIndex(const QModelIndex &index)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_itemDelegateForIndex_c2395_0, &_call_cbs_itemDelegateForIndex_c2395_0);
  ...
  methods += new qt_gsi::GenericMethod ("*nativeEvent", "@brief Virtual method bool QTreeView::nativeEvent(const QByteArray &eventType, void *message, QIntegerForSizeof<void *>::Signed *result)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_nativeEvent_6949_0, &_call_cbs_nativeEvent_6949_0);
