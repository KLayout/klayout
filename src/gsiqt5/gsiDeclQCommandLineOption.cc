...
gsi::Class<QCommandLineOption> decl_QCommandLineOption ("QCommandLineOption",
  methods_QCommandLineOption (),
  "@qt\n@brief Binding of QCommandLineOption");


GSIQT_PUBLIC gsi::Class<QCommandLineOption> &qtdecl_QCommandLineOption () { return decl_QCommandLineOption; }
