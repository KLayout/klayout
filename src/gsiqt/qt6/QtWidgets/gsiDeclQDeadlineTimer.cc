...
// QPair<qint64, unsigned> QDeadlineTimer::_q_data()


static void _init_f__q_data_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<QPair<qint64, unsigned> > ();
}

static void _call_f__q_data_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QPair<qint64, unsigned> > ((QPair<qint64, unsigned>)((QDeadlineTimer *)cls)->_q_data ());
}
...
static void _init_f_remainingTimeAsDuration_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<std::chrono::nanoseconds > ();
}

static void _call_f_remainingTimeAsDuration_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<std::chrono::nanoseconds > ((std::chrono::nanoseconds)((QDeadlineTimer *)cls)->remainingTimeAsDuration ());
}
...
static gsi::Methods methods_QDeadlineTimer () {
  ...
  methods += new qt_gsi::GenericMethod ("_q_data", "@brief Method QPair<qint64, unsigned> QDeadlineTimer::_q_data()\n", true, &_init_f__q_data_c0, &_call_f__q_data_c0);
  ...
  methods += new qt_gsi::GenericMethod ("remainingTimeAsDuration", "@brief Method std::chrono::nanoseconds QDeadlineTimer::remainingTimeAsDuration()\n", true, &_init_f_remainingTimeAsDuration_c0, &_call_f_remainingTimeAsDuration_c0);
...
gsi::Class<QDeadlineTimer> decl_QDeadlineTimer ("Qt", "QDeadlineTimer",
  methods_QDeadlineTimer (),
  "@qt\n@brief Binding of QDeadlineTimer");


GSI_QT_PUBLIC gsi::Class<QDeadlineTimer> &qtdecl_QDeadlineTimer () { return decl_QDeadlineTimer; }
...
static gsi::Enum<QDeadlineTimer::ForeverConstant> decl_QDeadlineTimer_ForeverConstant_Enum ("Qt", "QDeadlineTimer_ForeverConstant",
...
static gsi::QFlagsClass<QDeadlineTimer::ForeverConstant > decl_QDeadlineTimer_ForeverConstant_Enums ("Qt", "QDeadlineTimer_QFlags_ForeverConstant",
