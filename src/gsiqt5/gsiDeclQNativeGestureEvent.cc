...
gsi::Class<QNativeGestureEvent> decl_QNativeGestureEvent (qtdecl_QInputEvent (), "QNativeGestureEvent",
  methods_QNativeGestureEvent (),
  "@qt\n@brief Binding of QNativeGestureEvent");


GSIQT_PUBLIC gsi::Class<QNativeGestureEvent> &qtdecl_QNativeGestureEvent () { return decl_QNativeGestureEvent; }
