...
static void _call_f_setFormat_2920 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QTextTableFormat &arg1 = args.read<const QTextTableFormat & > (heap);
  __SUPPRESS_UNUSED_WARNING(ret);
...
static gsi::Methods methods_QTextTable () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QTextTable::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
...
qt_gsi::QtNativeClass<QTextTable> decl_QTextTable (qtdecl_QTextFrame (), "QTextTable_Native",
  methods_QTextTable (),
  "@hide\n@alias QTextTable");

GSIQT_PUBLIC gsi::Class<QTextTable> &qtdecl_QTextTable () { return decl_QTextTable; }
...
static gsi::Methods methods_QTextTable_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*disconnectNotify", "@brief Virtual method void QTextTable::disconnectNotify(const char *signal)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_disconnectNotify_1731_0, &_call_cbs_disconnectNotify_1731_0, &_set_callback_cbs_disconnectNotify_1731_0);
...
gsi::Class<QTextTable_Adaptor> decl_QTextTable_Adaptor (qtdecl_QTextTable (), "QTextTable",
