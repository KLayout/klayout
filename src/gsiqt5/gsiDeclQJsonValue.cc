...
gsi::Class<QJsonValue> decl_QJsonValue ("QJsonValue",
  methods_QJsonValue (),
  "@qt\n@brief Binding of QJsonValue");


GSIQT_PUBLIC gsi::Class<QJsonValue> &qtdecl_QJsonValue () { return decl_QJsonValue; }
...
static gsi::Enum<QJsonValue::Type> decl_QJsonValue_Type_Enum ("QJsonValue_Type",
...
static gsi::QFlagsClass<QJsonValue::Type > decl_QJsonValue_Type_Enums ("QJsonValue_QFlags_Type",
