...
static void _init_f_isFallbackSessionManagementEnabled_0 (qt_gsi::GenericStaticMethod *decl)
{
  decl->set_return<bool > ();
}

static void _call_f_isFallbackSessionManagementEnabled_0 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<bool > ((bool)QGuiApplication::isFallbackSessionManagementEnabled ());
}
...
// static void QGuiApplication::setFallbackSessionManagementEnabled(bool)


static void _init_f_setFallbackSessionManagementEnabled_864 (qt_gsi::GenericStaticMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("arg1");
  decl->add_arg<bool > (argspec_0);
  decl->set_return<void > ();
...
static void _call_f_setFallbackSessionManagementEnabled_864 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  bool arg1 = gsi::arg_reader<bool >() (args, heap);
...
static gsi::Methods methods_QGuiApplication () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("isFallbackSessionManagementEnabled?", "@brief Static method bool QGuiApplication::isFallbackSessionManagementEnabled()\nThis method is static and can be called without an instance.", &_init_f_isFallbackSessionManagementEnabled_0, &_call_f_isFallbackSessionManagementEnabled_0);
  ...
  methods += new qt_gsi::GenericStaticMethod ("setFallbackSessionManagementEnabled", "@brief Static method void QGuiApplication::setFallbackSessionManagementEnabled(bool)\nThis method is static and can be called without an instance.", &_init_f_setFallbackSessionManagementEnabled_864, &_call_f_setFallbackSessionManagementEnabled_864);
