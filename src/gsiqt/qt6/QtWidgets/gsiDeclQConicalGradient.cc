...
gsi::Class<QConicalGradient> decl_QConicalGradient (qtdecl_QGradient (), "Qt", "QConicalGradient",
  methods_QConicalGradient (),
  "@qt\n@brief Binding of QConicalGradient");


GSI_QT_PUBLIC gsi::Class<QConicalGradient> &qtdecl_QConicalGradient () { return decl_QConicalGradient; }
