...
GSIQT_PUBLIC gsi::Class<QSslError> &qtdecl_QSslError () { return decl_QSslError; }
...
static gsi::Enum<QSslError::SslError> decl_QSslError_SslError_Enum ("QSslError_SslError",
...
static gsi::QFlagsClass<QSslError::SslError > decl_QSslError_SslError_Enums ("QSslError_QFlags_SslError",
