...
gsi::Class<QGraphicsEllipseItem> decl_QGraphicsEllipseItem (qtdecl_QAbstractGraphicsShapeItem (), "QGraphicsEllipseItem_Native",
  methods_QGraphicsEllipseItem (),
  "@hide\n@alias QGraphicsEllipseItem");

GSIQT_PUBLIC gsi::Class<QGraphicsEllipseItem> &qtdecl_QGraphicsEllipseItem () { return decl_QGraphicsEllipseItem; }
...
gsi::Class<QGraphicsEllipseItem_Adaptor> decl_QGraphicsEllipseItem_Adaptor (qtdecl_QGraphicsEllipseItem (), "QGraphicsEllipseItem",
