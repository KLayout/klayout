...
// static bool QImageIOHandler::allocateImage(QSize size, QImage::Format format, QImage *image)


static void _init_f_allocateImage_3631 (qt_gsi::GenericStaticMethod *decl)
{
  ...
  decl->add_arg<QImage * > (argspec_2);
  decl->set_return<bool > ();
}

static void _call_f_allocateImage_3631 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  ...
  QImage *arg3 = gsi::arg_reader<QImage * >() (args, heap);
  ret.write<bool > ((bool)QImageIOHandler::allocateImage (arg1, qt_gsi::QtToCppAdaptor<QImage::Format>(arg2).cref(), arg3));
}
...
static gsi::Methods methods_QImageIOHandler () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("allocateImage", "@brief Static method bool QImageIOHandler::allocateImage(QSize size, QImage::Format format, QImage *image)\nThis method is static and can be called without an instance.", &_init_f_allocateImage_3631, &_call_f_allocateImage_3631);
  return methods;
}
