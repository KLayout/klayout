...
qt_gsi::QtNativeClass<QTextFrame> decl_QTextFrame (qtdecl_QTextObject (), "QTextFrame_Native",
  methods_QTextFrame (),
  "@hide\n@alias QTextFrame");

GSIQT_PUBLIC gsi::Class<QTextFrame> &qtdecl_QTextFrame () { return decl_QTextFrame; }
...
gsi::Class<QTextFrame_Adaptor> decl_QTextFrame_Adaptor (qtdecl_QTextFrame (), "QTextFrame",
