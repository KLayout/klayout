...
gsi::Class<QGraphicsSceneHelpEvent> decl_QGraphicsSceneHelpEvent (qtdecl_QGraphicsSceneEvent (), "QGraphicsSceneHelpEvent_Native",
  methods_QGraphicsSceneHelpEvent (),
  "@hide\n@alias QGraphicsSceneHelpEvent");

GSIQT_PUBLIC gsi::Class<QGraphicsSceneHelpEvent> &qtdecl_QGraphicsSceneHelpEvent () { return decl_QGraphicsSceneHelpEvent; }
...
gsi::Class<QGraphicsSceneHelpEvent_Adaptor> decl_QGraphicsSceneHelpEvent_Adaptor (qtdecl_QGraphicsSceneHelpEvent (), "QGraphicsSceneHelpEvent",
