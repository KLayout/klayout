...
gsi::Class<QChildEvent> decl_QChildEvent (qtdecl_QEvent (), "Qt", "QChildEvent_Native",
  methods_QChildEvent (),
  "@hide\n@alias QChildEvent");

GSI_QT_PUBLIC gsi::Class<QChildEvent> &qtdecl_QChildEvent () { return decl_QChildEvent; }
...
gsi::Class<QChildEvent_Adaptor> decl_QChildEvent_Adaptor (qtdecl_QChildEvent (), "Qt", "QChildEvent",
