...
qt_gsi::QtNativeClass<QOffscreenSurface> decl_QOffscreenSurface (qtdecl_QObject (), "QOffscreenSurface_Native",
  methods_QOffscreenSurface (),
  "@hide\n@alias QOffscreenSurface");

GSIQT_PUBLIC gsi::Class<QOffscreenSurface> &qtdecl_QOffscreenSurface () { return decl_QOffscreenSurface; }
...
gsi::Class<QOffscreenSurface_Adaptor> decl_QOffscreenSurface_Adaptor (qtdecl_QOffscreenSurface (), "QOffscreenSurface",
