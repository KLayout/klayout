...
qt_gsi::QtNativeClass<QWindowsStyle> decl_QWindowsStyle (qtdecl_QCommonStyle (), "QWindowsStyle_Native",
  methods_QWindowsStyle (),
  "@hide\n@alias QWindowsStyle");

GSIQT_PUBLIC gsi::Class<QWindowsStyle> &qtdecl_QWindowsStyle () { return decl_QWindowsStyle; }
...
gsi::Class<QWindowsStyle_Adaptor> decl_QWindowsStyle_Adaptor (qtdecl_QWindowsStyle (), "QWindowsStyle",
