...
// QStyleOptionSizeGrip &QStyleOptionSizeGrip::operator=(const QStyleOptionSizeGrip &)


static void _init_f_operator_eq__3369 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("arg1");
  decl->add_arg<const QStyleOptionSizeGrip & > (argspec_0);
  decl->set_return<QStyleOptionSizeGrip & > ();
}

static void _call_f_operator_eq__3369 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QStyleOptionSizeGrip &arg1 = gsi::arg_reader<const QStyleOptionSizeGrip & >() (args, heap);
  ret.write<QStyleOptionSizeGrip & > ((QStyleOptionSizeGrip &)((QStyleOptionSizeGrip *)cls)->operator= (arg1));
}
...
static gsi::Methods methods_QStyleOptionSizeGrip () {
  ...
  methods += new qt_gsi::GenericMethod ("assign", "@brief Method QStyleOptionSizeGrip &QStyleOptionSizeGrip::operator=(const QStyleOptionSizeGrip &)\n", false, &_init_f_operator_eq__3369, &_call_f_operator_eq__3369);
  return methods;
}
