...
void PluginImpl::init (lay::LayoutViewBase *view, lay::Dispatcher *dispatcher)
{
  mp_view = view;
...
void PluginImpl::set_cursor (int c)
{
  if (ui ()) {
...
void PluginImpl::menu_activated (const std::string &symbol)
{
 ...
 */
void PluginImpl::configure_edt (const std::string &name, const std::string &value)
{
 ...
 */
bool PluginImpl::configure_impl (const std::string &name, const std::string &value)
{
...
//  for testing
void PluginImpl::configure_test (const std::string &name, const std::string &value)
{
  configure_edt (name, value);
}

bool PluginImpl::configure (const std::string &name, const std::string &value)
{
  configure_edt (name, value);
 ...
 *  @brief The implementation does not allow to bypass the base class configuration call
 */
void PluginImpl::config_finalize_impl ()
{
...
void PluginImpl::config_finalize ()
{
  lay::EditorServiceBase::config_finalize ();
  config_finalize_impl ();
}

bool PluginImpl::key_event (unsigned int key, unsigned int buttons)
{
...
bool PluginImpl::shortcut_override_event (unsigned int key, unsigned int buttons)
{
...
bool PluginImpl::mouse_press_event (const db::DPoint &p, unsigned int buttons, bool prio)
{
...
bool PluginImpl::mouse_press_event_noref (db::DPoint p, unsigned int buttons, bool prio)
{
  return mouse_press_event (p, buttons, prio);
}

bool PluginImpl::mouse_click_event (const db::DPoint &p, unsigned int buttons, bool prio)
{
...
//  NOTE: this version doesn't take a point reference which allows us to store the point in script code without generating a reference
bool PluginImpl::mouse_click_event_noref (db::DPoint p, unsigned int buttons, bool prio)
{
  return mouse_click_event (p, buttons, prio);
}

bool PluginImpl::mouse_double_click_event (const db::DPoint &p, unsigned int buttons, bool prio)
{
...
//  NOTE: this version doesn't take a point reference which allows us to store the point in script code without generating a reference
bool PluginImpl::mouse_double_click_event_noref (db::DPoint p, unsigned int buttons, bool prio)
{
  return mouse_double_click_event (p, buttons, prio);
}

bool PluginImpl::leave_event (bool prio)
{
...
bool PluginImpl::enter_event (bool prio)
{
...
bool PluginImpl::mouse_move_event (const db::DPoint &p, unsigned int buttons, bool prio)
{
...
//  NOTE: this version doesn't take a point reference which allows us to store the point in script code without generating a reference
bool PluginImpl::mouse_move_event_noref (db::DPoint p, unsigned int buttons, bool prio)
{
  return mouse_move_event (p, buttons, prio);
}

bool PluginImpl::mouse_release_event (const db::DPoint &p, unsigned int buttons, bool prio)
{
...
//  NOTE: this version doesn't take a point reference which allows us to store the point in script code without generating a reference
bool PluginImpl::mouse_release_event_noref (db::DPoint p, unsigned int buttons, bool prio)
{
  return mouse_release_event (p, buttons, prio);
}

bool PluginImpl::wheel_event (int delta, bool horizontal, const db::DPoint &p, unsigned int buttons, bool prio)
{
...
//  NOTE: this version doesn't take a point reference which allows us to store the point in script code without generating a reference
bool PluginImpl::wheel_event_noref (int delta, bool horizontal, db::DPoint p, unsigned int buttons, bool prio)
{
  return wheel_event (delta, horizontal, p, buttons, prio);
}

void PluginImpl::activated_impl ()
{
...
void PluginImpl::activated ()
{
  lay::EditorServiceBase::activated ();
  activated_impl ();
}

void PluginImpl::deactivated_impl ()
{
...
void PluginImpl::deactivated ()
{
  lay::EditorServiceBase::deactivated ();
  deactivated_impl ();
}

void PluginImpl::drag_cancel ()
{
...
void PluginImpl::add_mouse_cursor_dpoint (const db::DPoint &p, bool emphasize)
{
  lay::EditorServiceBase::add_mouse_cursor (p, emphasize);
}

void PluginImpl::add_mouse_cursor_point (const db::Point &p, int cv_index, const db::LayerProperties &lp, bool emphasize)
{
...
void PluginImpl::add_edge_marker_dedge (const db::DEdge &p, bool emphasize)
{
  lay::EditorServiceBase::add_edge_marker (p, emphasize);
}

void PluginImpl::add_edge_marker_edge (const db::Edge &p, int cv_index, const db::LayerProperties &lp, bool emphasize)
{
  const lay::CellView &cv = view ()->cellview (cv_index);
  if (! cv.is_valid ()) {
    return;
...
//  for testing
bool PluginImpl::has_tracking_position_test () const
{
  return has_tracking_position ();
}

bool PluginImpl::has_tracking_position () const
{
