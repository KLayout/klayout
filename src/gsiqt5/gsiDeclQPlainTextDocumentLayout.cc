...
qt_gsi::QtNativeClass<QPlainTextDocumentLayout> decl_QPlainTextDocumentLayout (qtdecl_QAbstractTextDocumentLayout (), "QPlainTextDocumentLayout_Native",
  methods_QPlainTextDocumentLayout (),
  "@hide\n@alias QPlainTextDocumentLayout");

GSIQT_PUBLIC gsi::Class<QPlainTextDocumentLayout> &qtdecl_QPlainTextDocumentLayout () { return decl_QPlainTextDocumentLayout; }
...
gsi::Class<QPlainTextDocumentLayout_Adaptor> decl_QPlainTextDocumentLayout_Adaptor (qtdecl_QPlainTextDocumentLayout (), "QPlainTextDocumentLayout",
