...
// QList<int> QAbstractItemDelegate::paintingRoles()
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QList<int> > ((QList<int>)((QAbstractItemDelegate *)cls)->paintingRoles ());
}
...
static gsi::Methods methods_QAbstractItemDelegate () {
  ...
  methods += new qt_gsi::GenericMethod ("paintingRoles", "@brief Method QList<int> QAbstractItemDelegate::paintingRoles()\n", true, &_init_f_paintingRoles_c0, &_call_f_paintingRoles_c0);
...
public:
  ...
  //  [adaptor impl] QList<int> QAbstractItemDelegate::paintingRoles()
  ...
  virtual QList<int> paintingRoles() const
  {
    if (cb_paintingRoles_c0_0.can_issue()) {
      return cb_paintingRoles_c0_0.issue<QAbstractItemDelegate_Adaptor, QList<int> >(&QAbstractItemDelegate_Adaptor::cbs_paintingRoles_c0_0);
    } else {
      return QAbstractItemDelegate::paintingRoles();
    }
  }
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QList<int> > ((QList<int>)((QAbstractItemDelegate_Adaptor *)cls)->cbs_paintingRoles_c0_0 ());
}
