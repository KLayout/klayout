...
gsi::Class<QGraphicsLayout> decl_QGraphicsLayout (qtdecl_QGraphicsLayoutItem (), "QtGui", "QGraphicsLayout_Native",
  methods_QGraphicsLayout (),
  "@hide\n@alias QGraphicsLayout");

GSI_QTGUI_PUBLIC gsi::Class<QGraphicsLayout> &qtdecl_QGraphicsLayout () { return decl_QGraphicsLayout; }
...
gsi::Class<QGraphicsLayout_Adaptor> decl_QGraphicsLayout_Adaptor (qtdecl_QGraphicsLayout (), "QtGui", "QGraphicsLayout",
