...
gsi::Class<QXmlFormatter> decl_QXmlFormatter (qtdecl_QXmlSerializer (), "QXmlFormatter_Native",
  methods_QXmlFormatter (),
  "@hide\n@alias QXmlFormatter");

GSIQT_PUBLIC gsi::Class<QXmlFormatter> &qtdecl_QXmlFormatter () { return decl_QXmlFormatter; }
...
gsi::Class<QXmlFormatter_Adaptor> decl_QXmlFormatter_Adaptor (qtdecl_QXmlFormatter (), "QXmlFormatter",
