...
gsi::Class<QXmlStreamEntityDeclaration> decl_QXmlStreamEntityDeclaration ("QXmlStreamEntityDeclaration",
  methods_QXmlStreamEntityDeclaration (),
  "@qt\n@brief Binding of QXmlStreamEntityDeclaration");


GSIQT_PUBLIC gsi::Class<QXmlStreamEntityDeclaration> &qtdecl_QXmlStreamEntityDeclaration () { return decl_QXmlStreamEntityDeclaration; }
