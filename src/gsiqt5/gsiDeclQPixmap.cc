...
static void _init_f_fill_4306 (qt_gsi::GenericMethod *decl)
{
...
static void _call_f_fill_4306 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
...
static void _init_f_fill_3816 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("device");
  decl->add_arg<const QPaintDevice * > (argspec_0);
...
static void _call_f_fill_3816 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QPaintDevice *arg1 = args.read<const QPaintDevice * > (heap);
...
static void _call_f_scroll_5269 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  QRegion *arg7 = args ? args.read<QRegion * > (heap) : (QRegion *)(0);
  __SUPPRESS_UNUSED_WARNING(ret);
...
static void _call_f_scroll_4317 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  QRegion *arg4 = args ? args.read<QRegion * > (heap) : (QRegion *)(0);
  __SUPPRESS_UNUSED_WARNING(ret);
...
static void _call_f_swap_1322 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QPixmap &arg1 = args.read<QPixmap & > (heap);
  __SUPPRESS_UNUSED_WARNING(ret);
...
static void _call_f_fromImageReader_5041 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QImageReader *arg1 = args.read<QImageReader * > (heap);
  QFlags<Qt::ImageConversionFlag> arg2 = args ? args.read<QFlags<Qt::ImageConversionFlag> > (heap) : (QFlags<Qt::ImageConversionFlag>)(Qt::AutoColor);
  ret.write<QPixmap > ((QPixmap)QPixmap::fromImageReader (arg1, arg2));
}


// static QPixmap QPixmap::grabWidget(QObject *widget, const QRect &rect)


static void _init_f_grabWidget_2986 (qt_gsi::GenericStaticMethod *decl)
{
...
static void _call_f_grabWidget_2986 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
...
// static QPixmap QPixmap::grabWidget(QObject *widget, int x, int y, int w, int h)


static void _init_f_grabWidget_3938 (qt_gsi::GenericStaticMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("widget");
  decl->add_arg<QObject * > (argspec_0);
...
static void _call_f_grabWidget_3938 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QObject *arg1 = args.read<QObject * > (heap);
...
static gsi::Methods methods_QPixmap () {
  ...
  methods += new qt_gsi::GenericMethod ("fill", "@brief Method void QPixmap::fill(const QPaintDevice *device, const QPoint &ofs)\n", false, &_init_f_fill_4306, &_call_f_fill_4306);
  methods += new qt_gsi::GenericMethod ("fill", "@brief Method void QPixmap::fill(const QPaintDevice *device, int xofs, int yofs)\n", false, &_init_f_fill_3816, &_call_f_fill_3816);
  ...
  methods += new qt_gsi::GenericStaticMethod ("grabWidget", "@brief Static method QPixmap QPixmap::grabWidget(QObject *widget, const QRect &rect)\nThis method is static and can be called without an instance.", &_init_f_grabWidget_2986, &_call_f_grabWidget_2986);
  methods += new qt_gsi::GenericStaticMethod ("grabWidget", "@brief Static method QPixmap QPixmap::grabWidget(QObject *widget, int x, int y, int w, int h)\nThis method is static and can be called without an instance.", &_init_f_grabWidget_3938, &_call_f_grabWidget_3938);
  methods += new qt_gsi::GenericStaticMethod ("grabWindow", "@brief Static method QPixmap QPixmap::grabWindow(WId, int x, int y, int w, int h)\nThis method is static and can be called without an instance.", &_init_f_grabWindow_3332, &_call_f_grabWindow_3332);
  methods += new qt_gsi::GenericStaticMethod ("trueMatrix", "@brief Static method QMatrix QPixmap::trueMatrix(const QMatrix &m, int w, int h)\nThis method is static and can be called without an instance.", &_init_f_trueMatrix_3341, &_call_f_trueMatrix_3341);
...
gsi::Class<QPixmap> decl_QPixmap (qtdecl_QPaintDevice (), "QPixmap_Native",
  methods_QPixmap (),
  "@hide\n@alias QPixmap");

GSIQT_PUBLIC gsi::Class<QPixmap> &qtdecl_QPixmap () { return decl_QPixmap; }
...
gsi::Class<QPixmap_Adaptor> decl_QPixmap_Adaptor (qtdecl_QPixmap (), "QPixmap",
