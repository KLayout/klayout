...
gsi::Class<QTabletEvent> decl_QTabletEvent (qtdecl_QInputEvent (), "QTabletEvent_Native",
  methods_QTabletEvent (),
  "@hide\n@alias QTabletEvent");

GSIQT_PUBLIC gsi::Class<QTabletEvent> &qtdecl_QTabletEvent () { return decl_QTabletEvent; }
...
gsi::Class<QTabletEvent_Adaptor> decl_QTabletEvent_Adaptor (qtdecl_QTabletEvent (), "QTabletEvent",
...
static gsi::Enum<QTabletEvent::PointerType> decl_QTabletEvent_PointerType_Enum ("QTabletEvent_PointerType",
...
static gsi::QFlagsClass<QTabletEvent::PointerType > decl_QTabletEvent_PointerType_Enums ("QTabletEvent_QFlags_PointerType",
...
static gsi::Enum<QTabletEvent::TabletDevice> decl_QTabletEvent_TabletDevice_Enum ("QTabletEvent_TabletDevice",
...
static gsi::QFlagsClass<QTabletEvent::TabletDevice > decl_QTabletEvent_TabletDevice_Enums ("QTabletEvent_QFlags_TabletDevice",
