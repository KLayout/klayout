...
public:
  ...
  //  [expose] void QFileDevice::setOpenMode(QFlags<QIODeviceBase::OpenModeFlag> openMode)
  void fp_QFileDevice_setOpenMode_3621 (QFlags<QIODeviceBase::OpenModeFlag> openMode) {
  ...
  //  [adaptor impl] bool QFileDevice::open(QFlags<QIODeviceBase::OpenModeFlag> mode)
  ...
  virtual bool open(QFlags<QIODeviceBase::OpenModeFlag> mode)
  {
    if (cb_open_3621_0.can_issue()) {
      return cb_open_3621_0.issue<QFileDevice_Adaptor, bool, QFlags<QIODeviceBase::OpenModeFlag> >(&QFileDevice_Adaptor::cbs_open_3621_0, mode);
    } else {
      return QFileDevice::open(mode);
    }
  }
  ...
  //  [adaptor impl] qint64 QFileDevice::skipData(qint64 maxSize)
  ...
  virtual qint64 skipData(qint64 maxSize)
  {
    if (cb_skipData_986_0.can_issue()) {
      return cb_skipData_986_0.issue<QFileDevice_Adaptor, qint64, qint64>(&QFileDevice_Adaptor::cbs_skipData_986_0, maxSize);
    } else {
      return QFileDevice::skipData(maxSize);
    }
  }
...
// bool QFileDevice::open(QFlags<QIODeviceBase::OpenModeFlag> mode)
...
static void _call_cbs_open_3621_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<bool > ((bool)((QFileDevice_Adaptor *)cls)->cbs_open_3621_0 (arg1));
}

static void _set_callback_cbs_open_3621_0 (void *cls, const gsi::Callback &cb)
{
  ((QFileDevice_Adaptor *)cls)->cb_open_3621_0 = cb;
}
...
// exposed void QFileDevice::setOpenMode(QFlags<QIODeviceBase::OpenModeFlag> openMode)
...
static void _call_fp_setOpenMode_3621 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QFileDevice_Adaptor *)cls)->fp_QFileDevice_setOpenMode_3621 (arg1);
}
...
// qint64 QFileDevice::skipData(qint64 maxSize)
...
static void _call_cbs_skipData_986_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  qint64 arg1 = args.read<qint64 > (heap);
  ret.write<qint64 > ((qint64)((QFileDevice_Adaptor *)cls)->cbs_skipData_986_0 (arg1));
}

static void _set_callback_cbs_skipData_986_0 (void *cls, const gsi::Callback &cb)
{
  ((QFileDevice_Adaptor *)cls)->cb_skipData_986_0 = cb;
}
...
static gsi::Methods methods_QFileDevice_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("open", "@brief Virtual method bool QFileDevice::open(QFlags<QIODeviceBase::OpenModeFlag> mode)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_open_3621_0, &_call_cbs_open_3621_0);
