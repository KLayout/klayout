...
qt_gsi::QtNativeClass<QActionGroup> decl_QActionGroup (qtdecl_QObject (), "QtWidgets", "QActionGroup_Native",
  methods_QActionGroup (),
  "@hide\n@alias QActionGroup");

GSI_QTWIDGETS_PUBLIC gsi::Class<QActionGroup> &qtdecl_QActionGroup () { return decl_QActionGroup; }
...
gsi::Class<QActionGroup_Adaptor> decl_QActionGroup_Adaptor (qtdecl_QActionGroup (), "QtWidgets", "QActionGroup",
