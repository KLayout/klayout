...
qt_gsi::QtNativeClass<QDirModel> decl_QDirModel (qtdecl_QAbstractItemModel (), "QtGui", "QDirModel_Native",
  methods_QDirModel (),
  "@hide\n@alias QDirModel");

GSI_QTGUI_PUBLIC gsi::Class<QDirModel> &qtdecl_QDirModel () { return decl_QDirModel; }
...
gsi::Class<QDirModel_Adaptor> decl_QDirModel_Adaptor (qtdecl_QDirModel (), "QtGui", "QDirModel",
