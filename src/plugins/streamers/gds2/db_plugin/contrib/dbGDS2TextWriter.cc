...
void GDS2WriterText::write_byte (unsigned char b)
{
  ssFormattingStream << b << " ";
}

void GDS2WriterText::write_short (int16_t i)
{
  ssFormattingStream << i << " ";
}


void GDS2WriterText::write_int (int32_t l)
{
...
void GDS2WriterText::write_double (double d)
{
  ssFormattingStream << d << " ";
}


void GDS2WriterText::write_time (const short *time)
{
...
void GDS2WriterText::write_string (const char *t)
{
  ssFormattingStream << t;
}


void GDS2WriterText::write_string (const std::string &t)
{
  write_string (t.c_str ());
}

void GDS2WriterText::write_record_size (int16_t /*i*/)
{
  // Nothing to do here
}


void GDS2WriterText::write_record (int16_t i)
{
  if (siCurrentRecord) {
    if (siCurrentRecord != sXY) {
...
void GDS2WriterText::progress_checkpoint ()
{
