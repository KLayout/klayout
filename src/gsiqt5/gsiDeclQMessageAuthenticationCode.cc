...
gsi::Class<QMessageAuthenticationCode> decl_QMessageAuthenticationCode ("QMessageAuthenticationCode",
  methods_QMessageAuthenticationCode (),
  "@qt\n@brief Binding of QMessageAuthenticationCode");


GSIQT_PUBLIC gsi::Class<QMessageAuthenticationCode> &qtdecl_QMessageAuthenticationCode () { return decl_QMessageAuthenticationCode; }
