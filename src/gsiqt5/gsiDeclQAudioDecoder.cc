...
qt_gsi::QtNativeClass<QAudioDecoder> decl_QAudioDecoder (qtdecl_QMediaObject (), "QAudioDecoder_Native",
  methods_QAudioDecoder (),
  "@hide\n@alias QAudioDecoder");

GSIQT_PUBLIC gsi::Class<QAudioDecoder> &qtdecl_QAudioDecoder () { return decl_QAudioDecoder; }
...
static void _call_emitter_error_2347 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs & /*ret*/) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QAudioDecoder::Error>::target_type & arg1 = args.read<const qt_gsi::Converter<QAudioDecoder::Error>::target_type & > (heap);
...
gsi::Class<QAudioDecoder_Adaptor> decl_QAudioDecoder_Adaptor (qtdecl_QAudioDecoder (), "QAudioDecoder",
...
static gsi::Enum<QAudioDecoder::Error> decl_QAudioDecoder_Error_Enum ("QAudioDecoder_Error",
...
static gsi::QFlagsClass<QAudioDecoder::Error > decl_QAudioDecoder_Error_Enums ("QAudioDecoder_QFlags_Error",
...
static gsi::Enum<QAudioDecoder::State> decl_QAudioDecoder_State_Enum ("QAudioDecoder_State",
...
static gsi::QFlagsClass<QAudioDecoder::State > decl_QAudioDecoder_State_Enums ("QAudioDecoder_QFlags_State",
