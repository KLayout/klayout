...
gsi::Class<QXmlResultItems> decl_QXmlResultItems ("QXmlResultItems_Native",
  methods_QXmlResultItems (),
  "@hide\n@alias QXmlResultItems");

GSIQT_PUBLIC gsi::Class<QXmlResultItems> &qtdecl_QXmlResultItems () { return decl_QXmlResultItems; }
...
gsi::Class<QXmlResultItems_Adaptor> decl_QXmlResultItems_Adaptor (qtdecl_QXmlResultItems (), "QXmlResultItems",
