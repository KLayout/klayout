...
qt_gsi::QtNativeClass<QNetworkAccessManager> decl_QNetworkAccessManager (qtdecl_QObject (), "QNetworkAccessManager_Native",
  methods_QNetworkAccessManager (),
  "@hide\n@alias QNetworkAccessManager");

GSIQT_PUBLIC gsi::Class<QNetworkAccessManager> &qtdecl_QNetworkAccessManager () { return decl_QNetworkAccessManager; }
...
gsi::Class<QNetworkAccessManager_Adaptor> decl_QNetworkAccessManager_Adaptor (qtdecl_QNetworkAccessManager (), "QNetworkAccessManager",
...
static gsi::Enum<QNetworkAccessManager::Operation> decl_QNetworkAccessManager_Operation_Enum ("QNetworkAccessManager_Operation",
...
static gsi::QFlagsClass<QNetworkAccessManager::Operation > decl_QNetworkAccessManager_Operation_Enums ("QNetworkAccessManager_QFlags_Operation",
