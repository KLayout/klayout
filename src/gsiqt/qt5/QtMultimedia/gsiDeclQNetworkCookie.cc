...
gsi::Class<QNetworkCookie> decl_QNetworkCookie ("QtMultimedia", "QNetworkCookie",
  methods_QNetworkCookie (),
  "@qt\n@brief Binding of QNetworkCookie");


GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QNetworkCookie> &qtdecl_QNetworkCookie () { return decl_QNetworkCookie; }
...
static gsi::Enum<QNetworkCookie::RawForm> decl_QNetworkCookie_RawForm_Enum ("QtMultimedia", "QNetworkCookie_RawForm",
...
static gsi::QFlagsClass<QNetworkCookie::RawForm > decl_QNetworkCookie_RawForm_Enums ("QtMultimedia", "QNetworkCookie_QFlags_RawForm",
