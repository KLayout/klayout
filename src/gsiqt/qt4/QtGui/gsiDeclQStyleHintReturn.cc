...
gsi::Class<QStyleHintReturn> decl_QStyleHintReturn ("QtGui", "QStyleHintReturn",
  methods_QStyleHintReturn (),
  "@qt\n@brief Binding of QStyleHintReturn");


GSI_QTGUI_PUBLIC gsi::Class<QStyleHintReturn> &qtdecl_QStyleHintReturn () { return decl_QStyleHintReturn; }
