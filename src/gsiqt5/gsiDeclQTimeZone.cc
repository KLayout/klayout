...
gsi::Class<QTimeZone> decl_QTimeZone ("QTimeZone",
  methods_QTimeZone (),
  "@qt\n@brief Binding of QTimeZone");


GSIQT_PUBLIC gsi::Class<QTimeZone> &qtdecl_QTimeZone () { return decl_QTimeZone; }
...
static gsi::Enum<QTimeZone::NameType> decl_QTimeZone_NameType_Enum ("QTimeZone_NameType",
...
static gsi::QFlagsClass<QTimeZone::NameType > decl_QTimeZone_NameType_Enums ("QTimeZone_QFlags_NameType",
...
static gsi::Enum<QTimeZone::TimeType> decl_QTimeZone_TimeType_Enum ("QTimeZone_TimeType",
...
static gsi::QFlagsClass<QTimeZone::TimeType > decl_QTimeZone_TimeType_Enums ("QTimeZone_QFlags_TimeType",
