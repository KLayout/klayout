...
qt_gsi::QtNativeClass<QMediaServiceProviderPlugin> decl_QMediaServiceProviderPlugin (qtdecl_QObject (), "QMediaServiceProviderPlugin_Native",
  methods_QMediaServiceProviderPlugin (),
  "@hide\n@alias QMediaServiceProviderPlugin");

GSIQT_PUBLIC gsi::Class<QMediaServiceProviderPlugin> &qtdecl_QMediaServiceProviderPlugin () { return decl_QMediaServiceProviderPlugin; }
...
gsi::Class<QMediaServiceProviderPlugin_Adaptor> decl_QMediaServiceProviderPlugin_Adaptor (qtdecl_QMediaServiceProviderPlugin (), "QMediaServiceProviderPlugin",
