...
gsi::Class<QCalendar> decl_QCalendar ("Qt", "QCalendar",
  methods_QCalendar (),
  "@qt\n@brief Binding of QCalendar");


GSI_QT_PUBLIC gsi::Class<QCalendar> &qtdecl_QCalendar () { return decl_QCalendar; }
...
static gsi::Enum<QCalendar::System> decl_QCalendar_System_Enum ("Qt", "QCalendar_System",
...
static gsi::QFlagsClass<QCalendar::System > decl_QCalendar_System_Enums ("Qt", "QCalendar_QFlags_System",
