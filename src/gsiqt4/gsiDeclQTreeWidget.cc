...
qt_gsi::QtNativeClass<QTreeWidget> decl_QTreeWidget (qtdecl_QTreeView (), "QTreeWidget_Native",
  methods_QTreeWidget (),
  "@hide\n@alias QTreeWidget");

GSIQT_PUBLIC gsi::Class<QTreeWidget> &qtdecl_QTreeWidget () { return decl_QTreeWidget; }
...
gsi::Class<QTreeWidget_Adaptor> decl_QTreeWidget_Adaptor (qtdecl_QTreeWidget (), "QTreeWidget",
