...
gsi::Class<QXmlStreamNotationDeclaration> decl_QXmlStreamNotationDeclaration ("QXmlStreamNotationDeclaration",
  methods_QXmlStreamNotationDeclaration (),
  "@qt\n@brief Binding of QXmlStreamNotationDeclaration");


GSIQT_PUBLIC gsi::Class<QXmlStreamNotationDeclaration> &qtdecl_QXmlStreamNotationDeclaration () { return decl_QXmlStreamNotationDeclaration; }
