...
// qsizetype QStringMatcher::indexIn(const QString &str, qsizetype from)


static void _init_f_indexIn_c3359 (qt_gsi::GenericMethod *decl)
{
...
static void _call_f_indexIn_c3359 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QString &arg1 = gsi::arg_reader<const QString & >() (args, heap);
