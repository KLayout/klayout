...
//  Constructor QDataStream::QDataStream(QByteArray *, QFlags<QIODeviceBase::OpenModeFlag> flags)


static void _init_ctor_QDataStream_5131 (qt_gsi::GenericStaticMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("arg1");
...
static void _call_ctor_QDataStream_5131 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
...
// bool QDataStream::isDeviceTransactionStarted()


static void _init_f_isDeviceTransactionStarted_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<bool > ();
}

static void _call_f_isDeviceTransactionStarted_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<bool > ((bool)((QDataStream *)cls)->isDeviceTransactionStarted ());
}
...
static gsi::Methods methods_QDataStream () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QDataStream::QDataStream(QByteArray *, QFlags<QIODeviceBase::OpenModeFlag> flags)\nThis method creates an object of class QDataStream.", &_init_ctor_QDataStream_5131, &_call_ctor_QDataStream_5131);
  ...
  methods += new qt_gsi::GenericMethod ("isDeviceTransactionStarted?", "@brief Method bool QDataStream::isDeviceTransactionStarted()\n", true, &_init_f_isDeviceTransactionStarted_c0, &_call_f_isDeviceTransactionStarted_c0);
...
gsi::Class<QDataStream> decl_QDataStream (qtdecl_QIODeviceBase (), "Qt", "QDataStream",
...
GSI_QT_PUBLIC gsi::Class<QDataStream> &qtdecl_QDataStream () { return decl_QDataStream; }
...
static gsi::Enum<QDataStream::ByteOrder> decl_QDataStream_ByteOrder_Enum ("Qt", "QDataStream_ByteOrder",
...
static gsi::QFlagsClass<QDataStream::ByteOrder > decl_QDataStream_ByteOrder_Enums ("Qt", "QDataStream_QFlags_ByteOrder",
...
static gsi::Enum<QDataStream::FloatingPointPrecision> decl_QDataStream_FloatingPointPrecision_Enum ("Qt", "QDataStream_FloatingPointPrecision",
...
static gsi::QFlagsClass<QDataStream::FloatingPointPrecision > decl_QDataStream_FloatingPointPrecision_Enums ("Qt", "QDataStream_QFlags_FloatingPointPrecision",
...
static gsi::Enum<QDataStream::Status> decl_QDataStream_Status_Enum ("Qt", "QDataStream_Status",
...
static gsi::QFlagsClass<QDataStream::Status > decl_QDataStream_Status_Enums ("Qt", "QDataStream_QFlags_Status",
