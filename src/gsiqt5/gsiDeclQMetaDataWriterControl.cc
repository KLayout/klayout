...
qt_gsi::QtNativeClass<QMetaDataWriterControl> decl_QMetaDataWriterControl (qtdecl_QMediaControl (), "QMetaDataWriterControl_Native",
  methods_QMetaDataWriterControl (),
  "@hide\n@alias QMetaDataWriterControl");

GSIQT_PUBLIC gsi::Class<QMetaDataWriterControl> &qtdecl_QMetaDataWriterControl () { return decl_QMetaDataWriterControl; }
...
gsi::Class<QMetaDataWriterControl_Adaptor> decl_QMetaDataWriterControl_Adaptor (qtdecl_QMetaDataWriterControl (), "QMetaDataWriterControl",
