...
gsi::Class<QLockFile> decl_QLockFile ("QLockFile",
  methods_QLockFile (),
  "@qt\n@brief Binding of QLockFile");


GSIQT_PUBLIC gsi::Class<QLockFile> &qtdecl_QLockFile () { return decl_QLockFile; }
...
static gsi::Enum<QLockFile::LockError> decl_QLockFile_LockError_Enum ("QLockFile_LockError",
...
static gsi::QFlagsClass<QLockFile::LockError > decl_QLockFile_LockError_Enums ("QLockFile_QFlags_LockError",
