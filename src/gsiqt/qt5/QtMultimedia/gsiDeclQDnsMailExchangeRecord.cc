...
gsi::Class<QDnsMailExchangeRecord> decl_QDnsMailExchangeRecord ("QtMultimedia", "QDnsMailExchangeRecord",
  methods_QDnsMailExchangeRecord (),
  "@qt\n@brief Binding of QDnsMailExchangeRecord");


GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QDnsMailExchangeRecord> &qtdecl_QDnsMailExchangeRecord () { return decl_QDnsMailExchangeRecord; }
