...
static void _init_f_setTabArray_1584 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("tabStops");
  decl->add_arg<QList<qreal> > (argspec_0);
  decl->set_return<void > ();
}

static void _call_f_setTabArray_1584 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
...
{
  static gsi::ArgSpecBase argspec_0 ("tabStops");
  decl->add_arg<QList<QTextOption::Tab> > (argspec_0);
  decl->set_return<void > ();
}
...
static gsi::Methods methods_QTextOption () {
  ...
  methods += new qt_gsi::GenericMethod ("setTabArray|tabArray=", "@brief Method void QTextOption::setTabArray(QList<qreal> tabStops)\n", false, &_init_f_setTabArray_1584, &_call_f_setTabArray_1584);
  ...
  methods += new qt_gsi::GenericMethod ("setTabs|tabs=", "@brief Method void QTextOption::setTabs(QList<QTextOption::Tab> tabStops)\n", false, &_init_f_setTabs_2581, &_call_f_setTabs_2581);
...
GSIQT_PUBLIC gsi::Class<QTextOption> &qtdecl_QTextOption () { return decl_QTextOption; }
...
static gsi::Enum<QTextOption::Flag> decl_QTextOption_Flag_Enum ("QTextOption_Flag",
...
static gsi::QFlagsClass<QTextOption::Flag > decl_QTextOption_Flag_Enums ("QTextOption_QFlags_Flag",
...
static gsi::Enum<QTextOption::WrapMode> decl_QTextOption_WrapMode_Enum ("QTextOption_WrapMode",
...
static gsi::QFlagsClass<QTextOption::WrapMode > decl_QTextOption_WrapMode_Enums ("QTextOption_QFlags_WrapMode",
