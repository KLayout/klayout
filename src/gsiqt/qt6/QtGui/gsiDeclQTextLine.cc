...
static void _init_f_draw_c3304 (qt_gsi::GenericMethod *decl)
{
...
static void _call_f_draw_c3304 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
...
static gsi::Methods methods_QTextLine () {
  ...
  methods += new qt_gsi::GenericMethod ("draw", "@brief Method void QTextLine::draw(QPainter *painter, const QPointF &position)\n", true, &_init_f_draw_c3304, &_call_f_draw_c3304);
