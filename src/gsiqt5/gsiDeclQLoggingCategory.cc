...
gsi::Class<QLoggingCategory> decl_QLoggingCategory ("QLoggingCategory",
  methods_QLoggingCategory (),
  "@qt\n@brief Binding of QLoggingCategory");


GSIQT_PUBLIC gsi::Class<QLoggingCategory> &qtdecl_QLoggingCategory () { return decl_QLoggingCategory; }
