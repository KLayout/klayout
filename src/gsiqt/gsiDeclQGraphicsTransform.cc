...
qt_gsi::QtNativeClass<QGraphicsTransform> decl_QGraphicsTransform (qtdecl_QObject (), "QGraphicsTransform_Native",
  methods_QGraphicsTransform (),
  "@hide\n@alias QGraphicsTransform");

GSIQT_PUBLIC gsi::Class<QGraphicsTransform> &qtdecl_QGraphicsTransform () { return decl_QGraphicsTransform; }
...
gsi::Class<QGraphicsTransform_Adaptor> decl_QGraphicsTransform_Adaptor (qtdecl_QGraphicsTransform (), "QGraphicsTransform",
