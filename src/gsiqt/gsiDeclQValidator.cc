...
static gsi::Methods methods_QValidator () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QValidator::tr(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_tr_3354, &_call_f_tr_3354);
  ...
  methods += new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QValidator::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
...
qt_gsi::QtNativeClass<QValidator> decl_QValidator (qtdecl_QObject (), "QValidator_Native",
  methods_QValidator (),
  "@hide\n@alias QValidator");

GSIQT_PUBLIC gsi::Class<QValidator> &qtdecl_QValidator () { return decl_QValidator; }
...
static gsi::Methods methods_QValidator_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*disconnectNotify", "@brief Virtual method void QValidator::disconnectNotify(const char *signal)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_disconnectNotify_1731_0, &_call_cbs_disconnectNotify_1731_0, &_set_callback_cbs_disconnectNotify_1731_0);
...
gsi::Class<QValidator_Adaptor> decl_QValidator_Adaptor (qtdecl_QValidator (), "QValidator",
...
static gsi::Enum<QValidator::State> decl_QValidator_State_Enum ("QValidator_State",
...
static gsi::QFlagsClass<QValidator::State > decl_QValidator_State_Enums ("QValidator_QFlags_State",
