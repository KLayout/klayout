...
static gsi::Methods methods_QSoundEffect () {
  ...
  methods += new qt_gsi::GenericMethod ("setAudioDevice|audioDevice=", "@brief Method void QSoundEffect::setAudioDevice(const QAudioDevice &device)\n", false, &_init_f_setAudioDevice_2484, &_call_f_setAudioDevice_2484);
  ...
  methods += gsi::qt_signal ("audioDeviceChanged()", "audioDeviceChanged", "@brief Signal declaration for QSoundEffect::audioDeviceChanged()\nYou can bind a procedure to this signal.");
...
public:
  ...
  //  [emitter impl] void QSoundEffect::audioDeviceChanged()
  void emitter_QSoundEffect_audioDeviceChanged_0()
  {
    emit QSoundEffect::audioDeviceChanged();
  }
...
// emitter void QSoundEffect::audioDeviceChanged()

static void _init_emitter_audioDeviceChanged_0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<void > ();
}

static void _call_emitter_audioDeviceChanged_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs & /*ret*/) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ((QSoundEffect_Adaptor *)cls)->emitter_QSoundEffect_audioDeviceChanged_0 ();
}
...
static gsi::Methods methods_QSoundEffect_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("emit_audioDeviceChanged", "@brief Emitter for signal void QSoundEffect::audioDeviceChanged()\nCall this method to emit this signal.", false, &_init_emitter_audioDeviceChanged_0, &_call_emitter_audioDeviceChanged_0);
