...
gsi::Class<QJsonObject::iterator> decl_QJsonObject_Iterator ("QJsonObject_Iterator",
...
GSIQT_PUBLIC gsi::Class<QJsonObject::iterator> &qtdecl_QJsonObject_Iterator () { return decl_QJsonObject_Iterator; }
