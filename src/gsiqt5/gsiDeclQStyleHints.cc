...
qt_gsi::QtNativeClass<QStyleHints> decl_QStyleHints (qtdecl_QObject (), "QStyleHints_Native",
  methods_QStyleHints (),
  "@hide\n@alias QStyleHints");

GSIQT_PUBLIC gsi::Class<QStyleHints> &qtdecl_QStyleHints () { return decl_QStyleHints; }
...
gsi::Class<QStyleHints_Adaptor> decl_QStyleHints_Adaptor (qtdecl_QStyleHints (), "QStyleHints",
