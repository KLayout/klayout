...
GSIQT_PUBLIC gsi::Class<QXmlDTDHandler> &qtdecl_QXmlDTDHandler () { return decl_QXmlDTDHandler; }
...
gsi::Class<QXmlDTDHandler_Adaptor> decl_QXmlDTDHandler_Adaptor (qtdecl_QXmlDTDHandler (), "QXmlDTDHandler",
