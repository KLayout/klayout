...
gsi::Class<QGlyphRun> decl_QGlyphRun ("QGlyphRun",
  methods_QGlyphRun (),
  "@qt\n@brief Binding of QGlyphRun");


GSIQT_PUBLIC gsi::Class<QGlyphRun> &qtdecl_QGlyphRun () { return decl_QGlyphRun; }
...
static gsi::Enum<QGlyphRun::GlyphRunFlag> decl_QGlyphRun_GlyphRunFlag_Enum ("QGlyphRun_GlyphRunFlag",
...
static gsi::QFlagsClass<QGlyphRun::GlyphRunFlag > decl_QGlyphRun_GlyphRunFlag_Enums ("QGlyphRun_QFlags_GlyphRunFlag",
