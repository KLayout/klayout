...
gsi::Class<QGraphicsItemGroup> decl_QGraphicsItemGroup (qtdecl_QGraphicsItem (), "QGraphicsItemGroup_Native",
  methods_QGraphicsItemGroup (),
  "@hide\n@alias QGraphicsItemGroup");

GSIQT_PUBLIC gsi::Class<QGraphicsItemGroup> &qtdecl_QGraphicsItemGroup () { return decl_QGraphicsItemGroup; }
...
gsi::Class<QGraphicsItemGroup_Adaptor> decl_QGraphicsItemGroup_Adaptor (qtdecl_QGraphicsItemGroup (), "QGraphicsItemGroup",
