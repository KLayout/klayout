...
static gsi::Enum<QFont::HintingPreference> decl_QFont_HintingPreference_Enum ("QFont_HintingPreference",
...
static gsi::QFlagsClass<QFont::HintingPreference > decl_QFont_HintingPreference_Enums ("QFont_QFlags_HintingPreference",
