...
gsi::Class<QRadialGradient> decl_QRadialGradient (qtdecl_QGradient (), "QRadialGradient",
  methods_QRadialGradient (),
  "@qt\n@brief Binding of QRadialGradient");


GSIQT_PUBLIC gsi::Class<QRadialGradient> &qtdecl_QRadialGradient () { return decl_QRadialGradient; }
