...
//  Constructor QAnyStringView::QAnyStringView(std::nullptr_t)


static void _init_ctor_QAnyStringView_1879 (qt_gsi::GenericStaticMethod *decl)
{
...
static void _call_ctor_QAnyStringView_1879 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
...
static gsi::Methods methods_QAnyStringView () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QAnyStringView::QAnyStringView(std::nullptr_t)\nThis method creates an object of class QAnyStringView.", &_init_ctor_QAnyStringView_1879, &_call_ctor_QAnyStringView_1879);
...
gsi::Class<QAnyStringView> decl_QAnyStringView ("Qt", "QAnyStringView",
  methods_QAnyStringView (),
  "@qt\n@brief Binding of QAnyStringView");


GSI_QT_PUBLIC gsi::Class<QAnyStringView> &qtdecl_QAnyStringView () { return decl_QAnyStringView; }
