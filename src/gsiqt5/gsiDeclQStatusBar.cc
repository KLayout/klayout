...
qt_gsi::QtNativeClass<QStatusBar> decl_QStatusBar (qtdecl_QWidget (), "QStatusBar_Native",
  methods_QStatusBar (),
  "@hide\n@alias QStatusBar");

GSIQT_PUBLIC gsi::Class<QStatusBar> &qtdecl_QStatusBar () { return decl_QStatusBar; }
...
gsi::Class<QStatusBar_Adaptor> decl_QStatusBar_Adaptor (qtdecl_QStatusBar (), "QStatusBar",
