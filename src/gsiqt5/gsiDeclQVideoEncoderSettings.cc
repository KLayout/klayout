...
gsi::Class<QVideoEncoderSettings> decl_QVideoEncoderSettings ("QVideoEncoderSettings",
  methods_QVideoEncoderSettings (),
  "@qt\n@brief Binding of QVideoEncoderSettings");


GSIQT_PUBLIC gsi::Class<QVideoEncoderSettings> &qtdecl_QVideoEncoderSettings () { return decl_QVideoEncoderSettings; }
