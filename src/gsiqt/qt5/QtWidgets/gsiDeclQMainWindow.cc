...
public:
  ...
  //  [adaptor impl] void QMainWindow::enterEvent(QEvent *event)
  ...
  virtual void enterEvent(QEvent *event)
  {
    if (cb_enterEvent_1217_0.can_issue()) {
      cb_enterEvent_1217_0.issue<QMainWindow_Adaptor, QEvent *>(&QMainWindow_Adaptor::cbs_enterEvent_1217_0, event);
    } else {
      QMainWindow::enterEvent(event);
    }
  }
...
// void QMainWindow::enterEvent(QEvent *event)
