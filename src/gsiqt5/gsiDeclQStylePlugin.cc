...
qt_gsi::QtNativeClass<QStylePlugin> decl_QStylePlugin (qtdecl_QObject (), "QStylePlugin_Native",
  methods_QStylePlugin (),
  "@hide\n@alias QStylePlugin");

GSIQT_PUBLIC gsi::Class<QStylePlugin> &qtdecl_QStylePlugin () { return decl_QStylePlugin; }
...
gsi::Class<QStylePlugin_Adaptor> decl_QStylePlugin_Adaptor (qtdecl_QStylePlugin (), "QStylePlugin",
