...
gsi::Class<QStyleOptionTabBarBase> decl_QStyleOptionTabBarBase (qtdecl_QStyleOption (), "QStyleOptionTabBarBase",
  methods_QStyleOptionTabBarBase (),
  "@qt\n@brief Binding of QStyleOptionTabBarBase");


GSIQT_PUBLIC gsi::Class<QStyleOptionTabBarBase> &qtdecl_QStyleOptionTabBarBase () { return decl_QStyleOptionTabBarBase; }
