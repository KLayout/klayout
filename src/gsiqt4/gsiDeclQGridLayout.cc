...
qt_gsi::QtNativeClass<QGridLayout> decl_QGridLayout (qtdecl_QLayout (), "QGridLayout_Native",
  methods_QGridLayout (),
  "@hide\n@alias QGridLayout");

GSIQT_PUBLIC gsi::Class<QGridLayout> &qtdecl_QGridLayout () { return decl_QGridLayout; }
...
gsi::Class<QGridLayout_Adaptor> decl_QGridLayout_Adaptor (qtdecl_QGridLayout (), "QGridLayout",
