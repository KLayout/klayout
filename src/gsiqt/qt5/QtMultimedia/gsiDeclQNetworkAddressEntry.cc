...
gsi::Class<QNetworkAddressEntry> decl_QNetworkAddressEntry ("QtMultimedia", "QNetworkAddressEntry",
  methods_QNetworkAddressEntry (),
  "@qt\n@brief Binding of QNetworkAddressEntry");


GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QNetworkAddressEntry> &qtdecl_QNetworkAddressEntry () { return decl_QNetworkAddressEntry; }
