...
static void _init_f_operator_eq__3466 (qt_gsi::GenericMethod *decl)
{
  ...
  decl->add_arg<const QStyleOptionFocusRect & > (argspec_0);
  decl->set_return<QStyleOptionFocusRect & > ();
}
...
static void _call_f_operator_eq__3466 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  const QStyleOptionFocusRect &arg1 = gsi::arg_reader<const QStyleOptionFocusRect & >() (args, heap);
  ret.write<QStyleOptionFocusRect & > ((QStyleOptionFocusRect &)((QStyleOptionFocusRect *)cls)->operator= (arg1));
}
...
static gsi::Methods methods_QStyleOptionFocusRect () {
  ...
  methods += new qt_gsi::GenericMethod ("assign", "@brief Method QStyleOptionFocusRect &QStyleOptionFocusRect::operator=(const QStyleOptionFocusRect &)\n", false, &_init_f_operator_eq__3466, &_call_f_operator_eq__3466);
  return methods;
}
