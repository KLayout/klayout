...
qt_gsi::QtNativeClass<QImageIOPlugin> decl_QImageIOPlugin (qtdecl_QObject (), "QImageIOPlugin_Native",
  methods_QImageIOPlugin (),
  "@hide\n@alias QImageIOPlugin");

GSIQT_PUBLIC gsi::Class<QImageIOPlugin> &qtdecl_QImageIOPlugin () { return decl_QImageIOPlugin; }
...
gsi::Class<QImageIOPlugin_Adaptor> decl_QImageIOPlugin_Adaptor (qtdecl_QImageIOPlugin (), "QImageIOPlugin",
...
static gsi::Enum<QImageIOPlugin::Capability> decl_QImageIOPlugin_Capability_Enum ("QImageIOPlugin_Capability",
...
static gsi::QFlagsClass<QImageIOPlugin::Capability > decl_QImageIOPlugin_Capability_Enums ("QImageIOPlugin_QFlags_Capability",
