...
qt_gsi::QtNativeClass<QCameraControl> decl_QCameraControl (qtdecl_QMediaControl (), "QCameraControl_Native",
  methods_QCameraControl (),
  "@hide\n@alias QCameraControl");

GSIQT_PUBLIC gsi::Class<QCameraControl> &qtdecl_QCameraControl () { return decl_QCameraControl; }
...
gsi::Class<QCameraControl_Adaptor> decl_QCameraControl_Adaptor (qtdecl_QCameraControl (), "QCameraControl",
...
static gsi::Enum<QCameraControl::PropertyChangeType> decl_QCameraControl_PropertyChangeType_Enum ("QCameraControl_PropertyChangeType",
...
static gsi::QFlagsClass<QCameraControl::PropertyChangeType > decl_QCameraControl_PropertyChangeType_Enums ("QCameraControl_QFlags_PropertyChangeType",
