...
qt_gsi::QtNativeClass<QToolBar> decl_QToolBar (qtdecl_QWidget (), "QToolBar_Native",
  methods_QToolBar (),
  "@hide\n@alias QToolBar");

GSIQT_PUBLIC gsi::Class<QToolBar> &qtdecl_QToolBar () { return decl_QToolBar; }
...
gsi::Class<QToolBar_Adaptor> decl_QToolBar_Adaptor (qtdecl_QToolBar (), "QToolBar",
