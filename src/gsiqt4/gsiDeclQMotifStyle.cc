...
qt_gsi::QtNativeClass<QMotifStyle> decl_QMotifStyle (qtdecl_QCommonStyle (), "QMotifStyle_Native",
  methods_QMotifStyle (),
  "@hide\n@alias QMotifStyle");

GSIQT_PUBLIC gsi::Class<QMotifStyle> &qtdecl_QMotifStyle () { return decl_QMotifStyle; }
...
gsi::Class<QMotifStyle_Adaptor> decl_QMotifStyle_Adaptor (qtdecl_QMotifStyle (), "QMotifStyle",
