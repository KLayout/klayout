...
gsi::Class<QSpacerItem> decl_QSpacerItem (qtdecl_QLayoutItem (), "QSpacerItem_Native",
  methods_QSpacerItem (),
  "@hide\n@alias QSpacerItem");

GSIQT_PUBLIC gsi::Class<QSpacerItem> &qtdecl_QSpacerItem () { return decl_QSpacerItem; }
...
gsi::Class<QSpacerItem_Adaptor> decl_QSpacerItem_Adaptor (qtdecl_QSpacerItem (), "QSpacerItem",
