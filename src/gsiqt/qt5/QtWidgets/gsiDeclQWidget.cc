...
public:
  ...
  //  [adaptor impl] void QWidget::enterEvent(QEvent *event)
  ...
  virtual void enterEvent(QEvent *event)
  {
    if (cb_enterEvent_1217_0.can_issue()) {
      cb_enterEvent_1217_0.issue<QWidget_Adaptor, QEvent *>(&QWidget_Adaptor::cbs_enterEvent_1217_0, event);
    } else {
      QWidget::enterEvent(event);
    }
  }
  ...
  //  [adaptor impl] bool QWidget::nativeEvent(const QByteArray &eventType, void *message, long int *result)
  ...
  virtual bool nativeEvent(const QByteArray &eventType, void *message, long int *result)
  {
    if (cb_nativeEvent_4678_0.can_issue()) {
      return cb_nativeEvent_4678_0.issue<QWidget_Adaptor, bool, const QByteArray &, void *, long int *>(&QWidget_Adaptor::cbs_nativeEvent_4678_0, eventType, message, result);
    } else {
      return QWidget::nativeEvent(eventType, message, result);
    }
  }
...
// bool QWidget::nativeEvent(const QByteArray &eventType, void *message, long int *result)
...
static void _call_cbs_nativeEvent_4678_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<bool > ((bool)((QWidget_Adaptor *)cls)->cbs_nativeEvent_4678_0 (arg1, arg2, arg3));
}

static void _set_callback_cbs_nativeEvent_4678_0 (void *cls, const gsi::Callback &cb)
{
  ((QWidget_Adaptor *)cls)->cb_nativeEvent_4678_0 = cb;
}
...
static gsi::Methods methods_QWidget_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*nativeEvent", "@brief Virtual method bool QWidget::nativeEvent(const QByteArray &eventType, void *message, long int *result)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_nativeEvent_4678_0, &_call_cbs_nativeEvent_4678_0);
