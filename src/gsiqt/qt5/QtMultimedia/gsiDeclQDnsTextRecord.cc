...
gsi::Class<QDnsTextRecord> decl_QDnsTextRecord ("QtMultimedia", "QDnsTextRecord",
  methods_QDnsTextRecord (),
  "@qt\n@brief Binding of QDnsTextRecord");


GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QDnsTextRecord> &qtdecl_QDnsTextRecord () { return decl_QDnsTextRecord; }
