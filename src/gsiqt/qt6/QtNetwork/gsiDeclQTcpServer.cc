...
static void _init_f_setSocketDescriptor_3614 (qt_gsi::GenericMethod *decl)
{
...
static void _call_f_setSocketDescriptor_3614 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
...
public:
  ...
  void cbs_incomingConnection_3614_0(QIntegerForSizeof<void *>::Signed handle)
  {
  ...
  {
    if (cb_incomingConnection_3614_0.can_issue()) {
      cb_incomingConnection_3614_0.issue<QTcpServer_Adaptor, QIntegerForSizeof<void *>::Signed>(&QTcpServer_Adaptor::cbs_incomingConnection_3614_0, handle);
    } else {
      QTcpServer::incomingConnection(handle);
    }
  }
  ...
  gsi::Callback cb_incomingConnection_3614_0;
...
static void _init_cbs_incomingConnection_3614_0 (qt_gsi::GenericMethod *decl)
{
...
static void _call_cbs_incomingConnection_3614_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QIntegerForSizeof<void *>::Signed arg1 = args.read<QIntegerForSizeof<void *>::Signed > (heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTcpServer_Adaptor *)cls)->cbs_incomingConnection_3614_0 (arg1);
}

static void _set_callback_cbs_incomingConnection_3614_0 (void *cls, const gsi::Callback &cb)
{
  ((QTcpServer_Adaptor *)cls)->cb_incomingConnection_3614_0 = cb;
}
...
static gsi::Methods methods_QTcpServer_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*incomingConnection", "@brief Virtual method void QTcpServer::incomingConnection(QIntegerForSizeof<void *>::Signed handle)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_incomingConnection_3614_0, &_call_cbs_incomingConnection_3614_0);
  methods += new qt_gsi::GenericMethod ("*incomingConnection", "@hide", false, &_init_cbs_incomingConnection_3614_0, &_call_cbs_incomingConnection_3614_0, &_set_callback_cbs_incomingConnection_3614_0);
