...
qt_gsi::QtNativeClass<QAbstractSocket> decl_QAbstractSocket (qtdecl_QIODevice (), "QtMultimedia", "QAbstractSocket",
  methods_QAbstractSocket (),
  "@qt\n@brief Binding of QAbstractSocket");


GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QAbstractSocket> &qtdecl_QAbstractSocket () { return decl_QAbstractSocket; }
...
static gsi::Enum<QAbstractSocket::BindFlag> decl_QAbstractSocket_BindFlag_Enum ("QtMultimedia", "QAbstractSocket_BindFlag",
...
static gsi::QFlagsClass<QAbstractSocket::BindFlag > decl_QAbstractSocket_BindFlag_Enums ("QtMultimedia", "QAbstractSocket_QFlags_BindFlag",
...
static gsi::Enum<QAbstractSocket::NetworkLayerProtocol> decl_QAbstractSocket_NetworkLayerProtocol_Enum ("QtMultimedia", "QAbstractSocket_NetworkLayerProtocol",
...
static gsi::QFlagsClass<QAbstractSocket::NetworkLayerProtocol > decl_QAbstractSocket_NetworkLayerProtocol_Enums ("QtMultimedia", "QAbstractSocket_QFlags_NetworkLayerProtocol",
...
static gsi::Enum<QAbstractSocket::PauseMode> decl_QAbstractSocket_PauseMode_Enum ("QtMultimedia", "QAbstractSocket_PauseMode",
...
static gsi::QFlagsClass<QAbstractSocket::PauseMode > decl_QAbstractSocket_PauseMode_Enums ("QtMultimedia", "QAbstractSocket_QFlags_PauseMode",
...
static gsi::Enum<QAbstractSocket::SocketError> decl_QAbstractSocket_SocketError_Enum ("QtMultimedia", "QAbstractSocket_SocketError",
...
static gsi::QFlagsClass<QAbstractSocket::SocketError > decl_QAbstractSocket_SocketError_Enums ("QtMultimedia", "QAbstractSocket_QFlags_SocketError",
...
static gsi::Enum<QAbstractSocket::SocketOption> decl_QAbstractSocket_SocketOption_Enum ("QtMultimedia", "QAbstractSocket_SocketOption",
...
static gsi::QFlagsClass<QAbstractSocket::SocketOption > decl_QAbstractSocket_SocketOption_Enums ("QtMultimedia", "QAbstractSocket_QFlags_SocketOption",
...
static gsi::Enum<QAbstractSocket::SocketState> decl_QAbstractSocket_SocketState_Enum ("QtMultimedia", "QAbstractSocket_SocketState",
...
static gsi::QFlagsClass<QAbstractSocket::SocketState > decl_QAbstractSocket_SocketState_Enums ("QtMultimedia", "QAbstractSocket_QFlags_SocketState",
...
static gsi::Enum<QAbstractSocket::SocketType> decl_QAbstractSocket_SocketType_Enum ("QtMultimedia", "QAbstractSocket_SocketType",
...
static gsi::QFlagsClass<QAbstractSocket::SocketType > decl_QAbstractSocket_SocketType_Enums ("QtMultimedia", "QAbstractSocket_QFlags_SocketType",
