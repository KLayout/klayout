...
gsi::Class<QGraphicsSceneDragDropEvent> decl_QGraphicsSceneDragDropEvent (qtdecl_QGraphicsSceneEvent (), "QtGui", "QGraphicsSceneDragDropEvent_Native",
  methods_QGraphicsSceneDragDropEvent (),
  "@hide\n@alias QGraphicsSceneDragDropEvent");

GSI_QTGUI_PUBLIC gsi::Class<QGraphicsSceneDragDropEvent> &qtdecl_QGraphicsSceneDragDropEvent () { return decl_QGraphicsSceneDragDropEvent; }
...
gsi::Class<QGraphicsSceneDragDropEvent_Adaptor> decl_QGraphicsSceneDragDropEvent_Adaptor (qtdecl_QGraphicsSceneDragDropEvent (), "QtGui", "QGraphicsSceneDragDropEvent",
