...
gsi::Class<QPaintEvent> decl_QPaintEvent (qtdecl_QEvent (), "QPaintEvent_Native",
  methods_QPaintEvent (),
  "@hide\n@alias QPaintEvent");

GSIQT_PUBLIC gsi::Class<QPaintEvent> &qtdecl_QPaintEvent () { return decl_QPaintEvent; }
...
gsi::Class<QPaintEvent_Adaptor> decl_QPaintEvent_Adaptor (qtdecl_QPaintEvent (), "QPaintEvent",
