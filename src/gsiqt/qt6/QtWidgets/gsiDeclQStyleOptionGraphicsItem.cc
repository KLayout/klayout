...
static void _init_f_operator_eq__3772 (qt_gsi::GenericMethod *decl)
{
  ...
  decl->add_arg<const QStyleOptionGraphicsItem & > (argspec_0);
  decl->set_return<QStyleOptionGraphicsItem & > ();
}
...
static void _call_f_operator_eq__3772 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  const QStyleOptionGraphicsItem &arg1 = gsi::arg_reader<const QStyleOptionGraphicsItem & >() (args, heap);
  ret.write<QStyleOptionGraphicsItem & > ((QStyleOptionGraphicsItem &)((QStyleOptionGraphicsItem *)cls)->operator= (arg1));
}
...
static gsi::Methods methods_QStyleOptionGraphicsItem () {
  ...
  methods += new qt_gsi::GenericMethod ("assign", "@brief Method QStyleOptionGraphicsItem &QStyleOptionGraphicsItem::operator=(const QStyleOptionGraphicsItem &)\n", false, &_init_f_operator_eq__3772, &_call_f_operator_eq__3772);
...
gsi::Class<QStyleOptionGraphicsItem> decl_QStyleOptionGraphicsItem (qtdecl_QStyleOption (), "QtWidgets", "QStyleOptionGraphicsItem",
  methods_QStyleOptionGraphicsItem (),
  "@qt\n@brief Binding of QStyleOptionGraphicsItem");


GSI_QTWIDGETS_PUBLIC gsi::Class<QStyleOptionGraphicsItem> &qtdecl_QStyleOptionGraphicsItem () { return decl_QStyleOptionGraphicsItem; }
