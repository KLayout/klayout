...
gsi::Class<QStyleOptionTabV2> decl_QStyleOptionTabV2 (qtdecl_QStyleOptionTab (), "QStyleOptionTabV2",
  methods_QStyleOptionTabV2 (),
  "@qt\n@brief Binding of QStyleOptionTabV2");


GSIQT_PUBLIC gsi::Class<QStyleOptionTabV2> &qtdecl_QStyleOptionTabV2 () { return decl_QStyleOptionTabV2; }
