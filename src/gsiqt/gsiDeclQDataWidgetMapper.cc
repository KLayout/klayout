...
GSIQT_PUBLIC gsi::Class<QDataWidgetMapper> &qtdecl_QDataWidgetMapper () { return decl_QDataWidgetMapper; }
...
gsi::Class<QDataWidgetMapper_Adaptor> decl_QDataWidgetMapper_Adaptor (qtdecl_QDataWidgetMapper (), "QDataWidgetMapper",
...
static gsi::Enum<QDataWidgetMapper::SubmitPolicy> decl_QDataWidgetMapper_SubmitPolicy_Enum ("QDataWidgetMapper_SubmitPolicy",
...
static gsi::QFlagsClass<QDataWidgetMapper::SubmitPolicy > decl_QDataWidgetMapper_SubmitPolicy_Enums ("QDataWidgetMapper_QFlags_SubmitPolicy",
