...
gsi::Class<QDeferredDeleteEvent> decl_QDeferredDeleteEvent (qtdecl_QEvent (), "Qt", "QDeferredDeleteEvent_Native",
  methods_QDeferredDeleteEvent (),
  "@hide\n@alias QDeferredDeleteEvent");

GSI_QT_PUBLIC gsi::Class<QDeferredDeleteEvent> &qtdecl_QDeferredDeleteEvent () { return decl_QDeferredDeleteEvent; }
...
gsi::Class<QDeferredDeleteEvent_Adaptor> decl_QDeferredDeleteEvent_Adaptor (qtdecl_QDeferredDeleteEvent (), "Qt", "QDeferredDeleteEvent",
