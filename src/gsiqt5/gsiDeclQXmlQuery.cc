...
gsi::Class<QXmlQuery> decl_QXmlQuery ("QXmlQuery",
  methods_QXmlQuery (),
  "@qt\n@brief Binding of QXmlQuery");


GSIQT_PUBLIC gsi::Class<QXmlQuery> &qtdecl_QXmlQuery () { return decl_QXmlQuery; }
...
static gsi::Enum<QXmlQuery::QueryLanguage> decl_QXmlQuery_QueryLanguage_Enum ("QXmlQuery_QueryLanguage",
...
static gsi::QFlagsClass<QXmlQuery::QueryLanguage > decl_QXmlQuery_QueryLanguage_Enums ("QXmlQuery_QFlags_QueryLanguage",
