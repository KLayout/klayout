...
qt_gsi::QtNativeClass<QIconEnginePlugin> decl_QIconEnginePlugin (qtdecl_QObject (), "QIconEnginePlugin_Native",
  methods_QIconEnginePlugin (),
  "@hide\n@alias QIconEnginePlugin");

GSIQT_PUBLIC gsi::Class<QIconEnginePlugin> &qtdecl_QIconEnginePlugin () { return decl_QIconEnginePlugin; }
...
gsi::Class<QIconEnginePlugin_Adaptor> decl_QIconEnginePlugin_Adaptor (qtdecl_QIconEnginePlugin (), "QIconEnginePlugin",
