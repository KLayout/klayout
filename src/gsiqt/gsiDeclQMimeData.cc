...
gsi::Class<QMimeData> decl_QMimeData (qtdecl_QObject (), "QMimeData_Native",
  methods_QMimeData (),
  "@hide\n@alias QMimeData");
...
static gsi::Methods methods_QMimeData_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("formats", "@hide", true, &_init_cbs_formats_c0_0, &_call_cbs_formats_c0_0);
  ...
  methods += new qt_gsi::GenericMethod ("hasFormat", "@hide", true, &_init_cbs_hasFormat_c2025_0, &_call_cbs_hasFormat_c2025_0);
  ...
  methods += new qt_gsi::GenericMethod ("*retrieveData", "@hide", true, &_init_cbs_retrieveData_c3693_0, &_call_cbs_retrieveData_c3693_0);
