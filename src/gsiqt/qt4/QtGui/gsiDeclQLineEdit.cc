...
qt_gsi::QtNativeClass<QLineEdit> decl_QLineEdit (qtdecl_QWidget (), "QtGui", "QLineEdit_Native",
  methods_QLineEdit (),
  "@hide\n@alias QLineEdit");

GSI_QTGUI_PUBLIC gsi::Class<QLineEdit> &qtdecl_QLineEdit () { return decl_QLineEdit; }
...
gsi::Class<QLineEdit_Adaptor> decl_QLineEdit_Adaptor (qtdecl_QLineEdit (), "QtGui", "QLineEdit",
...
static gsi::Enum<QLineEdit::EchoMode> decl_QLineEdit_EchoMode_Enum ("QtGui", "QLineEdit_EchoMode",
...
static gsi::QFlagsClass<QLineEdit::EchoMode > decl_QLineEdit_EchoMode_Enums ("QtGui", "QLineEdit_QFlags_EchoMode",
