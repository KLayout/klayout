...
// void QStandardItem::multiData(QModelRoleDataSpan roleDataSpan)
...
static void _call_f_multiData_c2196 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QStandardItem *)cls)->multiData (arg1);
}
...
public:
  ...
  //  [adaptor impl] void QStandardItem::multiData(QModelRoleDataSpan roleDataSpan)
  void cbs_multiData_c2196_0(QModelRoleDataSpan roleDataSpan) const
  {
  ...
  {
    if (cb_multiData_c2196_0.can_issue()) {
      cb_multiData_c2196_0.issue<QStandardItem_Adaptor, QModelRoleDataSpan>(&QStandardItem_Adaptor::cbs_multiData_c2196_0, roleDataSpan);
    } else {
      QStandardItem::multiData(roleDataSpan);
    }
  }
  ...
  gsi::Callback cb_multiData_c2196_0;
...
static void _init_cbs_multiData_c2196_0 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("roleDataSpan");
  decl->add_arg<QModelRoleDataSpan > (argspec_0);
  decl->set_return<void > ();
...
static void _call_cbs_multiData_c2196_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
...
static void _set_callback_cbs_multiData_c2196_0 (void *cls, const gsi::Callback &cb)
{
  ((QStandardItem_Adaptor *)cls)->cb_multiData_c2196_0 = cb;
}
...
static gsi::Methods methods_QStandardItem_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("multiData", "@brief Virtual method void QStandardItem::multiData(QModelRoleDataSpan roleDataSpan)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_multiData_c2196_0, &_call_cbs_multiData_c2196_0);
  methods += new qt_gsi::GenericMethod ("multiData", "@hide", true, &_init_cbs_multiData_c2196_0, &_call_cbs_multiData_c2196_0, &_set_callback_cbs_multiData_c2196_0);
