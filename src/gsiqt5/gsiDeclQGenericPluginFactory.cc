...
gsi::Class<QGenericPluginFactory> decl_QGenericPluginFactory ("QGenericPluginFactory",
  methods_QGenericPluginFactory (),
  "@qt\n@brief Binding of QGenericPluginFactory");


GSIQT_PUBLIC gsi::Class<QGenericPluginFactory> &qtdecl_QGenericPluginFactory () { return decl_QGenericPluginFactory; }
