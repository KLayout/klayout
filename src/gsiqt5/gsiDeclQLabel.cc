...
qt_gsi::QtNativeClass<QLabel> decl_QLabel (qtdecl_QFrame (), "QLabel_Native",
  methods_QLabel (),
  "@hide\n@alias QLabel");

GSIQT_PUBLIC gsi::Class<QLabel> &qtdecl_QLabel () { return decl_QLabel; }
...
gsi::Class<QLabel_Adaptor> decl_QLabel_Adaptor (qtdecl_QLabel (), "QLabel",
