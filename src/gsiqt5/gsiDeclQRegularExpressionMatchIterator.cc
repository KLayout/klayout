...
gsi::Class<QRegularExpressionMatchIterator> decl_QRegularExpressionMatchIterator ("QRegularExpressionMatchIterator",
  methods_QRegularExpressionMatchIterator (),
  "@qt\n@brief Binding of QRegularExpressionMatchIterator");


GSIQT_PUBLIC gsi::Class<QRegularExpressionMatchIterator> &qtdecl_QRegularExpressionMatchIterator () { return decl_QRegularExpressionMatchIterator; }
