...
gsi::Class<QStyleOptionTitleBar> decl_QStyleOptionTitleBar (qtdecl_QStyleOptionComplex (), "QtGui", "QStyleOptionTitleBar",
  methods_QStyleOptionTitleBar (),
  "@qt\n@brief Binding of QStyleOptionTitleBar");


GSI_QTGUI_PUBLIC gsi::Class<QStyleOptionTitleBar> &qtdecl_QStyleOptionTitleBar () { return decl_QStyleOptionTitleBar; }
