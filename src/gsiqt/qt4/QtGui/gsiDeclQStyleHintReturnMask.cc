...
gsi::Class<QStyleHintReturnMask> decl_QStyleHintReturnMask (qtdecl_QStyleHintReturn (), "QtGui", "QStyleHintReturnMask",
  methods_QStyleHintReturnMask (),
  "@qt\n@brief Binding of QStyleHintReturnMask");


GSI_QTGUI_PUBLIC gsi::Class<QStyleHintReturnMask> &qtdecl_QStyleHintReturnMask () { return decl_QStyleHintReturnMask; }
