...
qt_gsi::QtNativeClass<QGraphicsScale> decl_QGraphicsScale (qtdecl_QGraphicsTransform (), "QGraphicsScale_Native",
  methods_QGraphicsScale (),
  "@hide\n@alias QGraphicsScale");

GSIQT_PUBLIC gsi::Class<QGraphicsScale> &qtdecl_QGraphicsScale () { return decl_QGraphicsScale; }
...
gsi::Class<QGraphicsScale_Adaptor> decl_QGraphicsScale_Adaptor (qtdecl_QGraphicsScale (), "QGraphicsScale",
