...
qt_gsi::QtNativeClass<QNetworkConfigurationManager> decl_QNetworkConfigurationManager (qtdecl_QObject (), "QNetworkConfigurationManager_Native",
  methods_QNetworkConfigurationManager (),
  "@hide\n@alias QNetworkConfigurationManager");

GSIQT_PUBLIC gsi::Class<QNetworkConfigurationManager> &qtdecl_QNetworkConfigurationManager () { return decl_QNetworkConfigurationManager; }
...
gsi::Class<QNetworkConfigurationManager_Adaptor> decl_QNetworkConfigurationManager_Adaptor (qtdecl_QNetworkConfigurationManager (), "QNetworkConfigurationManager",
...
static gsi::Enum<QNetworkConfigurationManager::Capability> decl_QNetworkConfigurationManager_Capability_Enum ("QNetworkConfigurationManager_Capability",
...
static gsi::QFlagsClass<QNetworkConfigurationManager::Capability > decl_QNetworkConfigurationManager_Capability_Enums ("QNetworkConfigurationManager_QFlags_Capability",
