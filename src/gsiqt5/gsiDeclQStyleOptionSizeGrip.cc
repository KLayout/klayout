...
gsi::Class<QStyleOptionSizeGrip> decl_QStyleOptionSizeGrip (qtdecl_QStyleOptionComplex (), "QStyleOptionSizeGrip",
  methods_QStyleOptionSizeGrip (),
  "@qt\n@brief Binding of QStyleOptionSizeGrip");


GSIQT_PUBLIC gsi::Class<QStyleOptionSizeGrip> &qtdecl_QStyleOptionSizeGrip () { return decl_QStyleOptionSizeGrip; }
