...
gsi::Class<QFocusEvent> decl_QFocusEvent (qtdecl_QEvent (), "QFocusEvent_Native",
  methods_QFocusEvent (),
  "@hide\n@alias QFocusEvent");

GSIQT_PUBLIC gsi::Class<QFocusEvent> &qtdecl_QFocusEvent () { return decl_QFocusEvent; }
...
gsi::Class<QFocusEvent_Adaptor> decl_QFocusEvent_Adaptor (qtdecl_QFocusEvent (), "QFocusEvent",
