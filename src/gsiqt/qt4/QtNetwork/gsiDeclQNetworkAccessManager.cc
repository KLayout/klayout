...
static void _call_cbs_createRequest_7733_1 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QNetworkAccessManager::Operation>::target_type & arg1 = gsi::arg_reader<const qt_gsi::Converter<QNetworkAccessManager::Operation>::target_type & >() (args, heap);
  const QNetworkRequest &arg2 = gsi::arg_reader<const QNetworkRequest & >() (args, heap);
