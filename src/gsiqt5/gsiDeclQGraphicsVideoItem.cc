...
qt_gsi::QtNativeClass<QGraphicsVideoItem> decl_QGraphicsVideoItem (qtdecl_QGraphicsObject (), "QGraphicsVideoItem_Native",
  methods_QGraphicsVideoItem (),
  "@hide\n@alias QGraphicsVideoItem");

GSIQT_PUBLIC gsi::Class<QGraphicsVideoItem> &qtdecl_QGraphicsVideoItem () { return decl_QGraphicsVideoItem; }
...
gsi::Class<QGraphicsVideoItem_Adaptor> decl_QGraphicsVideoItem_Adaptor (qtdecl_QGraphicsVideoItem (), "QGraphicsVideoItem",
