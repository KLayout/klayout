...
public:
  ...
  //  [adaptor impl] bool QGraphicsProxyWidget::isEmpty()
  ...
  virtual bool isEmpty() const
  {
    if (cb_isEmpty_c0_0.can_issue()) {
      return cb_isEmpty_c0_0.issue<QGraphicsProxyWidget_Adaptor, bool>(&QGraphicsProxyWidget_Adaptor::cbs_isEmpty_c0_0);
    } else {
      return QGraphicsProxyWidget::isEmpty();
    }
  }
...
// bool QGraphicsProxyWidget::isEmpty()
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<bool > ((bool)((QGraphicsProxyWidget_Adaptor *)cls)->cbs_isEmpty_c0_0 ());
}

static void _set_callback_cbs_isEmpty_c0_0 (void *cls, const gsi::Callback &cb)
{
  ((QGraphicsProxyWidget_Adaptor *)cls)->cb_isEmpty_c0_0 = cb;
}
