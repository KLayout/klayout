...
gsi::Class<QNetworkCacheMetaData> decl_QNetworkCacheMetaData ("QtMultimedia", "QNetworkCacheMetaData",
  methods_QNetworkCacheMetaData (),
  "@qt\n@brief Binding of QNetworkCacheMetaData");


GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QNetworkCacheMetaData> &qtdecl_QNetworkCacheMetaData () { return decl_QNetworkCacheMetaData; }
