...
static gsi::Methods methods_QGraphicsOpacityEffect () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QGraphicsOpacityEffect::tr(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_tr_3354, &_call_f_tr_3354);
  ...
  methods += new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QGraphicsOpacityEffect::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
...
qt_gsi::QtNativeClass<QGraphicsOpacityEffect> decl_QGraphicsOpacityEffect (qtdecl_QGraphicsEffect (), "QtGui", "QGraphicsOpacityEffect_Native",
  methods_QGraphicsOpacityEffect (),
  "@hide\n@alias QGraphicsOpacityEffect");

GSI_QTGUI_PUBLIC gsi::Class<QGraphicsOpacityEffect> &qtdecl_QGraphicsOpacityEffect () { return decl_QGraphicsOpacityEffect; }
...
static gsi::Methods methods_QGraphicsOpacityEffect_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*disconnectNotify", "@brief Virtual method void QGraphicsOpacityEffect::disconnectNotify(const char *signal)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_disconnectNotify_1731_0, &_call_cbs_disconnectNotify_1731_0);
...
gsi::Class<QGraphicsOpacityEffect_Adaptor> decl_QGraphicsOpacityEffect_Adaptor (qtdecl_QGraphicsOpacityEffect (), "QtGui", "QGraphicsOpacityEffect",
