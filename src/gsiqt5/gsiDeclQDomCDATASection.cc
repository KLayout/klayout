...
gsi::Class<QDomCDATASection> decl_QDomCDATASection (qtdecl_QDomText (), "QDomCDATASection",
  methods_QDomCDATASection (),
  "@qt\n@brief Binding of QDomCDATASection");


GSIQT_PUBLIC gsi::Class<QDomCDATASection> &qtdecl_QDomCDATASection () { return decl_QDomCDATASection; }
