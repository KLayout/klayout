...
gsi::Class<QTableWidgetSelectionRange> decl_QTableWidgetSelectionRange ("QtGui", "QTableWidgetSelectionRange",
  methods_QTableWidgetSelectionRange (),
  "@qt\n@brief Binding of QTableWidgetSelectionRange");


GSI_QTGUI_PUBLIC gsi::Class<QTableWidgetSelectionRange> &qtdecl_QTableWidgetSelectionRange () { return decl_QTableWidgetSelectionRange; }
