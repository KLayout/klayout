...
gsi::Class<QStyleOptionFrame> decl_QStyleOptionFrame (qtdecl_QStyleOption (), "QtGui", "QStyleOptionFrame",
  methods_QStyleOptionFrame (),
  "@qt\n@brief Binding of QStyleOptionFrame");


GSI_QTGUI_PUBLIC gsi::Class<QStyleOptionFrame> &qtdecl_QStyleOptionFrame () { return decl_QStyleOptionFrame; }
