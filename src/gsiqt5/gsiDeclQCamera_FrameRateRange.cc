...
gsi::Class<QCamera::FrameRateRange> decl_QCamera_FrameRateRange ("QCamera_FrameRateRange",
...
GSIQT_PUBLIC gsi::Class<QCamera::FrameRateRange> &qtdecl_QCamera_FrameRateRange () { return decl_QCamera_FrameRateRange; }
