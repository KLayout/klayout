...
GSIQT_PUBLIC gsi::Class<QXmlDeclHandler> &qtdecl_QXmlDeclHandler () { return decl_QXmlDeclHandler; }
...
gsi::Class<QXmlDeclHandler_Adaptor> decl_QXmlDeclHandler_Adaptor (qtdecl_QXmlDeclHandler (), "QXmlDeclHandler",
