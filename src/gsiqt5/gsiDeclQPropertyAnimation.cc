...
qt_gsi::QtNativeClass<QPropertyAnimation> decl_QPropertyAnimation (qtdecl_QVariantAnimation (), "QPropertyAnimation_Native",
  methods_QPropertyAnimation (),
  "@hide\n@alias QPropertyAnimation");

GSIQT_PUBLIC gsi::Class<QPropertyAnimation> &qtdecl_QPropertyAnimation () { return decl_QPropertyAnimation; }
...
gsi::Class<QPropertyAnimation_Adaptor> decl_QPropertyAnimation_Adaptor (qtdecl_QPropertyAnimation (), "QPropertyAnimation",
