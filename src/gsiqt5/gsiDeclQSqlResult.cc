...
GSIQT_PUBLIC gsi::Class<QSqlResult> &qtdecl_QSqlResult () { return decl_QSqlResult; }
...
static gsi::Methods methods_QSqlResult_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*detachFromResultSet", "@hide", false, &_init_cbs_detachFromResultSet_0_0, &_call_cbs_detachFromResultSet_0_0);
  methods += new qt_gsi::GenericMethod ("*detachFromResultSet", "@brief Virtual method void QSqlResult::detachFromResultSet()\nThis method can be reimplemented in a derived class.", false, &_init_cbs_detachFromResultSet_0_0, &_call_cbs_detachFromResultSet_0_0, &_set_callback_cbs_detachFromResultSet_0_0);
  ...
  methods += new qt_gsi::GenericMethod ("*execBatch", "@hide", false, &_init_cbs_execBatch_864_1, &_call_cbs_execBatch_864_1);
  methods += new qt_gsi::GenericMethod ("*execBatch", "@brief Virtual method bool QSqlResult::execBatch(bool arrayBind)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_execBatch_864_1, &_call_cbs_execBatch_864_1, &_set_callback_cbs_execBatch_864_1);
  ...
  methods += new qt_gsi::GenericMethod ("*nextResult", "@hide", false, &_init_cbs_nextResult_0_0, &_call_cbs_nextResult_0_0);
  methods += new qt_gsi::GenericMethod ("*nextResult", "@brief Virtual method bool QSqlResult::nextResult()\nThis method can be reimplemented in a derived class.", false, &_init_cbs_nextResult_0_0, &_call_cbs_nextResult_0_0, &_set_callback_cbs_nextResult_0_0);
  ...
  methods += new qt_gsi::GenericMethod ("*setNumericalPrecisionPolicy", "@brief Virtual method void QSqlResult::setNumericalPrecisionPolicy(QSql::NumericalPrecisionPolicy policy)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_setNumericalPrecisionPolicy_3429_0, &_call_cbs_setNumericalPrecisionPolicy_3429_0, &_set_callback_cbs_setNumericalPrecisionPolicy_3429_0);
...
gsi::Class<QSqlResult_Adaptor> decl_QSqlResult_Adaptor (qtdecl_QSqlResult (), "QSqlResult",
