...
gsi::Class<QCameraFocusZone> decl_QCameraFocusZone ("QCameraFocusZone",
  methods_QCameraFocusZone (),
  "@qt\n@brief Binding of QCameraFocusZone");


GSIQT_PUBLIC gsi::Class<QCameraFocusZone> &qtdecl_QCameraFocusZone () { return decl_QCameraFocusZone; }
...
static gsi::Enum<QCameraFocusZone::FocusZoneStatus> decl_QCameraFocusZone_FocusZoneStatus_Enum ("QCameraFocusZone_FocusZoneStatus",
...
static gsi::QFlagsClass<QCameraFocusZone::FocusZoneStatus > decl_QCameraFocusZone_FocusZoneStatus_Enums ("QCameraFocusZone_QFlags_FocusZoneStatus",
