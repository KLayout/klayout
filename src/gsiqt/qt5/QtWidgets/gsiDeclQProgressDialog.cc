...
public:
  ...
  //  [adaptor impl] void QProgressDialog::enterEvent(QEvent *event)
  ...
  virtual void enterEvent(QEvent *event)
  {
    if (cb_enterEvent_1217_0.can_issue()) {
      cb_enterEvent_1217_0.issue<QProgressDialog_Adaptor, QEvent *>(&QProgressDialog_Adaptor::cbs_enterEvent_1217_0, event);
    } else {
      QProgressDialog::enterEvent(event);
    }
  }
...
// void QProgressDialog::enterEvent(QEvent *event)
...
static gsi::Methods methods_QProgressDialog_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*create|qt_create", "@brief Method void QProgressDialog::create(WId, bool initializeWindow, bool destroyOldWindow)\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_create_2208, &_call_fp_create_2208);
  ...
  methods += new qt_gsi::GenericMethod ("*destroy|qt_destroy", "@brief Method void QProgressDialog::destroy(bool destroyWindow, bool destroySubWindows)\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_destroy_1620, &_call_fp_destroy_1620);
