...
qt_gsi::QtNativeClass<QWidgetAction> decl_QWidgetAction (qtdecl_QAction (), "QWidgetAction_Native",
  methods_QWidgetAction (),
  "@hide\n@alias QWidgetAction");

GSIQT_PUBLIC gsi::Class<QWidgetAction> &qtdecl_QWidgetAction () { return decl_QWidgetAction; }
...
gsi::Class<QWidgetAction_Adaptor> decl_QWidgetAction_Adaptor (qtdecl_QWidgetAction (), "QWidgetAction",
