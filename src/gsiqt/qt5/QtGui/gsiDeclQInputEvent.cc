...
// void QInputEvent::setTimestamp(unsigned long int atimestamp)


static void _init_f_setTimestamp_2348 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("atimestamp");
  decl->add_arg<unsigned long int > (argspec_0);
  decl->set_return<void > ();
}

static void _call_f_setTimestamp_2348 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
...
// unsigned long int QInputEvent::timestamp()
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<unsigned long int > ((unsigned long int)((QInputEvent *)cls)->timestamp ());
}
...
static gsi::Methods methods_QInputEvent () {
  ...
  methods += new qt_gsi::GenericMethod ("setTimestamp|timestamp=", "@brief Method void QInputEvent::setTimestamp(unsigned long int atimestamp)\n", false, &_init_f_setTimestamp_2348, &_call_f_setTimestamp_2348);
  methods += new qt_gsi::GenericMethod (":timestamp", "@brief Method unsigned long int QInputEvent::timestamp()\n", true, &_init_f_timestamp_c0, &_call_f_timestamp_c0);
  return methods;
}
