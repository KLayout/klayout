...
qt_gsi::QtNativeClass<QPinchGesture> decl_QPinchGesture (qtdecl_QGesture (), "QPinchGesture_Native",
  methods_QPinchGesture (),
  "@hide\n@alias QPinchGesture");

GSIQT_PUBLIC gsi::Class<QPinchGesture> &qtdecl_QPinchGesture () { return decl_QPinchGesture; }
...
gsi::Class<QPinchGesture_Adaptor> decl_QPinchGesture_Adaptor (qtdecl_QPinchGesture (), "QPinchGesture",
...
static gsi::Enum<QPinchGesture::ChangeFlag> decl_QPinchGesture_ChangeFlag_Enum ("QPinchGesture_ChangeFlag",
...
static gsi::QFlagsClass<QPinchGesture::ChangeFlag > decl_QPinchGesture_ChangeFlag_Enums ("QPinchGesture_QFlags_ChangeFlag",
