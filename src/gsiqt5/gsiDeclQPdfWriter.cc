...
qt_gsi::QtNativeClass<QPdfWriter> decl_QPdfWriter (qtdecl_QObject (), "QPdfWriter_Native",
  methods_QPdfWriter (),
  "@hide\n@alias QPdfWriter");

GSIQT_PUBLIC gsi::Class<QPdfWriter> &qtdecl_QPdfWriter () { return decl_QPdfWriter; }
...
gsi::Class<QPdfWriter_Adaptor> decl_QPdfWriter_Adaptor (qtdecl_QPdfWriter (), "QPdfWriter",
