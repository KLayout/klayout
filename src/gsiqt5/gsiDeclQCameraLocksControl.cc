...
qt_gsi::QtNativeClass<QCameraLocksControl> decl_QCameraLocksControl (qtdecl_QMediaControl (), "QCameraLocksControl_Native",
  methods_QCameraLocksControl (),
  "@hide\n@alias QCameraLocksControl");

GSIQT_PUBLIC gsi::Class<QCameraLocksControl> &qtdecl_QCameraLocksControl () { return decl_QCameraLocksControl; }
...
static gsi::Methods methods_QCameraLocksControl_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("lockStatus", "@hide", true, &_init_cbs_lockStatus_c2029_0, &_call_cbs_lockStatus_c2029_0);
  methods += new qt_gsi::GenericMethod ("lockStatus", "@brief Virtual method QCamera::LockStatus QCameraLocksControl::lockStatus(QCamera::LockType lock)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_lockStatus_c2029_0, &_call_cbs_lockStatus_c2029_0, &_set_callback_cbs_lockStatus_c2029_0);
  ...
  methods += new qt_gsi::GenericMethod ("searchAndLock", "@hide", false, &_init_cbs_searchAndLock_2725_0, &_call_cbs_searchAndLock_2725_0);
  methods += new qt_gsi::GenericMethod ("searchAndLock", "@brief Virtual method void QCameraLocksControl::searchAndLock(QFlags<QCamera::LockType> locks)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_searchAndLock_2725_0, &_call_cbs_searchAndLock_2725_0, &_set_callback_cbs_searchAndLock_2725_0);
  ...
  methods += new qt_gsi::GenericMethod ("supportedLocks", "@hide", true, &_init_cbs_supportedLocks_c0_0, &_call_cbs_supportedLocks_c0_0);
  methods += new qt_gsi::GenericMethod ("supportedLocks", "@brief Virtual method QFlags<QCamera::LockType> QCameraLocksControl::supportedLocks()\nThis method can be reimplemented in a derived class.", true, &_init_cbs_supportedLocks_c0_0, &_call_cbs_supportedLocks_c0_0, &_set_callback_cbs_supportedLocks_c0_0);
  ...
  methods += new qt_gsi::GenericMethod ("unlock", "@hide", false, &_init_cbs_unlock_2725_0, &_call_cbs_unlock_2725_0);
  methods += new qt_gsi::GenericMethod ("unlock", "@brief Virtual method void QCameraLocksControl::unlock(QFlags<QCamera::LockType> locks)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_unlock_2725_0, &_call_cbs_unlock_2725_0, &_set_callback_cbs_unlock_2725_0);
  return methods;
}

gsi::Class<QCameraLocksControl_Adaptor> decl_QCameraLocksControl_Adaptor (qtdecl_QCameraLocksControl (), "QCameraLocksControl",
