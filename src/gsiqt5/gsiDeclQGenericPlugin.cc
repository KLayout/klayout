...
qt_gsi::QtNativeClass<QGenericPlugin> decl_QGenericPlugin (qtdecl_QObject (), "QGenericPlugin_Native",
  methods_QGenericPlugin (),
  "@hide\n@alias QGenericPlugin");

GSIQT_PUBLIC gsi::Class<QGenericPlugin> &qtdecl_QGenericPlugin () { return decl_QGenericPlugin; }
...
gsi::Class<QGenericPlugin_Adaptor> decl_QGenericPlugin_Adaptor (qtdecl_QGenericPlugin (), "QGenericPlugin",
