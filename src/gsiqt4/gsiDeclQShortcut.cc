...
qt_gsi::QtNativeClass<QShortcut> decl_QShortcut (qtdecl_QObject (), "QShortcut_Native",
  methods_QShortcut (),
  "@hide\n@alias QShortcut");

GSIQT_PUBLIC gsi::Class<QShortcut> &qtdecl_QShortcut () { return decl_QShortcut; }
...
gsi::Class<QShortcut_Adaptor> decl_QShortcut_Adaptor (qtdecl_QShortcut (), "QShortcut",
