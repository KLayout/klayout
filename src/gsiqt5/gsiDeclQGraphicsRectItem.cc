...
gsi::Class<QGraphicsRectItem> decl_QGraphicsRectItem (qtdecl_QAbstractGraphicsShapeItem (), "QGraphicsRectItem_Native",
  methods_QGraphicsRectItem (),
  "@hide\n@alias QGraphicsRectItem");

GSIQT_PUBLIC gsi::Class<QGraphicsRectItem> &qtdecl_QGraphicsRectItem () { return decl_QGraphicsRectItem; }
...
gsi::Class<QGraphicsRectItem_Adaptor> decl_QGraphicsRectItem_Adaptor (qtdecl_QGraphicsRectItem (), "QGraphicsRectItem",
