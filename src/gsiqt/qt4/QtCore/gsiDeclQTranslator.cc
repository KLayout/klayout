...
static gsi::Methods methods_QTranslator_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("translate", "@brief Virtual method QString QTranslator::translate(const char *context, const char *sourceText, const char *disambiguation)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_translate_c4977_1, &_call_cbs_translate_c4977_1);
  methods += new qt_gsi::GenericMethod ("translate", "@hide", true, &_init_cbs_translate_c4977_1, &_call_cbs_translate_c4977_1, &_set_callback_cbs_translate_c4977_1);
  return methods;
}
