...
gsi::Class<QStyleOptionGroupBox> decl_QStyleOptionGroupBox (qtdecl_QStyleOptionComplex (), "QtGui", "QStyleOptionGroupBox",
  methods_QStyleOptionGroupBox (),
  "@qt\n@brief Binding of QStyleOptionGroupBox");


GSI_QTGUI_PUBLIC gsi::Class<QStyleOptionGroupBox> &qtdecl_QStyleOptionGroupBox () { return decl_QStyleOptionGroupBox; }
