...
qt_gsi::QtNativeClass<QGraphicsSvgItem> decl_QGraphicsSvgItem (qtdecl_QGraphicsObject (), "QGraphicsSvgItem_Native",
  methods_QGraphicsSvgItem (),
  "@hide\n@alias QGraphicsSvgItem");

GSIQT_PUBLIC gsi::Class<QGraphicsSvgItem> &qtdecl_QGraphicsSvgItem () { return decl_QGraphicsSvgItem; }
...
gsi::Class<QGraphicsSvgItem_Adaptor> decl_QGraphicsSvgItem_Adaptor (qtdecl_QGraphicsSvgItem (), "QGraphicsSvgItem",
