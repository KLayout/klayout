...
qt_gsi::QtNativeClass<QDnsLookup> decl_QDnsLookup (qtdecl_QObject (), "QtMultimedia", "QDnsLookup_Native",
  methods_QDnsLookup (),
  "@hide\n@alias QDnsLookup");

GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QDnsLookup> &qtdecl_QDnsLookup () { return decl_QDnsLookup; }
...
gsi::Class<QDnsLookup_Adaptor> decl_QDnsLookup_Adaptor (qtdecl_QDnsLookup (), "QtMultimedia", "QDnsLookup",
...
static gsi::Enum<QDnsLookup::Error> decl_QDnsLookup_Error_Enum ("QtMultimedia", "QDnsLookup_Error",
...
static gsi::QFlagsClass<QDnsLookup::Error > decl_QDnsLookup_Error_Enums ("QtMultimedia", "QDnsLookup_QFlags_Error",
...
static gsi::Enum<QDnsLookup::Type> decl_QDnsLookup_Type_Enum ("QtMultimedia", "QDnsLookup_Type",
...
static gsi::QFlagsClass<QDnsLookup::Type > decl_QDnsLookup_Type_Enums ("QtMultimedia", "QDnsLookup_QFlags_Type",
