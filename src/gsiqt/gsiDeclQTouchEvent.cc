...
static gsi::Enum<QTouchEvent::DeviceType> decl_QTouchEvent_DeviceType_Enum ("QTouchEvent_DeviceType",
...
static gsi::QFlagsClass<QTouchEvent::DeviceType > decl_QTouchEvent_DeviceType_Enums ("QTouchEvent_QFlags_DeviceType",
