...
GSIQT_PUBLIC gsi::Class<QXmlInputSource> &qtdecl_QXmlInputSource () { return decl_QXmlInputSource; }
...
gsi::Class<QXmlInputSource_Adaptor> decl_QXmlInputSource_Adaptor (qtdecl_QXmlInputSource (), "QXmlInputSource",
