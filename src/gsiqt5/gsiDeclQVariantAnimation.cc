...
qt_gsi::QtNativeClass<QVariantAnimation> decl_QVariantAnimation (qtdecl_QAbstractAnimation (), "QVariantAnimation_Native",
  methods_QVariantAnimation (),
  "@hide\n@alias QVariantAnimation");

GSIQT_PUBLIC gsi::Class<QVariantAnimation> &qtdecl_QVariantAnimation () { return decl_QVariantAnimation; }
...
gsi::Class<QVariantAnimation_Adaptor> decl_QVariantAnimation_Adaptor (qtdecl_QVariantAnimation (), "QVariantAnimation",
