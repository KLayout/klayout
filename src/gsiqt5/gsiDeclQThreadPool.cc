...
qt_gsi::QtNativeClass<QThreadPool> decl_QThreadPool (qtdecl_QObject (), "QThreadPool_Native",
  methods_QThreadPool (),
  "@hide\n@alias QThreadPool");

GSIQT_PUBLIC gsi::Class<QThreadPool> &qtdecl_QThreadPool () { return decl_QThreadPool; }
...
gsi::Class<QThreadPool_Adaptor> decl_QThreadPool_Adaptor (qtdecl_QThreadPool (), "QThreadPool",
