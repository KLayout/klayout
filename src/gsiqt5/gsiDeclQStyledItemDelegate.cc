...
qt_gsi::QtNativeClass<QStyledItemDelegate> decl_QStyledItemDelegate (qtdecl_QAbstractItemDelegate (), "QStyledItemDelegate_Native",
  methods_QStyledItemDelegate (),
  "@hide\n@alias QStyledItemDelegate");

GSIQT_PUBLIC gsi::Class<QStyledItemDelegate> &qtdecl_QStyledItemDelegate () { return decl_QStyledItemDelegate; }
...
gsi::Class<QStyledItemDelegate_Adaptor> decl_QStyledItemDelegate_Adaptor (qtdecl_QStyledItemDelegate (), "QStyledItemDelegate",
