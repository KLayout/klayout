...
static void _call_f_setMode_1850 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QLCDNumber::Mode>::target_type & arg1 = args.read<const qt_gsi::Converter<QLCDNumber::Mode>::target_type & > (heap);
  __SUPPRESS_UNUSED_WARNING(ret);
...
static void _call_f_setSegmentStyle_2713 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QLCDNumber::SegmentStyle>::target_type & arg1 = args.read<const qt_gsi::Converter<QLCDNumber::SegmentStyle>::target_type & > (heap);
  __SUPPRESS_UNUSED_WARNING(ret);
...
qt_gsi::QtNativeClass<QLCDNumber> decl_QLCDNumber (qtdecl_QFrame (), "QLCDNumber_Native",
  methods_QLCDNumber (),
  "@hide\n@alias QLCDNumber");

GSIQT_PUBLIC gsi::Class<QLCDNumber> &qtdecl_QLCDNumber () { return decl_QLCDNumber; }
...
public:
  ...
  //  [expose] void QLCDNumber::initStyleOption(QStyleOptionFrame *option)
  void fp_QLCDNumber_initStyleOption_c2356 (QStyleOptionFrame *option) const {
  ...
  //  [adaptor impl] bool QLCDNumber::nativeEvent(const QByteArray &eventType, void *message, long int *result)
  ...
  virtual bool nativeEvent(const QByteArray &eventType, void *message, long int *result)
  {
    if (cb_nativeEvent_4678_0.can_issue()) {
      return cb_nativeEvent_4678_0.issue<QLCDNumber_Adaptor, bool, const QByteArray &, void *, long int *>(&QLCDNumber_Adaptor::cbs_nativeEvent_4678_0, eventType, message, result);
    } else {
      return QLCDNumber::nativeEvent(eventType, message, result);
    }
  }
...
// exposed void QLCDNumber::initStyleOption(QStyleOptionFrame *option)
...
static void _call_fp_initStyleOption_c2356 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QLCDNumber_Adaptor *)cls)->fp_QLCDNumber_initStyleOption_c2356 (arg1);
}
...
// bool QLCDNumber::nativeEvent(const QByteArray &eventType, void *message, long int *result)
...
static void _call_cbs_nativeEvent_4678_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<bool > ((bool)((QLCDNumber_Adaptor *)cls)->cbs_nativeEvent_4678_0 (arg1, arg2, arg3));
}

static void _set_callback_cbs_nativeEvent_4678_0 (void *cls, const gsi::Callback &cb)
{
  ((QLCDNumber_Adaptor *)cls)->cb_nativeEvent_4678_0 = cb;
}
...
gsi::Class<QLCDNumber_Adaptor> decl_QLCDNumber_Adaptor (qtdecl_QLCDNumber (), "QLCDNumber",
...
static gsi::Enum<QLCDNumber::Mode> decl_QLCDNumber_Mode_Enum ("QLCDNumber_Mode",
...
static gsi::QFlagsClass<QLCDNumber::Mode > decl_QLCDNumber_Mode_Enums ("QLCDNumber_QFlags_Mode",
...
static gsi::Enum<QLCDNumber::SegmentStyle> decl_QLCDNumber_SegmentStyle_Enum ("QLCDNumber_SegmentStyle",
...
static gsi::QFlagsClass<QLCDNumber::SegmentStyle > decl_QLCDNumber_SegmentStyle_Enums ("QLCDNumber_QFlags_SegmentStyle",
