...
gsi::Class<QElapsedTimer> decl_QElapsedTimer ("QElapsedTimer",
  methods_QElapsedTimer (),
  "@qt\n@brief Binding of QElapsedTimer");


GSIQT_PUBLIC gsi::Class<QElapsedTimer> &qtdecl_QElapsedTimer () { return decl_QElapsedTimer; }
...
static gsi::Enum<QElapsedTimer::ClockType> decl_QElapsedTimer_ClockType_Enum ("QElapsedTimer_ClockType",
...
static gsi::QFlagsClass<QElapsedTimer::ClockType > decl_QElapsedTimer_ClockType_Enums ("QElapsedTimer_QFlags_ClockType",
