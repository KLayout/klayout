...
qt_gsi::QtNativeClass<QVideoEncoderSettingsControl> decl_QVideoEncoderSettingsControl (qtdecl_QMediaControl (), "QVideoEncoderSettingsControl_Native",
  methods_QVideoEncoderSettingsControl (),
  "@hide\n@alias QVideoEncoderSettingsControl");

GSIQT_PUBLIC gsi::Class<QVideoEncoderSettingsControl> &qtdecl_QVideoEncoderSettingsControl () { return decl_QVideoEncoderSettingsControl; }
...
gsi::Class<QVideoEncoderSettingsControl_Adaptor> decl_QVideoEncoderSettingsControl_Adaptor (qtdecl_QVideoEncoderSettingsControl (), "QVideoEncoderSettingsControl",
