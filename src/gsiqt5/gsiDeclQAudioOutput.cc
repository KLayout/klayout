...
qt_gsi::QtNativeClass<QAudioOutput> decl_QAudioOutput (qtdecl_QObject (), "QAudioOutput_Native",
  methods_QAudioOutput (),
  "@hide\n@alias QAudioOutput");

GSIQT_PUBLIC gsi::Class<QAudioOutput> &qtdecl_QAudioOutput () { return decl_QAudioOutput; }
...
gsi::Class<QAudioOutput_Adaptor> decl_QAudioOutput_Adaptor (qtdecl_QAudioOutput (), "QAudioOutput",
