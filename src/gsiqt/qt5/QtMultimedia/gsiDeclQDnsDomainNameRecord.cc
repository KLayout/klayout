...
gsi::Class<QDnsDomainNameRecord> decl_QDnsDomainNameRecord ("QtMultimedia", "QDnsDomainNameRecord",
  methods_QDnsDomainNameRecord (),
  "@qt\n@brief Binding of QDnsDomainNameRecord");


GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QDnsDomainNameRecord> &qtdecl_QDnsDomainNameRecord () { return decl_QDnsDomainNameRecord; }
