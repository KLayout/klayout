...
//  Constructor QPolygon::QPolygon(const QList<QPoint> &v)


static void _init_ctor_QPolygon_2531 (qt_gsi::GenericStaticMethod *decl)
{
...
static void _call_ctor_QPolygon_2531 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
...
static gsi::Methods methods_QPolygon () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QPolygon::QPolygon(const QList<QPoint> &v)\nThis method creates an object of class QPolygon.", &_init_ctor_QPolygon_2531, &_call_ctor_QPolygon_2531);
