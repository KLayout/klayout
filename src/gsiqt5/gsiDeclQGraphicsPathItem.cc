...
gsi::Class<QGraphicsPathItem> decl_QGraphicsPathItem (qtdecl_QAbstractGraphicsShapeItem (), "QGraphicsPathItem_Native",
  methods_QGraphicsPathItem (),
  "@hide\n@alias QGraphicsPathItem");

GSIQT_PUBLIC gsi::Class<QGraphicsPathItem> &qtdecl_QGraphicsPathItem () { return decl_QGraphicsPathItem; }
...
gsi::Class<QGraphicsPathItem_Adaptor> decl_QGraphicsPathItem_Adaptor (qtdecl_QGraphicsPathItem (), "QGraphicsPathItem",
