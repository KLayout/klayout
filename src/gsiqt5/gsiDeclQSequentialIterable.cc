...
gsi::Class<QSequentialIterable> decl_QSequentialIterable ("QSequentialIterable",
  methods_QSequentialIterable (),
  "@qt\n@brief Binding of QSequentialIterable");


GSIQT_PUBLIC gsi::Class<QSequentialIterable> &qtdecl_QSequentialIterable () { return decl_QSequentialIterable; }
