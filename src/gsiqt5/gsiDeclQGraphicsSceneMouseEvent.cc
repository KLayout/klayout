...
gsi::Class<QGraphicsSceneMouseEvent> decl_QGraphicsSceneMouseEvent (qtdecl_QGraphicsSceneEvent (), "QGraphicsSceneMouseEvent_Native",
  methods_QGraphicsSceneMouseEvent (),
  "@hide\n@alias QGraphicsSceneMouseEvent");

GSIQT_PUBLIC gsi::Class<QGraphicsSceneMouseEvent> &qtdecl_QGraphicsSceneMouseEvent () { return decl_QGraphicsSceneMouseEvent; }
...
gsi::Class<QGraphicsSceneMouseEvent_Adaptor> decl_QGraphicsSceneMouseEvent_Adaptor (qtdecl_QGraphicsSceneMouseEvent (), "QGraphicsSceneMouseEvent",
