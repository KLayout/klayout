...
public:
  ...
  //  [adaptor impl] void QDial::enterEvent(QEvent *event)
  ...
  virtual void enterEvent(QEvent *event)
  {
    if (cb_enterEvent_1217_0.can_issue()) {
      cb_enterEvent_1217_0.issue<QDial_Adaptor, QEvent *>(&QDial_Adaptor::cbs_enterEvent_1217_0, event);
    } else {
      QDial::enterEvent(event);
    }
  }
  ...
  //  [adaptor impl] bool QDial::nativeEvent(const QByteArray &eventType, void *message, long int *result)
  ...
  virtual bool nativeEvent(const QByteArray &eventType, void *message, long int *result)
  {
    if (cb_nativeEvent_4678_0.can_issue()) {
      return cb_nativeEvent_4678_0.issue<QDial_Adaptor, bool, const QByteArray &, void *, long int *>(&QDial_Adaptor::cbs_nativeEvent_4678_0, eventType, message, result);
    } else {
      return QDial::nativeEvent(eventType, message, result);
    }
  }
...
// void QDial::enterEvent(QEvent *event)
...
// bool QDial::nativeEvent(const QByteArray &eventType, void *message, long int *result)
...
static void _call_cbs_nativeEvent_4678_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<bool > ((bool)((QDial_Adaptor *)cls)->cbs_nativeEvent_4678_0 (arg1, arg2, arg3));
}

static void _set_callback_cbs_nativeEvent_4678_0 (void *cls, const gsi::Callback &cb)
{
  ((QDial_Adaptor *)cls)->cb_nativeEvent_4678_0 = cb;
}
...
static gsi::Methods methods_QDial_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*nativeEvent", "@brief Virtual method bool QDial::nativeEvent(const QByteArray &eventType, void *message, long int *result)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_nativeEvent_4678_0, &_call_cbs_nativeEvent_4678_0);
