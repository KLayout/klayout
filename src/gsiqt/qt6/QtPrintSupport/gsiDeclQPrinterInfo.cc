...
// QPrinter::ColorMode QPrinterInfo::defaultColorMode()


static void _init_f_defaultColorMode_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<qt_gsi::Converter<QPrinter::ColorMode>::target_type > ();
}

static void _call_f_defaultColorMode_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<qt_gsi::Converter<QPrinter::ColorMode>::target_type > ((qt_gsi::Converter<QPrinter::ColorMode>::target_type)qt_gsi::CppToQtAdaptor<QPrinter::ColorMode>(((QPrinterInfo *)cls)->defaultColorMode ()));
}
...
// QList<QPrinter::ColorMode> QPrinterInfo::supportedColorModes()


static void _init_f_supportedColorModes_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<QList<QPrinter::ColorMode> > ();
}

static void _call_f_supportedColorModes_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QList<QPrinter::ColorMode> > ((QList<QPrinter::ColorMode>)((QPrinterInfo *)cls)->supportedColorModes ());
}
...
static gsi::Methods methods_QPrinterInfo () {
  ...
  methods += new qt_gsi::GenericMethod ("defaultColorMode", "@brief Method QPrinter::ColorMode QPrinterInfo::defaultColorMode()\n", true, &_init_f_defaultColorMode_c0, &_call_f_defaultColorMode_c0);
  ...
  methods += new qt_gsi::GenericMethod ("supportedColorModes", "@brief Method QList<QPrinter::ColorMode> QPrinterInfo::supportedColorModes()\n", true, &_init_f_supportedColorModes_c0, &_call_f_supportedColorModes_c0);
