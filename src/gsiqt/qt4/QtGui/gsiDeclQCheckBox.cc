...
qt_gsi::QtNativeClass<QCheckBox> decl_QCheckBox (qtdecl_QAbstractButton (), "QtGui", "QCheckBox_Native",
  methods_QCheckBox (),
  "@hide\n@alias QCheckBox");

GSI_QTGUI_PUBLIC gsi::Class<QCheckBox> &qtdecl_QCheckBox () { return decl_QCheckBox; }
...
gsi::Class<QCheckBox_Adaptor> decl_QCheckBox_Adaptor (qtdecl_QCheckBox (), "QtGui", "QCheckBox",
