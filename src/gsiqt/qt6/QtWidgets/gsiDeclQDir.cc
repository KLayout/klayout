...
// std::filesystem::path QDir::filesystemAbsolutePath()


static void _init_f_filesystemAbsolutePath_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<std::filesystem::path > ();
}

static void _call_f_filesystemAbsolutePath_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<std::filesystem::path > ((std::filesystem::path)((QDir *)cls)->filesystemAbsolutePath ());
}


// std::filesystem::path QDir::filesystemCanonicalPath()


static void _init_f_filesystemCanonicalPath_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<std::filesystem::path > ();
}

static void _call_f_filesystemCanonicalPath_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<std::filesystem::path > ((std::filesystem::path)((QDir *)cls)->filesystemCanonicalPath ());
}


// std::filesystem::path QDir::filesystemPath()


static void _init_f_filesystemPath_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<std::filesystem::path > ();
}

static void _call_f_filesystemPath_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<std::filesystem::path > ((std::filesystem::path)((QDir *)cls)->filesystemPath ());
}
...
static gsi::Methods methods_QDir () {
  ...
  methods += new qt_gsi::GenericMethod ("filesystemAbsolutePath", "@brief Method std::filesystem::path QDir::filesystemAbsolutePath()\n", true, &_init_f_filesystemAbsolutePath_c0, &_call_f_filesystemAbsolutePath_c0);
  methods += new qt_gsi::GenericMethod ("filesystemCanonicalPath", "@brief Method std::filesystem::path QDir::filesystemCanonicalPath()\n", true, &_init_f_filesystemCanonicalPath_c0, &_call_f_filesystemCanonicalPath_c0);
  methods += new qt_gsi::GenericMethod ("filesystemPath", "@brief Method std::filesystem::path QDir::filesystemPath()\n", true, &_init_f_filesystemPath_c0, &_call_f_filesystemPath_c0);
...
gsi::Class<QDir> decl_QDir ("Qt", "QDir",
  methods_QDir (),
  "@qt\n@brief Binding of QDir");


GSI_QT_PUBLIC gsi::Class<QDir> &qtdecl_QDir () { return decl_QDir; }
...
static gsi::Enum<QDir::Filter> decl_QDir_Filter_Enum ("Qt", "QDir_Filter",
...
static gsi::QFlagsClass<QDir::Filter > decl_QDir_Filter_Enums ("Qt", "QDir_QFlags_Filter",
...
static gsi::Enum<QDir::SortFlag> decl_QDir_SortFlag_Enum ("Qt", "QDir_SortFlag",
...
static gsi::QFlagsClass<QDir::SortFlag > decl_QDir_SortFlag_Enums ("Qt", "QDir_QFlags_SortFlag",
