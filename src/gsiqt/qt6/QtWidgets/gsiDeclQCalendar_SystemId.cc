...
gsi::Class<QCalendar::SystemId> decl_QCalendar_SystemId ("Qt", "QCalendar_SystemId",
...
GSI_QT_PUBLIC gsi::Class<QCalendar::SystemId> &qtdecl_QCalendar_SystemId () { return decl_QCalendar_SystemId; }
