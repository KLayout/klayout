...
qt_gsi::QtNativeClass<QUndoView> decl_QUndoView (qtdecl_QListView (), "QtGui", "QUndoView_Native",
  methods_QUndoView (),
  "@hide\n@alias QUndoView");

GSI_QTGUI_PUBLIC gsi::Class<QUndoView> &qtdecl_QUndoView () { return decl_QUndoView; }
...
gsi::Class<QUndoView_Adaptor> decl_QUndoView_Adaptor (qtdecl_QUndoView (), "QtGui", "QUndoView",
