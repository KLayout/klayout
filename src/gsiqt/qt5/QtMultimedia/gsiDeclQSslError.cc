...
gsi::Class<QSslError> decl_QSslError ("QtMultimedia", "QSslError",
  methods_QSslError (),
  "@qt\n@brief Binding of QSslError");


GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QSslError> &qtdecl_QSslError () { return decl_QSslError; }
...
static gsi::Enum<QSslError::SslError> decl_QSslError_SslError_Enum ("QtMultimedia", "QSslError_SslError",
...
static gsi::QFlagsClass<QSslError::SslError > decl_QSslError_SslError_Enums ("QtMultimedia", "QSslError_QFlags_SslError",
