...
gsi::Class<QTextImageFormat> decl_QTextImageFormat (qtdecl_QTextCharFormat (), "QTextImageFormat",
  methods_QTextImageFormat (),
  "@qt\n@brief Binding of QTextImageFormat");


GSIQT_PUBLIC gsi::Class<QTextImageFormat> &qtdecl_QTextImageFormat () { return decl_QTextImageFormat; }
