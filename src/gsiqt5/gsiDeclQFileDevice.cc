...
qt_gsi::QtNativeClass<QFileDevice> decl_QFileDevice (qtdecl_QIODevice (), "QFileDevice_Native",
  methods_QFileDevice (),
  "@hide\n@alias QFileDevice");

GSIQT_PUBLIC gsi::Class<QFileDevice> &qtdecl_QFileDevice () { return decl_QFileDevice; }
...
gsi::Class<QFileDevice_Adaptor> decl_QFileDevice_Adaptor (qtdecl_QFileDevice (), "QFileDevice",
...
static gsi::Enum<QFileDevice::FileError> decl_QFileDevice_FileError_Enum ("QFileDevice_FileError",
...
static gsi::QFlagsClass<QFileDevice::FileError > decl_QFileDevice_FileError_Enums ("QFileDevice_QFlags_FileError",
...
static gsi::Enum<QFileDevice::Permission> decl_QFileDevice_Permission_Enum ("QFileDevice_Permission",
...
static gsi::QFlagsClass<QFileDevice::Permission > decl_QFileDevice_Permission_Enums ("QFileDevice_QFlags_Permission",
