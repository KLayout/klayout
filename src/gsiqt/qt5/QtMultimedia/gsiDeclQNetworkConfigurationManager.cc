...
qt_gsi::QtNativeClass<QNetworkConfigurationManager> decl_QNetworkConfigurationManager (qtdecl_QObject (), "QtMultimedia", "QNetworkConfigurationManager_Native",
  methods_QNetworkConfigurationManager (),
  "@hide\n@alias QNetworkConfigurationManager");

GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QNetworkConfigurationManager> &qtdecl_QNetworkConfigurationManager () { return decl_QNetworkConfigurationManager; }
...
gsi::Class<QNetworkConfigurationManager_Adaptor> decl_QNetworkConfigurationManager_Adaptor (qtdecl_QNetworkConfigurationManager (), "QtMultimedia", "QNetworkConfigurationManager",
...
static gsi::Enum<QNetworkConfigurationManager::Capability> decl_QNetworkConfigurationManager_Capability_Enum ("QtMultimedia", "QNetworkConfigurationManager_Capability",
...
static gsi::QFlagsClass<QNetworkConfigurationManager::Capability > decl_QNetworkConfigurationManager_Capability_Enums ("QtMultimedia", "QNetworkConfigurationManager_QFlags_Capability",
