...
qt_gsi::QtNativeClass<QNetworkReply> decl_QNetworkReply (qtdecl_QIODevice (), "QtMultimedia", "QNetworkReply",
  methods_QNetworkReply (),
  "@qt\n@brief Binding of QNetworkReply");


GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QNetworkReply> &qtdecl_QNetworkReply () { return decl_QNetworkReply; }
...
static gsi::Enum<QNetworkReply::NetworkError> decl_QNetworkReply_NetworkError_Enum ("QtMultimedia", "QNetworkReply_NetworkError",
...
static gsi::QFlagsClass<QNetworkReply::NetworkError > decl_QNetworkReply_NetworkError_Enums ("QtMultimedia", "QNetworkReply_QFlags_NetworkError",
