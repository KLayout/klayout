...
qt_gsi::QtNativeClass<QNetworkDiskCache> decl_QNetworkDiskCache (qtdecl_QAbstractNetworkCache (), "QtMultimedia", "QNetworkDiskCache_Native",
  methods_QNetworkDiskCache (),
  "@hide\n@alias QNetworkDiskCache");

GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QNetworkDiskCache> &qtdecl_QNetworkDiskCache () { return decl_QNetworkDiskCache; }
...
gsi::Class<QNetworkDiskCache_Adaptor> decl_QNetworkDiskCache_Adaptor (qtdecl_QNetworkDiskCache (), "QtMultimedia", "QNetworkDiskCache",
