...
qt_gsi::QtNativeClass<QTabWidget> decl_QTabWidget (qtdecl_QWidget (), "QTabWidget_Native",
  methods_QTabWidget (),
  "@hide\n@alias QTabWidget");

GSIQT_PUBLIC gsi::Class<QTabWidget> &qtdecl_QTabWidget () { return decl_QTabWidget; }
...
gsi::Class<QTabWidget_Adaptor> decl_QTabWidget_Adaptor (qtdecl_QTabWidget (), "QTabWidget",
...
static gsi::Enum<QTabWidget::TabPosition> decl_QTabWidget_TabPosition_Enum ("QTabWidget_TabPosition",
...
static gsi::QFlagsClass<QTabWidget::TabPosition > decl_QTabWidget_TabPosition_Enums ("QTabWidget_QFlags_TabPosition",
...
static gsi::Enum<QTabWidget::TabShape> decl_QTabWidget_TabShape_Enum ("QTabWidget_TabShape",
...
static gsi::QFlagsClass<QTabWidget::TabShape > decl_QTabWidget_TabShape_Enums ("QTabWidget_QFlags_TabShape",
