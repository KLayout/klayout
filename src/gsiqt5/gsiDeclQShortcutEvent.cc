...
gsi::Class<QShortcutEvent> decl_QShortcutEvent (qtdecl_QEvent (), "QShortcutEvent_Native",
  methods_QShortcutEvent (),
  "@hide\n@alias QShortcutEvent");

GSIQT_PUBLIC gsi::Class<QShortcutEvent> &qtdecl_QShortcutEvent () { return decl_QShortcutEvent; }
...
gsi::Class<QShortcutEvent_Adaptor> decl_QShortcutEvent_Adaptor (qtdecl_QShortcutEvent (), "QShortcutEvent",
