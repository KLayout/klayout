...
qt_gsi::QtNativeClass<QCoreApplication> decl_QCoreApplication (qtdecl_QObject (), "Qt", "QCoreApplication_Native",
  methods_QCoreApplication (),
  "@hide\n@alias QCoreApplication");

GSI_QT_PUBLIC gsi::Class<QCoreApplication> &qtdecl_QCoreApplication () { return decl_QCoreApplication; }
...
gsi::Class<QCoreApplication_Adaptor> decl_QCoreApplication_Adaptor (qtdecl_QCoreApplication (), "Qt", "QCoreApplication",
