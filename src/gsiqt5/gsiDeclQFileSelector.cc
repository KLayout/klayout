...
qt_gsi::QtNativeClass<QFileSelector> decl_QFileSelector (qtdecl_QObject (), "QFileSelector_Native",
  methods_QFileSelector (),
  "@hide\n@alias QFileSelector");

GSIQT_PUBLIC gsi::Class<QFileSelector> &qtdecl_QFileSelector () { return decl_QFileSelector; }
...
gsi::Class<QFileSelector_Adaptor> decl_QFileSelector_Adaptor (qtdecl_QFileSelector (), "QFileSelector",
