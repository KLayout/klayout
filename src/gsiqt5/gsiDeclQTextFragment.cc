...
static void _init_f_operator_excl__eq__c2635u1 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("o");
  decl->add_arg<const QTextFragment & > (argspec_0);
  decl->set_return<bool > ();
...
static void _call_f_operator_excl__eq__c2635u1 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QTextFragment &arg1 = args.read<const QTextFragment & > (heap);
...
static void _init_f_operator_eq__eq__c2635u1 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("o");
  decl->add_arg<const QTextFragment & > (argspec_0);
  decl->set_return<bool > ();
...
static void _call_f_operator_eq__eq__c2635u1 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QTextFragment &arg1 = args.read<const QTextFragment & > (heap);
...
static gsi::Methods methods_QTextFragment () {
  ...
  methods += new qt_gsi::GenericMethod ("==", "@brief Method bool QTextFragment::operator==(const QTextFragment &o)\n", true, &_init_f_operator_eq__eq__c2635u1, &_call_f_operator_eq__eq__c2635u1);
