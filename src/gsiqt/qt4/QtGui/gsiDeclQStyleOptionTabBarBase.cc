...
gsi::Class<QStyleOptionTabBarBase> decl_QStyleOptionTabBarBase (qtdecl_QStyleOption (), "QtGui", "QStyleOptionTabBarBase",
  methods_QStyleOptionTabBarBase (),
  "@qt\n@brief Binding of QStyleOptionTabBarBase");


GSI_QTGUI_PUBLIC gsi::Class<QStyleOptionTabBarBase> &qtdecl_QStyleOptionTabBarBase () { return decl_QStyleOptionTabBarBase; }
