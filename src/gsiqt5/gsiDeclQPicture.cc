...
static void _call_f_swap_1431 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QPicture &arg1 = args.read<QPicture & > (heap);
  __SUPPRESS_UNUSED_WARNING(ret);
...
gsi::Class<QPicture> decl_QPicture (qtdecl_QPaintDevice (), "QPicture_Native",
  methods_QPicture (),
  "@hide\n@alias QPicture");

GSIQT_PUBLIC gsi::Class<QPicture> &qtdecl_QPicture () { return decl_QPicture; }
...
gsi::Class<QPicture_Adaptor> decl_QPicture_Adaptor (qtdecl_QPicture (), "QPicture",
