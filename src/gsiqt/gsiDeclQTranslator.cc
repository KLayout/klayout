...
static gsi::Methods methods_QTranslator () {
  ...
  methods += new qt_gsi::GenericMethod ("load", "@brief Method bool QTranslator::load(const unsigned char *data, int len)\n", false, &_init_f_load_3395, &_call_f_load_3395);
  methods += new qt_gsi::GenericMethod ("translate", "@brief Method QString QTranslator::translate(const char *context, const char *sourceText, const char *disambiguation)\n", true, &_init_f_translate_c4977, &_call_f_translate_c4977);
  ...
  methods += new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QTranslator::tr(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_tr_3354, &_call_f_tr_3354);
  ...
  methods += new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QTranslator::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
...
gsi::Class<QTranslator> decl_QTranslator (qtdecl_QObject (), "QTranslator_Native",
  methods_QTranslator (),
  "@hide\n@alias QTranslator");
...
static gsi::Methods methods_QTranslator_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*disconnectNotify", "@brief Virtual method void QTranslator::disconnectNotify(const char *signal)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_disconnectNotify_1731_0, &_call_cbs_disconnectNotify_1731_0, &_set_callback_cbs_disconnectNotify_1731_0);
  ...
  methods += new qt_gsi::GenericMethod ("translate", "@hide", true, &_init_cbs_translate_c4977_1, &_call_cbs_translate_c4977_1);
  methods += new qt_gsi::GenericMethod ("translate", "@brief Virtual method QString QTranslator::translate(const char *context, const char *sourceText, const char *disambiguation)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_translate_c4977_1, &_call_cbs_translate_c4977_1, &_set_callback_cbs_translate_c4977_1);
  return methods;
}
