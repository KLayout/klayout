...
qt_gsi::QtNativeClass<QAbstractNetworkCache> decl_QAbstractNetworkCache (qtdecl_QObject (), "QtMultimedia", "QAbstractNetworkCache_Native",
  methods_QAbstractNetworkCache (),
  "@hide\n@alias QAbstractNetworkCache");

GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QAbstractNetworkCache> &qtdecl_QAbstractNetworkCache () { return decl_QAbstractNetworkCache; }
...
gsi::Class<QAbstractNetworkCache_Adaptor> decl_QAbstractNetworkCache_Adaptor (qtdecl_QAbstractNetworkCache (), "QtMultimedia", "QAbstractNetworkCache",
