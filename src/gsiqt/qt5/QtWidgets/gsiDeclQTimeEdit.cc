...
static gsi::Methods methods_QTimeEdit () {
  ...
  methods += gsi::qt_signal<const QTime & > ("timeChanged(const QTime &)", "timeChanged", gsi::arg("time"), "@brief Signal declaration for QTimeEdit::timeChanged(const QTime &time)\nYou can bind a procedure to this signal.");
  methods += gsi::qt_signal<const QTime & > ("userTimeChanged(const QTime &)", "userTimeChanged", gsi::arg("time"), "@brief Signal declaration for QTimeEdit::userTimeChanged(const QTime &time)\nYou can bind a procedure to this signal.");
...
public:
  ...
  //  [emitter impl] void QTimeEdit::timeChanged(const QTime &time)
  void emitter_QTimeEdit_timeChanged_1793(const QTime &time)
  {
    emit QTimeEdit::timeChanged(time);
  }

  //  [emitter impl] void QTimeEdit::userTimeChanged(const QTime &time)
  void emitter_QTimeEdit_userTimeChanged_1793(const QTime &time)
  {
  ...
  //  [adaptor impl] void QTimeEdit::enterEvent(QEvent *event)
  ...
  virtual void enterEvent(QEvent *event)
  {
    if (cb_enterEvent_1217_0.can_issue()) {
      cb_enterEvent_1217_0.issue<QTimeEdit_Adaptor, QEvent *>(&QTimeEdit_Adaptor::cbs_enterEvent_1217_0, event);
    } else {
      QTimeEdit::enterEvent(event);
    }
  }
  ...
  //  [adaptor impl] bool QTimeEdit::nativeEvent(const QByteArray &eventType, void *message, long int *result)
  ...
  virtual bool nativeEvent(const QByteArray &eventType, void *message, long int *result)
  {
    if (cb_nativeEvent_4678_0.can_issue()) {
      return cb_nativeEvent_4678_0.issue<QTimeEdit_Adaptor, bool, const QByteArray &, void *, long int *>(&QTimeEdit_Adaptor::cbs_nativeEvent_4678_0, eventType, message, result);
    } else {
      return QTimeEdit::nativeEvent(eventType, message, result);
    }
  }
...
// void QTimeEdit::enterEvent(QEvent *event)
...
// bool QTimeEdit::nativeEvent(const QByteArray &eventType, void *message, long int *result)
...
static void _call_cbs_nativeEvent_4678_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<bool > ((bool)((QTimeEdit_Adaptor *)cls)->cbs_nativeEvent_4678_0 (arg1, arg2, arg3));
}

static void _set_callback_cbs_nativeEvent_4678_0 (void *cls, const gsi::Callback &cb)
{
  ((QTimeEdit_Adaptor *)cls)->cb_nativeEvent_4678_0 = cb;
}
...
// emitter void QTimeEdit::timeChanged(const QTime &time)
...
// emitter void QTimeEdit::userTimeChanged(const QTime &time)

static void _init_emitter_userTimeChanged_1793 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("time");
  decl->add_arg<const QTime & > (argspec_0);
  decl->set_return<void > ();
...
static void _call_emitter_userTimeChanged_1793 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs & /*ret*/) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QTime &arg1 = gsi::arg_reader<const QTime & >() (args, heap);
  ((QTimeEdit_Adaptor *)cls)->emitter_QTimeEdit_userTimeChanged_1793 (arg1);
}
...
static gsi::Methods methods_QTimeEdit_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*create|qt_create", "@brief Method void QTimeEdit::create(WId, bool initializeWindow, bool destroyOldWindow)\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_create_2208, &_call_fp_create_2208);
  ...
  methods += new qt_gsi::GenericMethod ("*destroy|qt_destroy", "@brief Method void QTimeEdit::destroy(bool destroyWindow, bool destroySubWindows)\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_destroy_1620, &_call_fp_destroy_1620);
  ...
  methods += new qt_gsi::GenericMethod ("*nativeEvent", "@brief Virtual method bool QTimeEdit::nativeEvent(const QByteArray &eventType, void *message, long int *result)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_nativeEvent_4678_0, &_call_cbs_nativeEvent_4678_0);
  ...
  methods += new qt_gsi::GenericMethod ("emit_timeChanged", "@brief Emitter for signal void QTimeEdit::timeChanged(const QTime &time)\nCall this method to emit this signal.", false, &_init_emitter_timeChanged_1793, &_call_emitter_timeChanged_1793);
  ...
  methods += new qt_gsi::GenericMethod ("emit_userTimeChanged", "@brief Emitter for signal void QTimeEdit::userTimeChanged(const QTime &time)\nCall this method to emit this signal.", false, &_init_emitter_userTimeChanged_1793, &_call_emitter_userTimeChanged_1793);
