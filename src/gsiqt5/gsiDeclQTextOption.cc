...
static gsi::Enum<QTextOption::TabType> decl_QTextOption_TabType_Enum ("QTextOption_TabType",
...
static gsi::QFlagsClass<QTextOption::TabType > decl_QTextOption_TabType_Enums ("QTextOption_QFlags_TabType",
