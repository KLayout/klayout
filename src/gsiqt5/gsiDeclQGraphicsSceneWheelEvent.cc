...
gsi::Class<QGraphicsSceneWheelEvent> decl_QGraphicsSceneWheelEvent (qtdecl_QGraphicsSceneEvent (), "QGraphicsSceneWheelEvent_Native",
  methods_QGraphicsSceneWheelEvent (),
  "@hide\n@alias QGraphicsSceneWheelEvent");

GSIQT_PUBLIC gsi::Class<QGraphicsSceneWheelEvent> &qtdecl_QGraphicsSceneWheelEvent () { return decl_QGraphicsSceneWheelEvent; }
...
gsi::Class<QGraphicsSceneWheelEvent_Adaptor> decl_QGraphicsSceneWheelEvent_Adaptor (qtdecl_QGraphicsSceneWheelEvent (), "QGraphicsSceneWheelEvent",
