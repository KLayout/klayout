...
static gsi::Methods methods_QItemSelectionRange () {
  ...
  methods += new qt_gsi::GenericMethod ("bottomRight", "@brief Method QModelIndex QItemSelectionRange::bottomRight()\n", true, &_init_f_bottomRight_c0, &_call_f_bottomRight_c0);
  ...
  methods += new qt_gsi::GenericMethod ("intersect", "@brief Method QItemSelectionRange QItemSelectionRange::intersect(const QItemSelectionRange &other)\n", true, &_init_f_intersect_c3220, &_call_f_intersect_c3220);
  ...
  methods += new qt_gsi::GenericMethod ("topLeft", "@brief Method QModelIndex QItemSelectionRange::topLeft()\n", true, &_init_f_topLeft_c0, &_call_f_topLeft_c0);
...
GSIQT_PUBLIC gsi::Class<QItemSelectionRange> &qtdecl_QItemSelectionRange () { return decl_QItemSelectionRange; }
