...
static void _init_f_listen_3470 (qt_gsi::GenericMethod *decl)
{
...
static void _call_f_listen_3470 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
...
qt_gsi::QtNativeClass<QLocalServer> decl_QLocalServer (qtdecl_QObject (), "QtMultimedia", "QLocalServer_Native",
  methods_QLocalServer (),
  "@hide\n@alias QLocalServer");

GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QLocalServer> &qtdecl_QLocalServer () { return decl_QLocalServer; }
...
gsi::Class<QLocalServer_Adaptor> decl_QLocalServer_Adaptor (qtdecl_QLocalServer (), "QtMultimedia", "QLocalServer",
...
static gsi::Enum<QLocalServer::SocketOption> decl_QLocalServer_SocketOption_Enum ("QtMultimedia", "QLocalServer_SocketOption",
...
static gsi::QFlagsClass<QLocalServer::SocketOption > decl_QLocalServer_SocketOption_Enums ("QtMultimedia", "QLocalServer_QFlags_SocketOption",
