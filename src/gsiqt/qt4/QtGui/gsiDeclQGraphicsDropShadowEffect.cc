...
qt_gsi::QtNativeClass<QGraphicsDropShadowEffect> decl_QGraphicsDropShadowEffect (qtdecl_QGraphicsEffect (), "QtGui", "QGraphicsDropShadowEffect_Native",
  methods_QGraphicsDropShadowEffect (),
  "@hide\n@alias QGraphicsDropShadowEffect");

GSI_QTGUI_PUBLIC gsi::Class<QGraphicsDropShadowEffect> &qtdecl_QGraphicsDropShadowEffect () { return decl_QGraphicsDropShadowEffect; }
...
gsi::Class<QGraphicsDropShadowEffect_Adaptor> decl_QGraphicsDropShadowEffect_Adaptor (qtdecl_QGraphicsDropShadowEffect (), "QtGui", "QGraphicsDropShadowEffect",
