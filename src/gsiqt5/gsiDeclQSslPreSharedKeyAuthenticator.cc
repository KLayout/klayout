...
gsi::Class<QSslPreSharedKeyAuthenticator> decl_QSslPreSharedKeyAuthenticator ("QSslPreSharedKeyAuthenticator",
  methods_QSslPreSharedKeyAuthenticator (),
  "@qt\n@brief Binding of QSslPreSharedKeyAuthenticator");


GSIQT_PUBLIC gsi::Class<QSslPreSharedKeyAuthenticator> &qtdecl_QSslPreSharedKeyAuthenticator () { return decl_QSslPreSharedKeyAuthenticator; }
