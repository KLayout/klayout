...
static void _init_f_staticPlugins_0 (qt_gsi::GenericStaticMethod *decl)
{
  decl->set_return<QVector<QStaticPlugin> > ();
}

static void _call_f_staticPlugins_0 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QVector<QStaticPlugin> > ((QVector<QStaticPlugin>)QPluginLoader::staticPlugins ());
}
