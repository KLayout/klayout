...
static gsi::Methods methods_QProcess () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("execute", "@brief Static method int QProcess::execute(const QString &program)\nThis method is static and can be called without an instance.", &_init_f_execute_2025, &_call_f_execute_2025);
  ...
  methods += new qt_gsi::GenericStaticMethod ("startDetached", "@brief Static method bool QProcess::startDetached(const QString &program)\nThis method is static and can be called without an instance.", &_init_f_startDetached_2025, &_call_f_startDetached_2025);
  ...
  methods += new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QProcess::tr(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_tr_3354, &_call_f_tr_3354);
  ...
  methods += new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QProcess::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
...
gsi::Class<QProcess> decl_QProcess (qtdecl_QIODevice (), "QProcess",
  methods_QProcess (),
