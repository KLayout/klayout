...
qt_gsi::QtNativeClass<QTextBrowser> decl_QTextBrowser (qtdecl_QTextEdit (), "QTextBrowser_Native",
  methods_QTextBrowser (),
  "@hide\n@alias QTextBrowser");

GSIQT_PUBLIC gsi::Class<QTextBrowser> &qtdecl_QTextBrowser () { return decl_QTextBrowser; }
...
gsi::Class<QTextBrowser_Adaptor> decl_QTextBrowser_Adaptor (qtdecl_QTextBrowser (), "QTextBrowser",
