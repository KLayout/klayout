...
static void _call_f_putPoints_4115 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  int arg1 = args.read<int > (heap);
  int arg2 = args.read<int > (heap);
  const QPolygon &arg3 = args.read<const QPolygon & > (heap);
...
static void _call_f_swap_1443 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QPolygon &arg1 = args.read<QPolygon & > (heap);
  __SUPPRESS_UNUSED_WARNING(ret);
...
GSIQT_PUBLIC gsi::Class<QPolygon> &qtdecl_QPolygon () { return decl_QPolygon; }
