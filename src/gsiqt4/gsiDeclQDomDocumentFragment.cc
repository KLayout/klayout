...
gsi::Class<QDomDocumentFragment> decl_QDomDocumentFragment (qtdecl_QDomNode (), "QDomDocumentFragment",
  methods_QDomDocumentFragment (),
  "@qt\n@brief Binding of QDomDocumentFragment");


GSIQT_PUBLIC gsi::Class<QDomDocumentFragment> &qtdecl_QDomDocumentFragment () { return decl_QDomDocumentFragment; }
