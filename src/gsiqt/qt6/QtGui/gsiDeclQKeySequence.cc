...
//  Constructor QKeySequence::QKeySequence(QKeyCombination k1, QKeyCombination k2, QKeyCombination k3, QKeyCombination k4)


static void _init_ctor_QKeySequence_7488 (qt_gsi::GenericStaticMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("k1");
  decl->add_arg<QKeyCombination > (argspec_0);
  static gsi::ArgSpecBase argspec_1 ("k2", true, "QKeyCombination::fromCombined(0)");
  decl->add_arg<QKeyCombination > (argspec_1);
  static gsi::ArgSpecBase argspec_2 ("k3", true, "QKeyCombination::fromCombined(0)");
  decl->add_arg<QKeyCombination > (argspec_2);
  static gsi::ArgSpecBase argspec_3 ("k4", true, "QKeyCombination::fromCombined(0)");
  decl->add_arg<QKeyCombination > (argspec_3);
  decl->set_return_new<QKeySequence> ();
}

static void _call_ctor_QKeySequence_7488 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QKeyCombination arg1 = gsi::arg_reader<QKeyCombination >() (args, heap);
  QKeyCombination arg2 = args ? gsi::arg_reader<QKeyCombination >() (args, heap) : gsi::arg_maker<QKeyCombination >() (QKeyCombination::fromCombined(0), heap);
  QKeyCombination arg3 = args ? gsi::arg_reader<QKeyCombination >() (args, heap) : gsi::arg_maker<QKeyCombination >() (QKeyCombination::fromCombined(0), heap);
  QKeyCombination arg4 = args ? gsi::arg_reader<QKeyCombination >() (args, heap) : gsi::arg_maker<QKeyCombination >() (QKeyCombination::fromCombined(0), heap);
  ret.write<QKeySequence *> (new QKeySequence (arg1, arg2, arg3, arg4));
}
...
// QKeyCombination QKeySequence::operator[](unsigned int i)
...
static void _call_f_operator_index__c1772 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<QKeyCombination > ((QKeyCombination)((QKeySequence *)cls)->operator[] (arg1));
}
...
static gsi::Methods methods_QKeySequence () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QKeySequence::QKeySequence(QKeyCombination k1, QKeyCombination k2, QKeyCombination k3, QKeyCombination k4)\nThis method creates an object of class QKeySequence.", &_init_ctor_QKeySequence_7488, &_call_ctor_QKeySequence_7488);
  ...
  methods += new qt_gsi::GenericMethod ("[]", "@brief Method QKeyCombination QKeySequence::operator[](unsigned int i)\n", true, &_init_f_operator_index__c1772, &_call_f_operator_index__c1772);
