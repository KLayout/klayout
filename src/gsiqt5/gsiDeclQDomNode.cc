...
static void _call_f_save_c5033 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  const qt_gsi::Converter<QDomNode::EncodingPolicy>::target_type & arg3 = args ? args.read<const qt_gsi::Converter<QDomNode::EncodingPolicy>::target_type & > (heap) : (const qt_gsi::Converter<QDomNode::EncodingPolicy>::target_type &)(qt_gsi::CppToQtReadAdaptor<QDomNode::EncodingPolicy>(heap, QDomNode::EncodingFromDocument));
  __SUPPRESS_UNUSED_WARNING(ret);
...
GSIQT_PUBLIC gsi::Class<QDomNode> &qtdecl_QDomNode () { return decl_QDomNode; }
...
static gsi::Enum<QDomNode::EncodingPolicy> decl_QDomNode_EncodingPolicy_Enum ("QDomNode_EncodingPolicy",
...
static gsi::QFlagsClass<QDomNode::EncodingPolicy > decl_QDomNode_EncodingPolicy_Enums ("QDomNode_QFlags_EncodingPolicy",
...
static gsi::Enum<QDomNode::NodeType> decl_QDomNode_NodeType_Enum ("QDomNode_NodeType",
...
static gsi::QFlagsClass<QDomNode::NodeType > decl_QDomNode_NodeType_Enums ("QDomNode_QFlags_NodeType",
