...
qt_gsi::QtNativeClass<QState> decl_QState (qtdecl_QAbstractState (), "QState_Native",
  methods_QState (),
  "@hide\n@alias QState");

GSIQT_PUBLIC gsi::Class<QState> &qtdecl_QState () { return decl_QState; }
...
gsi::Class<QState_Adaptor> decl_QState_Adaptor (qtdecl_QState (), "QState",
...
static gsi::Enum<QState::ChildMode> decl_QState_ChildMode_Enum ("QState_ChildMode",
...
static gsi::QFlagsClass<QState::ChildMode > decl_QState_ChildMode_Enums ("QState_QFlags_ChildMode",
...
static gsi::Enum<QState::RestorePolicy> decl_QState_RestorePolicy_Enum ("QState_RestorePolicy",
...
static gsi::QFlagsClass<QState::RestorePolicy > decl_QState_RestorePolicy_Enums ("QState_QFlags_RestorePolicy",
