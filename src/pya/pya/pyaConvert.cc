...
long python2c_func<long>::operator() (PyObject *rval)
{
  ...
  if (PyLong_Check (rval)) {
    ...
    throw tl::TypeError (tl::to_string (tr ("Argument cannot be converted to an integer")));
  }
}
...
char python2c_func<char>::operator() (PyObject *rval)
{
  ...
  if (PyLong_Check (rval)) {
    ...
    throw tl::TypeError (tl::to_string (tr ("Argument cannot be converted to a character")));
  }
}
...
double python2c_func<double>::operator() (PyObject *rval)
{
  ...
  if (PyLong_Check (rval)) {
    ...
    throw tl::TypeError (tl::to_string (tr ("Argument cannot be converted to a floating-point value")));
  }
}
...
std::string python2c_func<std::string>::operator() (PyObject *rval)
{
  ...
  if (PyUnicode_Check (rval)) {
    ...
    throw tl::TypeError (tl::to_string (tr ("Argument cannot be converted to a string")));
  }
}
...
std::vector<char> python2c_func<std::vector<char> >::operator() (PyObject *rval)
{
  ...
  if (PyUnicode_Check (rval)) {
    ...
    throw tl::TypeError (tl::to_string (tr ("Argument cannot be converted to a byte array")));
  }
}
