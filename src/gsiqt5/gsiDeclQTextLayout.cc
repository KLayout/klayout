...
GSIQT_PUBLIC gsi::Class<QTextLayout> &qtdecl_QTextLayout () { return decl_QTextLayout; }
...
static gsi::Enum<QTextLayout::CursorMode> decl_QTextLayout_CursorMode_Enum ("QTextLayout_CursorMode",
...
static gsi::QFlagsClass<QTextLayout::CursorMode > decl_QTextLayout_CursorMode_Enums ("QTextLayout_QFlags_CursorMode",
