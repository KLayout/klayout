...
qt_gsi::QtNativeClass<QSoundEffect> decl_QSoundEffect (qtdecl_QObject (), "QSoundEffect_Native",
  methods_QSoundEffect (),
  "@hide\n@alias QSoundEffect");

GSIQT_PUBLIC gsi::Class<QSoundEffect> &qtdecl_QSoundEffect () { return decl_QSoundEffect; }
...
gsi::Class<QSoundEffect_Adaptor> decl_QSoundEffect_Adaptor (qtdecl_QSoundEffect (), "QSoundEffect",
...
static gsi::Enum<QSoundEffect::Status> decl_QSoundEffect_Status_Enum ("QSoundEffect_Status",
...
static gsi::QFlagsClass<QSoundEffect::Status > decl_QSoundEffect_Status_Enums ("QSoundEffect_QFlags_Status",
