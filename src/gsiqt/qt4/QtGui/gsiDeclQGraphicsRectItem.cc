...
gsi::Class<QGraphicsRectItem> decl_QGraphicsRectItem (qtdecl_QAbstractGraphicsShapeItem (), "QtGui", "QGraphicsRectItem_Native",
  methods_QGraphicsRectItem (),
  "@hide\n@alias QGraphicsRectItem");

GSI_QTGUI_PUBLIC gsi::Class<QGraphicsRectItem> &qtdecl_QGraphicsRectItem () { return decl_QGraphicsRectItem; }
...
static void _call_ctor_QGraphicsRectItem_Adaptor_7677 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  QGraphicsScene *arg6 = args ? args.read<QGraphicsScene * > (heap) : (QGraphicsScene *)(0);
...
static gsi::Methods methods_QGraphicsRectItem_Adaptor () {
  gsi::Methods methods;
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QGraphicsRectItem::QGraphicsRectItem(QGraphicsItem *parent, QGraphicsScene *scene)\nThis method creates an object of class QGraphicsRectItem.", &_init_ctor_QGraphicsRectItem_Adaptor_3825, &_call_ctor_QGraphicsRectItem_Adaptor_3825);
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QGraphicsRectItem::QGraphicsRectItem(const QRectF &rect, QGraphicsItem *parent, QGraphicsScene *scene)\nThis method creates an object of class QGraphicsRectItem.", &_init_ctor_QGraphicsRectItem_Adaptor_5579, &_call_ctor_QGraphicsRectItem_Adaptor_5579);
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QGraphicsRectItem::QGraphicsRectItem(double x, double y, double w, double h, QGraphicsItem *parent, QGraphicsScene *scene)\nThis method creates an object of class QGraphicsRectItem.", &_init_ctor_QGraphicsRectItem_Adaptor_7677, &_call_ctor_QGraphicsRectItem_Adaptor_7677);
...
gsi::Class<QGraphicsRectItem_Adaptor> decl_QGraphicsRectItem_Adaptor (qtdecl_QGraphicsRectItem (), "QtGui", "QGraphicsRectItem",
