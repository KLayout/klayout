...
gsi::Class<QExposeEvent> decl_QExposeEvent (qtdecl_QEvent (), "QExposeEvent_Native",
  methods_QExposeEvent (),
  "@hide\n@alias QExposeEvent");

GSIQT_PUBLIC gsi::Class<QExposeEvent> &qtdecl_QExposeEvent () { return decl_QExposeEvent; }
...
gsi::Class<QExposeEvent_Adaptor> decl_QExposeEvent_Adaptor (qtdecl_QExposeEvent (), "QExposeEvent",
