...
static void _init_f_createPixmap_928 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("size");
  decl->add_arg<QSize > (argspec_0);
  decl->set_return<QPixmap > ();
}

static void _call_f_createPixmap_928 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QSize arg1 = gsi::arg_reader<QSize >() (args, heap);
  ret.write<QPixmap > ((QPixmap)((QPaintEngine *)cls)->createPixmap (arg1));
}


// QPixmap QPaintEngine::createPixmapFromImage(QImage image, QFlags<Qt::ImageConversionFlag> flags)


static void _init_f_createPixmapFromImage_4260 (qt_gsi::GenericMethod *decl)
{
...
static void _call_f_createPixmapFromImage_4260 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  ...
  ret.write<QPixmap > ((QPixmap)((QPaintEngine *)cls)->createPixmapFromImage (arg1, arg2));
}
...
static gsi::Methods methods_QPaintEngine () {
  ...
  methods += new qt_gsi::GenericMethod ("createPixmap", "@brief Method QPixmap QPaintEngine::createPixmap(QSize size)\n", false, &_init_f_createPixmap_928, &_call_f_createPixmap_928);
  methods += new qt_gsi::GenericMethod ("createPixmapFromImage", "@brief Method QPixmap QPaintEngine::createPixmapFromImage(QImage image, QFlags<Qt::ImageConversionFlag> flags)\n", false, &_init_f_createPixmapFromImage_4260, &_call_f_createPixmapFromImage_4260);
...
public:
  ...
  //  [adaptor impl] QPixmap QPaintEngine::createPixmap(QSize size)
  QPixmap cbs_createPixmap_928_0(QSize size)
  {
  ...
  {
    if (cb_createPixmap_928_0.can_issue()) {
      return cb_createPixmap_928_0.issue<QPaintEngine_Adaptor, QPixmap, QSize>(&QPaintEngine_Adaptor::cbs_createPixmap_928_0, size);
    } else {
      return QPaintEngine::createPixmap(size);
    }
  }

  //  [adaptor impl] QPixmap QPaintEngine::createPixmapFromImage(QImage image, QFlags<Qt::ImageConversionFlag> flags)
  QPixmap cbs_createPixmapFromImage_4260_1(QImage image, QFlags<Qt::ImageConversionFlag> flags)
  {
    return QPaintEngine::createPixmapFromImage(image, flags);
  }

  virtual QPixmap createPixmapFromImage(QImage image, QFlags<Qt::ImageConversionFlag> flags)
  {
    if (cb_createPixmapFromImage_4260_1.can_issue()) {
      return cb_createPixmapFromImage_4260_1.issue<QPaintEngine_Adaptor, QPixmap, QImage, QFlags<Qt::ImageConversionFlag> >(&QPaintEngine_Adaptor::cbs_createPixmapFromImage_4260_1, image, flags);
    } else {
      return QPaintEngine::createPixmapFromImage(image, flags);
    }
  }
  ...
  gsi::Callback cb_createPixmap_928_0;
  gsi::Callback cb_createPixmapFromImage_4260_1;
...
static void _init_cbs_createPixmap_928_0 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("size");
  decl->add_arg<QSize > (argspec_0);
  decl->set_return<QPixmap > ();
...
static void _call_cbs_createPixmap_928_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QSize arg1 = args.read<QSize > (heap);
  ret.write<QPixmap > ((QPixmap)((QPaintEngine_Adaptor *)cls)->cbs_createPixmap_928_0 (arg1));
}

static void _set_callback_cbs_createPixmap_928_0 (void *cls, const gsi::Callback &cb)
{
  ((QPaintEngine_Adaptor *)cls)->cb_createPixmap_928_0 = cb;
}


// QPixmap QPaintEngine::createPixmapFromImage(QImage image, QFlags<Qt::ImageConversionFlag> flags)

static void _init_cbs_createPixmapFromImage_4260_1 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("image");
  decl->add_arg<QImage > (argspec_0);
...
static void _call_cbs_createPixmapFromImage_4260_1 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QImage arg1 = args.read<QImage > (heap);
  QFlags<Qt::ImageConversionFlag> arg2 = args.read<QFlags<Qt::ImageConversionFlag> > (heap);
  ret.write<QPixmap > ((QPixmap)((QPaintEngine_Adaptor *)cls)->cbs_createPixmapFromImage_4260_1 (arg1, arg2));
}

static void _set_callback_cbs_createPixmapFromImage_4260_1 (void *cls, const gsi::Callback &cb)
{
  ((QPaintEngine_Adaptor *)cls)->cb_createPixmapFromImage_4260_1 = cb;
}
...
static gsi::Methods methods_QPaintEngine_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("createPixmap", "@brief Virtual method QPixmap QPaintEngine::createPixmap(QSize size)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_createPixmap_928_0, &_call_cbs_createPixmap_928_0);
  methods += new qt_gsi::GenericMethod ("createPixmap", "@hide", false, &_init_cbs_createPixmap_928_0, &_call_cbs_createPixmap_928_0, &_set_callback_cbs_createPixmap_928_0);
  methods += new qt_gsi::GenericMethod ("createPixmapFromImage", "@brief Virtual method QPixmap QPaintEngine::createPixmapFromImage(QImage image, QFlags<Qt::ImageConversionFlag> flags)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_createPixmapFromImage_4260_1, &_call_cbs_createPixmapFromImage_4260_1);
  methods += new qt_gsi::GenericMethod ("createPixmapFromImage", "@hide", false, &_init_cbs_createPixmapFromImage_4260_1, &_call_cbs_createPixmapFromImage_4260_1, &_set_callback_cbs_createPixmapFromImage_4260_1);
