...
{
  db::Region r;
  EXPECT_EQ (db::compare (r, ""), true);
  EXPECT_EQ (r == db::Region (), true);
  EXPECT_EQ (r < db::Region (), false);
  EXPECT_EQ (r != db::Region (), false);
  EXPECT_EQ (db::compare (r.bbox (), "()"), true);
  ...
  EXPECT_EQ (r == r, true);
  EXPECT_EQ (r < r, false);
  EXPECT_EQ (db::compare (r, "(0,0;0,200;100,200;100,0)"), true);
  EXPECT_EQ (db::compare (r.transformed (db::Trans (db::Vector (1, 2))), "(1,2;1,202;101,202;101,2)"), true);
  EXPECT_EQ (db::compare (r.bbox (), "(0,0;100,200)"), true);
  ...
  EXPECT_EQ (db::compare (rr.bbox (), "(0,0;110,200)"), true);
  ...
  db::Region r1 = r;
  db::Region r2;
  EXPECT_EQ (db::compare (r1, "(0,0;0,200;100,200;100,0)"), true);
  EXPECT_EQ (db::compare (r2, ""), true);
  EXPECT_EQ (db::compare (r1.bbox (), "(0,0;100,200)"), true);
  EXPECT_EQ (db::compare (r2.bbox (), "()"), true);
  r1.swap (r2);
  EXPECT_EQ (db::compare (r1, ""), true);
  EXPECT_EQ (db::compare (r2, "(0,0;0,200;100,200;100,0)"), true);
  EXPECT_EQ (db::compare (r1.bbox (), "()"), true);
  EXPECT_EQ (db::compare (r2.bbox (), "(0,0;100,200)"), true);
  ...
  EXPECT_EQ (db::compare ((r + db::Region (db::Box (db::Point (10, 20), db::Point (110, 220)))).merged (), "(0,0;0,200;10,200;10,220;110,220;110,20;100,20;100,0)"), true);
  EXPECT_EQ (db::compare ((r + db::Region (db::Box (db::Point (10, 20), db::Point (110, 220)))).merged (false, 1), "(10,20;10,200;100,200;100,20)"), true);
  EXPECT_EQ (db::compare ((r | db::Region (db::Box (db::Point (10, 20), db::Point (110, 220)))), "(0,0;0,200;10,200;10,220;110,220;110,20;100,20;100,0)"), true);
  ...
  r.merge ();
  EXPECT_EQ (db::compare (r, "(0,0;0,200;10,200;10,220;110,220;110,20;100,20;100,0)"), true);
  EXPECT_EQ (db::compare (r.bbox (), "(0,0;110,220)"), true);
  EXPECT_EQ (r.is_merged (), true);
  EXPECT_EQ (r.is_box (), false);
  EXPECT_EQ (r.empty (), false);
  ...
  EXPECT_EQ (db::compare (r.merged (false), "(0,0;0,50;50,50;50,100;100,100;100,50;50,50;50,0)"), true);
...
TEST(2) 
{
  ...
  EXPECT_EQ (db::compare ((r & db::Region (db::Box (db::Point (10, 20), db::Point (110, 220)))), "(10,20;10,200;100,200;100,20)"), true);

  r &= db::Region (db::Box (db::Point (10, 20), db::Point (110, 220)));
  EXPECT_EQ (r.is_box (), true);
  EXPECT_EQ (r.empty (), false);
  EXPECT_EQ (r.is_merged (), true);
  EXPECT_EQ (db::compare (r, "(10,20;10,200;100,200;100,20)"), true);
...
TEST(3) 
{
  ...
  EXPECT_EQ (db::compare ((r & rr), "(10,20;10,220;110,220;110,20)"), true);
  EXPECT_EQ (db::compare ((rr & r), "(10,20;10,220;110,220;110,20)"), true);
  EXPECT_EQ (db::compare ((r & db::Region ()), ""), true);
  EXPECT_EQ ((r & db::Region ()).empty (), true);
  EXPECT_EQ (db::compare ((db::Region () & r), ""), true);
  EXPECT_EQ ((db::Region () & r).empty (), true);

  EXPECT_EQ (db::compare (r.andnot(rr).first, "(10,20;10,220;110,220;110,20)"), true);
  EXPECT_EQ (db::compare (rr.andnot(r).first, "(10,20;10,220;110,220;110,20)"), true);
  EXPECT_EQ (db::compare (r.andnot(db::Region ()).first, ""), true);
  EXPECT_EQ (r.andnot(db::Region ()).first.empty (), true);
  EXPECT_EQ (db::compare (db::Region ().andnot(r).first, ""), true);
  ...
  EXPECT_EQ (r.empty (), false);
  EXPECT_EQ (r.is_merged (), true);
  EXPECT_EQ (db::compare (r, "(10,20;10,220;110,220;110,20)"), true);
}
...
TEST(4) 
{
  ...
  EXPECT_EQ (db::compare ((r ^ db::Region (db::Box (db::Point (10, 20), db::Point (110, 220)))), "(0,0;0,200;10,200;10,220;110,220;110,20;100,20;100,0/10,20;100,20;100,200;10,200)"), true);
...
TEST(5) 
{
  ...
  EXPECT_EQ (db::compare ((r ^ db::Region (db::Box (db::Point (10, 20), db::Point (110, 220)))), "(-100,-100;-100,400;200,400;200,-100/10,20;110,20;110,220;10,220)"), true);
  ...
  EXPECT_EQ (r.empty (), false);
  EXPECT_EQ (r.is_merged (), true);
  EXPECT_EQ (db::compare (r, "(-100,-100;-100,400;200,400;200,-100/10,20;110,20;110,220;10,220)"), true);

  db::Region rr;
  std::string s = r.to_string ();
  tl::Extractor ex (s.c_str ());
  EXPECT_EQ (ex.try_read (rr), true);
  EXPECT_EQ (db::compare (rr, "(-100,-100;-100,400;200,400;200,-100/10,20;110,20;110,220;10,220)"), true);

  EXPECT_EQ (db::compare (r.holes (), "(10,20;10,220;110,220;110,20)"), true);
  EXPECT_EQ (db::compare (r.hulls (), "(-100,-100;-100,400;200,400;200,-100)"), true);
}
...
TEST(6) 
{
  ...
  EXPECT_EQ (db::compare ((r - db::Region (db::Box (db::Point (10, 20), db::Point (110, 220)))), "(0,0;0,200;10,200;10,20;100,20;100,0)"), true);

  r -= db::Region (db::Box (db::Point (10, 20), db::Point (110, 220)));
  EXPECT_EQ (r.is_box (), false);
  EXPECT_EQ (r.empty (), false);
  EXPECT_EQ (r.is_merged (), true);
  EXPECT_EQ (db::compare (r, "(0,0;0,200;10,200;10,20;100,20;100,0)"), true);
}
...
TEST(7) 
{
  ...
  EXPECT_EQ (db::compare (r.andnot(db::Region (db::Box (db::Point (10, 20), db::Point (110, 220)))).second, "(-100,-100;-100,400;200,400;200,-100/10,20;110,20;110,220;10,220)"), true);
  ...
  EXPECT_EQ (db::compare (db::Region ().andnot(r).second, ""), true);
...
TEST(8) 
{
  ...
  EXPECT_EQ (db::compare (r.sized (10), "(-10,-10;-10,210;110,210;110,-10)"), true);
  EXPECT_EQ (r.sized (10).is_box (), true);
  EXPECT_EQ (r.sized (10).is_merged (), true);
  EXPECT_EQ (db::compare (r.sized (db::Coord (10), db::Coord (20)), "(-10,-20;-10,220;110,220;110,-20)"), true);
  EXPECT_EQ (r.sized (db::Coord (10), db::Coord (20)).is_box (), true);
  EXPECT_EQ (r.sized (db::Coord (10), db::Coord (20)).is_merged (), true);

  r.size (10);
  EXPECT_EQ (db::compare (r, "(-10,-10;-10,210;110,210;110,-10)"), true);
  r.size (db::Coord (10), db::Coord (20));
  EXPECT_EQ (db::compare (r, "(-20,-30;-20,230;120,230;120,-30)"), true);
}
...
TEST(9) 
{
  ...
  r.insert (db::Box (db::Point (0, 0), db::Point (100, 200)));
  r.insert (db::Box (db::Point (-100, -100), db::Point (200, 400)));
  EXPECT_EQ (db::compare (r.sized (10), "(-110,-110;-110,410;210,410;210,-110)"), true);
  EXPECT_EQ (r.sized (10).is_box (), true);
  EXPECT_EQ (r.sized (10).is_merged (), false);
  EXPECT_EQ (db::compare (r.sized (db::Coord (10), db::Coord (20)), "(-110,-120;-110,420;210,420;210,-120)"), true);
  EXPECT_EQ (r.sized (db::Coord (10), db::Coord (20)).is_box (), true);
...
{
  db::Region r;
  EXPECT_EQ (db::compare (r.selected_interacting (db::Region (db::Box (db::Point (20, 20), db::Point (30, 30)))), ""), true);
  r.insert (db::Box (db::Point (0, 0), db::Point (100, 200)));
  r.insert (db::Box (db::Point (-100, -100), db::Point (0, 0)));
  r.set_merged_semantics (false);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Region (db::Box (db::Point (20, 20), db::Point (30, 30)))), "(0,0;0,200;100,200;100,0)"), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (db::Region (db::Box (db::Point (20, 20), db::Point (30, 30)))), "(-100,-100;-100,0;0,0;0,-100)"), true);
  ...
  EXPECT_EQ (db::compare (r.selected_interacting (db::Region (db::Box (db::Point (-200, -200), db::Point (-190, -190)))), ""), true);
  db::Region rr = r;
  r.select_interacting (db::Region (db::Box (db::Point (-20, -20), db::Point (-10, -10))));
  EXPECT_EQ (db::compare (r, "(-100,-100;-100,0;0,0;0,-100)"), true);
  rr.select_not_interacting (db::Region (db::Box (db::Point (-20, -20), db::Point (-10, -10))));
  EXPECT_EQ (db::compare (rr, "(0,0;0,200;100,200;100,0)"), true);

  r.clear ();
  r.insert(db::Box (db::Point (1000, 0), db::Point (6000, 4000)));
  EXPECT_EQ (db::compare (r.selected_interacting (db::Region (db::Box (db::Point (0, 4000), db::Point (2000, 6000)))), "(1000,0;1000,4000;6000,4000;6000,0)"), true);
  EXPECT_EQ (db::compare (db::Region (db::Box (db::Point (0, 4000), db::Point (2000, 6000))).selected_interacting (r), "(0,4000;0,6000;2000,6000;2000,4000)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Region (db::Box (db::Point (0, 4000), db::Point (1000, 6000)))), "(1000,0;1000,4000;6000,4000;6000,0)"), true);
  EXPECT_EQ (db::compare (db::Region (db::Box (db::Point (0, 4000), db::Point (1000, 6000))).selected_interacting (r), "(0,4000;0,6000;1000,6000;1000,4000)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Region (db::Box (db::Point (0, 4001), db::Point (2000, 6000)))), ""), true);
  EXPECT_EQ (db::compare (db::Region (db::Box (db::Point (0, 4001), db::Point (2000, 6000))).selected_interacting (r), ""), true);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Region (db::Box (db::Point (0, 3999), db::Point (1000, 6000)))), "(1000,0;1000,4000;6000,4000;6000,0)"), true);
  EXPECT_EQ (db::compare (db::Region (db::Box (db::Point (0, 3999), db::Point (1000, 6000))).selected_interacting (r), "(0,3999;0,6000;1000,6000;1000,3999)"), true);
  EXPECT_EQ (db::compare (r.selected_overlapping (db::Region (db::Box (db::Point (0, 4000), db::Point (2000, 6000)))), ""), true);
  EXPECT_EQ (db::compare (db::Region (db::Box (db::Point (0, 4000), db::Point (2000, 6000))).selected_overlapping (r), ""), true);
  EXPECT_EQ (db::compare (r.selected_overlapping (db::Region (db::Box (db::Point (0, 4000), db::Point (1000, 6000)))), ""), true);
  EXPECT_EQ (db::compare (db::Region (db::Box (db::Point (0, 4000), db::Point (1000, 6000))).selected_overlapping (r), ""), true);
  EXPECT_EQ (db::compare (r.selected_overlapping (db::Region (db::Box (db::Point (0, 4001), db::Point (2000, 6000)))), ""), true);
  EXPECT_EQ (db::compare (db::Region (db::Box (db::Point (0, 4001), db::Point (2000, 6000))).selected_overlapping (r), ""), true);
  EXPECT_EQ (db::compare (r.selected_overlapping (db::Region (db::Box (db::Point (0, 3999), db::Point (1001, 6000)))), "(1000,0;1000,4000;6000,4000;6000,0)"), true);
  EXPECT_EQ (db::compare (db::Region (db::Box (db::Point (0, 3999), db::Point (1001, 6000))).selected_overlapping (r), "(0,3999;0,6000;1001,6000;1001,3999)"), true);
}
...
TEST(10c) 
{
  ...
  r.set_merged_semantics (true);
  r.set_min_coherence (false);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Region (db::Box (db::Point (20, 20), db::Point (30, 30)))), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Region (db::Box (db::Point (-20, -20), db::Point (30, 30)))), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Region (db::Box (db::Point (-200, -200), db::Point (-190, -190)))), ""), true);
  r.select_interacting (db::Region (db::Box (db::Point (-20, -20), db::Point (-10, -10))));
  EXPECT_EQ (db::compare (r, "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
}
...
TEST(11)
{
  ...
  EXPECT_EQ (db::compare (db::Region (db::Polygon (db::Box (db::Point (0, 0), db::Point (10, 10)))), "(0,0;0,10;10,10;10,0)"), true);
  EXPECT_EQ (db::compare (db::Region (db::Polygon ()), ""), true);
  EXPECT_EQ (db::compare (db::Region (db::Box ()), ""), true);

  db::Point pts[2] = { db::Point (0, 0), db::Point (0, 20) };
  EXPECT_EQ (db::compare (db::Region (db::Path (pts + 0, pts + 2, 10)), "(-5,0;-5,20;5,20;5,0)"), true);
}
...
TEST(12) 
{
  ...
  EXPECT_EQ (db::compare (rr, ""), true);
  db::RegionPerimeterFilter f1 (0, 41, false);
  rr = r.filtered (f1);
  EXPECT_EQ (db::compare (rr, "(0,0;0,10;10,10;10,0)"), true);
  db::RegionPerimeterFilter f2 (0, 41, true);
  rr = r.filtered (f2);
  EXPECT_EQ (db::compare (rr, "(20,20;20,50;40,50;40,20)"), true);
  EXPECT_EQ (db::compare (rr, "(20,20;20,50;40,50;40,20)"), true);
  db::RegionPerimeterFilter f3 (50, std::numeric_limits<db::RegionPerimeterFilter::perimeter_type>::max (), false);
  r.filter (f3);
  EXPECT_EQ (db::compare (r, "(20,20;20,50;40,50;40,20)"), true);
}
...
TEST(15a) 
{
  ...
  EXPECT_EQ (db::compare (r.width_check (5), ""), true);
...
TEST(15b) 
{
  ...
  EXPECT_EQ (db::compare (r.width_check (120, db::RegionCheckOptions (false, db::Projection)), "(400,200;400,300)|(500,300;500,200)"), true);
  ...
  EXPECT_EQ (db::compare (r.notch_check (120, db::RegionCheckOptions (false, db::Projection)), "(300,200;400,200)|(400,300;300,300)"), true);
...
TEST(15e)
{
  ...
  EXPECT_EQ (db::compare (r.space_check (1000), "(20857,3600;20857,66000)|(19957,66000;19957,3600)"), true);
}
...
TEST(15i)
{
  ...
  EXPECT_EQ (db::compare (r.separation_check (rl, 40, options), ""), true);
  EXPECT_EQ (db::compare (r.separation_check (rt, 40, options), ""), true);
  ...
  EXPECT_EQ (db::compare (r.separation_check (rl + rr, 40, options), ""), true);
  EXPECT_EQ (db::compare (r.separation_check (rl + rt, 40, options), ""), true);
  EXPECT_EQ (db::compare (r.separation_check (rl, 40, options), "(-90,-90;-90,90)/(-100,90;-100,-90)"), true);
  EXPECT_EQ (db::compare (r.separation_check (rt, 40, options), "(-90,90;90,90)/(90,100;-90,100)"), true);
  EXPECT_EQ (db::compare (r.separation_check (rt + rr + rb, 40, options), "(-90,90;90,90)/(90,100;-90,100);(90,90;90,-90)/(100,-90;100,90);(90,-90;-90,-90)/(-90,-100;90,-100)"), true);
  ...
  EXPECT_EQ (db::compare (r.separation_check (rl, 40, options), "(-90,-90;-90,90)/(-100,90;-100,-90)"), true);
  EXPECT_EQ (db::compare (r.separation_check (rt, 40, options), "(-90,90;90,90)/(90,100;-90,100)"), true);
  EXPECT_EQ (db::compare (r.separation_check (rt + rr + rb, 40, options), ""), true);
  ...
  EXPECT_EQ (db::compare (r.separation_check (rl + rr, 40, options), "(90,90;90,-90)/(100,-90;100,90);(-90,-90;-90,90)/(-100,90;-100,-90)"), true);
  EXPECT_EQ (db::compare (r.separation_check (rl + rt, 40, options), ""), true);
  EXPECT_EQ (db::compare (r.separation_check (rr + rt, 40, options), ""), true);
  EXPECT_EQ (db::compare (r.separation_check (rl, 40, options), ""), true);
  EXPECT_EQ (db::compare (r.separation_check (rt, 40, options), ""), true);
  EXPECT_EQ (db::compare (r.separation_check (rt + rr + rb, 40, options), "(-90,90;90,90)/(90,100;-90,100);(90,90;90,-90)/(100,-90;100,90);(90,-90;-90,-90)/(-90,-100;90,-100)"), true);
}
...
TEST(16)
{
  ...
  EXPECT_EQ (db::compare (a.inside_check (b, 15), "(10,20;10,30)/(0,9;0,41)"), true);
  EXPECT_EQ (db::compare (a.inside_check (b, 15, db::RegionCheckOptions (true)), "(10,20;10,30)/(0,0;0,100)"), true);
  ...
  EXPECT_EQ (db::compare (b.enclosing_check (a, 15), "(0,9;0,41)/(10,20;10,30)"), true);
  EXPECT_EQ (db::compare (b.enclosing_check (a, 15, db::RegionCheckOptions (true)), "(0,0;0,100)/(10,20;10,30)"), true);
  ...
  EXPECT_EQ (db::compare (b.separation_check (a, 15), "(30,9;30,41)/(20,30;20,20)"), true);
  EXPECT_EQ (db::compare (b.separation_check (a, 15, db::RegionCheckOptions (true)), "(30,0;30,100)/(20,30;20,20)"), true);
  ...
  EXPECT_EQ (db::compare (b.overlap_check (a, 15), "(15,6;15,44)/(20,30;20,20)"), true);
  EXPECT_EQ (db::compare (b.overlap_check (a, 15, db::RegionCheckOptions (true)), "(15,0;15,100)/(20,30;20,20)"), true);
...
TEST(18a) 
{
  ...
  EXPECT_EQ (db::compare (r.selected_inside (rr), "(20,30;20,50;40,50;40,30)"), true);
  {
    db::Region o = r;
    o.select_inside (rr);
    EXPECT_EQ (db::compare (o, "(20,30;20,50;40,50;40,30)"), true);
    o = r;
  ...
  EXPECT_EQ (db::compare (r.selected_interacting (rr), "(0,0;0,20;20,20;20,0);(50,10;50,30;70,30;70,10);(20,30;20,50;40,50;40,30);(0,60;0,80;60,80;60,60);(0,100;0,130;30,130;30,100)"), true);
  {
    ...
    o = r;
    EXPECT_EQ (db::compare (o.selected_not_interacting (rr), "(70,60;70,80;90,80;90,60)"), true);
    ...
    EXPECT_EQ (db::compare (o, "(70,60;70,80;90,80;90,60)"), true);
  }
  ...
  EXPECT_EQ (db::compare (r.selected_enclosing (rr), "(0,100;0,130;30,130;30,100)"), true);
  {
    db::Region o = r;
    o.select_enclosing (rr);
    EXPECT_EQ (db::compare (o, "(0,100;0,130;30,130;30,100)"), true);
    o = r;
...
TEST(18c)
{
  ...
  EXPECT_EQ (db::compare (r.selected_inside (rr), "(-20,0;-20,20;20,20;20,0)"), true);
  EXPECT_EQ (db::compare (r.selected_overlapping (rr), "(-20,0;-20,20;20,20;20,0)"), true);
  ...
  EXPECT_EQ (db::compare (r.selected_not_outside (rr), "(-20,0;-20,20;20,20;20,0)"), true);
  ...
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr), ""), true);
  ...
  EXPECT_EQ (db::compare (r.selected_outside (rr), "(-120,0;-120,20;-100,20;-100,0);(100,0;100,20;120,20;120,0)"), true);
  EXPECT_EQ (db::compare (r.selected_inside (rr), ""), true);
  EXPECT_EQ (db::compare (r.selected_overlapping (rr), "(-20,0;-20,20;20,20;20,0)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr), "(-20,0;-20,20;20,20;20,0);(-120,0;-120,20;-100,20;-100,0);(100,0;100,20;120,20;120,0)"), true);
  ...
  EXPECT_EQ (db::compare (r.selected_outside (rr), ""), true);
  ...
  EXPECT_EQ (db::compare (r.selected_not_inside (rr), ""), true);
  EXPECT_EQ (db::compare (r.selected_not_overlapping (rr), ""), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr), ""), true);
}
...
TEST(18d)
{
  ...
  EXPECT_EQ (db::compare (r.pull_inside (rr), "(10,110;10,120;20,120;20,110)"), true);
...
TEST(19)
{
  ...
  EXPECT_EQ (db::compare (r1.in (r2, false), "(0,0;0,30;20,30;20,0)"), true);
  EXPECT_EQ (db::compare (r1.in (r2, true), ""), true);
  EXPECT_EQ (db::compare (r2.in (r1, true), ""), true);
  ...
  EXPECT_EQ (db::compare (r1.in (r2, true), "(0,0;0,20;10,20;10,0)"), true);
  EXPECT_EQ (db::compare (r2.in (r1, true), "(0,0;0,10;20,10;20,0)"), true);
}
...
TEST(20)
{
...

  {
    ...
    EXPECT_EQ (db::compare (r1.bbox (), "(120,20;220,140)"), true);
    ...
    EXPECT_EQ (db::compare (r2, "(120,20;120,40;140,40;140,20)"), true);
...

  {
    ...
    EXPECT_EQ (r1.has_valid_polygons (), false);
    EXPECT_EQ (db::compare (r1, "(120,20;120,40;140,40;140,20)"), true);
    EXPECT_EQ (r1.has_valid_polygons (), false);
    ...
    EXPECT_EQ (db::compare (r1.transformed (db::ICplxTrans (0.5)), "(60,10;60,20;70,20;70,10)"), true);
    r1.transform (db::ICplxTrans (0.5));
    EXPECT_EQ (r1.has_valid_polygons (), true);
    EXPECT_EQ (db::compare (r1, "(60,10;60,20;70,20;70,10)"), true);
...

  {
    ...
    EXPECT_EQ (db::compare (r1.space_check (2), ""), true);
  }
...

  {
    ...
    EXPECT_EQ (db::compare (r1.holes (), ""), true);
    db::Region r2 (db::RecursiveShapeIterator (ly, ly.cell (top), l2));
    EXPECT_EQ (r2.has_valid_polygons (), false);
    ...
    EXPECT_EQ (db::compare ((r1 - r1), ""), true);
    EXPECT_EQ (db::compare (r2.selected_outside (r1), "(80,40;80,70;140,70;140,40)"), true);
    EXPECT_EQ (db::compare (r2.selected_inside (r1), "(60,10;60,20;70,20;70,10)"), true);
    ...
    EXPECT_EQ (db::compare (r2, "(80,40;80,70;140,70;140,40)"), true);
  }
}
...
{
  db::Region r;
  EXPECT_EQ (db::compare (r.strange_polygon_check (), ""), true);
...
{
  db::Region r;
  EXPECT_EQ (db::compare (r.angle_check (0, 180.0, false), ""), true);
  EXPECT_EQ (db::compare (r.angle_check (0, 180.0, true), ""), true);
  ...
  EXPECT_EQ (db::compare (r.angle_check (0, 180.0, true), ""), true);
  EXPECT_EQ (db::compare (r.angle_check (45.0, 45.1, false), "(0,1000;1000,2000)/(1000,2000;1000,0)"), true);
  EXPECT_EQ (db::compare (r.angle_check (0.0, 90.0, false), "(0,1000;1000,2000)/(1000,2000;1000,0)"), true);
  ...
  EXPECT_EQ (db::compare (r.angle_check (90.1, 180.0, false), "(0,0;0,1000)/(0,1000;1000,2000)"), true);
...
TEST(22b)
{
  ...
  EXPECT_EQ (db::compare (r.angle_check (0, 180.0, true), "(1000,800;200,800)/(200,800;800,200)"), true);
  EXPECT_EQ (db::compare (r.angle_check (45.0, 45.1, false), "(0,0;1000,1000)/(1000,1000;1000,800);(800,0;0,0)/(0,0;1000,1000)"), true);
  EXPECT_EQ (db::compare (r.angle_check (315.0, 315.1, false), "(1000,800;200,800)/(200,800;800,200)"), true);
...
{
  db::Region r;
  EXPECT_EQ (db::compare (r.grid_check (10, 20), ""), true);
  ...
  EXPECT_EQ (db::compare (r.grid_check (0, 0), ""), true);
  EXPECT_EQ (db::compare (r.grid_check (5, 0), ""), true);
  EXPECT_EQ (db::compare (r.grid_check (0, 10), ""), true);
...
{
  db::Region r;
  EXPECT_EQ (db::compare (r.snapped (10, 20), ""), true);
  ...
  EXPECT_EQ (db::compare (r.snapped (0, 0), "(0,0;0,500;1000,500;1000,0/105,100;910,100;910,290;105,290)"), true);
  EXPECT_EQ (db::compare (r.snapped (5, 0), "(0,0;0,500;1000,500;1000,0/105,100;910,100;910,290;105,290)"), true);
  EXPECT_EQ (db::compare (r.snapped (0, 10), "(0,0;0,500;1000,500;1000,0/105,100;910,100;910,290;105,290)"), true);
  EXPECT_EQ (db::compare (r.snapped (10, 10), "(0,0;0,500;1000,500;1000,0/110,100;910,100;910,290;110,290)"), true);
  EXPECT_EQ (db::compare (r.snapped (10, 20), "(0,0;0,500;1000,500;1000,0/110,100;910,100;910,300;110,300)"), true);
}
...
TEST(24b)
{
  ...
  EXPECT_EQ (db::compare (r.snapped (10, 10), "(-10,-10;-10,20;20,20;20,-10)"), true);
}
...
TEST(25)
{
  ...
  EXPECT_EQ (db::compare (r.rounded_corners (50, 100, 16), "(80,-500;43,-485;15,-457;0,-420;0,920;15,957;43,985;80,1000;420,1000;457,985;485,957;500,920;500,40;508,22;522,8;540,0;920,0;957,-15;985,-43;1000,-80;1000,-420;985,-457;957,-485;920,-500)"), true);
  db::Region rr = r;
...
TEST(26) 
{
  ...
  EXPECT_EQ (db::compare ((r - db::Region ()), "(0,0;0,200;50,200;50,250;150,250;150,50;100,50;100,0)"), true);
  EXPECT_EQ (db::compare ((r | db::Region ()), "(0,0;0,200;50,200;50,250;150,250;150,50;100,50;100,0)"), true);
  EXPECT_EQ (db::compare ((r ^ db::Region ()), "(0,0;0,200;50,200;50,250;150,250;150,50;100,50;100,0)"), true);
  EXPECT_EQ (db::compare ((db::Region () - r), ""), true);
  EXPECT_EQ (db::compare ((db::Region () | r), "(0,0;0,200;50,200;50,250;150,250;150,50;100,50;100,0)"), true);
  EXPECT_EQ (db::compare ((db::Region () ^ r), "(0,0;0,200;50,200;50,250;150,250;150,50;100,50;100,0)"), true);
  EXPECT_EQ (db::compare ((r & db::Region (db::Box (db::Point (20, 20), db::Point (120, 220)))), "(20,20;20,200;50,200;50,220;120,220;120,50;100,50;100,20)"), true);
  EXPECT_EQ (db::compare ((db::Region (db::Box (db::Point (20, 20), db::Point (120, 220))) & r), "(20,20;20,200;50,200;50,220;120,220;120,50;100,50;100,20)"), true);
...
TEST(27) 
{
  ...
  EXPECT_EQ (db::compare (r.sized (db::Coord (-10), db::Coord (-20)), "(10,20;10,180;90,180;90,20)"), true);
  EXPECT_EQ (db::compare (r.sized (db::Coord (-50), db::Coord (-20)), ""), true);
  EXPECT_EQ (db::compare (r.sized (db::Coord (-50), db::Coord (-100)), ""), true);
  EXPECT_EQ (db::compare (r.sized (db::Coord (-55), db::Coord (-20)), ""), true);
  EXPECT_EQ (db::compare (r.sized (db::Coord (-10), db::Coord (-105)), ""), true);
  EXPECT_EQ (db::compare (r.sized (db::Coord (-55), db::Coord (-105)), ""), true);
}
...
TEST(28) 
{
  ...
  EXPECT_EQ (db::compare ((r1 & r2), ""), true);
  EXPECT_EQ (db::compare ((r1 & r2.sized (db::Coord (5), db::Coord (5))), "(95,95;95,200;100,200;100,95)"), true);
}
...
{
  db::Region r;
  EXPECT_EQ (db::compare (r.selected_interacting (db::Edges (db::Edge (db::Point (20, 20), db::Point (30, 30)))), ""), true);
  r.insert (db::Box (db::Point (0, 0), db::Point (100, 200)));
  r.insert (db::Box (db::Point (-100, -100), db::Point (0, 0)));
  r.set_merged_semantics (false);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Edges (db::Edge (db::Point (20, 20), db::Point (30, 30)))), "(0,0;0,200;100,200;100,0)"), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (db::Edges (db::Edge (db::Point (20, 20), db::Point (30, 30)))), "(-100,-100;-100,0;0,0;0,-100)"), true);
  ...
  EXPECT_EQ (db::compare (r.selected_interacting (db::Edges (db::Edge (db::Point (-200, -200), db::Point (-190, -190)))), ""), true);
  db::Region rr = r;
  ...
  r.clear ();
  r.insert(db::Box (db::Point (1000, 0), db::Point (6000, 4000)));
  EXPECT_EQ (db::compare (r.selected_interacting (db::Edges (db::Edge (db::Point (0, 4000), db::Point (2000, 6000)))), ""), true);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Edges (db::Edge (db::Point (1000, 4000), db::Point (2000, 6000)))), "(1000,0;1000,4000;6000,4000;6000,0)"), true);
  EXPECT_EQ (db::compare (db::Edges (db::Edge (db::Point (0, 4000), db::Point (2000, 6000))).selected_interacting (r), ""), true);
  EXPECT_EQ (db::compare (db::Edges (db::Edge (db::Point (1000, 4000), db::Point (2000, 6000))).selected_interacting (r), "(1000,4000;2000,6000)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Edges (db::Edge (db::Point (1000, 4001), db::Point (2000, 6000)))), ""), true);
  EXPECT_EQ (db::compare (db::Edges (db::Edge (db::Point (1000, 4001), db::Point (2000, 6000))).selected_interacting (r), ""), true);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Edges (db::Edge (db::Point (1000, 3999), db::Point (1000, 6000)))), "(1000,0;1000,4000;6000,4000;6000,0)"), true);
  EXPECT_EQ (db::compare (db::Edges (db::Edge (db::Point (1000, 3999), db::Point (1000, 6000))).selected_interacting (r), "(1000,3999;1000,6000)"), true);
}
...
TEST(30c)
{
  ...
  r.set_merged_semantics (true);
  r.set_min_coherence (false);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Edges (db::Edge (db::Point (20, 20), db::Point (30, 30)))), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Edges (db::Edge (db::Point (-20, -20), db::Point (30, 30)))), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Edges (db::Edge (db::Point (-200, -200), db::Point (-190, -190)))), ""), true);
  r.select_interacting (db::Edges (db::Edge (db::Point (-20, -20), db::Point (-10, -10))));
  EXPECT_EQ (db::compare (r, "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
...
{
  db::Region r;
  EXPECT_EQ (db::compare (r.pull_interacting (db::Region (db::Box (db::Point (20, 20), db::Point (30, 30)))), ""), true);
  r.insert (db::Box (db::Point (0, 0), db::Point (100, 200)));
  r.insert (db::Box (db::Point (-100, -100), db::Point (0, 0)));
  r.set_merged_semantics (true);
  r.set_min_coherence (false);
  EXPECT_EQ (db::compare (r.pull_interacting (db::Region (db::Box (db::Point (20, 20), db::Point (30, 30)))), "(20,20;20,30;30,30;30,20)"), true);
  EXPECT_EQ (db::compare (r.pull_interacting (db::Region (db::Box (db::Point (-20, -20), db::Point (30, 30)))), "(-20,-20;-20,30;30,30;30,-20)"), true);
  EXPECT_EQ (db::compare (r.pull_interacting (db::Region (db::Box (db::Point (-200, -200), db::Point (-190, -190)))), ""), true);

  r.clear ();
  r.insert(db::Box (db::Point (1000, 0), db::Point (6000, 4000)));
  EXPECT_EQ (db::compare (r.pull_overlapping (db::Region (db::Box (db::Point (0, 4000), db::Point (2000, 6000)))), ""), true);
  EXPECT_EQ (db::compare (db::Region (db::Box (db::Point (0, 4000), db::Point (2000, 6000))).pull_overlapping (r), ""), true);
  EXPECT_EQ (db::compare (r.pull_overlapping (db::Region (db::Box (db::Point (0, 4000), db::Point (1000, 6000)))), ""), true);
  EXPECT_EQ (db::compare (db::Region (db::Box (db::Point (0, 4000), db::Point (1000, 6000))).pull_overlapping (r), ""), true);
  EXPECT_EQ (db::compare (r.pull_overlapping (db::Region (db::Box (db::Point (0, 4001), db::Point (2000, 6000)))), ""), true);
  EXPECT_EQ (db::compare (db::Region (db::Box (db::Point (0, 4001), db::Point (2000, 6000))).pull_overlapping (r), ""), true);
  EXPECT_EQ (db::compare (r.pull_overlapping (db::Region (db::Box (db::Point (0, 3999), db::Point (1001, 6000)))), "(0,3999;0,6000;1001,6000;1001,3999)"), true);
  EXPECT_EQ (db::compare (db::Region (db::Box (db::Point (0, 3999), db::Point (1001, 6000))).pull_overlapping (r), "(1000,0;1000,4000;6000,4000;6000,0)"), true);
}
...
{
  db::Region r;
  EXPECT_EQ (db::compare (r.selected_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (30, 30))))), ""), true);
  r.insert (db::Box (db::Point (0, 0), db::Point (100, 200)));
  r.insert (db::Box (db::Point (-100, -100), db::Point (0, 0)));
  r.set_merged_semantics (false);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (30, 30))))), "(0,0;0,200;100,200;100,0)"), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (30, 30))))), "(-100,-100;-100,0;0,0;0,-100)"), true);
  db::Texts tt;
  ...
  EXPECT_EQ (db::compare (r.selected_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (300, 30))))), ""), true);
  db::Region rr = r;
  ...
  r.clear ();
  r.insert(db::Box (db::Point (1000, 0), db::Point (6000, 4000)));
  EXPECT_EQ (db::compare (r.selected_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (2000, 6000))))), ""), true);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (2000, 2000))))), "(1000,0;1000,4000;6000,4000;6000,0)"), true);
  EXPECT_EQ (db::compare (db::Texts (db::Text ("abc", db::Trans (db::Vector (2000, 6000)))).selected_interacting (r), ""), true);
  EXPECT_EQ (db::compare (db::Texts (db::Text ("abc", db::Trans (db::Vector (2000, 2000)))).selected_interacting (r), "('abc',r0 2000,2000)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (2000, 6000))))), ""), true);
  EXPECT_EQ (db::compare (db::Texts (db::Text ("abc", db::Trans (db::Vector (2000, 6000)))).selected_interacting (r), ""), true);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (1000, 2000))))), "(1000,0;1000,4000;6000,4000;6000,0)"), true);
  EXPECT_EQ (db::compare (db::Texts (db::Text ("abc", db::Trans (db::Vector (1000, 2000)))).selected_interacting (r), "('abc',r0 1000,2000)"), true);
}
...
TEST(34b)
{
  ...
  EXPECT_EQ (db::compare (r.selected_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (-190, -190))))), ""), true);
  r.select_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (-10, -10)))));
  EXPECT_EQ (db::compare (r, "(-100,-100;-100,0;0,0;0,-100)"), true);
}
...
TEST(34c)
{
  ...
  r.set_merged_semantics (true);
  r.set_min_coherence (false);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (30, 30))))), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (0, 0))))), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (-190, -190))))), ""), true);
  r.select_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (-10, -10)))));
  EXPECT_EQ (db::compare (r, "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
}
...
{
  db::Region r;
  EXPECT_EQ (db::compare (r.pull_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (30, 30))))), ""), true);
  r.insert (db::Box (db::Point (0, 0), db::Point (100, 200)));
  r.insert (db::Box (db::Point (-100, -100), db::Point (0, 0)));
  r.set_merged_semantics (true);
  r.set_min_coherence (false);
  EXPECT_EQ (db::compare (r.pull_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (30, 30))))), "('abc',r0 30,30)"), true);
  EXPECT_EQ (db::compare (r.pull_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (0, 0))))), "('abc',r0 0,0)"), true);
  EXPECT_EQ (db::compare (r.pull_interacting (db::Texts (db::Text ("abc", db::Trans (db::Vector (-190, -190))))), ""), true);
}
...
TEST(35a_interact_with_count_region)
{
  ...
  EXPECT_EQ (db::compare (r.selected_interacting (empty), ""), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr, 0, 2), ""), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr, 1, 2), ""), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr, 1, 4), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr, 2, 4), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr, 2, 1), ""), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr, 3, 4), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr, 4, 5), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr, 5, 5), ""), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr2), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr2, 1, 2), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr2, 1, 4), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr2, 2, 5), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr2, 4, 5), ""), true);

  EXPECT_EQ (db::compare (r.selected_not_interacting (empty), "(0,0;0,200;100,200;100,0);(-100,-100;-100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr), ""), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr, 0, 2), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr, 1, 2), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr, 1, 4), ""), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr, 2, 4), ""), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr, 2, 1), "(0,0;0,200;100,200;100,0);(-100,-100;-100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr, 3, 4), ""), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr, 4, 5), ""), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr, 5, 5), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr2), ""), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr2, 1, 2), ""), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr2, 1, 4), ""), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr2, 2, 5), ""), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr2, 4, 5), "(-100,-100;-100,0;0,0;0,200;100,200;100,0;0,0;0,-100)"), true);

  r.set_merged_semantics (false);

  EXPECT_EQ (db::compare (r.selected_interacting (empty), ""), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr), "(0,0;0,200;100,200;100,0);(-100,-100;-100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr, 0, 2), "(0,0;0,200;100,200;100,0)"), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr, 1, 2), "(0,0;0,200;100,200;100,0)"), true);
  ...
  EXPECT_EQ (db::compare (r.selected_interacting (rr, 2, 1), ""), true);
  EXPECT_EQ (db::compare (r.selected_interacting (rr, 3, 4), "(-100,-100;-100,0;0,0;0,-100)"), true);

  EXPECT_EQ (db::compare (r.selected_not_interacting (empty), "(0,0;0,200;100,200;100,0);(-100,-100;-100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr), ""), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr, 0, 2), "(-100,-100;-100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr, 1, 2), "(-100,-100;-100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr, 1, 4), ""), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr, 2, 4), ""), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr, 2, 1), "(0,0;0,200;100,200;100,0);(-100,-100;-100,0;0,0;0,-100)"), true);
  EXPECT_EQ (db::compare (r.selected_not_interacting (rr, 3, 4), "(0,0;0,200;100,200;100,0)"), true);
}
...
TEST(100_Processors)
{
  ...
  EXPECT_EQ (db::compare (r.processed (db::CornersAsDots (0.0, true, 180.0, true)), "(100,400;100,400)"), true);
  ...
  EXPECT_EQ (db::compare (r.processed (db::CornersAsDots (-90.0, false, 90.0, true)), "(100,400;100,400)"), true);
  ...
  EXPECT_EQ (db::compare (r.processed (db::CornersAsDots (-90.0, false, 90.0, false)), ""), true);
  db::Region ext;
  r.processed (db::CornersAsDots (0.0, true, 180.0, true)).extended (ext, 10, 10, 20, 20);
  EXPECT_EQ (db::compare (ext, "(90,380;90,420;110,420;110,380)"), true);
  ...
  EXPECT_EQ (db::compare (r.processed (db::CornersAsRectangles (0.0, true, 180.0, true, 2)), "(98,398;98,402;102,402;102,398)"), true);
...
TEST(issue_277)
{
  ...
  EXPECT_EQ (db::compare (r.sized (1).merged (false, 1), ""), true);

  r.set_min_coherence (true);
  EXPECT_EQ (db::compare (r.sized (1).merged (false, 1), "(399,399;399,401;401,401;401,399)"), true);
