...
gsi::Class<QCalendar::YearMonthDay> decl_QCalendar_YearMonthDay ("Qt", "QCalendar_YearMonthDay",
...
GSI_QT_PUBLIC gsi::Class<QCalendar::YearMonthDay> &qtdecl_QCalendar_YearMonthDay () { return decl_QCalendar_YearMonthDay; }
