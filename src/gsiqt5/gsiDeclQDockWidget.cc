...
public:
  ...
  //  [adaptor impl] bool QDockWidget::nativeEvent(const QByteArray &eventType, void *message, long int *result)
  ...
  virtual bool nativeEvent(const QByteArray &eventType, void *message, long int *result)
  {
    if (cb_nativeEvent_4678_0.can_issue()) {
      return cb_nativeEvent_4678_0.issue<QDockWidget_Adaptor, bool, const QByteArray &, void *, long int *>(&QDockWidget_Adaptor::cbs_nativeEvent_4678_0, eventType, message, result);
    } else {
      return QDockWidget::nativeEvent(eventType, message, result);
    }
  }
...
// bool QDockWidget::nativeEvent(const QByteArray &eventType, void *message, long int *result)
...
static void _call_cbs_nativeEvent_4678_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<bool > ((bool)((QDockWidget_Adaptor *)cls)->cbs_nativeEvent_4678_0 (arg1, arg2, arg3));
}

static void _set_callback_cbs_nativeEvent_4678_0 (void *cls, const gsi::Callback &cb)
{
  ((QDockWidget_Adaptor *)cls)->cb_nativeEvent_4678_0 = cb;
}
