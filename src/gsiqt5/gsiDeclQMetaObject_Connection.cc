...
gsi::Class<QMetaObject::Connection> decl_QMetaObject_Connection ("QMetaObject_Connection",
...
GSIQT_PUBLIC gsi::Class<QMetaObject::Connection> &qtdecl_QMetaObject_Connection () { return decl_QMetaObject_Connection; }
