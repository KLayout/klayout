...
static void _call_ctor_QStyleOptionMenuItem_3360 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QStyleOptionMenuItem &arg1 = args.read<const QStyleOptionMenuItem & > (heap);
...
gsi::Class<QStyleOptionMenuItem> decl_QStyleOptionMenuItem (qtdecl_QStyleOption (), "QStyleOptionMenuItem",
  methods_QStyleOptionMenuItem (),
  "@qt\n@brief Binding of QStyleOptionMenuItem");


GSIQT_PUBLIC gsi::Class<QStyleOptionMenuItem> &qtdecl_QStyleOptionMenuItem () { return decl_QStyleOptionMenuItem; }
