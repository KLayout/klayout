...
qt_gsi::QtNativeClass<QNetworkDiskCache> decl_QNetworkDiskCache (qtdecl_QAbstractNetworkCache (), "QNetworkDiskCache_Native",
  methods_QNetworkDiskCache (),
  "@hide\n@alias QNetworkDiskCache");

GSIQT_PUBLIC gsi::Class<QNetworkDiskCache> &qtdecl_QNetworkDiskCache () { return decl_QNetworkDiskCache; }
...
static gsi::Methods methods_QNetworkDiskCache_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*expire", "@hide", false, &_init_cbs_expire_0_0, &_call_cbs_expire_0_0);
...
gsi::Class<QNetworkDiskCache_Adaptor> decl_QNetworkDiskCache_Adaptor (qtdecl_QNetworkDiskCache (), "QNetworkDiskCache",
