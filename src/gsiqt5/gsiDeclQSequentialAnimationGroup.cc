...
qt_gsi::QtNativeClass<QSequentialAnimationGroup> decl_QSequentialAnimationGroup (qtdecl_QAnimationGroup (), "QSequentialAnimationGroup_Native",
  methods_QSequentialAnimationGroup (),
  "@hide\n@alias QSequentialAnimationGroup");

GSIQT_PUBLIC gsi::Class<QSequentialAnimationGroup> &qtdecl_QSequentialAnimationGroup () { return decl_QSequentialAnimationGroup; }
...
gsi::Class<QSequentialAnimationGroup_Adaptor> decl_QSequentialAnimationGroup_Adaptor (qtdecl_QSequentialAnimationGroup (), "QSequentialAnimationGroup",
