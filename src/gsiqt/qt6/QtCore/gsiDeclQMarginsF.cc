...
// void QMarginsF::setBottom(double abottom)


static void _init_f_setBottom_1071 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("abottom");
  decl->add_arg<double > (argspec_0);
...
// void QMarginsF::setLeft(double aleft)


static void _init_f_setLeft_1071 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("aleft");
  decl->add_arg<double > (argspec_0);
  decl->set_return<void > ();
}
...
// void QMarginsF::setRight(double aright)


static void _init_f_setRight_1071 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("aright");
  decl->add_arg<double > (argspec_0);
  decl->set_return<void > ();
}
...
// void QMarginsF::setTop(double atop)


static void _init_f_setTop_1071 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("atop");
  decl->add_arg<double > (argspec_0);
  decl->set_return<void > ();
}
...
static gsi::Methods methods_QMarginsF () {
  ...
  methods += new qt_gsi::GenericMethod ("setBottom|bottom=", "@brief Method void QMarginsF::setBottom(double abottom)\n", false, &_init_f_setBottom_1071, &_call_f_setBottom_1071);
  methods += new qt_gsi::GenericMethod ("setLeft|left=", "@brief Method void QMarginsF::setLeft(double aleft)\n", false, &_init_f_setLeft_1071, &_call_f_setLeft_1071);
  methods += new qt_gsi::GenericMethod ("setRight|right=", "@brief Method void QMarginsF::setRight(double aright)\n", false, &_init_f_setRight_1071, &_call_f_setRight_1071);
  methods += new qt_gsi::GenericMethod ("setTop|top=", "@brief Method void QMarginsF::setTop(double atop)\n", false, &_init_f_setTop_1071, &_call_f_setTop_1071);
  ...
  methods += gsi::method_ext("|", &::op_QMarginsF_operator_pipe__4262, gsi::arg ("m2"), "@brief Operator QMarginsF ::operator|(const QMarginsF &m1, const QMarginsF &m2)\nThis is the mapping of the global operator to the instance method.");
