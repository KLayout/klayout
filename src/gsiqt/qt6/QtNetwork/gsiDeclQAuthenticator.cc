...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QVariantHash > ((QVariantHash)((QAuthenticator *)cls)->options ());
}
...
static gsi::Methods methods_QAuthenticator () {
  ...
  methods += new qt_gsi::GenericMethod ("options", "@brief Method QVariantHash QAuthenticator::options()\n", true, &_init_f_options_c0, &_call_f_options_c0);
