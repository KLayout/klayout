...
static void _call_f_exec_2456 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  QFlags<Qt::DropAction> arg1 = args ? args.read<QFlags<Qt::DropAction> > (heap) : (QFlags<Qt::DropAction>)(Qt::MoveAction);
...
static void _call_f_start_2456 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QFlags<Qt::DropAction> arg1 = args ? args.read<QFlags<Qt::DropAction> > (heap) : (QFlags<Qt::DropAction>)(Qt::CopyAction);
...
GSIQT_PUBLIC gsi::Class<QDrag> &qtdecl_QDrag () { return decl_QDrag; }
...
gsi::Class<QDrag_Adaptor> decl_QDrag_Adaptor (qtdecl_QDrag (), "QDrag",
