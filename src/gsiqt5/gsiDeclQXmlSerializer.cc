...
gsi::Class<QXmlSerializer> decl_QXmlSerializer (qtdecl_QAbstractXmlReceiver (), "QXmlSerializer_Native",
  methods_QXmlSerializer (),
  "@hide\n@alias QXmlSerializer");

GSIQT_PUBLIC gsi::Class<QXmlSerializer> &qtdecl_QXmlSerializer () { return decl_QXmlSerializer; }
...
gsi::Class<QXmlSerializer_Adaptor> decl_QXmlSerializer_Adaptor (qtdecl_QXmlSerializer (), "QXmlSerializer",
