...
void VariantUserClassBase::clear_class_table ()
{
...
void VariantUserClassBase::register_user_class (const std::string &name, const VariantUserClassBase *cls)
{
...
bool Variant::equal_core (const tl::Variant &d, type t) const
{
  if (t == t_nil) {
    return true;
  } else if (t == t_bool) {
...
bool Variant::less_core (const tl::Variant &d, type t) const
{
  if (t == t_nil) {
    return false;
  } else if (t == t_bool) {
...
bool Variant::equal (const Variant &d) const
{
...
bool Variant::less (const Variant &d) const
{
  std::pair<bool, type> tt = normalized_type_rigid (m_type, d.m_type);
  if (! tt.first) {
