...
qt_gsi::QtNativeClass<QPictureFormatPlugin> decl_QPictureFormatPlugin (qtdecl_QObject (), "QPictureFormatPlugin_Native",
  methods_QPictureFormatPlugin (),
  "@hide\n@alias QPictureFormatPlugin");

GSIQT_PUBLIC gsi::Class<QPictureFormatPlugin> &qtdecl_QPictureFormatPlugin () { return decl_QPictureFormatPlugin; }
...
gsi::Class<QPictureFormatPlugin_Adaptor> decl_QPictureFormatPlugin_Adaptor (qtdecl_QPictureFormatPlugin (), "QPictureFormatPlugin",
