...
qt_gsi::QtNativeClass<QMenuBar> decl_QMenuBar (qtdecl_QWidget (), "QMenuBar_Native",
  methods_QMenuBar (),
  "@hide\n@alias QMenuBar");

GSIQT_PUBLIC gsi::Class<QMenuBar> &qtdecl_QMenuBar () { return decl_QMenuBar; }
...
gsi::Class<QMenuBar_Adaptor> decl_QMenuBar_Adaptor (qtdecl_QMenuBar (), "QMenuBar",
