...
gsi::Class<QTextListFormat> decl_QTextListFormat (qtdecl_QTextFormat (), "QTextListFormat",
  methods_QTextListFormat (),
  "@qt\n@brief Binding of QTextListFormat");


GSIQT_PUBLIC gsi::Class<QTextListFormat> &qtdecl_QTextListFormat () { return decl_QTextListFormat; }
...
static gsi::Enum<QTextListFormat::Style> decl_QTextListFormat_Style_Enum ("QTextListFormat_Style",
...
static gsi::QFlagsClass<QTextListFormat::Style > decl_QTextListFormat_Style_Enums ("QTextListFormat_QFlags_Style",
