...
qt_gsi::QtNativeClass<QPlastiqueStyle> decl_QPlastiqueStyle (qtdecl_QWindowsStyle (), "QPlastiqueStyle_Native",
  methods_QPlastiqueStyle (),
  "@hide\n@alias QPlastiqueStyle");

GSIQT_PUBLIC gsi::Class<QPlastiqueStyle> &qtdecl_QPlastiqueStyle () { return decl_QPlastiqueStyle; }
...
static gsi::Methods methods_QPlastiqueStyle_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("subElementRect", "@hide", true, &_init_cbs_subElementRect_c6528_0, &_call_cbs_subElementRect_c6528_0);
...
gsi::Class<QPlastiqueStyle_Adaptor> decl_QPlastiqueStyle_Adaptor (qtdecl_QPlastiqueStyle (), "QPlastiqueStyle",
