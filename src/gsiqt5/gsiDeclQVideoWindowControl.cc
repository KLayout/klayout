...
qt_gsi::QtNativeClass<QVideoWindowControl> decl_QVideoWindowControl (qtdecl_QMediaControl (), "QVideoWindowControl_Native",
  methods_QVideoWindowControl (),
  "@hide\n@alias QVideoWindowControl");

GSIQT_PUBLIC gsi::Class<QVideoWindowControl> &qtdecl_QVideoWindowControl () { return decl_QVideoWindowControl; }
...
gsi::Class<QVideoWindowControl_Adaptor> decl_QVideoWindowControl_Adaptor (qtdecl_QVideoWindowControl (), "QVideoWindowControl",
