...
public:
   ...
   */
  void dump (const std::string &path, bool decompose_by_id = false, double dbu = 0.001, double xscale = 1.0, double yscale = 1.0) const;

  /**
   *  @brief Creates a new layout object representing the polygon graph
   *  This method is for testing purposes mainly.
   */
  db::Layout *to_layout (bool decompose_by_id = false, double dbu = 0.001, double xscale = 1.0, double yscale = 1.0) const;
