...
GSIQT_PUBLIC gsi::Class<QXmlLexicalHandler> &qtdecl_QXmlLexicalHandler () { return decl_QXmlLexicalHandler; }
...
gsi::Class<QXmlLexicalHandler_Adaptor> decl_QXmlLexicalHandler_Adaptor (qtdecl_QXmlLexicalHandler (), "QXmlLexicalHandler",
