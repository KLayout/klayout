...
public:
  ...
  virtual QWidget * widget() const
  {
    if (cb_widget_c0_0.can_issue()) {
      return cb_widget_c0_0.issue<QSpacerItem_Adaptor, QWidget *>(&QSpacerItem_Adaptor::cbs_widget_c0_0);
    } else {
      return QSpacerItem::widget();
    }
  }
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QWidget * > ((QWidget *)((QSpacerItem_Adaptor *)cls)->cbs_widget_c0_0 ());
}

static void _set_callback_cbs_widget_c0_0 (void *cls, const gsi::Callback &cb)
{
  ((QSpacerItem_Adaptor *)cls)->cb_widget_c0_0 = cb;
}
