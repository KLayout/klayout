...
//  Constructor QTextEncoder::QTextEncoder(const QTextCodec *codec, QTextCodec::ConversionFlags flags)


static void _init_ctor_QTextEncoder_5276 (qt_gsi::GenericStaticMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("codec");
  decl->add_arg<const QTextCodec * > (argspec_0);
  static gsi::ArgSpecBase argspec_1 ("flags");
  decl->add_arg<QTextCodec::ConversionFlags > (argspec_1);
  decl->set_return_new<QTextEncoder> ();
}

static void _call_ctor_QTextEncoder_5276 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QTextCodec *arg1 = gsi::arg_reader<const QTextCodec * >() (args, heap);
  QTextCodec::ConversionFlags arg2 = gsi::arg_reader<QTextCodec::ConversionFlags >() (args, heap);
  ret.write<QTextEncoder *> (new QTextEncoder (arg1, arg2));
}
...
gsi::Class<QTextEncoder> decl_QTextEncoder ("QtCore5Compat", "QTextEncoder",
  methods_QTextEncoder (),
  "@qt\n@brief Binding of QTextEncoder");


GSI_QTCORE5COMPAT_PUBLIC gsi::Class<QTextEncoder> &qtdecl_QTextEncoder () { return decl_QTextEncoder; }
