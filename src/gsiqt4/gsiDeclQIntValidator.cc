...
static gsi::Methods methods_QIntValidator () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QIntValidator::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
...
qt_gsi::QtNativeClass<QIntValidator> decl_QIntValidator (qtdecl_QValidator (), "QIntValidator_Native",
  methods_QIntValidator (),
  "@hide\n@alias QIntValidator");

GSIQT_PUBLIC gsi::Class<QIntValidator> &qtdecl_QIntValidator () { return decl_QIntValidator; }
...
static gsi::Methods methods_QIntValidator_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*disconnectNotify", "@brief Virtual method void QIntValidator::disconnectNotify(const char *signal)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_disconnectNotify_1731_0, &_call_cbs_disconnectNotify_1731_0, &_set_callback_cbs_disconnectNotify_1731_0);
...
gsi::Class<QIntValidator_Adaptor> decl_QIntValidator_Adaptor (qtdecl_QIntValidator (), "QIntValidator",
