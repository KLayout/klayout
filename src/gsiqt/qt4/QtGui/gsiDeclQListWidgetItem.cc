...
gsi::Class<QListWidgetItem> decl_QListWidgetItem ("QtGui", "QListWidgetItem_Native",
  methods_QListWidgetItem (),
  "@hide\n@alias QListWidgetItem");

GSI_QTGUI_PUBLIC gsi::Class<QListWidgetItem> &qtdecl_QListWidgetItem () { return decl_QListWidgetItem; }
...
gsi::Class<QListWidgetItem_Adaptor> decl_QListWidgetItem_Adaptor (qtdecl_QListWidgetItem (), "QtGui", "QListWidgetItem",
