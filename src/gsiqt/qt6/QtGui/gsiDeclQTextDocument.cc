...
// double QTextDocument::baselineOffset()


static void _init_f_baselineOffset_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<double > ();
}

static void _call_f_baselineOffset_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<double > ((double)((QTextDocument *)cls)->baselineOffset ());
}
...
// void QTextDocument::setBaselineOffset(double baseline)


static void _init_f_setBaselineOffset_1071 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("baseline");
  decl->add_arg<double > (argspec_0);
  decl->set_return<void > ();
}

static void _call_f_setBaselineOffset_1071 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  double arg1 = gsi::arg_reader<double >() (args, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTextDocument *)cls)->setBaselineOffset (arg1);
}
...
// void QTextDocument::setMarkdown(const QString &markdown, QFlags<QTextDocument::MarkdownFeature> features)


static void _init_f_setMarkdown_6049 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("markdown");
  decl->add_arg<const QString & > (argspec_0);
  static gsi::ArgSpecBase argspec_1 ("features", true, "QTextDocument::MarkdownDialectGitHub");
  decl->add_arg<QFlags<QTextDocument::MarkdownFeature> > (argspec_1);
  decl->set_return<void > ();
}

static void _call_f_setMarkdown_6049 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QString &arg1 = gsi::arg_reader<const QString & >() (args, heap);
  QFlags<QTextDocument::MarkdownFeature> arg2 = args ? gsi::arg_reader<QFlags<QTextDocument::MarkdownFeature> >() (args, heap) : gsi::arg_maker<QFlags<QTextDocument::MarkdownFeature> >() (QTextDocument::MarkdownDialectGitHub, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTextDocument *)cls)->setMarkdown (arg1, arg2);
}
...
// void QTextDocument::setSubScriptBaseline(double baseline)


static void _init_f_setSubScriptBaseline_1071 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("baseline");
  decl->add_arg<double > (argspec_0);
  decl->set_return<void > ();
...
static void _call_f_setSubScriptBaseline_1071 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  double arg1 = gsi::arg_reader<double >() (args, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTextDocument *)cls)->setSubScriptBaseline (arg1);
}


// void QTextDocument::setSuperScriptBaseline(double baseline)


static void _init_f_setSuperScriptBaseline_1071 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("baseline");
  decl->add_arg<double > (argspec_0);
  decl->set_return<void > ();
...
static void _call_f_setSuperScriptBaseline_1071 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  double arg1 = gsi::arg_reader<double >() (args, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTextDocument *)cls)->setSuperScriptBaseline (arg1);
}
...
// double QTextDocument::subScriptBaseline()


static void _init_f_subScriptBaseline_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<double > ();
}

static void _call_f_subScriptBaseline_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<double > ((double)((QTextDocument *)cls)->subScriptBaseline ());
}


// double QTextDocument::superScriptBaseline()


static void _init_f_superScriptBaseline_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<double > ();
}

static void _call_f_superScriptBaseline_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<double > ((double)((QTextDocument *)cls)->superScriptBaseline ());
}
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QString > ((QString)((QTextDocument *)cls)->toHtml ());
}


// QString QTextDocument::toMarkdown(QFlags<QTextDocument::MarkdownFeature> features)


static void _init_f_toMarkdown_c4132 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("features", true, "QTextDocument::MarkdownDialectGitHub");
  decl->add_arg<QFlags<QTextDocument::MarkdownFeature> > (argspec_0);
  decl->set_return<QString > ();
}

static void _call_f_toMarkdown_c4132 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QFlags<QTextDocument::MarkdownFeature> arg1 = args ? gsi::arg_reader<QFlags<QTextDocument::MarkdownFeature> >() (args, heap) : gsi::arg_maker<QFlags<QTextDocument::MarkdownFeature> >() (QTextDocument::MarkdownDialectGitHub, heap);
  ret.write<QString > ((QString)((QTextDocument *)cls)->toMarkdown (arg1));
}
...
static gsi::Methods methods_QTextDocument () {
  ...
  methods += new qt_gsi::GenericMethod ("allFormats", "@brief Method QList<QTextFormat> QTextDocument::allFormats()\n", true, &_init_f_allFormats_c0, &_call_f_allFormats_c0);
  ...
  methods += new qt_gsi::GenericMethod ("setMarkdown", "@brief Method void QTextDocument::setMarkdown(const QString &markdown, QFlags<QTextDocument::MarkdownFeature> features)\n", false, &_init_f_setMarkdown_6049, &_call_f_setMarkdown_6049);
...
//  Implementation of the enum wrapper class for QTextDocument::MarkdownFeature
namespace qt_gsi
{

static gsi::Enum<QTextDocument::MarkdownFeature> decl_QTextDocument_MarkdownFeature_Enum ("QtGui", "QTextDocument_MarkdownFeature",
    gsi::enum_const ("MarkdownNoHTML", QTextDocument::MarkdownNoHTML, "@brief Enum constant QTextDocument::MarkdownNoHTML") +
    gsi::enum_const ("MarkdownDialectCommonMark", QTextDocument::MarkdownDialectCommonMark, "@brief Enum constant QTextDocument::MarkdownDialectCommonMark") +
    gsi::enum_const ("MarkdownDialectGitHub", QTextDocument::MarkdownDialectGitHub, "@brief Enum constant QTextDocument::MarkdownDialectGitHub"),
  "@qt\n@brief This class represents the QTextDocument::MarkdownFeature enum");

static gsi::QFlagsClass<QTextDocument::MarkdownFeature > decl_QTextDocument_MarkdownFeature_Enums ("QtGui", "QTextDocument_QFlags_MarkdownFeature",
  "@qt\n@brief This class represents the QFlags<QTextDocument::MarkdownFeature> flag set");

//  Inject the declarations into the parent
static gsi::ClassExt<QTextDocument> inject_QTextDocument_MarkdownFeature_Enum_in_parent (decl_QTextDocument_MarkdownFeature_Enum.defs ());
static gsi::ClassExt<QTextDocument> decl_QTextDocument_MarkdownFeature_Enum_as_child (decl_QTextDocument_MarkdownFeature_Enum, "MarkdownFeature");
static gsi::ClassExt<QTextDocument> decl_QTextDocument_MarkdownFeature_Enums_as_child (decl_QTextDocument_MarkdownFeature_Enums, "QFlags_MarkdownFeature");
...
//  Implementation of the enum wrapper class for QTextDocument::ResourceType
namespace qt_gsi
{

static gsi::Enum<QTextDocument::ResourceType> decl_QTextDocument_ResourceType_Enum ("QtGui", "QTextDocument_ResourceType",
    gsi::enum_const ("UnknownResource", QTextDocument::UnknownResource, "@brief Enum constant QTextDocument::UnknownResource") +
    gsi::enum_const ("HtmlResource", QTextDocument::HtmlResource, "@brief Enum constant QTextDocument::HtmlResource") +
    gsi::enum_const ("ImageResource", QTextDocument::ImageResource, "@brief Enum constant QTextDocument::ImageResource") +
    gsi::enum_const ("StyleSheetResource", QTextDocument::StyleSheetResource, "@brief Enum constant QTextDocument::StyleSheetResource") +
    gsi::enum_const ("MarkdownResource", QTextDocument::MarkdownResource, "@brief Enum constant QTextDocument::MarkdownResource") +
    gsi::enum_const ("UserResource", QTextDocument::UserResource, "@brief Enum constant QTextDocument::UserResource"),
  "@qt\n@brief This class represents the QTextDocument::ResourceType enum");

static gsi::QFlagsClass<QTextDocument::ResourceType > decl_QTextDocument_ResourceType_Enums ("QtGui", "QTextDocument_QFlags_ResourceType",
  "@qt\n@brief This class represents the QFlags<QTextDocument::ResourceType> flag set");

//  Inject the declarations into the parent
static gsi::ClassExt<QTextDocument> inject_QTextDocument_ResourceType_Enum_in_parent (decl_QTextDocument_ResourceType_Enum.defs ());
static gsi::ClassExt<QTextDocument> decl_QTextDocument_ResourceType_Enum_as_child (decl_QTextDocument_ResourceType_Enum, "ResourceType");
static gsi::ClassExt<QTextDocument> decl_QTextDocument_ResourceType_Enums_as_child (decl_QTextDocument_ResourceType_Enums, "QFlags_ResourceType");
