...
//  Constructor QSqlField::QSqlField(const QString &fieldName, QMetaType type, const QString &tableName)


static void _init_ctor_QSqlField_5160 (qt_gsi::GenericStaticMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("fieldName", true, "QString()");
  decl->add_arg<const QString & > (argspec_0);
  static gsi::ArgSpecBase argspec_1 ("type", true, "QMetaType()");
  decl->add_arg<QMetaType > (argspec_1);
  static gsi::ArgSpecBase argspec_2 ("tableName", true, "QString()");
  decl->add_arg<const QString & > (argspec_2);
  decl->set_return_new<QSqlField> ();
}

static void _call_ctor_QSqlField_5160 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QString &arg1 = args ? gsi::arg_reader<const QString & >() (args, heap) : gsi::arg_maker<const QString & >() (QString(), heap);
  QMetaType arg2 = args ? gsi::arg_reader<QMetaType >() (args, heap) : gsi::arg_maker<QMetaType >() (QMetaType(), heap);
  const QString &arg3 = args ? gsi::arg_reader<const QString & >() (args, heap) : gsi::arg_maker<const QString & >() (QString(), heap);
  ret.write<QSqlField *> (new QSqlField (arg1, arg2, arg3));
}
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QMetaType > ((QMetaType)((QSqlField *)cls)->metaType ());
}
...
static void _init_f_setMetaType_1326 (qt_gsi::GenericMethod *decl)
{
...
static void _call_f_setMetaType_1326 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QMetaType arg1 = gsi::arg_reader<QMetaType >() (args, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QSqlField *)cls)->setMetaType (arg1);
}
...
static gsi::Methods methods_QSqlField () {
  gsi::Methods methods;
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QSqlField::QSqlField(const QString &fieldName, QMetaType type, const QString &tableName)\nThis method creates an object of class QSqlField.", &_init_ctor_QSqlField_5160, &_call_ctor_QSqlField_5160);
  ...
  methods += new qt_gsi::GenericMethod (":metaType", "@brief Method QMetaType QSqlField::metaType()\n", true, &_init_f_metaType_c0, &_call_f_metaType_c0);
  ...
  methods += new qt_gsi::GenericMethod ("setMetaType|metaType=", "@brief Method void QSqlField::setMetaType(QMetaType type)\n", false, &_init_f_setMetaType_1326, &_call_f_setMetaType_1326);
