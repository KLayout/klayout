...
// bool QSaveFile::open(QFlags<QIODeviceBase::OpenModeFlag> flags)
...
static gsi::Methods methods_QSaveFile () {
  ...
  methods += new qt_gsi::GenericMethod ("open", "@brief Method bool QSaveFile::open(QFlags<QIODeviceBase::OpenModeFlag> flags)\nThis is a reimplementation of QIODevice::open", false, &_init_f_open_3621, &_call_f_open_3621);
...
public:
  ...
  //  [expose] void QSaveFile::setOpenMode(QFlags<QIODeviceBase::OpenModeFlag> openMode)
  void fp_QSaveFile_setOpenMode_3621 (QFlags<QIODeviceBase::OpenModeFlag> openMode) {
  ...
  //  [adaptor impl] bool QSaveFile::open(QFlags<QIODeviceBase::OpenModeFlag> flags)
  bool cbs_open_3621_0(QFlags<QIODeviceBase::OpenModeFlag> flags)
  {
    return QSaveFile::open(flags);
  }

  virtual bool open(QFlags<QIODeviceBase::OpenModeFlag> flags)
  {
    if (cb_open_3621_0.can_issue()) {
      return cb_open_3621_0.issue<QSaveFile_Adaptor, bool, QFlags<QIODeviceBase::OpenModeFlag> >(&QSaveFile_Adaptor::cbs_open_3621_0, flags);
    } else {
      return QSaveFile::open(flags);
    }
  }
  ...
  //  [adaptor impl] qint64 QSaveFile::skipData(qint64 maxSize)
  ...
  virtual qint64 skipData(qint64 maxSize)
  {
    if (cb_skipData_986_0.can_issue()) {
      return cb_skipData_986_0.issue<QSaveFile_Adaptor, qint64, qint64>(&QSaveFile_Adaptor::cbs_skipData_986_0, maxSize);
    } else {
      return QSaveFile::skipData(maxSize);
    }
  }
...
{
  ((QSaveFile_Adaptor *)cls)->cb_open_3621_0 = cb;
}
...
// exposed void QSaveFile::setOpenMode(QFlags<QIODeviceBase::OpenModeFlag> openMode)
...
static void _call_fp_setOpenMode_3621 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  QFlags<QIODeviceBase::OpenModeFlag> arg1 = gsi::arg_reader<QFlags<QIODeviceBase::OpenModeFlag> >() (args, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QSaveFile_Adaptor *)cls)->fp_QSaveFile_setOpenMode_3621 (arg1);
}
...
// qint64 QSaveFile::skipData(qint64 maxSize)
...
{
  ((QSaveFile_Adaptor *)cls)->cb_skipData_986_0 = cb;
}
...
static gsi::Methods methods_QSaveFile_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("open", "@brief Virtual method bool QSaveFile::open(QFlags<QIODeviceBase::OpenModeFlag> flags)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_open_3621_0, &_call_cbs_open_3621_0);
