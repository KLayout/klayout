...
// bool QAbstractNativeEventFilter::nativeEventFilter(const QByteArray &eventType, void *message, QIntegerForSizeof<void *>::Signed *result)


static void _init_f_nativeEventFilter_6949 (qt_gsi::GenericMethod *decl)
{
...
static void _call_f_nativeEventFilter_6949 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
...
static gsi::Methods methods_QAbstractNativeEventFilter () {
  gsi::Methods methods;
  methods += new qt_gsi::GenericMethod ("nativeEventFilter", "@brief Method bool QAbstractNativeEventFilter::nativeEventFilter(const QByteArray &eventType, void *message, QIntegerForSizeof<void *>::Signed *result)\n", false, &_init_f_nativeEventFilter_6949, &_call_f_nativeEventFilter_6949);
  return methods;
}
...
public:
  ...
  //  [adaptor impl] bool QAbstractNativeEventFilter::nativeEventFilter(const QByteArray &eventType, void *message, QIntegerForSizeof<void *>::Signed *result)
  bool cbs_nativeEventFilter_6949_0(const QByteArray &eventType, void *message, QIntegerForSizeof<void *>::Signed *result)
  {
  ...
  virtual bool nativeEventFilter(const QByteArray &eventType, void *message, QIntegerForSizeof<void *>::Signed *result)
  {
    if (cb_nativeEventFilter_6949_0.can_issue()) {
      return cb_nativeEventFilter_6949_0.issue<QAbstractNativeEventFilter_Adaptor, bool, const QByteArray &, void *, QIntegerForSizeof<void *>::Signed *>(&QAbstractNativeEventFilter_Adaptor::cbs_nativeEventFilter_6949_0, eventType, message, result);
    } else {
      throw qt_gsi::AbstractMethodCalledException("nativeEventFilter");
    }
  }

  gsi::Callback cb_nativeEventFilter_6949_0;
};
...
static void _init_cbs_nativeEventFilter_6949_0 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("eventType");
  decl->add_arg<const QByteArray & > (argspec_0);
  static gsi::ArgSpecBase argspec_1 ("message");
...
static void _call_cbs_nativeEventFilter_6949_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
...
static void _set_callback_cbs_nativeEventFilter_6949_0 (void *cls, const gsi::Callback &cb)
{
  ((QAbstractNativeEventFilter_Adaptor *)cls)->cb_nativeEventFilter_6949_0 = cb;
}
...
static gsi::Methods methods_QAbstractNativeEventFilter_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("nativeEventFilter", "@brief Virtual method bool QAbstractNativeEventFilter::nativeEventFilter(const QByteArray &eventType, void *message, QIntegerForSizeof<void *>::Signed *result)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_nativeEventFilter_6949_0, &_call_cbs_nativeEventFilter_6949_0);
  methods += new qt_gsi::GenericMethod ("nativeEventFilter", "@hide", false, &_init_cbs_nativeEventFilter_6949_0, &_call_cbs_nativeEventFilter_6949_0, &_set_callback_cbs_nativeEventFilter_6949_0);
  return methods;
}
