...
qt_gsi::QtNativeClass<QTextEdit> decl_QTextEdit (qtdecl_QAbstractScrollArea (), "QTextEdit_Native",
  methods_QTextEdit (),
  "@hide\n@alias QTextEdit");

GSIQT_PUBLIC gsi::Class<QTextEdit> &qtdecl_QTextEdit () { return decl_QTextEdit; }
...
gsi::Class<QTextEdit_Adaptor> decl_QTextEdit_Adaptor (qtdecl_QTextEdit (), "QTextEdit",
...
static gsi::Enum<QTextEdit::AutoFormattingFlag> decl_QTextEdit_AutoFormattingFlag_Enum ("QTextEdit_AutoFormattingFlag",
...
static gsi::QFlagsClass<QTextEdit::AutoFormattingFlag > decl_QTextEdit_AutoFormattingFlag_Enums ("QTextEdit_QFlags_AutoFormattingFlag",
...
static gsi::Enum<QTextEdit::LineWrapMode> decl_QTextEdit_LineWrapMode_Enum ("QTextEdit_LineWrapMode",
...
static gsi::QFlagsClass<QTextEdit::LineWrapMode > decl_QTextEdit_LineWrapMode_Enums ("QTextEdit_QFlags_LineWrapMode",
