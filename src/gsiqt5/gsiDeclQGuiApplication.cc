...
qt_gsi::QtNativeClass<QGuiApplication> decl_QGuiApplication (qtdecl_QCoreApplication (), "QGuiApplication_Native",
...
GSIQT_PUBLIC gsi::Class<QGuiApplication> &qtdecl_QGuiApplication () { return decl_QGuiApplication; }
...
gsi::Class<QGuiApplication_Adaptor> decl_QGuiApplication_Adaptor (qtdecl_QGuiApplication (), "QGuiApplication",
