...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QEvent * > ((QEvent *)((QEvent *)cls)->clone ());
}
...
// bool QEvent::isInputEvent()


static void _init_f_isInputEvent_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<bool > ();
}

static void _call_f_isInputEvent_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<bool > ((bool)((QEvent *)cls)->isInputEvent ());
}


// bool QEvent::isPointerEvent()


static void _init_f_isPointerEvent_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<bool > ();
}

static void _call_f_isPointerEvent_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<bool > ((bool)((QEvent *)cls)->isPointerEvent ());
}


// bool QEvent::isSinglePointEvent()


static void _init_f_isSinglePointEvent_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<bool > ();
}

static void _call_f_isSinglePointEvent_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<bool > ((bool)((QEvent *)cls)->isSinglePointEvent ());
}
...
static gsi::Methods methods_QEvent () {
  ...
  methods += new qt_gsi::GenericMethod ("clone", "@brief Method QEvent *QEvent::clone()\n", true, &_init_f_clone_c0, &_call_f_clone_c0);
  ...
  methods += new qt_gsi::GenericMethod ("isInputEvent?", "@brief Method bool QEvent::isInputEvent()\n", true, &_init_f_isInputEvent_c0, &_call_f_isInputEvent_c0);
  methods += new qt_gsi::GenericMethod ("isPointerEvent?", "@brief Method bool QEvent::isPointerEvent()\n", true, &_init_f_isPointerEvent_c0, &_call_f_isPointerEvent_c0);
  methods += new qt_gsi::GenericMethod ("isSinglePointEvent?", "@brief Method bool QEvent::isSinglePointEvent()\n", true, &_init_f_isSinglePointEvent_c0, &_call_f_isSinglePointEvent_c0);
...
public:
  ...
  //  [adaptor impl] QEvent *QEvent::clone()
  ...
  virtual QEvent * clone() const
  {
    if (cb_clone_c0_0.can_issue()) {
      return cb_clone_c0_0.issue<QEvent_Adaptor, QEvent *>(&QEvent_Adaptor::cbs_clone_c0_0);
    } else {
      return QEvent::clone();
    }
  }

  //  [adaptor impl] void QEvent::setAccepted(bool accepted)
  ...
  virtual void setAccepted(bool accepted)
  {
    if (cb_setAccepted_864_0.can_issue()) {
      cb_setAccepted_864_0.issue<QEvent_Adaptor, bool>(&QEvent_Adaptor::cbs_setAccepted_864_0, accepted);
    } else {
      QEvent::setAccepted(accepted);
    }
  }
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QEvent * > ((QEvent *)((QEvent_Adaptor *)cls)->cbs_clone_c0_0 ());
}

static void _set_callback_cbs_clone_c0_0 (void *cls, const gsi::Callback &cb)
{
  ((QEvent_Adaptor *)cls)->cb_clone_c0_0 = cb;
}
...
static void _call_cbs_setAccepted_864_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QEvent_Adaptor *)cls)->cbs_setAccepted_864_0 (arg1);
}

static void _set_callback_cbs_setAccepted_864_0 (void *cls, const gsi::Callback &cb)
{
  ((QEvent_Adaptor *)cls)->cb_setAccepted_864_0 = cb;
}
...
static gsi::Enum<QEvent::Type> decl_QEvent_Type_Enum ("QtCore", "QEvent_Type",
    ...
    gsi::enum_const ("GraphicsSceneLeave", QEvent::GraphicsSceneLeave, "@brief Enum constant QEvent::GraphicsSceneLeave") +
