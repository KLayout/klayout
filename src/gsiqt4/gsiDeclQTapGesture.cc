...
qt_gsi::QtNativeClass<QTapGesture> decl_QTapGesture (qtdecl_QGesture (), "QTapGesture_Native",
  methods_QTapGesture (),
  "@hide\n@alias QTapGesture");

GSIQT_PUBLIC gsi::Class<QTapGesture> &qtdecl_QTapGesture () { return decl_QTapGesture; }
...
gsi::Class<QTapGesture_Adaptor> decl_QTapGesture_Adaptor (qtdecl_QTapGesture (), "QTapGesture",
