...
gsi::Class<QStyleOptionButton> decl_QStyleOptionButton (qtdecl_QStyleOption (), "QtGui", "QStyleOptionButton",
  methods_QStyleOptionButton (),
  "@qt\n@brief Binding of QStyleOptionButton");


GSI_QTGUI_PUBLIC gsi::Class<QStyleOptionButton> &qtdecl_QStyleOptionButton () { return decl_QStyleOptionButton; }
