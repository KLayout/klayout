...
gsi::Class<QGraphicsGridLayout> decl_QGraphicsGridLayout (qtdecl_QGraphicsLayout (), "QGraphicsGridLayout_Native",
  methods_QGraphicsGridLayout (),
  "@hide\n@alias QGraphicsGridLayout");

GSIQT_PUBLIC gsi::Class<QGraphicsGridLayout> &qtdecl_QGraphicsGridLayout () { return decl_QGraphicsGridLayout; }
...
gsi::Class<QGraphicsGridLayout_Adaptor> decl_QGraphicsGridLayout_Adaptor (qtdecl_QGraphicsGridLayout (), "QGraphicsGridLayout",
