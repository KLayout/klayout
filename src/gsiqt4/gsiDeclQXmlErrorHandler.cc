...
GSIQT_PUBLIC gsi::Class<QXmlErrorHandler> &qtdecl_QXmlErrorHandler () { return decl_QXmlErrorHandler; }
...
gsi::Class<QXmlErrorHandler_Adaptor> decl_QXmlErrorHandler_Adaptor (qtdecl_QXmlErrorHandler (), "QXmlErrorHandler",
