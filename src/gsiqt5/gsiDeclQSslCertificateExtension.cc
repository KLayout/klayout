...
gsi::Class<QSslCertificateExtension> decl_QSslCertificateExtension ("QSslCertificateExtension",
  methods_QSslCertificateExtension (),
  "@qt\n@brief Binding of QSslCertificateExtension");


GSIQT_PUBLIC gsi::Class<QSslCertificateExtension> &qtdecl_QSslCertificateExtension () { return decl_QSslCertificateExtension; }
