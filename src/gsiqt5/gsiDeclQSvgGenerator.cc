...
gsi::Class<QSvgGenerator> decl_QSvgGenerator (qtdecl_QPaintDevice (), "QSvgGenerator_Native",
  methods_QSvgGenerator (),
  "@hide\n@alias QSvgGenerator");

GSIQT_PUBLIC gsi::Class<QSvgGenerator> &qtdecl_QSvgGenerator () { return decl_QSvgGenerator; }
...
gsi::Class<QSvgGenerator_Adaptor> decl_QSvgGenerator_Adaptor (qtdecl_QSvgGenerator (), "QSvgGenerator",
