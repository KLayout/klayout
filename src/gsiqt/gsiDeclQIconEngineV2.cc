...
gsi::Class<QIconEngineV2> decl_QIconEngineV2 (qtdecl_QIconEngine (), "QIconEngineV2_Native",
  methods_QIconEngineV2 (),
  "@hide\n@alias QIconEngineV2");

GSIQT_PUBLIC gsi::Class<QIconEngineV2> &qtdecl_QIconEngineV2 () { return decl_QIconEngineV2; }
...
gsi::Class<QIconEngineV2_Adaptor> decl_QIconEngineV2_Adaptor (qtdecl_QIconEngineV2 (), "QIconEngineV2",
