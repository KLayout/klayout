...
// QList<QKeySequence> QShortcut::keys()
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QList<QKeySequence> > ((QList<QKeySequence>)((QShortcut *)cls)->keys ());
}
...
static void _init_f_setKeys_2869 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("key");
...
static void _call_f_setKeys_2869 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QShortcut *)cls)->setKeys (qt_gsi::QtToCppAdaptor<QKeySequence::StandardKey>(arg1).cref());
}
...
static void _init_f_setKeys_3131 (qt_gsi::GenericMethod *decl)
{
...
static void _call_f_setKeys_3131 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QList<QKeySequence> &arg1 = gsi::arg_reader<const QList<QKeySequence> & >() (args, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QShortcut *)cls)->setKeys (arg1);
}
...
static gsi::Methods methods_QShortcut () {
  ...
  methods += new qt_gsi::GenericMethod ("keys", "@brief Method QList<QKeySequence> QShortcut::keys()\n", true, &_init_f_keys_c0, &_call_f_keys_c0);
  ...
  methods += new qt_gsi::GenericMethod ("setKeys", "@brief Method void QShortcut::setKeys(QKeySequence::StandardKey key)\n", false, &_init_f_setKeys_2869, &_call_f_setKeys_2869);
  methods += new qt_gsi::GenericMethod ("setKeys", "@brief Method void QShortcut::setKeys(const QList<QKeySequence> &keys)\n", false, &_init_f_setKeys_3131, &_call_f_setKeys_3131);
...
public:
  ...
  //  [adaptor ctor] QShortcut::QShortcut(QObject *parent)
  QShortcut_Adaptor(QObject *parent) : QShortcut(parent)
  {
    qt_gsi::QtObjectBase::init (this);
  }

  //  [adaptor ctor] QShortcut::QShortcut(const QKeySequence &key, QObject *parent, const char *member, const char *ambiguousMember, Qt::ShortcutContext context)
  QShortcut_Adaptor(const QKeySequence &key, QObject *parent) : QShortcut(key, parent)
  {
    qt_gsi::QtObjectBase::init (this);
  }

  //  [adaptor ctor] QShortcut::QShortcut(const QKeySequence &key, QObject *parent, const char *member, const char *ambiguousMember, Qt::ShortcutContext context)
  QShortcut_Adaptor(const QKeySequence &key, QObject *parent, const char *member) : QShortcut(key, parent, member)
  {
    qt_gsi::QtObjectBase::init (this);
  }

  //  [adaptor ctor] QShortcut::QShortcut(const QKeySequence &key, QObject *parent, const char *member, const char *ambiguousMember, Qt::ShortcutContext context)
  QShortcut_Adaptor(const QKeySequence &key, QObject *parent, const char *member, const char *ambiguousMember) : QShortcut(key, parent, member, ambiguousMember)
  {
    qt_gsi::QtObjectBase::init (this);
  }

  //  [adaptor ctor] QShortcut::QShortcut(const QKeySequence &key, QObject *parent, const char *member, const char *ambiguousMember, Qt::ShortcutContext context)
  QShortcut_Adaptor(const QKeySequence &key, QObject *parent, const char *member, const char *ambiguousMember, Qt::ShortcutContext context) : QShortcut(key, parent, member, ambiguousMember, context)
  {
    qt_gsi::QtObjectBase::init (this);
  }

  //  [adaptor ctor] QShortcut::QShortcut(QKeySequence::StandardKey key, QObject *parent, const char *member, const char *ambiguousMember, Qt::ShortcutContext context)
  QShortcut_Adaptor(QKeySequence::StandardKey key, QObject *parent) : QShortcut(key, parent)
  {
    qt_gsi::QtObjectBase::init (this);
  }

  //  [adaptor ctor] QShortcut::QShortcut(QKeySequence::StandardKey key, QObject *parent, const char *member, const char *ambiguousMember, Qt::ShortcutContext context)
  QShortcut_Adaptor(QKeySequence::StandardKey key, QObject *parent, const char *member) : QShortcut(key, parent, member)
  {
    qt_gsi::QtObjectBase::init (this);
  }

  //  [adaptor ctor] QShortcut::QShortcut(QKeySequence::StandardKey key, QObject *parent, const char *member, const char *ambiguousMember, Qt::ShortcutContext context)
  QShortcut_Adaptor(QKeySequence::StandardKey key, QObject *parent, const char *member, const char *ambiguousMember) : QShortcut(key, parent, member, ambiguousMember)
  {
    qt_gsi::QtObjectBase::init (this);
  }

  //  [adaptor ctor] QShortcut::QShortcut(QKeySequence::StandardKey key, QObject *parent, const char *member, const char *ambiguousMember, Qt::ShortcutContext context)
  QShortcut_Adaptor(QKeySequence::StandardKey key, QObject *parent, const char *member, const char *ambiguousMember, Qt::ShortcutContext context) : QShortcut(key, parent, member, ambiguousMember, context)
  {
    qt_gsi::QtObjectBase::init (this);
  }
...
//  Constructor QShortcut::QShortcut(QObject *parent) (adaptor class)

static void _init_ctor_QShortcut_Adaptor_1302 (qt_gsi::GenericStaticMethod *decl)
{
...
static void _call_ctor_QShortcut_Adaptor_1302 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
...
//  Constructor QShortcut::QShortcut(const QKeySequence &key, QObject *parent, const char *member, const char *ambiguousMember, Qt::ShortcutContext context) (adaptor class)

static void _init_ctor_QShortcut_Adaptor_9198 (qt_gsi::GenericStaticMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("key");
  decl->add_arg<const QKeySequence & > (argspec_0);
...
static void _call_ctor_QShortcut_Adaptor_9198 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QKeySequence &arg1 = gsi::arg_reader<const QKeySequence & >() (args, heap);
...
//  Constructor QShortcut::QShortcut(QKeySequence::StandardKey key, QObject *parent, const char *member, const char *ambiguousMember, Qt::ShortcutContext context) (adaptor class)

static void _init_ctor_QShortcut_Adaptor_9551 (qt_gsi::GenericStaticMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("key");
  decl->add_arg<const qt_gsi::Converter<QKeySequence::StandardKey>::target_type & > (argspec_0);
  static gsi::ArgSpecBase argspec_1 ("parent");
...
static void _call_ctor_QShortcut_Adaptor_9551 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QKeySequence::StandardKey>::target_type & arg1 = gsi::arg_reader<const qt_gsi::Converter<QKeySequence::StandardKey>::target_type & >() (args, heap);
  ...
  const char *arg4 = args ? gsi::arg_reader<const char * >() (args, heap) : gsi::arg_maker<const char * >() (nullptr, heap);
  const qt_gsi::Converter<Qt::ShortcutContext>::target_type & arg5 = args ? gsi::arg_reader<const qt_gsi::Converter<Qt::ShortcutContext>::target_type & >() (args, heap) : gsi::arg_maker<const qt_gsi::Converter<Qt::ShortcutContext>::target_type & >() (qt_gsi::CppToQtReadAdaptor<Qt::ShortcutContext>(heap, Qt::WindowShortcut), heap);
  ret.write<QShortcut_Adaptor *> (new QShortcut_Adaptor (qt_gsi::QtToCppAdaptor<QKeySequence::StandardKey>(arg1).cref(), arg2, arg3, arg4, qt_gsi::QtToCppAdaptor<Qt::ShortcutContext>(arg5).cref()));
}
...
static gsi::Methods methods_QShortcut_Adaptor () {
  gsi::Methods methods;
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QShortcut::QShortcut(QObject *parent)\nThis method creates an object of class QShortcut.", &_init_ctor_QShortcut_Adaptor_1302, &_call_ctor_QShortcut_Adaptor_1302);
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QShortcut::QShortcut(const QKeySequence &key, QObject *parent, const char *member, const char *ambiguousMember, Qt::ShortcutContext context)\nThis method creates an object of class QShortcut.", &_init_ctor_QShortcut_Adaptor_9198, &_call_ctor_QShortcut_Adaptor_9198);
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QShortcut::QShortcut(QKeySequence::StandardKey key, QObject *parent, const char *member, const char *ambiguousMember, Qt::ShortcutContext context)\nThis method creates an object of class QShortcut.", &_init_ctor_QShortcut_Adaptor_9551, &_call_ctor_QShortcut_Adaptor_9551);
