...
gsi::Class<QStateMachine::WrappedEvent> decl_QStateMachine_WrappedEvent (qtdecl_QEvent (), "QStateMachine_WrappedEvent_Native",
  methods_QStateMachine_WrappedEvent (),
  "@hide\n@alias QStateMachine_WrappedEvent");

GSIQT_PUBLIC gsi::Class<QStateMachine::WrappedEvent> &qtdecl_QStateMachine_WrappedEvent () { return decl_QStateMachine_WrappedEvent; }
...
gsi::Class<QStateMachine_WrappedEvent_Adaptor> decl_QStateMachine_WrappedEvent_Adaptor (qtdecl_QStateMachine_WrappedEvent (), "QStateMachine_WrappedEvent",
