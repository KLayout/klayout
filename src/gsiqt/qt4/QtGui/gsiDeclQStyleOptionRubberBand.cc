...
gsi::Class<QStyleOptionRubberBand> decl_QStyleOptionRubberBand (qtdecl_QStyleOption (), "QtGui", "QStyleOptionRubberBand",
  methods_QStyleOptionRubberBand (),
  "@qt\n@brief Binding of QStyleOptionRubberBand");


GSI_QTGUI_PUBLIC gsi::Class<QStyleOptionRubberBand> &qtdecl_QStyleOptionRubberBand () { return decl_QStyleOptionRubberBand; }
