...
qt_gsi::QtNativeClass<QCameraInfoControl> decl_QCameraInfoControl (qtdecl_QMediaControl (), "QCameraInfoControl_Native",
  methods_QCameraInfoControl (),
  "@hide\n@alias QCameraInfoControl");

GSIQT_PUBLIC gsi::Class<QCameraInfoControl> &qtdecl_QCameraInfoControl () { return decl_QCameraInfoControl; }
...
gsi::Class<QCameraInfoControl_Adaptor> decl_QCameraInfoControl_Adaptor (qtdecl_QCameraInfoControl (), "QCameraInfoControl",
