...
qt_gsi::QtNativeClass<QTextBlockGroup> decl_QTextBlockGroup (qtdecl_QTextObject (), "QTextBlockGroup_Native",
  methods_QTextBlockGroup (),
  "@hide\n@alias QTextBlockGroup");

GSIQT_PUBLIC gsi::Class<QTextBlockGroup> &qtdecl_QTextBlockGroup () { return decl_QTextBlockGroup; }
...
gsi::Class<QTextBlockGroup_Adaptor> decl_QTextBlockGroup_Adaptor (qtdecl_QTextBlockGroup (), "QTextBlockGroup",
