...
public:
  ...
  //  [adaptor impl] bool QRubberBand::nativeEvent(const QByteArray &eventType, void *message, long int *result)
  ...
  virtual bool nativeEvent(const QByteArray &eventType, void *message, long int *result)
  {
    if (cb_nativeEvent_4678_0.can_issue()) {
      return cb_nativeEvent_4678_0.issue<QRubberBand_Adaptor, bool, const QByteArray &, void *, long int *>(&QRubberBand_Adaptor::cbs_nativeEvent_4678_0, eventType, message, result);
    } else {
      return QRubberBand::nativeEvent(eventType, message, result);
    }
  }
...
// bool QRubberBand::nativeEvent(const QByteArray &eventType, void *message, long int *result)
...
static void _call_cbs_nativeEvent_4678_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<bool > ((bool)((QRubberBand_Adaptor *)cls)->cbs_nativeEvent_4678_0 (arg1, arg2, arg3));
}

static void _set_callback_cbs_nativeEvent_4678_0 (void *cls, const gsi::Callback &cb)
{
  ((QRubberBand_Adaptor *)cls)->cb_nativeEvent_4678_0 = cb;
}
...
static gsi::Methods methods_QRubberBand_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*nativeEvent", "@brief Virtual method bool QRubberBand::nativeEvent(const QByteArray &eventType, void *message, long int *result)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_nativeEvent_4678_0, &_call_cbs_nativeEvent_4678_0);
