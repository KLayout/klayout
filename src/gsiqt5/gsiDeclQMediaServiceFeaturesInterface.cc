...
gsi::Class<QMediaServiceFeaturesInterface> decl_QMediaServiceFeaturesInterface ("QMediaServiceFeaturesInterface_Native",
  methods_QMediaServiceFeaturesInterface (),
  "@hide\n@alias QMediaServiceFeaturesInterface");

GSIQT_PUBLIC gsi::Class<QMediaServiceFeaturesInterface> &qtdecl_QMediaServiceFeaturesInterface () { return decl_QMediaServiceFeaturesInterface; }
...
gsi::Class<QMediaServiceFeaturesInterface_Adaptor> decl_QMediaServiceFeaturesInterface_Adaptor (qtdecl_QMediaServiceFeaturesInterface (), "QMediaServiceFeaturesInterface",
