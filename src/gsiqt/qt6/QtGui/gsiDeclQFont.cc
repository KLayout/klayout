...
static gsi::Methods methods_QFont () {
  ...
  methods += new qt_gsi::GenericMethod ("setFamilies|families=", "@brief Method void QFont::setFamilies(const QStringList &)\n", false, &_init_f_setFamilies_2437, &_call_f_setFamilies_2437);
  ...
  methods += new qt_gsi::GenericMethod ("setLegacyWeight|legacyWeight=", "@brief Method void QFont::setLegacyWeight(int legacyWeight)\n", false, &_init_f_setLegacyWeight_767, &_call_f_setLegacyWeight_767);
  ...
  methods += new qt_gsi::GenericMethod ("setResolveMask|resolveMask=", "@brief Method void QFont::setResolveMask(unsigned int mask)\n", false, &_init_f_setResolveMask_1772, &_call_f_setResolveMask_1772);
