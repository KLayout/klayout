...
qt_gsi::QtNativeClass<QPlainTextEdit> decl_QPlainTextEdit (qtdecl_QAbstractScrollArea (), "QPlainTextEdit_Native",
  methods_QPlainTextEdit (),
  "@hide\n@alias QPlainTextEdit");

GSIQT_PUBLIC gsi::Class<QPlainTextEdit> &qtdecl_QPlainTextEdit () { return decl_QPlainTextEdit; }
...
gsi::Class<QPlainTextEdit_Adaptor> decl_QPlainTextEdit_Adaptor (qtdecl_QPlainTextEdit (), "QPlainTextEdit",
...
static gsi::Enum<QPlainTextEdit::LineWrapMode> decl_QPlainTextEdit_LineWrapMode_Enum ("QPlainTextEdit_LineWrapMode",
...
static gsi::QFlagsClass<QPlainTextEdit::LineWrapMode > decl_QPlainTextEdit_LineWrapMode_Enums ("QPlainTextEdit_QFlags_LineWrapMode",
