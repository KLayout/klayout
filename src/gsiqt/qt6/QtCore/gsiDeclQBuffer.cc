...
// bool QBuffer::open(QFlags<QIODeviceBase::OpenModeFlag> openMode)
...
static gsi::Methods methods_QBuffer () {
  ...
  methods += new qt_gsi::GenericMethod ("open", "@brief Method bool QBuffer::open(QFlags<QIODeviceBase::OpenModeFlag> openMode)\nThis is a reimplementation of QIODevice::open", false, &_init_f_open_3621, &_call_f_open_3621);
