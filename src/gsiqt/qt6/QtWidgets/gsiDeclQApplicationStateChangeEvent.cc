...
gsi::Class<QApplicationStateChangeEvent> decl_QApplicationStateChangeEvent (qtdecl_QEvent (), "Qt", "QApplicationStateChangeEvent_Native",
  methods_QApplicationStateChangeEvent (),
  "@hide\n@alias QApplicationStateChangeEvent");

GSI_QT_PUBLIC gsi::Class<QApplicationStateChangeEvent> &qtdecl_QApplicationStateChangeEvent () { return decl_QApplicationStateChangeEvent; }
...
gsi::Class<QApplicationStateChangeEvent_Adaptor> decl_QApplicationStateChangeEvent_Adaptor (qtdecl_QApplicationStateChangeEvent (), "Qt", "QApplicationStateChangeEvent",
