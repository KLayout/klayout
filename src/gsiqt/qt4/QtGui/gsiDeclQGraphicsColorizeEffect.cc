...
qt_gsi::QtNativeClass<QGraphicsColorizeEffect> decl_QGraphicsColorizeEffect (qtdecl_QGraphicsEffect (), "QtGui", "QGraphicsColorizeEffect_Native",
  methods_QGraphicsColorizeEffect (),
  "@hide\n@alias QGraphicsColorizeEffect");

GSI_QTGUI_PUBLIC gsi::Class<QGraphicsColorizeEffect> &qtdecl_QGraphicsColorizeEffect () { return decl_QGraphicsColorizeEffect; }
...
gsi::Class<QGraphicsColorizeEffect_Adaptor> decl_QGraphicsColorizeEffect_Adaptor (qtdecl_QGraphicsColorizeEffect (), "QtGui", "QGraphicsColorizeEffect",
