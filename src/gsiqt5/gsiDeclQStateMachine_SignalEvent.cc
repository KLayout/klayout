...
gsi::Class<QStateMachine::SignalEvent> decl_QStateMachine_SignalEvent (qtdecl_QEvent (), "QStateMachine_SignalEvent_Native",
  methods_QStateMachine_SignalEvent (),
  "@hide\n@alias QStateMachine_SignalEvent");

GSIQT_PUBLIC gsi::Class<QStateMachine::SignalEvent> &qtdecl_QStateMachine_SignalEvent () { return decl_QStateMachine_SignalEvent; }
...
gsi::Class<QStateMachine_SignalEvent_Adaptor> decl_QStateMachine_SignalEvent_Adaptor (qtdecl_QStateMachine_SignalEvent (), "QStateMachine_SignalEvent",
