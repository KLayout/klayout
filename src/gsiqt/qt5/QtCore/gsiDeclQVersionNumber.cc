...
//  Constructor QVersionNumber::QVersionNumber(const QVector<int> &seg)


static void _init_ctor_QVersionNumber_2474 (qt_gsi::GenericStaticMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("seg");
  decl->add_arg<const QVector<int> & > (argspec_0);
  decl->set_return_new<QVersionNumber> ();
}

static void _call_ctor_QVersionNumber_2474 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QVector<int> &arg1 = gsi::arg_reader<const QVector<int> & >() (args, heap);
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QVector<int> > ((QVector<int>)((QVersionNumber *)cls)->segments ());
}
...
static gsi::Methods methods_QVersionNumber () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QVersionNumber::QVersionNumber(const QVector<int> &seg)\nThis method creates an object of class QVersionNumber.", &_init_ctor_QVersionNumber_2474, &_call_ctor_QVersionNumber_2474);
  ...
  methods += new qt_gsi::GenericMethod ("segments", "@brief Method QVector<int> QVersionNumber::segments()\n", true, &_init_f_segments_c0, &_call_f_segments_c0);
