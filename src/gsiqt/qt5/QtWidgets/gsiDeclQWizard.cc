...
public:
  ...
  //  [adaptor impl] void QWizard::enterEvent(QEvent *event)
  ...
  virtual void enterEvent(QEvent *event)
  {
    if (cb_enterEvent_1217_0.can_issue()) {
      cb_enterEvent_1217_0.issue<QWizard_Adaptor, QEvent *>(&QWizard_Adaptor::cbs_enterEvent_1217_0, event);
    } else {
      QWizard::enterEvent(event);
    }
  }
  ...
  //  [adaptor impl] bool QWizard::nativeEvent(const QByteArray &eventType, void *message, long int *result)
  ...
  virtual bool nativeEvent(const QByteArray &eventType, void *message, long int *result)
  {
    if (cb_nativeEvent_4678_0.can_issue()) {
      return cb_nativeEvent_4678_0.issue<QWizard_Adaptor, bool, const QByteArray &, void *, long int *>(&QWizard_Adaptor::cbs_nativeEvent_4678_0, eventType, message, result);
    } else {
      return QWizard::nativeEvent(eventType, message, result);
    }
  }
...
// void QWizard::enterEvent(QEvent *event)
...
// bool QWizard::nativeEvent(const QByteArray &eventType, void *message, long int *result)
...
static void _call_cbs_nativeEvent_4678_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<bool > ((bool)((QWizard_Adaptor *)cls)->cbs_nativeEvent_4678_0 (arg1, arg2, arg3));
}

static void _set_callback_cbs_nativeEvent_4678_0 (void *cls, const gsi::Callback &cb)
{
  ((QWizard_Adaptor *)cls)->cb_nativeEvent_4678_0 = cb;
}
...
static gsi::Methods methods_QWizard_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*nativeEvent", "@brief Virtual method bool QWizard::nativeEvent(const QByteArray &eventType, void *message, long int *result)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_nativeEvent_4678_0, &_call_cbs_nativeEvent_4678_0);
