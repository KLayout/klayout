...
GSIQT_PUBLIC gsi::Class<QXmlAttributes> &qtdecl_QXmlAttributes () { return decl_QXmlAttributes; }
...
gsi::Class<QXmlAttributes_Adaptor> decl_QXmlAttributes_Adaptor (qtdecl_QXmlAttributes (), "QXmlAttributes",
