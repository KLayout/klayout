...
qt_gsi::QtNativeClass<QFontComboBox> decl_QFontComboBox (qtdecl_QComboBox (), "QFontComboBox_Native",
  methods_QFontComboBox (),
  "@hide\n@alias QFontComboBox");

GSIQT_PUBLIC gsi::Class<QFontComboBox> &qtdecl_QFontComboBox () { return decl_QFontComboBox; }
...
gsi::Class<QFontComboBox_Adaptor> decl_QFontComboBox_Adaptor (qtdecl_QFontComboBox (), "QFontComboBox",
...
static gsi::Enum<QFontComboBox::FontFilter> decl_QFontComboBox_FontFilter_Enum ("QFontComboBox_FontFilter",
...
static gsi::QFlagsClass<QFontComboBox::FontFilter > decl_QFontComboBox_FontFilter_Enums ("QFontComboBox_QFlags_FontFilter",
