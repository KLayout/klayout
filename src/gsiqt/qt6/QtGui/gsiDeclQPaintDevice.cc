...
// double QPaintDevice::devicePixelRatio()
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<double > ((double)((QPaintDevice *)cls)->devicePixelRatio ());
}
...
static gsi::Methods methods_QPaintDevice () {
  ...
  methods += new qt_gsi::GenericMethod ("devicePixelRatio", "@brief Method double QPaintDevice::devicePixelRatio()\n", true, &_init_f_devicePixelRatio_c0, &_call_f_devicePixelRatio_c0);
