...
gsi::Class<QCameraViewfinderSettings> decl_QCameraViewfinderSettings ("QCameraViewfinderSettings",
  methods_QCameraViewfinderSettings (),
  "@qt\n@brief Binding of QCameraViewfinderSettings");


GSIQT_PUBLIC gsi::Class<QCameraViewfinderSettings> &qtdecl_QCameraViewfinderSettings () { return decl_QCameraViewfinderSettings; }
