...
// bool QTextTableFormat::borderCollapse()


static void _init_f_borderCollapse_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<bool > ();
}

static void _call_f_borderCollapse_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<bool > ((bool)((QTextTableFormat *)cls)->borderCollapse ());
}
...
// QList<QTextLength> QTextTableFormat::columnWidthConstraints()
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QList<QTextLength> > ((QList<QTextLength>)((QTextTableFormat *)cls)->columnWidthConstraints ());
}
...
static void _init_f_setBorderCollapse_864 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("borderCollapse");
  decl->add_arg<bool > (argspec_0);
  decl->set_return<void > ();
}

static void _call_f_setBorderCollapse_864 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  bool arg1 = gsi::arg_reader<bool >() (args, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QTextTableFormat *)cls)->setBorderCollapse (arg1);
}
...
static void _init_f_setColumnWidthConstraints_3040 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("constraints");
  decl->add_arg<const QList<QTextLength> & > (argspec_0);
  decl->set_return<void > ();
}

static void _call_f_setColumnWidthConstraints_3040 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QList<QTextLength> &arg1 = gsi::arg_reader<const QList<QTextLength> & >() (args, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
...
static gsi::Methods methods_QTextTableFormat () {
  ...
  methods += new qt_gsi::GenericMethod (":columnWidthConstraints", "@brief Method QList<QTextLength> QTextTableFormat::columnWidthConstraints()\n", true, &_init_f_columnWidthConstraints_c0, &_call_f_columnWidthConstraints_c0);
