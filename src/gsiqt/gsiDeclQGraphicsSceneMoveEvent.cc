...
gsi::Class<QGraphicsSceneMoveEvent> decl_QGraphicsSceneMoveEvent (qtdecl_QGraphicsSceneEvent (), "QGraphicsSceneMoveEvent_Native",
  methods_QGraphicsSceneMoveEvent (),
  "@hide\n@alias QGraphicsSceneMoveEvent");

GSIQT_PUBLIC gsi::Class<QGraphicsSceneMoveEvent> &qtdecl_QGraphicsSceneMoveEvent () { return decl_QGraphicsSceneMoveEvent; }
...
gsi::Class<QGraphicsSceneMoveEvent_Adaptor> decl_QGraphicsSceneMoveEvent_Adaptor (qtdecl_QGraphicsSceneMoveEvent (), "QGraphicsSceneMoveEvent",
