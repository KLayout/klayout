...
// int QSqlDriver::maximumIdentifierLength(QSqlDriver::IdentifierType type)


static void _init_f_maximumIdentifierLength_c3002 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("type");
  decl->add_arg<const qt_gsi::Converter<QSqlDriver::IdentifierType>::target_type & > (argspec_0);
  decl->set_return<int > ();
}

static void _call_f_maximumIdentifierLength_c3002 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QSqlDriver::IdentifierType>::target_type & arg1 = gsi::arg_reader<const qt_gsi::Converter<QSqlDriver::IdentifierType>::target_type & >() (args, heap);
  ret.write<int > ((int)((QSqlDriver *)cls)->maximumIdentifierLength (qt_gsi::QtToCppAdaptor<QSqlDriver::IdentifierType>(arg1).cref()));
}
...
static gsi::Methods methods_QSqlDriver () {
  ...
  methods += new qt_gsi::GenericMethod ("maximumIdentifierLength", "@brief Method int QSqlDriver::maximumIdentifierLength(QSqlDriver::IdentifierType type)\n", true, &_init_f_maximumIdentifierLength_c3002, &_call_f_maximumIdentifierLength_c3002);
...
public:
  ...
  //  [adaptor impl] int QSqlDriver::maximumIdentifierLength(QSqlDriver::IdentifierType type)
  int cbs_maximumIdentifierLength_c3002_0(const qt_gsi::Converter<QSqlDriver::IdentifierType>::target_type & type) const
  {
    return QSqlDriver::maximumIdentifierLength(qt_gsi::QtToCppAdaptor<QSqlDriver::IdentifierType>(type).cref());
  }

  virtual int maximumIdentifierLength(QSqlDriver::IdentifierType type) const
  {
    if (cb_maximumIdentifierLength_c3002_0.can_issue()) {
      return cb_maximumIdentifierLength_c3002_0.issue<QSqlDriver_Adaptor, int, const qt_gsi::Converter<QSqlDriver::IdentifierType>::target_type &>(&QSqlDriver_Adaptor::cbs_maximumIdentifierLength_c3002_0, qt_gsi::CppToQtAdaptor<QSqlDriver::IdentifierType>(type));
    } else {
  ...
  gsi::Callback cb_maximumIdentifierLength_c3002_0;
...
static void _init_cbs_maximumIdentifierLength_c3002_0 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("type");
  decl->add_arg<const qt_gsi::Converter<QSqlDriver::IdentifierType>::target_type & > (argspec_0);
  decl->set_return<int > ();
...
static void _call_cbs_maximumIdentifierLength_c3002_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QSqlDriver::IdentifierType>::target_type & arg1 = args.read<const qt_gsi::Converter<QSqlDriver::IdentifierType>::target_type & > (heap);
  ret.write<int > ((int)((QSqlDriver_Adaptor *)cls)->cbs_maximumIdentifierLength_c3002_0 (arg1));
}

static void _set_callback_cbs_maximumIdentifierLength_c3002_0 (void *cls, const gsi::Callback &cb)
{
  ((QSqlDriver_Adaptor *)cls)->cb_maximumIdentifierLength_c3002_0 = cb;
}
...
static gsi::Methods methods_QSqlDriver_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("maximumIdentifierLength", "@brief Virtual method int QSqlDriver::maximumIdentifierLength(QSqlDriver::IdentifierType type)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_maximumIdentifierLength_c3002_0, &_call_cbs_maximumIdentifierLength_c3002_0);
  methods += new qt_gsi::GenericMethod ("maximumIdentifierLength", "@hide", true, &_init_cbs_maximumIdentifierLength_c3002_0, &_call_cbs_maximumIdentifierLength_c3002_0, &_set_callback_cbs_maximumIdentifierLength_c3002_0);
