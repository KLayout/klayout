...
qt_gsi::QtNativeClass<QAbstractVideoSurface> decl_QAbstractVideoSurface (qtdecl_QObject (), "QAbstractVideoSurface_Native",
  methods_QAbstractVideoSurface (),
  "@hide\n@alias QAbstractVideoSurface");

GSIQT_PUBLIC gsi::Class<QAbstractVideoSurface> &qtdecl_QAbstractVideoSurface () { return decl_QAbstractVideoSurface; }
...
static void _call_fp_setError_3191 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QAbstractVideoSurface::Error>::target_type & arg1 = args.read<const qt_gsi::Converter<QAbstractVideoSurface::Error>::target_type & > (heap);
  __SUPPRESS_UNUSED_WARNING(ret);
...
gsi::Class<QAbstractVideoSurface_Adaptor> decl_QAbstractVideoSurface_Adaptor (qtdecl_QAbstractVideoSurface (), "QAbstractVideoSurface",
...
static gsi::Enum<QAbstractVideoSurface::Error> decl_QAbstractVideoSurface_Error_Enum ("QAbstractVideoSurface_Error",
...
static gsi::QFlagsClass<QAbstractVideoSurface::Error > decl_QAbstractVideoSurface_Error_Enums ("QAbstractVideoSurface_QFlags_Error",
