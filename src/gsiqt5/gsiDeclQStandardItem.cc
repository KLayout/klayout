...
static void _call_f_data_c767 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  int arg1 = args ? args.read<int > (heap) : (int)(Qt::UserRole + 1);
...
static void _call_f_setData_2778u1 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  int arg2 = args ? args.read<int > (heap) : (int)(Qt::UserRole + 1);
  __SUPPRESS_UNUSED_WARNING(ret);
...
GSIQT_PUBLIC gsi::Class<QStandardItem> &qtdecl_QStandardItem () { return decl_QStandardItem; }
...
gsi::Class<QStandardItem_Adaptor> decl_QStandardItem_Adaptor (qtdecl_QStandardItem (), "QStandardItem",
