...
//  Constructor QTextDecoder::QTextDecoder(const QTextCodec *codec, QTextCodec::ConversionFlags flags)


static void _init_ctor_QTextDecoder_5276 (qt_gsi::GenericStaticMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("codec");
  decl->add_arg<const QTextCodec * > (argspec_0);
...
static void _call_ctor_QTextDecoder_5276 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QTextCodec *arg1 = gsi::arg_reader<const QTextCodec * >() (args, heap);
...
static gsi::Methods methods_QTextDecoder () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QTextDecoder::QTextDecoder(const QTextCodec *codec, QTextCodec::ConversionFlags flags)\nThis method creates an object of class QTextDecoder.", &_init_ctor_QTextDecoder_5276, &_call_ctor_QTextDecoder_5276);
...
gsi::Class<QTextDecoder> decl_QTextDecoder ("QtCore5Compat", "QTextDecoder",
  methods_QTextDecoder (),
  "@qt\n@brief Binding of QTextDecoder");


GSI_QTCORE5COMPAT_PUBLIC gsi::Class<QTextDecoder> &qtdecl_QTextDecoder () { return decl_QTextDecoder; }
