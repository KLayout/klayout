...
gsi::Class<QAbstractGraphicsShapeItem> decl_QAbstractGraphicsShapeItem (qtdecl_QGraphicsItem (), "QtWidgets", "QAbstractGraphicsShapeItem_Native",
  methods_QAbstractGraphicsShapeItem (),
  "@hide\n@alias QAbstractGraphicsShapeItem");

GSI_QTWIDGETS_PUBLIC gsi::Class<QAbstractGraphicsShapeItem> &qtdecl_QAbstractGraphicsShapeItem () { return decl_QAbstractGraphicsShapeItem; }
...
gsi::Class<QAbstractGraphicsShapeItem_Adaptor> decl_QAbstractGraphicsShapeItem_Adaptor (qtdecl_QAbstractGraphicsShapeItem (), "QtWidgets", "QAbstractGraphicsShapeItem",
