...
gsi::Class<QMediaServiceProviderFactoryInterface> decl_QMediaServiceProviderFactoryInterface ("QMediaServiceProviderFactoryInterface_Native",
  methods_QMediaServiceProviderFactoryInterface (),
  "@hide\n@alias QMediaServiceProviderFactoryInterface");

GSIQT_PUBLIC gsi::Class<QMediaServiceProviderFactoryInterface> &qtdecl_QMediaServiceProviderFactoryInterface () { return decl_QMediaServiceProviderFactoryInterface; }
...
public:
  ...
  QMediaService * cbs_create_2025u1_0(QString const &key)
  {
  ...
  virtual QMediaService * create(QString const &key)
  {
    if (cb_create_2025u1_0.can_issue()) {
      return cb_create_2025u1_0.issue<QMediaServiceProviderFactoryInterface_Adaptor, QMediaService *, QString const &>(&QMediaServiceProviderFactoryInterface_Adaptor::cbs_create_2025u1_0, key);
    } else {
      throw qt_gsi::AbstractMethodCalledException("create");
    }
  }
...
static void _call_cbs_create_2025u1_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  QString const &arg1 = args.read<QString const & > (heap);
  ret.write<QMediaService * > ((QMediaService *)((QMediaServiceProviderFactoryInterface_Adaptor *)cls)->cbs_create_2025u1_0 (arg1));
}

static void _set_callback_cbs_create_2025u1_0 (void *cls, const gsi::Callback &cb)
{
  ((QMediaServiceProviderFactoryInterface_Adaptor *)cls)->cb_create_2025u1_0 = cb;
}
...
static gsi::Methods methods_QMediaServiceProviderFactoryInterface_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("qt_create", "@hide", false, &_init_cbs_create_2025u1_0, &_call_cbs_create_2025u1_0);
  methods += new qt_gsi::GenericMethod ("qt_create", "@brief Virtual method QMediaService *QMediaServiceProviderFactoryInterface::create(QString const &key)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_create_2025u1_0, &_call_cbs_create_2025u1_0, &_set_callback_cbs_create_2025u1_0);
...
gsi::Class<QMediaServiceProviderFactoryInterface_Adaptor> decl_QMediaServiceProviderFactoryInterface_Adaptor (qtdecl_QMediaServiceProviderFactoryInterface (), "QMediaServiceProviderFactoryInterface",
