...
public:
  ...
  //  [expose] void QListWidget::initStyleOption(QStyleOptionFrame *option)
  void fp_QListWidget_initStyleOption_c2356 (QStyleOptionFrame *option) const {
  ...
  //  [adaptor impl] void QListWidget::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
  ...
  virtual void dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
  {
    if (cb_dataChanged_7048_1.can_issue()) {
      cb_dataChanged_7048_1.issue<QListWidget_Adaptor, const QModelIndex &, const QModelIndex &, const QVector<int> &>(&QListWidget_Adaptor::cbs_dataChanged_7048_1, topLeft, bottomRight, roles);
    } else {
      QListWidget::dataChanged(topLeft, bottomRight, roles);
    }
  }
  ...
  //  [adaptor impl] bool QListWidget::nativeEvent(const QByteArray &eventType, void *message, long int *result)
  ...
  virtual bool nativeEvent(const QByteArray &eventType, void *message, long int *result)
  {
    if (cb_nativeEvent_4678_0.can_issue()) {
      return cb_nativeEvent_4678_0.issue<QListWidget_Adaptor, bool, const QByteArray &, void *, long int *>(&QListWidget_Adaptor::cbs_nativeEvent_4678_0, eventType, message, result);
    } else {
      return QListWidget::nativeEvent(eventType, message, result);
    }
  }
...
// void QListWidget::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
...
static void _call_cbs_dataChanged_7048_1 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QListWidget_Adaptor *)cls)->cbs_dataChanged_7048_1 (arg1, arg2, arg3);
}

static void _set_callback_cbs_dataChanged_7048_1 (void *cls, const gsi::Callback &cb)
{
  ((QListWidget_Adaptor *)cls)->cb_dataChanged_7048_1 = cb;
}
...
// exposed void QListWidget::initStyleOption(QStyleOptionFrame *option)
...
// bool QListWidget::nativeEvent(const QByteArray &eventType, void *message, long int *result)
...
static void _call_cbs_nativeEvent_4678_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<bool > ((bool)((QListWidget_Adaptor *)cls)->cbs_nativeEvent_4678_0 (arg1, arg2, arg3));
}

static void _set_callback_cbs_nativeEvent_4678_0 (void *cls, const gsi::Callback &cb)
{
  ((QListWidget_Adaptor *)cls)->cb_nativeEvent_4678_0 = cb;
}
