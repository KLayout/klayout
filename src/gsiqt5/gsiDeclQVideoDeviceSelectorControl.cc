...
qt_gsi::QtNativeClass<QVideoDeviceSelectorControl> decl_QVideoDeviceSelectorControl (qtdecl_QMediaControl (), "QVideoDeviceSelectorControl_Native",
  methods_QVideoDeviceSelectorControl (),
  "@hide\n@alias QVideoDeviceSelectorControl");

GSIQT_PUBLIC gsi::Class<QVideoDeviceSelectorControl> &qtdecl_QVideoDeviceSelectorControl () { return decl_QVideoDeviceSelectorControl; }
...
gsi::Class<QVideoDeviceSelectorControl_Adaptor> decl_QVideoDeviceSelectorControl_Adaptor (qtdecl_QVideoDeviceSelectorControl (), "QVideoDeviceSelectorControl",
