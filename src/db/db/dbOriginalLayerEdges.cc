...
bool OriginalLayerEdges::empty () const
{
  return m_iter.at_end_no_lock ();
}

bool OriginalLayerEdges::is_merged () const
{
  return m_is_merged;
}
...
bool OriginalLayerEdges::has_valid_edges () const
{
  return false;
}
...
void OriginalLayerEdges::apply_property_translator (const db::PropertiesTranslator &pt)
{
