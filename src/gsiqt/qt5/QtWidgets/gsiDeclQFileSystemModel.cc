...
qt_gsi::QtNativeClass<QFileSystemModel> decl_QFileSystemModel (qtdecl_QAbstractItemModel (), "QtWidgets", "QFileSystemModel_Native",
  methods_QFileSystemModel (),
  "@hide\n@alias QFileSystemModel");

GSI_QTWIDGETS_PUBLIC gsi::Class<QFileSystemModel> &qtdecl_QFileSystemModel () { return decl_QFileSystemModel; }
...
gsi::Class<QFileSystemModel_Adaptor> decl_QFileSystemModel_Adaptor (qtdecl_QFileSystemModel (), "QtWidgets", "QFileSystemModel",
