...
static gsi::Methods methods_QPointF () {
  ...
  methods += gsi::method_ext("+", &::op_QPointF_operator_plus__1986, "@brief Operator const QPointF ::operator+(const QPointF &p)\nThis is the mapping of the global operator to the instance method.");
  methods += gsi::method_ext("-", &::op_QPointF_operator_minus__1986, "@brief Operator const QPointF ::operator-(const QPointF &p)\nThis is the mapping of the global operator to the instance method.");
  methods += gsi::method_ext("/", &::op_QPointF_operator_slash__2847, gsi::arg ("divisor"), "@brief Operator const QPointF ::operator/(const QPointF &p, qreal divisor)\nThis is the mapping of the global operator to the instance method.");
  return methods;
}
