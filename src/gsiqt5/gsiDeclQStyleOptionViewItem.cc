...
gsi::Class<QStyleOptionViewItem> decl_QStyleOptionViewItem (qtdecl_QStyleOption (), "QStyleOptionViewItem",
  methods_QStyleOptionViewItem (),
  "@qt\n@brief Binding of QStyleOptionViewItem");


GSIQT_PUBLIC gsi::Class<QStyleOptionViewItem> &qtdecl_QStyleOptionViewItem () { return decl_QStyleOptionViewItem; }
