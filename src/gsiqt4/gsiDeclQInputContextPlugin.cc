...
qt_gsi::QtNativeClass<QInputContextPlugin> decl_QInputContextPlugin (qtdecl_QObject (), "QInputContextPlugin_Native",
  methods_QInputContextPlugin (),
  "@hide\n@alias QInputContextPlugin");

GSIQT_PUBLIC gsi::Class<QInputContextPlugin> &qtdecl_QInputContextPlugin () { return decl_QInputContextPlugin; }
...
static gsi::Methods methods_QInputContextPlugin_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("description", "@hide", false, &_init_cbs_description_2025_0, &_call_cbs_description_2025_0);
  ...
  methods += new qt_gsi::GenericMethod ("displayName", "@hide", false, &_init_cbs_displayName_2025_0, &_call_cbs_displayName_2025_0);
  ...
  methods += new qt_gsi::GenericMethod ("languages", "@hide", false, &_init_cbs_languages_2025_0, &_call_cbs_languages_2025_0);
...
gsi::Class<QInputContextPlugin_Adaptor> decl_QInputContextPlugin_Adaptor (qtdecl_QInputContextPlugin (), "QInputContextPlugin",
