...
public:
  ...
  //  [adaptor impl] void QFrame::enterEvent(QEvent *event)
  ...
  virtual void enterEvent(QEvent *event)
  {
    if (cb_enterEvent_1217_0.can_issue()) {
      cb_enterEvent_1217_0.issue<QFrame_Adaptor, QEvent *>(&QFrame_Adaptor::cbs_enterEvent_1217_0, event);
    } else {
      QFrame::enterEvent(event);
    }
  }
...
// void QFrame::enterEvent(QEvent *event)
