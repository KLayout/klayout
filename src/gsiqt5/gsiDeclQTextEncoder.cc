...
//  Constructor QTextEncoder::QTextEncoder(const QTextCodec *codec, QFlags<QTextCodec::ConversionFlag> flags)


static void _init_ctor_QTextEncoder_5857 (qt_gsi::GenericStaticMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("codec");
  decl->add_arg<const QTextCodec * > (argspec_0);
...
static void _call_ctor_QTextEncoder_5857 (const qt_gsi::GenericStaticMethod * /*decl*/, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QTextCodec *arg1 = args.read<const QTextCodec * > (heap);
...
static gsi::Methods methods_QTextEncoder () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QTextEncoder::QTextEncoder(const QTextCodec *codec, QFlags<QTextCodec::ConversionFlag> flags)\nThis method creates an object of class QTextEncoder.", &_init_ctor_QTextEncoder_5857, &_call_ctor_QTextEncoder_5857);
