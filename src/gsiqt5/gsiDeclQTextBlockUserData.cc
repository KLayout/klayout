...
GSIQT_PUBLIC gsi::Class<QTextBlockUserData> &qtdecl_QTextBlockUserData () { return decl_QTextBlockUserData; }
...
gsi::Class<QTextBlockUserData_Adaptor> decl_QTextBlockUserData_Adaptor (qtdecl_QTextBlockUserData (), "QTextBlockUserData",
