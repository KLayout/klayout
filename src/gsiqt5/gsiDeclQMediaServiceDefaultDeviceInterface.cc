...
gsi::Class<QMediaServiceDefaultDeviceInterface> decl_QMediaServiceDefaultDeviceInterface ("QMediaServiceDefaultDeviceInterface_Native",
  methods_QMediaServiceDefaultDeviceInterface (),
  "@hide\n@alias QMediaServiceDefaultDeviceInterface");

GSIQT_PUBLIC gsi::Class<QMediaServiceDefaultDeviceInterface> &qtdecl_QMediaServiceDefaultDeviceInterface () { return decl_QMediaServiceDefaultDeviceInterface; }
...
gsi::Class<QMediaServiceDefaultDeviceInterface_Adaptor> decl_QMediaServiceDefaultDeviceInterface_Adaptor (qtdecl_QMediaServiceDefaultDeviceInterface (), "QMediaServiceDefaultDeviceInterface",
