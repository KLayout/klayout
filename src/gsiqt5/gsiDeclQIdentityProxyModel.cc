...
// static QString QIdentityProxyModel::trUtf8(const char *s, const char *c, int n)
...
qt_gsi::QtNativeClass<QIdentityProxyModel> decl_QIdentityProxyModel (qtdecl_QAbstractProxyModel (), "QIdentityProxyModel_Native",
  methods_QIdentityProxyModel (),
  "@hide\n@alias QIdentityProxyModel");

GSIQT_PUBLIC gsi::Class<QIdentityProxyModel> &qtdecl_QIdentityProxyModel () { return decl_QIdentityProxyModel; }
...
public:
  ...
  //  [expose] QModelIndex QIdentityProxyModel::createIndex(int row, int column, void *data)
  QModelIndex fp_QIdentityProxyModel_createIndex_c2374 (int row, int column, void *data) const {
  ...
  //  [expose] void QIdentityProxyModel::resetInternalData()
  void fp_QIdentityProxyModel_resetInternalData_0 () {
  ...
  //  [emitter impl] void QIdentityProxyModel::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
  void emitter_QIdentityProxyModel_dataChanged_7048(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
  {
...
// emitter void QIdentityProxyModel::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
...
// exposed void QIdentityProxyModel::resetInternalData()
...
static void _call_fp_resetInternalData_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QIdentityProxyModel_Adaptor *)cls)->fp_QIdentityProxyModel_resetInternalData_0 ();
}
...
static gsi::Methods methods_QIdentityProxyModel_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("emit_dataChanged", "@brief Emitter for signal void QIdentityProxyModel::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)\nCall this method to emit this signal.", false, &_init_emitter_dataChanged_7048, &_call_emitter_dataChanged_7048);
...
gsi::Class<QIdentityProxyModel_Adaptor> decl_QIdentityProxyModel_Adaptor (qtdecl_QIdentityProxyModel (), "QIdentityProxyModel",
