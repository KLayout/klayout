...
static gsi::Methods methods_QCommonStyle () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QCommonStyle::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
...
qt_gsi::QtNativeClass<QCommonStyle> decl_QCommonStyle (qtdecl_QStyle (), "QtGui", "QCommonStyle_Native",
  methods_QCommonStyle (),
  "@hide\n@alias QCommonStyle");

GSI_QTGUI_PUBLIC gsi::Class<QCommonStyle> &qtdecl_QCommonStyle () { return decl_QCommonStyle; }
...
public:
  ...
  //  [expose] int QCommonStyle::layoutSpacingImplementation(QSizePolicy::ControlType control1, QSizePolicy::ControlType control2, Qt::Orientation orientation, const QStyleOption *option, const QWidget *widget)
  ...
  //  [expose] QIcon QCommonStyle::standardIconImplementation(QStyle::StandardPixmap standardIcon, const QStyleOption *opt, const QWidget *widget)
...
// exposed int QCommonStyle::layoutSpacingImplementation(QSizePolicy::ControlType control1, QSizePolicy::ControlType control2, Qt::Orientation orientation, const QStyleOption *option, const QWidget *widget)
...
// exposed QIcon QCommonStyle::standardIconImplementation(QStyle::StandardPixmap standardIcon, const QStyleOption *opt, const QWidget *widget)
...
static gsi::Methods methods_QCommonStyle_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*layoutSpacingImplementation", "@brief Method int QCommonStyle::layoutSpacingImplementation(QSizePolicy::ControlType control1, QSizePolicy::ControlType control2, Qt::Orientation orientation, const QStyleOption *option, const QWidget *widget)\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_layoutSpacingImplementation_c11697, &_call_fp_layoutSpacingImplementation_c11697);
  ...
  methods += new qt_gsi::GenericMethod ("*standardIconImplementation", "@brief Method QIcon QCommonStyle::standardIconImplementation(QStyle::StandardPixmap standardIcon, const QStyleOption *opt, const QWidget *widget)\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_standardIconImplementation_c6956, &_call_fp_standardIconImplementation_c6956);
...
gsi::Class<QCommonStyle_Adaptor> decl_QCommonStyle_Adaptor (qtdecl_QCommonStyle (), "QtGui", "QCommonStyle",
