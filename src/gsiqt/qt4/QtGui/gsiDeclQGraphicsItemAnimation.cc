...
qt_gsi::QtNativeClass<QGraphicsItemAnimation> decl_QGraphicsItemAnimation (qtdecl_QObject (), "QtGui", "QGraphicsItemAnimation_Native",
  methods_QGraphicsItemAnimation (),
  "@hide\n@alias QGraphicsItemAnimation");

GSI_QTGUI_PUBLIC gsi::Class<QGraphicsItemAnimation> &qtdecl_QGraphicsItemAnimation () { return decl_QGraphicsItemAnimation; }
...
gsi::Class<QGraphicsItemAnimation_Adaptor> decl_QGraphicsItemAnimation_Adaptor (qtdecl_QGraphicsItemAnimation (), "QtGui", "QGraphicsItemAnimation",
