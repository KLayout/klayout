...
qt_gsi::QtNativeClass<QRubberBand> decl_QRubberBand (qtdecl_QWidget (), "QRubberBand_Native",
  methods_QRubberBand (),
  "@hide\n@alias QRubberBand");

GSIQT_PUBLIC gsi::Class<QRubberBand> &qtdecl_QRubberBand () { return decl_QRubberBand; }
...
gsi::Class<QRubberBand_Adaptor> decl_QRubberBand_Adaptor (qtdecl_QRubberBand (), "QRubberBand",
...
static gsi::Enum<QRubberBand::Shape> decl_QRubberBand_Shape_Enum ("QRubberBand_Shape",
...
static gsi::QFlagsClass<QRubberBand::Shape > decl_QRubberBand_Shape_Enums ("QRubberBand_QFlags_Shape",
