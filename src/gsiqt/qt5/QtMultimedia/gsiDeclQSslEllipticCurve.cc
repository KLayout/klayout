...
gsi::Class<QSslEllipticCurve> decl_QSslEllipticCurve ("QtMultimedia", "QSslEllipticCurve",
  methods_QSslEllipticCurve (),
  "@qt\n@brief Binding of QSslEllipticCurve");


GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QSslEllipticCurve> &qtdecl_QSslEllipticCurve () { return decl_QSslEllipticCurve; }
