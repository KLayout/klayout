...
qt_gsi::QtNativeClass<QRadioData> decl_QRadioData (qtdecl_QObject (), "QRadioData_Native",
  methods_QRadioData (),
  "@hide\n@alias QRadioData");

GSIQT_PUBLIC gsi::Class<QRadioData> &qtdecl_QRadioData () { return decl_QRadioData; }
...
gsi::Class<QRadioData_Adaptor> decl_QRadioData_Adaptor (qtdecl_QRadioData (), "QRadioData",
...
static gsi::Enum<QRadioData::Error> decl_QRadioData_Error_Enum ("QRadioData_Error",
...
static gsi::QFlagsClass<QRadioData::Error > decl_QRadioData_Error_Enums ("QRadioData_QFlags_Error",
...
static gsi::Enum<QRadioData::ProgramType> decl_QRadioData_ProgramType_Enum ("QRadioData_ProgramType",
...
static gsi::QFlagsClass<QRadioData::ProgramType > decl_QRadioData_ProgramType_Enums ("QRadioData_QFlags_ProgramType",
