...
static void _init_f_activeConfiguration_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<QNetworkConfiguration > ();
}

static void _call_f_activeConfiguration_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QNetworkConfiguration > ((QNetworkConfiguration)((QNetworkAccessManager *)cls)->activeConfiguration ());
}
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QNetworkConfiguration > ((QNetworkConfiguration)((QNetworkAccessManager *)cls)->configuration ());
}
...
static void _init_f_networkAccessible_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<qt_gsi::Converter<QNetworkAccessManager::NetworkAccessibility>::target_type > ();
}

static void _call_f_networkAccessible_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<qt_gsi::Converter<QNetworkAccessManager::NetworkAccessibility>::target_type > ((qt_gsi::Converter<QNetworkAccessManager::NetworkAccessibility>::target_type)qt_gsi::CppToQtAdaptor<QNetworkAccessManager::NetworkAccessibility>(((QNetworkAccessManager *)cls)->networkAccessible ()));
}
...
static void _init_f_setConfiguration_3508 (qt_gsi::GenericMethod *decl)
{
...
static void _call_f_setConfiguration_3508 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QNetworkConfiguration &arg1 = args.read<const QNetworkConfiguration & > (heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QNetworkAccessManager *)cls)->setConfiguration (arg1);
}
...
static void _init_f_setNetworkAccessible_4770 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("accessible");
  decl->add_arg<const qt_gsi::Converter<QNetworkAccessManager::NetworkAccessibility>::target_type & > (argspec_0);
  decl->set_return<void > ();
}

static void _call_f_setNetworkAccessible_4770 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QNetworkAccessManager *)cls)->setNetworkAccessible (qt_gsi::QtToCppAdaptor<QNetworkAccessManager::NetworkAccessibility>(arg1).cref());
}
...
qt_gsi::QtNativeClass<QNetworkAccessManager> decl_QNetworkAccessManager (qtdecl_QObject (), "QtMultimedia", "QNetworkAccessManager_Native",
  methods_QNetworkAccessManager (),
  "@hide\n@alias QNetworkAccessManager");

GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QNetworkAccessManager> &qtdecl_QNetworkAccessManager () { return decl_QNetworkAccessManager; }
...
public:
  ...
  //  [emitter impl] void QNetworkAccessManager::networkAccessibleChanged(QNetworkAccessManager::NetworkAccessibility accessible)
  void emitter_QNetworkAccessManager_networkAccessibleChanged_4770(QNetworkAccessManager::NetworkAccessibility accessible)
  {
    emit QNetworkAccessManager::networkAccessibleChanged(accessible);
  }

  //  [emitter impl] void QNetworkAccessManager::networkSessionConnected()
...
// emitter void QNetworkAccessManager::networkAccessibleChanged(QNetworkAccessManager::NetworkAccessibility accessible)

static void _init_emitter_networkAccessibleChanged_4770 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("accessible");
  decl->add_arg<const qt_gsi::Converter<QNetworkAccessManager::NetworkAccessibility>::target_type & > (argspec_0);
  decl->set_return<void > ();
...
static void _call_emitter_networkAccessibleChanged_4770 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs & /*ret*/) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QNetworkAccessManager::NetworkAccessibility>::target_type & arg1 = args.read<const qt_gsi::Converter<QNetworkAccessManager::NetworkAccessibility>::target_type & > (heap);
  ((QNetworkAccessManager_Adaptor *)cls)->emitter_QNetworkAccessManager_networkAccessibleChanged_4770 (arg1);
}


// emitter void QNetworkAccessManager::networkSessionConnected()

static void _init_emitter_networkSessionConnected_0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<void > ();
}

static void _call_emitter_networkSessionConnected_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs & /*ret*/) 
{
  __SUPPRESS_UNUSED_WARNING(args);
...
gsi::Class<QNetworkAccessManager_Adaptor> decl_QNetworkAccessManager_Adaptor (qtdecl_QNetworkAccessManager (), "QtMultimedia", "QNetworkAccessManager",
...
//  Implementation of the enum wrapper class for QNetworkAccessManager::NetworkAccessibility
namespace qt_gsi
{

static gsi::Enum<QNetworkAccessManager::NetworkAccessibility> decl_QNetworkAccessManager_NetworkAccessibility_Enum ("QtMultimedia", "QNetworkAccessManager_NetworkAccessibility",
    gsi::enum_const ("UnknownAccessibility", QNetworkAccessManager::UnknownAccessibility, "@brief Enum constant QNetworkAccessManager::UnknownAccessibility") +
    gsi::enum_const ("NotAccessible", QNetworkAccessManager::NotAccessible, "@brief Enum constant QNetworkAccessManager::NotAccessible") +
    gsi::enum_const ("Accessible", QNetworkAccessManager::Accessible, "@brief Enum constant QNetworkAccessManager::Accessible"),
  "@qt\n@brief This class represents the QNetworkAccessManager::NetworkAccessibility enum");

static gsi::QFlagsClass<QNetworkAccessManager::NetworkAccessibility > decl_QNetworkAccessManager_NetworkAccessibility_Enums ("QtMultimedia", "QNetworkAccessManager_QFlags_NetworkAccessibility",
  "@qt\n@brief This class represents the QFlags<QNetworkAccessManager::NetworkAccessibility> flag set");

//  Inject the declarations into the parent
static gsi::ClassExt<QNetworkAccessManager> inject_QNetworkAccessManager_NetworkAccessibility_Enum_in_parent (decl_QNetworkAccessManager_NetworkAccessibility_Enum.defs ());
static gsi::ClassExt<QNetworkAccessManager> decl_QNetworkAccessManager_NetworkAccessibility_Enum_as_child (decl_QNetworkAccessManager_NetworkAccessibility_Enum, "NetworkAccessibility");
static gsi::ClassExt<QNetworkAccessManager> decl_QNetworkAccessManager_NetworkAccessibility_Enums_as_child (decl_QNetworkAccessManager_NetworkAccessibility_Enums, "QFlags_NetworkAccessibility");
...
static gsi::Enum<QNetworkAccessManager::Operation> decl_QNetworkAccessManager_Operation_Enum ("QtMultimedia", "QNetworkAccessManager_Operation",
...
static gsi::QFlagsClass<QNetworkAccessManager::Operation > decl_QNetworkAccessManager_Operation_Enums ("QtMultimedia", "QNetworkAccessManager_QFlags_Operation",
