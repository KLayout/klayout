...
gsi::Class<QStyleOptionToolBoxV2> decl_QStyleOptionToolBoxV2 (qtdecl_QStyleOptionToolBox (), "QStyleOptionToolBoxV2",
  methods_QStyleOptionToolBoxV2 (),
  "@qt\n@brief Binding of QStyleOptionToolBoxV2");


GSIQT_PUBLIC gsi::Class<QStyleOptionToolBoxV2> &qtdecl_QStyleOptionToolBoxV2 () { return decl_QStyleOptionToolBoxV2; }
