...
gsi::Class<QScrollEvent> decl_QScrollEvent (qtdecl_QEvent (), "QScrollEvent_Native",
  methods_QScrollEvent (),
  "@hide\n@alias QScrollEvent");

GSIQT_PUBLIC gsi::Class<QScrollEvent> &qtdecl_QScrollEvent () { return decl_QScrollEvent; }
...
gsi::Class<QScrollEvent_Adaptor> decl_QScrollEvent_Adaptor (qtdecl_QScrollEvent (), "QScrollEvent",
...
static gsi::Enum<QScrollEvent::ScrollState> decl_QScrollEvent_ScrollState_Enum ("QScrollEvent_ScrollState",
...
static gsi::QFlagsClass<QScrollEvent::ScrollState > decl_QScrollEvent_ScrollState_Enums ("QScrollEvent_QFlags_ScrollState",
