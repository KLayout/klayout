...
qt_gsi::QtNativeClass<QScreen> decl_QScreen (qtdecl_QObject (), "QScreen_Native",
  methods_QScreen (),
  "@hide\n@alias QScreen");

GSIQT_PUBLIC gsi::Class<QScreen> &qtdecl_QScreen () { return decl_QScreen; }
...
gsi::Class<QScreen_Adaptor> decl_QScreen_Adaptor (qtdecl_QScreen (), "QScreen",
