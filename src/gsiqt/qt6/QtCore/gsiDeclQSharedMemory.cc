...
// bool QSharedMemory::create(qsizetype size, QSharedMemory::AccessMode mode)


static void _init_f_create_4182 (qt_gsi::GenericMethod *decl)
{
...
static void _call_f_create_4182 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<qsizetype > ((qsizetype)((QSharedMemory *)cls)->size ());
}
...
static gsi::Methods methods_QSharedMemory () {
  ...
  methods += new qt_gsi::GenericMethod ("size", "@brief Method qsizetype QSharedMemory::size()\n", true, &_init_f_size_c0, &_call_f_size_c0);
