...
qt_gsi::QtNativeClass<QFileSystemModel> decl_QFileSystemModel (qtdecl_QAbstractItemModel (), "QFileSystemModel_Native",
...
public:
  ...
  //  [expose] void QFileSystemModel::resetInternalData()
  void fp_QFileSystemModel_resetInternalData_0 () {
  ...
  //  [emitter impl] void QFileSystemModel::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
  void emitter_QFileSystemModel_dataChanged_7048(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
  {
...
// emitter void QFileSystemModel::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles)
...
// exposed void QFileSystemModel::resetInternalData()
...
static void _call_fp_resetInternalData_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QFileSystemModel_Adaptor *)cls)->fp_QFileSystemModel_resetInternalData_0 ();
}
