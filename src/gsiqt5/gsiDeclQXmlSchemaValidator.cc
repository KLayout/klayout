...
gsi::Class<QXmlSchemaValidator> decl_QXmlSchemaValidator ("QXmlSchemaValidator",
  methods_QXmlSchemaValidator (),
  "@qt\n@brief Binding of QXmlSchemaValidator");


GSIQT_PUBLIC gsi::Class<QXmlSchemaValidator> &qtdecl_QXmlSchemaValidator () { return decl_QXmlSchemaValidator; }
