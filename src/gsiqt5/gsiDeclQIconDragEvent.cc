...
gsi::Class<QIconDragEvent> decl_QIconDragEvent (qtdecl_QEvent (), "QIconDragEvent_Native",
  methods_QIconDragEvent (),
  "@hide\n@alias QIconDragEvent");

GSIQT_PUBLIC gsi::Class<QIconDragEvent> &qtdecl_QIconDragEvent () { return decl_QIconDragEvent; }
...
gsi::Class<QIconDragEvent_Adaptor> decl_QIconDragEvent_Adaptor (qtdecl_QIconDragEvent (), "QIconDragEvent",
