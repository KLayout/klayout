...
static gsi::Enum<QColor::NameFormat> decl_QColor_NameFormat_Enum ("QColor_NameFormat",
...
static gsi::QFlagsClass<QColor::NameFormat > decl_QColor_NameFormat_Enums ("QColor_QFlags_NameFormat",
