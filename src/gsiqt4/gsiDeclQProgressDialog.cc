...
qt_gsi::QtNativeClass<QProgressDialog> decl_QProgressDialog (qtdecl_QDialog (), "QProgressDialog_Native",
  methods_QProgressDialog (),
  "@hide\n@alias QProgressDialog");

GSIQT_PUBLIC gsi::Class<QProgressDialog> &qtdecl_QProgressDialog () { return decl_QProgressDialog; }
...
gsi::Class<QProgressDialog_Adaptor> decl_QProgressDialog_Adaptor (qtdecl_QProgressDialog (), "QProgressDialog",
