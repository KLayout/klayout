...
// QStyleOptionViewItem &QStyleOptionViewItem::operator=(const QStyleOptionViewItem &)
...
static void _call_f_operator_eq__3366 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  const QStyleOptionViewItem &arg1 = gsi::arg_reader<const QStyleOptionViewItem & >() (args, heap);
  ret.write<QStyleOptionViewItem & > ((QStyleOptionViewItem &)((QStyleOptionViewItem *)cls)->operator= (arg1));
}
...
static gsi::Methods methods_QStyleOptionViewItem () {
  ...
  methods += new qt_gsi::GenericMethod ("assign", "@brief Method QStyleOptionViewItem &QStyleOptionViewItem::operator=(const QStyleOptionViewItem &)\n", false, &_init_f_operator_eq__3366, &_call_f_operator_eq__3366);
  return methods;
}
