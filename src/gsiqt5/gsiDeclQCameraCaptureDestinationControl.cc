...
qt_gsi::QtNativeClass<QCameraCaptureDestinationControl> decl_QCameraCaptureDestinationControl (qtdecl_QMediaControl (), "QCameraCaptureDestinationControl_Native",
  methods_QCameraCaptureDestinationControl (),
  "@hide\n@alias QCameraCaptureDestinationControl");

GSIQT_PUBLIC gsi::Class<QCameraCaptureDestinationControl> &qtdecl_QCameraCaptureDestinationControl () { return decl_QCameraCaptureDestinationControl; }
...
gsi::Class<QCameraCaptureDestinationControl_Adaptor> decl_QCameraCaptureDestinationControl_Adaptor (qtdecl_QCameraCaptureDestinationControl (), "QCameraCaptureDestinationControl",
