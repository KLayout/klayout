...
gsi::Class<QRunnable> decl_QRunnable ("QRunnable_Native",
  methods_QRunnable (),
  "@hide\n@alias QRunnable");

GSIQT_PUBLIC gsi::Class<QRunnable> &qtdecl_QRunnable () { return decl_QRunnable; }
...
gsi::Class<QRunnable_Adaptor> decl_QRunnable_Adaptor (qtdecl_QRunnable (), "QRunnable",
