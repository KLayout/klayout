...
gsi::Class<QXmlEntityResolver> decl_QXmlEntityResolver ("QtCore5Compat", "QXmlEntityResolver",
  methods_QXmlEntityResolver (),
  "@qt\n@brief Binding of QXmlEntityResolver");


GSI_QTCORE5COMPAT_PUBLIC gsi::Class<QXmlEntityResolver> &qtdecl_QXmlEntityResolver () { return decl_QXmlEntityResolver; }
