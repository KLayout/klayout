...
Class<db::DeviceClass::SpiceProfile> decl_dbDeviceClassSpiceProfile ("db", "DeviceClassSpiceProfile",
  ...
  gsi::method_ext ("terminal_order", &get_terminal_order,
    ...
    "names of the device."
    "\n"
    "Note, that the terminal order attribute is a copy. In order to manipulate it, you need "
    "to change the copy and put it back again:\n"
    "\n"
    "@code\n"
  ...
  gsi::method_ext ("incoming_parameters", &get_incoming_parameters,
    ...
    "\n"
    "Note, that the incoming parameter hash is a copy. In order to manipulate it, you "
    "need get and set it:\n"
    "\n"
    "@code\n"
