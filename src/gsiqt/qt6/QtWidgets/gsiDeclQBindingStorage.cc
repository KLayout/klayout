...
gsi::Class<QBindingStorage> decl_QBindingStorage ("Qt", "QBindingStorage",
  methods_QBindingStorage (),
  "@qt\n@brief Binding of QBindingStorage");


GSI_QT_PUBLIC gsi::Class<QBindingStorage> &qtdecl_QBindingStorage () { return decl_QBindingStorage; }
