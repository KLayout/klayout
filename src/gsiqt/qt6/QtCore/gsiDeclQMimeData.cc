...
public:
  ...
  //  [adaptor impl] QVariant QMimeData::retrieveData(const QString &mimetype, QMetaType preferredType)
  QVariant cbs_retrieveData_c3243_0(const QString &mimetype, QMetaType preferredType) const
  {
  ...
  {
    if (cb_retrieveData_c3243_0.can_issue()) {
      return cb_retrieveData_c3243_0.issue<QMimeData_Adaptor, QVariant, const QString &, QMetaType>(&QMimeData_Adaptor::cbs_retrieveData_c3243_0, mimetype, preferredType);
    } else {
      return QMimeData::retrieveData(mimetype, preferredType);
    }
  }
  ...
  gsi::Callback cb_retrieveData_c3243_0;
...
// QVariant QMimeData::retrieveData(const QString &mimetype, QMetaType preferredType)

static void _init_cbs_retrieveData_c3243_0 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("mimetype");
  decl->add_arg<const QString & > (argspec_0);
...
static void _call_cbs_retrieveData_c3243_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QString &arg1 = args.read<const QString & > (heap);
  QMetaType arg2 = args.read<QMetaType > (heap);
  ret.write<QVariant > ((QVariant)((QMimeData_Adaptor *)cls)->cbs_retrieveData_c3243_0 (arg1, arg2));
}

static void _set_callback_cbs_retrieveData_c3243_0 (void *cls, const gsi::Callback &cb)
{
  ((QMimeData_Adaptor *)cls)->cb_retrieveData_c3243_0 = cb;
}
...
static gsi::Methods methods_QMimeData_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*retrieveData", "@brief Virtual method QVariant QMimeData::retrieveData(const QString &mimetype, QMetaType preferredType)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_retrieveData_c3243_0, &_call_cbs_retrieveData_c3243_0);
  methods += new qt_gsi::GenericMethod ("*retrieveData", "@hide", true, &_init_cbs_retrieveData_c3243_0, &_call_cbs_retrieveData_c3243_0, &_set_callback_cbs_retrieveData_c3243_0);
