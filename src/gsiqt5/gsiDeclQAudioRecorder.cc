...
qt_gsi::QtNativeClass<QAudioRecorder> decl_QAudioRecorder (qtdecl_QMediaRecorder (), "QAudioRecorder_Native",
  methods_QAudioRecorder (),
  "@hide\n@alias QAudioRecorder");

GSIQT_PUBLIC gsi::Class<QAudioRecorder> &qtdecl_QAudioRecorder () { return decl_QAudioRecorder; }
...
gsi::Class<QAudioRecorder_Adaptor> decl_QAudioRecorder_Adaptor (qtdecl_QAudioRecorder (), "QAudioRecorder",
