...
gsi::Class<QVideoFrame> decl_QVideoFrame ("QVideoFrame",
  methods_QVideoFrame (),
  "@qt\n@brief Binding of QVideoFrame");


GSIQT_PUBLIC gsi::Class<QVideoFrame> &qtdecl_QVideoFrame () { return decl_QVideoFrame; }
...
static gsi::Enum<QVideoFrame::FieldType> decl_QVideoFrame_FieldType_Enum ("QVideoFrame_FieldType",
...
static gsi::QFlagsClass<QVideoFrame::FieldType > decl_QVideoFrame_FieldType_Enums ("QVideoFrame_QFlags_FieldType",
...
static gsi::Enum<QVideoFrame::PixelFormat> decl_QVideoFrame_PixelFormat_Enum ("QVideoFrame_PixelFormat",
...
static gsi::QFlagsClass<QVideoFrame::PixelFormat > decl_QVideoFrame_PixelFormat_Enums ("QVideoFrame_QFlags_PixelFormat",
