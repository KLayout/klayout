...
gsi::Class<QSslPreSharedKeyAuthenticator> decl_QSslPreSharedKeyAuthenticator ("QtMultimedia", "QSslPreSharedKeyAuthenticator",
  methods_QSslPreSharedKeyAuthenticator (),
  "@qt\n@brief Binding of QSslPreSharedKeyAuthenticator");


GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QSslPreSharedKeyAuthenticator> &qtdecl_QSslPreSharedKeyAuthenticator () { return decl_QSslPreSharedKeyAuthenticator; }
