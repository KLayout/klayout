...
gsi::Class<QNetworkInterface> decl_QNetworkInterface ("QtMultimedia", "QNetworkInterface",
  methods_QNetworkInterface (),
  "@qt\n@brief Binding of QNetworkInterface");


GSI_QTMULTIMEDIA_PUBLIC gsi::Class<QNetworkInterface> &qtdecl_QNetworkInterface () { return decl_QNetworkInterface; }
...
static gsi::Enum<QNetworkInterface::InterfaceFlag> decl_QNetworkInterface_InterfaceFlag_Enum ("QtMultimedia", "QNetworkInterface_InterfaceFlag",
...
static gsi::QFlagsClass<QNetworkInterface::InterfaceFlag > decl_QNetworkInterface_InterfaceFlag_Enums ("QtMultimedia", "QNetworkInterface_QFlags_InterfaceFlag",
