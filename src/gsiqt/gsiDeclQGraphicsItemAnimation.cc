...
static gsi::Methods methods_QGraphicsItemAnimation () {
  ...
  methods += new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QGraphicsItemAnimation::tr(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_tr_3354, &_call_f_tr_3354);
  ...
  methods += new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QGraphicsItemAnimation::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
...
gsi::Class<QGraphicsItemAnimation> decl_QGraphicsItemAnimation (qtdecl_QObject (), "QGraphicsItemAnimation_Native",
...
static gsi::Methods methods_QGraphicsItemAnimation_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("*disconnectNotify", "@brief Virtual method void QGraphicsItemAnimation::disconnectNotify(const char *signal)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_disconnectNotify_1731_0, &_call_cbs_disconnectNotify_1731_0, &_set_callback_cbs_disconnectNotify_1731_0);
