...
qt_gsi::QtNativeClass<QCameraImageCaptureControl> decl_QCameraImageCaptureControl (qtdecl_QMediaControl (), "QCameraImageCaptureControl_Native",
  methods_QCameraImageCaptureControl (),
  "@hide\n@alias QCameraImageCaptureControl");

GSIQT_PUBLIC gsi::Class<QCameraImageCaptureControl> &qtdecl_QCameraImageCaptureControl () { return decl_QCameraImageCaptureControl; }
...
gsi::Class<QCameraImageCaptureControl_Adaptor> decl_QCameraImageCaptureControl_Adaptor (qtdecl_QCameraImageCaptureControl (), "QCameraImageCaptureControl",
