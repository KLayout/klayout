...
qt_gsi::QtNativeClass<QCameraFeedbackControl> decl_QCameraFeedbackControl (qtdecl_QMediaControl (), "QCameraFeedbackControl_Native",
  methods_QCameraFeedbackControl (),
  "@hide\n@alias QCameraFeedbackControl");

GSIQT_PUBLIC gsi::Class<QCameraFeedbackControl> &qtdecl_QCameraFeedbackControl () { return decl_QCameraFeedbackControl; }
...
gsi::Class<QCameraFeedbackControl_Adaptor> decl_QCameraFeedbackControl_Adaptor (qtdecl_QCameraFeedbackControl (), "QCameraFeedbackControl",
...
static gsi::Enum<QCameraFeedbackControl::EventType> decl_QCameraFeedbackControl_EventType_Enum ("QCameraFeedbackControl_EventType",
...
static gsi::QFlagsClass<QCameraFeedbackControl::EventType > decl_QCameraFeedbackControl_EventType_Enums ("QCameraFeedbackControl_QFlags_EventType",
