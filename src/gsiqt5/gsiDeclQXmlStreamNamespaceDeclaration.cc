...
gsi::Class<QXmlStreamNamespaceDeclaration> decl_QXmlStreamNamespaceDeclaration ("QXmlStreamNamespaceDeclaration",
  methods_QXmlStreamNamespaceDeclaration (),
  "@qt\n@brief Binding of QXmlStreamNamespaceDeclaration");


GSIQT_PUBLIC gsi::Class<QXmlStreamNamespaceDeclaration> &qtdecl_QXmlStreamNamespaceDeclaration () { return decl_QXmlStreamNamespaceDeclaration; }
