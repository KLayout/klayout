...
qt_gsi::QtNativeClass<QCameraFocusControl> decl_QCameraFocusControl (qtdecl_QMediaControl (), "QCameraFocusControl_Native",
  methods_QCameraFocusControl (),
  "@hide\n@alias QCameraFocusControl");

GSIQT_PUBLIC gsi::Class<QCameraFocusControl> &qtdecl_QCameraFocusControl () { return decl_QCameraFocusControl; }
...
gsi::Class<QCameraFocusControl_Adaptor> decl_QCameraFocusControl_Adaptor (qtdecl_QCameraFocusControl (), "QCameraFocusControl",
