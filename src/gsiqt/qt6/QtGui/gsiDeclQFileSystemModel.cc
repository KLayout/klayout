...
// QAbstractFileIconProvider *QFileSystemModel::iconProvider()
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QAbstractFileIconProvider * > ((QAbstractFileIconProvider *)((QFileSystemModel *)cls)->iconProvider ());
}
...
// QFlags<QFileSystemModel::Option> QFileSystemModel::options()


static void _init_f_options_c0 (qt_gsi::GenericMethod *decl)
{
  decl->set_return<QFlags<QFileSystemModel::Option> > ();
}

static void _call_f_options_c0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QFlags<QFileSystemModel::Option> > ((QFlags<QFileSystemModel::Option>)((QFileSystemModel *)cls)->options ());
}
...
// QHash<int, QByteArray> QFileSystemModel::roleNames()
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QHash<int, QByteArray> > ((QHash<int, QByteArray>)((QFileSystemModel *)cls)->roleNames ());
}
...
// void QFileSystemModel::setOption(QFileSystemModel::Option option, bool on)


static void _init_f_setOption_3548 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("option");
  decl->add_arg<const qt_gsi::Converter<QFileSystemModel::Option>::target_type & > (argspec_0);
  static gsi::ArgSpecBase argspec_1 ("on", true, "true");
  decl->add_arg<bool > (argspec_1);
  decl->set_return<void > ();
}

static void _call_f_setOption_3548 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QFileSystemModel::Option>::target_type & arg1 = gsi::arg_reader<const qt_gsi::Converter<QFileSystemModel::Option>::target_type & >() (args, heap);
  bool arg2 = args ? gsi::arg_reader<bool >() (args, heap) : gsi::arg_maker<bool >() (true, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QFileSystemModel *)cls)->setOption (qt_gsi::QtToCppAdaptor<QFileSystemModel::Option>(arg1).cref(), arg2);
}


// void QFileSystemModel::setOptions(QFlags<QFileSystemModel::Option> options)


static void _init_f_setOptions_3488 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("options");
  decl->add_arg<QFlags<QFileSystemModel::Option> > (argspec_0);
  decl->set_return<void > ();
}

static void _call_f_setOptions_3488 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  QFlags<QFileSystemModel::Option> arg1 = gsi::arg_reader<QFlags<QFileSystemModel::Option> >() (args, heap);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QFileSystemModel *)cls)->setOptions (arg1);
}
...
static void _init_f_testOption_c2792 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("option");
  decl->add_arg<const qt_gsi::Converter<QFileSystemModel::Option>::target_type & > (argspec_0);
  decl->set_return<bool > ();
...
static void _call_f_testOption_c2792 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const qt_gsi::Converter<QFileSystemModel::Option>::target_type & arg1 = gsi::arg_reader<const qt_gsi::Converter<QFileSystemModel::Option>::target_type & >() (args, heap);
  ret.write<bool > ((bool)((QFileSystemModel *)cls)->testOption (qt_gsi::QtToCppAdaptor<QFileSystemModel::Option>(arg1).cref()));
}
...
static gsi::Methods methods_QFileSystemModel () {
  ...
  methods += new qt_gsi::GenericMethod (":iconProvider", "@brief Method QAbstractFileIconProvider *QFileSystemModel::iconProvider()\n", true, &_init_f_iconProvider_c0, &_call_f_iconProvider_c0);
  ...
  methods += new qt_gsi::GenericMethod ("setIconProvider|iconProvider=", "@brief Method void QFileSystemModel::setIconProvider(QAbstractFileIconProvider *provider)\n", false, &_init_f_setIconProvider_3143, &_call_f_setIconProvider_3143);
  ...
  methods += new qt_gsi::GenericMethod ("testOption", "@brief Method bool QFileSystemModel::testOption(QFileSystemModel::Option option)\n", true, &_init_f_testOption_c2792, &_call_f_testOption_c2792);
  ...
  methods += gsi::qt_signal<const QModelIndex &, const QModelIndex &, const QList<int> & > ("dataChanged(const QModelIndex &, const QModelIndex &, const QList<int> &)", "dataChanged", gsi::arg("topLeft"), gsi::arg("bottomRight"), gsi::arg("roles"), "@brief Signal declaration for QFileSystemModel::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QList<int> &roles)\nYou can bind a procedure to this signal.");
...
qt_gsi::QtNativeClass<QFileSystemModel> decl_QFileSystemModel (qtdecl_QAbstractItemModel (), "QtGui", "QFileSystemModel_Native",
  methods_QFileSystemModel (),
  "@hide\n@alias QFileSystemModel");

GSI_QTGUI_PUBLIC gsi::Class<QFileSystemModel> &qtdecl_QFileSystemModel () { return decl_QFileSystemModel; }
...
public:
  ...
  //  [expose] QModelIndex QFileSystemModel::createIndex(int row, int column, const void *data)
  QModelIndex fp_QFileSystemModel_createIndex_c3069 (int row, int column, const void *data) const {
    return QFileSystemModel::createIndex(row, column, data);
  }

  //  [expose] QModelIndex QFileSystemModel::createIndex(int row, int column, quintptr id)
  QModelIndex fp_QFileSystemModel_createIndex_c2657 (int row, int column, quintptr id) const {
  ...
  //  [expose] bool QFileSystemModel::isSignalConnected(const QMetaMethod &signal)
  bool fp_QFileSystemModel_isSignalConnected_c2394 (const QMetaMethod &signal) const {
  ...
  //  [expose] int QFileSystemModel::senderSignalIndex()
  int fp_QFileSystemModel_senderSignalIndex_c0 () const {
  ...
  //  [adaptor impl] bool QFileSystemModel::canDropMimeData(const QMimeData *data, Qt::DropAction action, int row, int column, const QModelIndex &parent)
  ...
  {
    return QFileSystemModel::canDropMimeData(data, qt_gsi::QtToCppAdaptor<Qt::DropAction>(action).cref(), row, column, parent);
  }

  virtual bool canDropMimeData(const QMimeData *data, Qt::DropAction action, int row, int column, const QModelIndex &parent) const
  {
    if (cb_canDropMimeData_c7425_0.can_issue()) {
      return cb_canDropMimeData_c7425_0.issue<QFileSystemModel_Adaptor, bool, const QMimeData *, const qt_gsi::Converter<Qt::DropAction>::target_type &, int, int, const QModelIndex &>(&QFileSystemModel_Adaptor::cbs_canDropMimeData_c7425_0, data, qt_gsi::CppToQtAdaptor<Qt::DropAction>(action), row, column, parent);
    } else {
  ...
  //  [adaptor impl] bool QFileSystemModel::clearItemData(const QModelIndex &index)
  ...
  virtual bool clearItemData(const QModelIndex &index)
  {
    if (cb_clearItemData_2395_0.can_issue()) {
      return cb_clearItemData_2395_0.issue<QFileSystemModel_Adaptor, bool, const QModelIndex &>(&QFileSystemModel_Adaptor::cbs_clearItemData_2395_0, index);
    } else {
      return QFileSystemModel::clearItemData(index);
    }
  }
  ...
  //  [emitter impl] void QFileSystemModel::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QList<int> &roles)
  void emitter_QFileSystemModel_dataChanged_6833(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QList<int> &roles)
  {
    emit QFileSystemModel::dataChanged(topLeft, bottomRight, roles);
  }
  ...
  //  [emitter impl] void QFileSystemModel::directoryLoaded(const QString &path)
  void emitter_QFileSystemModel_directoryLoaded_2025(const QString &path)
  {
    emit QFileSystemModel::directoryLoaded(path);
  }
  ...
  //  [emitter impl] void QFileSystemModel::layoutAboutToBeChanged(const QList<QPersistentModelIndex> &parents, QAbstractItemModel::LayoutChangeHint hint)
  void emitter_QFileSystemModel_layoutAboutToBeChanged_7947(const QList<QPersistentModelIndex> &parents, QAbstractItemModel::LayoutChangeHint hint)
  {
    emit QFileSystemModel::layoutAboutToBeChanged(parents, hint);
  }

  //  [emitter impl] void QFileSystemModel::layoutChanged(const QList<QPersistentModelIndex> &parents, QAbstractItemModel::LayoutChangeHint hint)
  void emitter_QFileSystemModel_layoutChanged_7947(const QList<QPersistentModelIndex> &parents, QAbstractItemModel::LayoutChangeHint hint)
  {
    emit QFileSystemModel::layoutChanged(parents, hint);
  }
  ...
  virtual bool moveColumns(const QModelIndex &sourceParent, int sourceColumn, int count, const QModelIndex &destinationParent, int destinationChild)
  {
    if (cb_moveColumns_6659_0.can_issue()) {
      return cb_moveColumns_6659_0.issue<QFileSystemModel_Adaptor, bool, const QModelIndex &, int, int, const QModelIndex &, int>(&QFileSystemModel_Adaptor::cbs_moveColumns_6659_0, sourceParent, sourceColumn, count, destinationParent, destinationChild);
    } else {
      return QFileSystemModel::moveColumns(sourceParent, sourceColumn, count, destinationParent, destinationChild);
    }
  }

  //  [adaptor impl] bool QFileSystemModel::moveRows(const QModelIndex &sourceParent, int sourceRow, int count, const QModelIndex &destinationParent, int destinationChild)
  ...
  virtual bool moveRows(const QModelIndex &sourceParent, int sourceRow, int count, const QModelIndex &destinationParent, int destinationChild)
  {
    if (cb_moveRows_6659_0.can_issue()) {
      return cb_moveRows_6659_0.issue<QFileSystemModel_Adaptor, bool, const QModelIndex &, int, int, const QModelIndex &, int>(&QFileSystemModel_Adaptor::cbs_moveRows_6659_0, sourceParent, sourceRow, count, destinationParent, destinationChild);
    } else {
      return QFileSystemModel::moveRows(sourceParent, sourceRow, count, destinationParent, destinationChild);
    }
  }

  //  [adaptor impl] void QFileSystemModel::multiData(const QModelIndex &index, QModelRoleDataSpan roleDataSpan)
  ...
  virtual void multiData(const QModelIndex &index, QModelRoleDataSpan roleDataSpan) const
  {
    if (cb_multiData_c4483_0.can_issue()) {
      cb_multiData_c4483_0.issue<QFileSystemModel_Adaptor, const QModelIndex &, QModelRoleDataSpan>(&QFileSystemModel_Adaptor::cbs_multiData_c4483_0, index, roleDataSpan);
    } else {
      QFileSystemModel::multiData(index, roleDataSpan);
    }
  }
  ...
  //  [adaptor impl] QHash<int, QByteArray> QFileSystemModel::roleNames()
  ...
  virtual QHash<int, QByteArray> roleNames() const
  {
    if (cb_roleNames_c0_0.can_issue()) {
      return cb_roleNames_c0_0.issue<QFileSystemModel_Adaptor, QHash<int, QByteArray> >(&QFileSystemModel_Adaptor::cbs_roleNames_c0_0);
    } else {
      return QFileSystemModel::roleNames();
    }
  }
  ...
  //  [adaptor impl] QModelIndex QFileSystemModel::sibling(int row, int column, const QModelIndex &idx)
  ...
  virtual QModelIndex sibling(int row, int column, const QModelIndex &idx) const
  {
    if (cb_sibling_c3713_0.can_issue()) {
      return cb_sibling_c3713_0.issue<QFileSystemModel_Adaptor, QModelIndex, int, int, const QModelIndex &>(&QFileSystemModel_Adaptor::cbs_sibling_c3713_0, row, column, idx);
    } else {
      return QFileSystemModel::sibling(row, column, idx);
    }
  }
  ...
  //  [adaptor impl] QFlags<Qt::DropAction> QFileSystemModel::supportedDragActions()
  ...
  virtual QFlags<Qt::DropAction> supportedDragActions() const
  {
    if (cb_supportedDragActions_c0_0.can_issue()) {
      return cb_supportedDragActions_c0_0.issue<QFileSystemModel_Adaptor, QFlags<Qt::DropAction> >(&QFileSystemModel_Adaptor::cbs_supportedDragActions_c0_0);
    } else {
      return QFileSystemModel::supportedDragActions();
    }
  }
  ...
  //  [adaptor impl] void QFileSystemModel::disconnectNotify(const QMetaMethod &signal)
  ...
  virtual void disconnectNotify(const QMetaMethod &signal)
  {
    if (cb_disconnectNotify_2394_0.can_issue()) {
      cb_disconnectNotify_2394_0.issue<QFileSystemModel_Adaptor, const QMetaMethod &>(&QFileSystemModel_Adaptor::cbs_disconnectNotify_2394_0, signal);
    } else {
      QFileSystemModel::disconnectNotify(signal);
    }
  }
  ...
  //  [adaptor impl] void QFileSystemModel::resetInternalData()
  ...
  virtual void resetInternalData()
  {
    if (cb_resetInternalData_0_0.can_issue()) {
      cb_resetInternalData_0_0.issue<QFileSystemModel_Adaptor>(&QFileSystemModel_Adaptor::cbs_resetInternalData_0_0);
    } else {
      QFileSystemModel::resetInternalData();
    }
  }
...
// bool QFileSystemModel::canDropMimeData(const QMimeData *data, Qt::DropAction action, int row, int column, const QModelIndex &parent)
...
static void _call_cbs_canDropMimeData_c7425_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  int arg4 = gsi::arg_reader<int >() (args, heap);
  const QModelIndex &arg5 = gsi::arg_reader<const QModelIndex & >() (args, heap);
  ret.write<bool > ((bool)((QFileSystemModel_Adaptor *)cls)->cbs_canDropMimeData_c7425_0 (arg1, arg2, arg3, arg4, arg5));
}

static void _set_callback_cbs_canDropMimeData_c7425_0 (void *cls, const gsi::Callback &cb)
{
  ((QFileSystemModel_Adaptor *)cls)->cb_canDropMimeData_c7425_0 = cb;
}
...
// bool QFileSystemModel::clearItemData(const QModelIndex &index)
...
static void _call_cbs_clearItemData_2395_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  const QModelIndex &arg1 = gsi::arg_reader<const QModelIndex & >() (args, heap);
  ret.write<bool > ((bool)((QFileSystemModel_Adaptor *)cls)->cbs_clearItemData_2395_0 (arg1));
}

static void _set_callback_cbs_clearItemData_2395_0 (void *cls, const gsi::Callback &cb)
{
  ((QFileSystemModel_Adaptor *)cls)->cb_clearItemData_2395_0 = cb;
}
...
// exposed QModelIndex QFileSystemModel::createIndex(int row, int column, const void *data)
...
static void _call_fp_createIndex_c3069 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<QModelIndex > ((QModelIndex)((QFileSystemModel_Adaptor *)cls)->fp_QFileSystemModel_createIndex_c3069 (arg1, arg2, arg3));
}


// exposed QModelIndex QFileSystemModel::createIndex(int row, int column, quintptr id)
...
// emitter void QFileSystemModel::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QList<int> &roles)
...
static void _call_emitter_dataChanged_6833 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs & /*ret*/) 
{
  ...
  ((QFileSystemModel_Adaptor *)cls)->emitter_QFileSystemModel_dataChanged_6833 (arg1, arg2, arg3);
}
...
// emitter void QFileSystemModel::directoryLoaded(const QString &path)

static void _init_emitter_directoryLoaded_2025 (qt_gsi::GenericMethod *decl)
{
  static gsi::ArgSpecBase argspec_0 ("path");
  decl->add_arg<const QString & > (argspec_0);
  decl->set_return<void > ();
...
static void _call_emitter_directoryLoaded_2025 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs & /*ret*/) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  tl::Heap heap;
  const QString &arg1 = gsi::arg_reader<const QString & >() (args, heap);
...
// void QFileSystemModel::disconnectNotify(const QMetaMethod &signal)
...
static void _call_cbs_disconnectNotify_2394_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QFileSystemModel_Adaptor *)cls)->cbs_disconnectNotify_2394_0 (arg1);
}

static void _set_callback_cbs_disconnectNotify_2394_0 (void *cls, const gsi::Callback &cb)
{
  ((QFileSystemModel_Adaptor *)cls)->cb_disconnectNotify_2394_0 = cb;
}
...
// exposed bool QFileSystemModel::isSignalConnected(const QMetaMethod &signal)
...
// emitter void QFileSystemModel::layoutAboutToBeChanged(const QList<QPersistentModelIndex> &parents, QAbstractItemModel::LayoutChangeHint hint)
...
// emitter void QFileSystemModel::layoutChanged(const QList<QPersistentModelIndex> &parents, QAbstractItemModel::LayoutChangeHint hint)
...
static void _call_cbs_moveColumns_6659_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  const QModelIndex &arg4 = gsi::arg_reader<const QModelIndex & >() (args, heap);
  int arg5 = gsi::arg_reader<int >() (args, heap);
  ret.write<bool > ((bool)((QFileSystemModel_Adaptor *)cls)->cbs_moveColumns_6659_0 (arg1, arg2, arg3, arg4, arg5));
}

static void _set_callback_cbs_moveColumns_6659_0 (void *cls, const gsi::Callback &cb)
{
  ((QFileSystemModel_Adaptor *)cls)->cb_moveColumns_6659_0 = cb;
}


// bool QFileSystemModel::moveRows(const QModelIndex &sourceParent, int sourceRow, int count, const QModelIndex &destinationParent, int destinationChild)
...
static void _call_cbs_moveRows_6659_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  const QModelIndex &arg4 = gsi::arg_reader<const QModelIndex & >() (args, heap);
  int arg5 = gsi::arg_reader<int >() (args, heap);
  ret.write<bool > ((bool)((QFileSystemModel_Adaptor *)cls)->cbs_moveRows_6659_0 (arg1, arg2, arg3, arg4, arg5));
}
...
// void QFileSystemModel::multiData(const QModelIndex &index, QModelRoleDataSpan roleDataSpan)
...
static void _call_cbs_multiData_c4483_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QFileSystemModel_Adaptor *)cls)->cbs_multiData_c4483_0 (arg1, arg2);
}

static void _set_callback_cbs_multiData_c4483_0 (void *cls, const gsi::Callback &cb)
{
  ((QFileSystemModel_Adaptor *)cls)->cb_multiData_c4483_0 = cb;
}
...
// void QFileSystemModel::resetInternalData()
...
static void _call_cbs_resetInternalData_0_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  __SUPPRESS_UNUSED_WARNING(args);
  __SUPPRESS_UNUSED_WARNING(ret);
  ((QFileSystemModel_Adaptor *)cls)->cbs_resetInternalData_0_0 ();
}

static void _set_callback_cbs_resetInternalData_0_0 (void *cls, const gsi::Callback &cb)
{
  ((QFileSystemModel_Adaptor *)cls)->cb_resetInternalData_0_0 = cb;
}
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QHash<int, QByteArray> > ((QHash<int, QByteArray>)((QFileSystemModel_Adaptor *)cls)->cbs_roleNames_c0_0 ());
}

static void _set_callback_cbs_roleNames_c0_0 (void *cls, const gsi::Callback &cb)
{
  ((QFileSystemModel_Adaptor *)cls)->cb_roleNames_c0_0 = cb;
}
...
// exposed int QFileSystemModel::senderSignalIndex()
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<int > ((int)((QFileSystemModel_Adaptor *)cls)->fp_QFileSystemModel_senderSignalIndex_c0 ());
}
...
static void _call_cbs_sibling_c3713_0 (const qt_gsi::GenericMethod * /*decl*/, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  int arg2 = gsi::arg_reader<int >() (args, heap);
  const QModelIndex &arg3 = gsi::arg_reader<const QModelIndex & >() (args, heap);
  ret.write<QModelIndex > ((QModelIndex)((QFileSystemModel_Adaptor *)cls)->cbs_sibling_c3713_0 (arg1, arg2, arg3));
}

static void _set_callback_cbs_sibling_c3713_0 (void *cls, const gsi::Callback &cb)
{
  ((QFileSystemModel_Adaptor *)cls)->cb_sibling_c3713_0 = cb;
}
...
// QFlags<Qt::DropAction> QFileSystemModel::supportedDragActions()
...
{
  __SUPPRESS_UNUSED_WARNING(args);
  ret.write<QFlags<Qt::DropAction> > ((QFlags<Qt::DropAction>)((QFileSystemModel_Adaptor *)cls)->cbs_supportedDragActions_c0_0 ());
}

static void _set_callback_cbs_supportedDragActions_c0_0 (void *cls, const gsi::Callback &cb)
{
  ((QFileSystemModel_Adaptor *)cls)->cb_supportedDragActions_c0_0 = cb;
}
...
static gsi::Methods methods_QFileSystemModel_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("clearItemData", "@brief Virtual method bool QFileSystemModel::clearItemData(const QModelIndex &index)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_clearItemData_2395_0, &_call_cbs_clearItemData_2395_0);
  ...
  methods += new qt_gsi::GenericMethod ("emit_dataChanged", "@brief Emitter for signal void QFileSystemModel::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QList<int> &roles)\nCall this method to emit this signal.", false, &_init_emitter_dataChanged_6833, &_call_emitter_dataChanged_6833);
  ...
  methods += new qt_gsi::GenericMethod ("multiData", "@brief Virtual method void QFileSystemModel::multiData(const QModelIndex &index, QModelRoleDataSpan roleDataSpan)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_multiData_c4483_0, &_call_cbs_multiData_c4483_0);
...
gsi::Class<QFileSystemModel_Adaptor> decl_QFileSystemModel_Adaptor (qtdecl_QFileSystemModel (), "QtGui", "QFileSystemModel",
...
//  Implementation of the enum wrapper class for QFileSystemModel::Option
namespace qt_gsi
{

static gsi::Enum<QFileSystemModel::Option> decl_QFileSystemModel_Option_Enum ("QtGui", "QFileSystemModel_Option",
    gsi::enum_const ("DontWatchForChanges", QFileSystemModel::DontWatchForChanges, "@brief Enum constant QFileSystemModel::DontWatchForChanges") +
    gsi::enum_const ("DontResolveSymlinks", QFileSystemModel::DontResolveSymlinks, "@brief Enum constant QFileSystemModel::DontResolveSymlinks") +
    gsi::enum_const ("DontUseCustomDirectoryIcons", QFileSystemModel::DontUseCustomDirectoryIcons, "@brief Enum constant QFileSystemModel::DontUseCustomDirectoryIcons"),
  "@qt\n@brief This class represents the QFileSystemModel::Option enum");

static gsi::QFlagsClass<QFileSystemModel::Option > decl_QFileSystemModel_Option_Enums ("QtGui", "QFileSystemModel_QFlags_Option",
  "@qt\n@brief This class represents the QFlags<QFileSystemModel::Option> flag set");

//  Inject the declarations into the parent
static gsi::ClassExt<QFileSystemModel> inject_QFileSystemModel_Option_Enum_in_parent (decl_QFileSystemModel_Option_Enum.defs ());
static gsi::ClassExt<QFileSystemModel> decl_QFileSystemModel_Option_Enum_as_child (decl_QFileSystemModel_Option_Enum, "Option");
static gsi::ClassExt<QFileSystemModel> decl_QFileSystemModel_Option_Enums_as_child (decl_QFileSystemModel_Option_Enums, "QFlags_Option");
