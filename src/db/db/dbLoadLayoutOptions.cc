...
void LoadLayoutOptions::set_options (const FormatSpecificReaderOptions &options)
{
...
void LoadLayoutOptions::set_option_by_method (const std::string &method, const tl::Variant &value)
{
...
void LoadLayoutOptions::set_option_by_name (const std::string &method, const tl::Variant &value)
{
