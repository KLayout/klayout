...
static gsi::Enum<Qt::AnchorAttribute> decl_Qt_AnchorAttribute_Enum ("QtCore", "Qt_AnchorAttribute",
...
static gsi::QFlagsClass<Qt::AnchorAttribute > decl_Qt_AnchorAttribute_Enums ("QtCore", "Qt_QFlags_AnchorAttribute",
