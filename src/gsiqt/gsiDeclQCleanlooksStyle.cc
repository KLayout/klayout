...
GSIQT_PUBLIC gsi::Class<QCleanlooksStyle> &qtdecl_QCleanlooksStyle () { return decl_QCleanlooksStyle; }
...
static gsi::Methods methods_QCleanlooksStyle_Adaptor () {
  ...
  methods += new qt_gsi::GenericMethod ("drawComplexControl", "@hide", true, &_init_cbs_drawComplexControl_c9027_0, &_call_cbs_drawComplexControl_c9027_0);
  ...
  methods += new qt_gsi::GenericMethod ("drawControl", "@hide", true, &_init_cbs_drawControl_c8285_0, &_call_cbs_drawControl_c8285_0);
  ...
  methods += new qt_gsi::GenericMethod ("sizeFromContents", "@hide", true, &_init_cbs_sizeFromContents_c8477_0, &_call_cbs_sizeFromContents_c8477_0);
  ...
  methods += new qt_gsi::GenericMethod ("subControlRect", "@hide", true, &_init_cbs_subControlRect_c9798_0, &_call_cbs_subControlRect_c9798_0);
...
gsi::Class<QCleanlooksStyle_Adaptor> decl_QCleanlooksStyle_Adaptor (qtdecl_QCleanlooksStyle (), "QCleanlooksStyle",
