...
gsi::Class<QStyleHintReturnVariant> decl_QStyleHintReturnVariant (qtdecl_QStyleHintReturn (), "QtGui", "QStyleHintReturnVariant",
  methods_QStyleHintReturnVariant (),
  "@qt\n@brief Binding of QStyleHintReturnVariant");


GSI_QTGUI_PUBLIC gsi::Class<QStyleHintReturnVariant> &qtdecl_QStyleHintReturnVariant () { return decl_QStyleHintReturnVariant; }
